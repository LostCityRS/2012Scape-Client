...
public class ClientOptions extends Node {
	...
	public void method15443(Packet arg0) {
		if (arg0 == null || arg0.field9629 == null) {
			...
			if (var2 < 23) {
				...
				this.field9637 = new ClientOptionsAntiAliasing(arg0.method15220(), this);
				this.field9665 = new ClientOptionsAntiAliasing(this.field9637.method15829(), this);
				this.field9673 = new ClientOptionsBloom(arg0.method15220(), this);
				this.field9642 = new ClientOptionsBrightness(arg0.method15220(), this);
				this.field9643 = new ClientOptionsBuildArea(arg0.method15220(), this);
				if (var2 >= 27) {
					this.field9644 = new ClientOptionsDrawDistance(arg0.method15220(), this);
				}
				this.field9645 = new ClientOptionsFlickeringEffects(arg0.method15220(), this);
				this.field9646 = new ClientOptionsFog(arg0.method15220(), this);
				this.field9647 = new ClientOptionsGroundBlending(arg0.method15220(), this);
				this.field9671 = new ClientOptionsGroundDecoration(arg0.method15220(), this);
				this.field9649 = new ClientOptionsIdleAnimations(arg0.method15220(), this);
				this.field9650 = new ClientOptionsLightingDetail(arg0.method15220(), this);
				this.field9651 = new ClientOptionsSceneryShadows(arg0.method15220(), this);
				if (var2 >= 24) {
					this.field9641 = new ClientOptionsOrthographic(arg0.method15220(), this);
				}
				this.field9648 = new ClientOptionsParticles(arg0.method15220(), this);
				this.field9660 = new ClientOptionsRemoveRoofs(arg0.method15220(), this);
				this.field9655 = new ClientOptionsRemoveRoofs(this.field9660.method15735(), this);
				this.field9677 = new ClientOptionsScreenSize(arg0.method15220(), this);
				if (var2 >= 25) {
					this.field9657 = new ClientOptionsSkyboxes(arg0.method15220(), this);
				}
				this.field9658 = new ClientOptionsCharacterShadows(arg0.method15220(), this);
				if (var2 <= 25) {
					arg0.field9626++;
				}
				this.field9659 = new ClientOptionsTextures(arg0.method15220(), this);
				this.field9670 = new ClientOptionsDisplayMode(arg0.method15220(), this);
				this.field9661 = new ClientOptionsDisplayMode(this.field9670.method15781(), this);
				arg0.method15220();
				this.field9666 = new ClientOptionsWaterDetail(arg0.method15220(), this);
				this.field9663 = new ClientOptionsMaxScreenSize(arg0.method15220(), this);
				this.field9664 = new ClientOptionsMaxScreenSize(this.field9663.method15766(), this);
				this.field9640 = new ClientOptionsCustomCursors(arg0.method15220(), this);
				this.field9633 = new ClientOptionsPreset(arg0.method15220(), this);
				this.field9652 = new ClientOptionsCpuUsage(arg0.method15220(), this);
				this.field9668 = new ClientOptionsLoadingScreen(arg0.method15220(), this);
				this.field9669 = new ClientOptionsUnknown1(arg0.method15220(), this);
				if (var2 >= 26) {
					this.field9667 = new ClientOptionsUnknown2(arg0.method15220(), this);
				}
				this.field9654 = new ClientOptionsVolume(arg0.method15220(), this);
				this.field9672 = new ClientOptionsVolume(arg0.method15220(), this);
				this.field9653 = new ClientOptionsVolume(arg0.method15220(), this);
				this.field9674 = new ClientOptionsVolume(arg0.method15220(), this);
				this.field9675 = new ClientOptionsVolume(arg0.method15220(), this);
				this.field9676 = new ClientOptionsStereo(arg0.method15220(), this);
				this.method15445(false);
			}
		}
		this.method15444();
	...
	public void method15446(Packet arg0, int arg1) {
		this.field9642 = new ClientOptionsBrightness(arg0.method15220(), this);
		arg0.field9626++;
		this.field9660 = new ClientOptionsRemoveRoofs(arg0.method15220() + 1, this);
		this.field9671 = new ClientOptionsGroundDecoration(arg0.method15220(), this);
		arg0.field9626++;
		this.field9649 = new ClientOptionsIdleAnimations(arg0.method15220(), this);
		this.field9645 = new ClientOptionsFlickeringEffects(arg0.method15220(), this);
	...
	public Packet method15447() {
		...
		var1.method15308(this.field9642.method15672());
		var1.method15308(this.field9643.method15792());
		var1.method15308(this.field9644.method15853());
		var1.method15308(this.field9645.method15679());
		var1.method15308(this.field9646.method15696());
		var1.method15308(this.field9647.method15843());
		var1.method15308(this.field9671.method15725());
		var1.method15308(this.field9649.method15837());
		var1.method15308(this.field9650.method15667());
		var1.method15308(this.field9651.method15747());
		var1.method15308(this.field9641.method15741());
		var1.method15308(this.field9648.method15716());
		var1.method15308(this.field9660.method15735());
		var1.method15308(this.field9677.method15794());
		var1.method15308(this.field9657.method15807());
		var1.method15308(this.field9658.method15709());
		var1.method15308(this.field9659.method15686());
		var1.method15308(this.field9670.method15781());
		var1.method15308(0);
		var1.method15308(this.field9666.method15755());
		var1.method15308(this.field9663.method15766());
		var1.method15308(this.field9640.method15908());
		var1.method15308(this.field9633.method15868());
		var1.method15308(this.field9652.method15874());
		var1.method15308(this.field9668.method15859());
		var1.method15308(this.field9669.method15877());
		var1.method15308(this.field9667.method15884());
		var1.method15308(this.field9654.method15899());
		var1.method15308(this.field9672.method15899());
		var1.method15308(this.field9653.method15899());
		var1.method15308(this.field9674.method15899());
		var1.method15308(this.field9675.method15899());
		var1.method15308(this.field9676.method15891());
		return var1;
	}
