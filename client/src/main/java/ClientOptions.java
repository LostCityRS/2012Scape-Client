...
public class ClientOptions extends Node {
    ...
    public Packet createPreferencesBlock() {
        ...
        var1.p1(this.bloom.method15816());
        ...
        var1.p1(this.lightDetail.method15667());
        var1.p1(this.sceneryShadows.method15747());
        ...
        var1.p1(this.texturing.method15686());
        var1.p1(this.toolkitDefault.getValue());
        var1.p1(0);
        var1.p1(this.waterDetail.method15755());
