...
public class GlHdWaterWaveEffect extends GlEffect {
	...
	@ObfuscatedName("xr.t")
	public GlEffectRelated1 field7480;

	public GlHdWaterWaveEffect(GlToolkit arg0, GlEffectRelated1 arg1) {
		super(arg0);
		this.field7480 = arg1;
		if (this.field7480.field1086 != null && this.field1062.field8212 && this.field1062.field8213) {
			...
			this.field7477 = GlProgram.method2027(this.field1062, new class82[] { var3, var4 });
