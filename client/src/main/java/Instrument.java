...
public class Instrument {
    ...
    @ObfuscatedName("mu.j")
    public SoundEnvelope field4070;

    @ObfuscatedName("mu.a")
    public SoundEnvelope field4069;

    @ObfuscatedName("mu.s")
    public SoundEnvelope field4086;

    @ObfuscatedName("mu.c")
    public SoundEnvelope field4072;

    @ObfuscatedName("mu.m")
    public SoundEnvelope field4091;

    @ObfuscatedName("mu.t")
    public SoundEnvelope field4071;

    @ObfuscatedName("mu.l")
    public SoundEnvelope field4088;
            ...
            if (arg0 >= var31 + var32) {
                ...
                while (var33 < var34) {
                    ...
                    for (int var36 = 0; var36 < var31; var36++) {
                        var35 += (int) ((long) field4084[var31 + var33 - 1 - var36] * (long) SoundFilter.field4101[0][var36] >> 16);
                    }
                    for (int var37 = 0; var37 < var33; var37++) {
                        var35 -= (int) ((long) field4084[var33 - 1 - var37] * (long) SoundFilter.field4101[1][var37] >> 16);
                    }
                ...
                while (true) {
                    ...
                    while (var33 < var38) {
                        ...
                        for (int var40 = 0; var40 < var31; var40++) {
                            var39 += (int) ((long) field4084[var31 + var33 - 1 - var40] * (long) SoundFilter.field4101[0][var40] >> 16);
                        }
                        for (int var41 = 0; var41 < var32; var41++) {
                            var39 -= (int) ((long) field4084[var33 - 1 - var41] * (long) SoundFilter.field4101[1][var41] >> 16);
                        }
                    ...
                    if (var33 >= arg0 - var31) {
                        while (var33 < arg0) {
                            ...
                            for (int var43 = var31 + var33 - arg0; var43 < var31; var43++) {
                                var42 += (int) ((long) field4084[var31 + var33 - 1 - var43] * (long) SoundFilter.field4101[0][var43] >> 16);
                            }
                            for (int var44 = 0; var44 < var32; var44++) {
                                var42 -= (int) ((long) field4084[var33 - 1 - var44] * (long) SoundFilter.field4101[1][var44] >> 16);
                            }
    ...
    public final void method6600(Packet arg0) {
        this.field4074 = new SoundEnvelope();
