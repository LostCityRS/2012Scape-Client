...
public class class756 extends class894 implements class298 {
	...
	public boolean method954() {
		this.field8845 = true;
		if (class0.method18(IDirect3DDevice.SetRenderTarget(this.field8848.field9975, 0, this.field8851))) {
			return false;
		} else if (class0.method18(IDirect3DDevice.SetDepthStencilSurface(this.field8848.field9975, this.field8846))) {
			return false;
		} else {
