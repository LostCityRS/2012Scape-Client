...
public class class797 extends Node {
	...
	public void method15106() {
		...
		if (this.field9525 != null) {
			...
			if (var3 == null) {
				...
				this.field9546 = var3.field6533 * 512;
			...
			if (var1 != var4) {
				...
				if (var5 == null) {
					...
					this.field9546 = var5.field7263 * 512;
			...
			this.field9522 = 0;
			this.field9546 = this.field9513.field10060 * 512;
			this.field9532 = 256;
			this.field9524 = 256;
		}
	...
	public static void method14954(int arg0, int arg1, int arg2, int arg3, LocType arg4, class903 arg5, PlayerEntity arg6) {
		...
		if (arg4 != null) {
			...
			var7.field9546 = arg4.field6533 * 512;
			...
			if (var10 != null) {
				...
				var7.field9546 = var10.field7263 * 512;
			...
			var7.field9546 = arg6.field10060 * 512;
			var7.field9532 = 256;
			var7.field9524 = 256;
			var7.field9522 = 0;
	...
	public static void method4977(class797 arg0, int arg1, int arg2, int arg3, int arg4) {
		...
		if (arg0.field9540 != null) {
			...
			int var15 = arg0.field9532 == 256 && arg0.field9524 == 256 ? 256 : class395.method4688(arg0.field9524, arg0.field9532);
			if (arg0.field9537) {
