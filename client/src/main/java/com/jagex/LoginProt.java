...
public class LoginProt {
	...
	@ObfuscatedName("jc.z")
	public static final LoginProt LOBBYLOGIN = new LoginProt(30, -2);
	...
	public static LoginProt[] method6889() {
		return new LoginProt[] { field2963, field2964, INIT_JS5REMOTE_CONNECTION, GAMELOGIN, INIT_GAME_CONNECTION, field2968, field2966, field2969, field2959, LOBBYLOGIN, field2962 };
	}
