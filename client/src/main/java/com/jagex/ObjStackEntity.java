...
public class ObjStackEntity extends class973 {
	...
	public class425 method12812(class14 arg0) {
		...
		if (this.field10609 != -1) {
			class13 var35 = Statics.field3492.method12316(this.field10609).method12241(arg0, 526336, this.field10610, null, null, this.field10614, this.field10615, this.field10616, this.field10617);
			if (var35 != null) {
		...
		if (this.field10607 != -1) {
			class13 var36 = Statics.field3492.method12316(this.field10607).method12241(arg0, 526336, this.field10608, null, null, this.field10614, this.field10615, this.field10616, this.field10617);
			if (var36 != null) {
		...
		class13 var37 = Statics.field3492.method12316(this.field10611).method12241(arg0, 526336, this.field10605, null, null, this.field10614, this.field10615, this.field10616, this.field10617);
		if (var37 != null) {
	...
	public int method15633() {
		class592 var1 = Statics.field3492.method12316(this.field10611);
		int var2 = var1.field7121;
		if (this.field10607 != -1) {
			class592 var3 = Statics.field3492.method12316(this.field10607);
			if (var3.field7121 > var2) {
				var2 = var3.field7121;
			}
		}
		if (this.field10609 != -1) {
			class592 var4 = Statics.field3492.method12316(this.field10609);
	...
	public boolean method12814(class14 arg0, int arg1, int arg2) {
		...
		class13 var5 = Statics.field3492.method12316(this.field10611).method12241(arg0, 131072, this.field10605, null, null, 0, 0, 0, 0);
		if (var5 != null && var5.method272(arg1, arg2, var4, true, 0)) {
			return true;
		}
		if (this.field10607 != -1) {
			class13 var6 = Statics.field3492.method12316(this.field10607).method12241(arg0, 131072, this.field10608, null, null, 0, 0, 0, 0);
			if (var6 != null && var6.method272(arg1, arg2, var4, true, 0)) {
				return true;
			}
		}
		if (this.field10609 != -1) {
			class13 var7 = Statics.field3492.method12316(this.field10609).method12241(arg0, 131072, this.field10610, null, null, 0, 0, 0, 0);
