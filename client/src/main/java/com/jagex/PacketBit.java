...
public class PacketBit extends Packet {
	...
	public void setSeed(Isaac arg0) {
		this.random = arg0;
	}

	@ObfuscatedName("ajl.ie(II)V")
	public void pIsaac1(int arg0) {
		this.data[++this.pos - 1] = (byte) (arg0 + this.random.nextInt());
	}

	@ObfuscatedName("ajl.ii(I)Z")
	public boolean isIsaac2() {
		int var1 = this.data[this.pos] - this.random.getInt() & 0xFF;
		return var1 >= 128;
	}

	@ObfuscatedName("ajl.in(I)I")
	public int gIsaac1or2() {
		int var1 = this.data[++this.pos - 1] - this.random.nextInt() & 0xFF;
		return var1 < 128 ? var1 : (var1 - 128 << 8) + (this.data[++this.pos - 1] - this.random.nextInt() & 0xFF);
	}

	@ObfuscatedName("ajl.ih([BIIB)V")
	public void gIsaacArrayBuffer(byte[] arg0, int arg1, int arg2) {
		for (int var4 = 0; var4 < arg2; var4++) {
			arg0[arg1 + var4] = (byte) (this.data[++this.pos - 1] - this.random.nextInt());
		}
	}
