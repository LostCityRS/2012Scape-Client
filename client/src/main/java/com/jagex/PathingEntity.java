...
public abstract class PathingEntity extends class974 implements class198 {
	...
	public void method14023(class14 arg0, class13[] arg1, class314 arg2, boolean arg3) {
		if (!arg3) {
			...
			if ((this.field8640 == null || this.field8640.field4945) && (var6 > 0 || var8 > 0)) {
				this.field8640 = class467.method8123(client.field9213, true);
			}
			if (this.field8640 != null) {
				...
				this.field8640.method8106(arg0, (long) client.field9213, var15, var19, false);
				this.field8613 = true;
			}
		...
		if (arg0 != -1 && var8 != -1) {
			if (arg0 == var8) {
				...
				if (var9.field5264 && var9.field5252 != -1) {
					class509 var10 = Statics.field566.method11144(var9.field5252);
				...
				if (var12.field5252 != -1 && var13.field5252 != -1) {
					class509 var14 = Statics.field566.method11144(var12.field5252);
					class509 var15 = Statics.field566.method11144(var13.field5252);
	...
	public void method13957(class14 arg0, class439 arg1, int arg2, int arg3, int arg4, int arg5) {
		for (int var7 = 0; var7 < this.field8641.length; var7++) {
			...
			if (var9.field1204 == -1 || var9.field1203.method11776()) {
				...
				class507 var10 = Statics.field4213.method11082(var9.field1204);
	...
	public void method13958(int arg0, int arg1, int arg2, int arg3, int arg4) {
		...
		this.field8603 = (this.field8603 >> 1) - (int) var6.field3476;
	}
	...
	public void method14002() {
		if (this.field8653 != -1) {
			class165.method7691(this.field8653);
			this.field8652 = null;
			this.field8653 = -1;
		}
	}
