...
public class class100 {
	...
	@ObfuscatedName("cl.u")
	public final class682 field1141;

	@ObfuscatedName("cl.j")
	public final class672 field1138;
	...
	public class100(class682 arg0, class672 arg1) {
		this.field1141 = arg0;
		this.field1138 = arg1;
		this.field1139 = (this.field1138.field387 * 569721097 * this.field1138.field385 * 1570646497 >> this.field1141.field8092) + 2;
		this.field1140 = (this.field1138.field386 * -1903733271 * this.field1138.field385 * 1570646497 >> this.field1141.field8092) + 2;
		this.field1142 = new byte[this.field1140 * this.field1139];
		this.field1143 = this.field1141.field8092 + 7 - this.field1138.field388 * -452021343;
		this.field1137 = this.field1138.field387 * 569721097 >> this.field1143;
		this.field1144 = this.field1138.field386 * -1903733271 >> this.field1143;
	}
				...
				for (int var18 = 0; var18 < this.field1137; var18++) {
					...
					for (int var23 = var16; var23 < var17; var23++) {
						if (var23 - arg1 >= -arg2 && var23 - arg1 <= arg2) {
							int var24 = this.field1138.field387 * 569721097 * var23 + var20;
