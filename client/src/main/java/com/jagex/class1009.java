...
public class class1009 extends class974 {
	...
	public class1009(class423 arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, boolean arg14, int arg15, int arg16) {
		...
		this.field10630 = arg1 * -2061954455;
		this.field10625 = arg7 * 1762007185;
		this.field10622 = arg8 * -856099249;
		this.field10623 = arg9 * -1028892063;
		this.field10635 = arg10 * -343398029;
		this.field10624 = arg11 * -1443658699;
		this.field10626 = arg12 * 81957217;
		this.field10628 = arg6 * 1371408789;
		this.field10620 = arg13 * -1976090467;
		this.field10619 = arg14;
		this.field10629 = false;
		this.field10627 = arg15 * 740219687;
		this.field10639 = arg16 * -248208299;
		int var18 = Statics.field4213.method11082(this.field10630 * -382886439).field5252 * 627575481;
	...
	public int method12809() {
		return this.field10636 * -1910431635;
	}

	@ObfuscatedName("alv.u(B)I")
	public int method17154() {
		return this.field10639 * 1038825725;
	}
	...
	public final void method17162(int arg0, int arg1, int arg2, int arg3) {
		...
		if (!this.field10629) {
			...
			if (var8 != 0.0F) {
				var5.field3475 += (float) (this.field10635 * 920986555) * var6 / var8;
				var5.field3477 += (float) (this.field10635 * 920986555) * var7 / var8;
			}
			if (this.field10619) {
				var5.field3476 = client.method8663((int) var5.field3475, (int) var5.field3477, this.field9807) - this.field10628 * 1939732925;
			}
			this.method8551(var5);
		}
		double var9 = (double) (this.field10622 * -118595409 + 1 - arg3);
		...
		if (this.field10623 * -221918815 == -1) {
			this.field10633 = (double) ((float) arg2 - var5.field3476) / var9;
		} else {
			if (!this.field10629) {
				this.field10633 = -this.field10621 * Math.tan((double) (this.field10623 * -221918815) * 0.02454369D);
			}
	...
	public void method17152() {
		if (this.field10629 || this.field10624 * 1125559837 == 0) {
			return;
		}
		class719 var1 = null;
		if (client.field8988 * 212861031 == 0) {
			var1 = Statics.field1537[this.field10624 * 1125559837 - 1].method2854();
		} else if (this.field10624 * 1125559837 < 0) {
			int var2 = -(this.field10624 * 1125559837) - 1;
			if (client.field9071 * -663794775 == var2) {
				var1 = Statics.field2119;
			} else {
				var1 = client.field9070[var2];
			}
		} else {
			int var3 = this.field10624 * 1125559837 - 1;
		...
		this.method8552(var5.field3475, (float) (client.method8663((int) var5.field3475, (int) var5.field3477, this.field9807) - this.field10628 * 1939732925), var5.field3477);
		if (this.field10627 * 1731388567 < 0) {
			return;
		}
		class439 var6 = var1.method13959();
		int var7 = 0;
		int var8 = 0;
		if (var6.field4716 != null && var6.field4716[this.field10627 * 1731388567] != null) {
			var7 += var6.field4716[this.field10627 * 1731388567][0];
			var8 += var6.field4716[this.field10627 * 1731388567][2];
		}
		if (var6.field4729 != null && var6.field4729[this.field10627 * 1731388567] != null) {
			var7 += var6.field4729[this.field10627 * 1731388567][0];
			var8 += var6.field4729[this.field10627 * 1731388567][2];
		}
		if (var7 == 0 && var8 == 0) {
			return;
		}
		...
		int var10 = var9;
		if (var1.field8654 != null && var1.field8654[this.field10627 * 1731388567] != -1) {
			var10 = var1.field8654[this.field10627 * 1731388567];
		}
	...
	public final void method17157(int arg0) {
		...
		if (this.field10619) {
			var2.field3464.field3476 = client.method8663((int) var2.field3464.field3475, (int) var2.field3464.field3477, this.field9807) - this.field10628 * 1939732925;
		} else if (this.field10623 * -221918815 == -1) {
	...
	public class13 method17156(class14 arg0, int arg1) {
		class507 var3 = Statics.field4213.method11082(this.field10630 * -382886439);
	...
	public class425 method12812(class14 arg0) {
		...
		var2.method275();
		this.field10636 = var2.method278() * -1422399131;
		return var4;
	}
	...
	public void method17158(class14 arg0, class13 arg1, class314 arg2) {
		...
		if ((this.field10632 == null || this.field10632.field4945) && (var4 != null || var5 != null)) {
			this.field10632 = class467.method8123(client.field9213 * 1194705519, true);
		}
		if (this.field10632 != null) {
			this.field10632.method8106(arg0, (long) (client.field9213 * 1194705519), var4, var5, false);
