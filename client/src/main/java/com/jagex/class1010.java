...
public class class1010 extends class974 {
	...
	public class1010(class423 arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, boolean arg13, int arg14) {
		...
		this.field10640 = arg1 * -606857833;
		this.field10646 = arg12 * -1320477109;
		this.field10645 = arg14 * -1051861387;
		class507 var16 = Statics.field4213.method11082(this.field10640 * 120044071);
		int var17 = var16.field5252 * 627575481;
		if (var17 != -1) {
	...
	public int method12809() {
		return this.field10643 * 1281860831;
	}

	@ObfuscatedName("alf.u(B)I")
	public int method17176() {
		return this.field10645 * 1580630493;
	}
	...
	public class425 method12812(class14 arg0) {
		class13 var2 = this.method17190(arg0, (this.field10646 * -2065155229 == 0 ? 0 : 5) | 0x800, this.field10640 * 120044071);
		if (var2 == null) {
			return null;
		}
		if (this.field10646 * -2065155229 != 0) {
			var2.method246(this.field10646 * 1104877568);
		}
		...
		this.field10643 = var2.method278() * 700258079;
		var2.method275();
		return var4;
	}
	...
	public void method12851(class14 arg0) {
		class13 var2 = this.method17190(arg0, 0, this.field10640 * 120044071);
		if (var2 != null) {
	...
	public void method17185(class14 arg0, class13 arg1, class314 arg2) {
		...
		if ((this.field10641 == null || this.field10641.field4945) && (var4 != null || var5 != null)) {
			this.field10641 = class467.method8123(client.field9213 * 1194705519, true);
		}
		if (this.field10641 != null) {
			this.field10641.method8106(arg0, (long) (client.field9213 * 1194705519), var4, var5, false);
