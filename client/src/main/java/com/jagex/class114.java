...
public final class class114 {
	...
	public class114(int arg0) {
		this.field1200 = arg0 * 1346605965;
	}
	...
	public void method2418(int arg0, int arg1) {
		if (this.field1199 == null) {
			this.field1199 = new class565(this.field1200 * -1099307195);
		}
	...
	public int method2417(int arg0) {
		...
		int var3 = var2.field6409 * -1193451171;
		int var4 = var2.field6411 * 1058261429 == 31 ? -1 : (0x1 << var2.field6411 * 1058261429 + 1) - 1;
		return (this.method2416(var3) & var4) >>> var2.field6410 * -293399283;
	}
}
