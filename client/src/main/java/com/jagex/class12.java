...
public abstract class class12 {
	...
	public class12(int arg0, int arg1, int arg2, int[][] arg3) {
		this.field387 = arg0 * 1710398777;
		this.field386 = arg1 * 2087375449;
		int var5 = 0;
		while (arg2 > 1) {
			var5++;
			arg2 >>= 0x1;
		}
		this.field385 = (0x1 << var5) * 190044705;
		this.field388 = var5 * -542642079;
		this.field389 = arg3;
	}

	@ObfuscatedName("xa.c(III)I")
	public final int method196(int arg0, int arg1) {
		int var3 = arg0 >> this.field388 * -452021343;
		int var4 = arg1 >> this.field388 * -452021343;
		if (var3 < 0 || var4 < 0 || var3 > this.field387 * 569721097 - 1 || var4 > this.field386 * -1903733271 - 1) {
			return 0;
		}
		int var5 = arg0 & this.field385 * 1570646497 - 1;
		int var6 = arg1 & this.field385 * 1570646497 - 1;
		int var7 = (this.field385 * 1570646497 - var5) * this.field389[var3][var4] + this.field389[var3 + 1][var4] * var5 >> this.field388 * -452021343;
		int var8 = (this.field385 * 1570646497 - var5) * this.field389[var3][var4 + 1] + this.field389[var3 + 1][var4 + 1] * var5 >> this.field388 * -452021343;
		return (this.field385 * 1570646497 - var6) * var7 + var6 * var8 >> this.field388 * -452021343;
	}
	...
	public abstract void method204(class780 arg0, int[] arg1);
