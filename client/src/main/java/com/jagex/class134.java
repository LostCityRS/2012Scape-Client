...
public class class134 {
	...
	public class134(int arg0, int arg1, int arg2, int arg3, byte arg4) {
		this.field1383 = arg0 * 1465370579;
		this.field1374 = arg1 * -478535401;
		this.field1375 = arg2 * -2077335735;
		this.field1376 = arg3 * -548490207;
		this.field1382 = arg4;
	}

	@ObfuscatedName("dx.u(B)Liu;")
	public class273 method2702() {
		return class273.method2841(this.field1383 * -2143213477);
	}

	@ObfuscatedName("dx.j(IIIB)Ldx;")
	public class134 method2701(int arg0, int arg1, int arg2) {
		return new class134(this.field1383 * -2143213477, arg0, arg1, arg2, this.field1382);
	}
}
