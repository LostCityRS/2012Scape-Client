...
public abstract class class14 {
	...
	@ObfuscatedName("ra.v")
	public int field411 = -1742603957;
	...
	public class14(class16 arg0) {
		...
		this.field397 = var2 * -1347530049;
	}

	@ObfuscatedName("sh.u(ILjava/awt/Canvas;Lma;Lls;II)Lra;")
	public static class14 method11222(int arg0, Canvas arg1, class16 arg2, class334 arg3, int arg4) {
		int var5 = 0;
		int var6 = 0;
		if (arg1 != null) {
	...
	public static synchronized class14 method11995(int arg0, Canvas arg1, class16 arg2, class334 arg3, int arg4, int arg5, int arg6) {
		if (arg0 == 0) {
	...
	public void method442() {
		field398[this.field397 * 1002839359] = false;
	...
	public final void method462(Canvas arg0) {
		...
		if (var2 == null) {
			throw new RuntimeException();
		} else if (this.field411 * -974047331 <= 0 && this.field415 == this.field412) {
			if (this.field412 != null) {
				this.field412.method925();
			}
			if (this.field411 * -974047331 < 0) {
				this.field412 = var2;
			}
			this.field415 = var2;
			var2.method954();
	...
	public final void method464(class674 arg0) {
		if (this.field411 * -974047331 >= 3) {
			throw new RuntimeException();
		}
		if (this.field411 * -974047331 >= 0) {
			this.field407[this.field411 * -974047331].method925();
		} else {
			this.field415.method925();
		}
		this.field412 = this.field407[(this.field411 += 1742603957) * -974047331] = arg0;
		arg0.method954();
	}

	@ObfuscatedName("ra.az(Lyu;B)V")
	public final void method696(class674 arg0) {
		if (this.field411 * -974047331 < 0 || this.field407[this.field411 * -974047331] != arg0) {
			throw new RuntimeException();
		}
		this.field407[(this.field411 -= 1742603957) * -974047331 + 1] = null;
		arg0.method925();
		if (this.field411 * -974047331 >= 0) {
			this.field412 = this.field407[this.field411 * -974047331];
			this.field407[this.field411 * -974047331].method954();
		} else {
	...
	public class780 method534(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
		return new class780(arg0, arg1, arg2, arg3, arg4, arg5);
	}
	...
	public abstract class314 method516();
	...
	public abstract class12 method521(int arg0, int arg1, int[][] arg2, int[][] arg3, int arg4, int arg5, int arg6);

	@ObfuscatedName("ra.ci(Lkc;)V")
	public abstract void method524(class314 arg0);

	@ObfuscatedName("ra.ca()Lkc;")
	public abstract class314 method525();

	@ObfuscatedName("ra.RA(Z)V")
	public abstract void method526(boolean arg0);

	@ObfuscatedName("ra.cv()Lka;")
	public abstract class320 method528();
	...
	public abstract void method535(int arg0, class780[] arg1);
	...
	public abstract class13 method625(class129 arg0, int arg1, int arg2, int arg3, int arg4);
	...
	public abstract void method733(class128 arg0);
	...
	public abstract class320 method781();

	@ObfuscatedName("ra.ch(Lka;)V")
	public abstract void method784(class320 arg0);
