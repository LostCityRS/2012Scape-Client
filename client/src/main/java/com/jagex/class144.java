...
public class class144 {
	...
	@ObfuscatedName("dd.l")
	public static int field1530 = -1252884095;
	...
	@ObfuscatedName("dd.w")
	public static int field1536 = -380415269;

	@ObfuscatedName("dd.b")
	public static int field1533 = -1502003747;
	...
	public static boolean method2467(int arg0) {
		if (field1533 * 1705573771 != arg0 || Statics.field10188 == null) {
			method2911();
			Statics.field10188 = class145.field1541;
			field1533 = arg0 * 1502003747;
		}
	...
	public static void method7325(class814 arg0) {
		while (true) {
			...
			switch(var1) {
				case 0:
					field1527 = arg0.method15239() * -1495628687;
					field1531 = arg0.method15239() * -1154205425;
					break;
				case 255:
					return;
			}
	...
	public static void method2911() {
		...
		field1530 = -1252884095;
		field1527 = 0;
		field1531 = 0;
		Statics.field10188 = null;
		field1533 = -1502003747;
		field1536 = -380415269;
		if (!field1526) {
			return;
		}
	...
	public static void method1383() {
		...
		field1526 = true;
		field1536 = class395.field4202 * 663106551;
		if (field1531 * 543659503 != 0 && field1527 * -260522863 != 0) {
			client.field9197 = 334;
			client.field9188 = 334;
			client.field9200 = client.field9199 = (short) (field1531 * -819208704 / (field1527 * -260522863));
		}
	}

	@ObfuscatedName("acy.c(ZI)V")
	public static void method14961(boolean arg0) {
		if (client.field8988 * 212861031 == 1 || client.field8988 * 212861031 == 2) {
			return;
		}
		if (!arg0) {
			...
			if (field1536 * 756393645 != -1) {
				class155.method8662();
				class395.field4202 = 651188029;
				class395.method11057(field1536 * 756393645, 255, 50);
			}
		}
		client.field8988 = -745333929;
		Statics.field4561 = null;
		Statics.field416 = null;
		client.field8989 = false;
		if (field1533 * 1705573771 > 0) {
			class502.method1372(class619.field7312, field1533 * 1705573771, -1);
		}
		method2911();
