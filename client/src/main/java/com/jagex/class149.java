...
public final class class149 {
	...
	public class149(class814 arg0, int arg1) {
		this.field1559 = arg1 * -1447776889;
		int var3 = arg0.method15220();
		switch(var3) {
			case 0:
				this.field1560 = arg0.method15411() * -875325853;
				break;
			case 1:
				this.field1560 = 875325853;
				break;
			default:
				this.field1560 = 875325853;
		}
	...
	public void method2851(int arg0, int arg1, int arg2, int arg3) {
		if (!this.field1563) {
			this.field1563 = true;
			if (this.field1560 * -2100847797 >= 0) {
				this.field1558 = new class903(client.field8980.method6098(), 25);
				this.field1558.field8593 = this.field1559 * 1012769289;
				this.field1558.field8618 = client.field9213 * -343671217;
				this.field1558.method16149(Statics.field3774.method12565(this.field1560 * -2100847797));
				this.field1558.method13979(this.field1558.field10075.field7213 * 665946395);
				this.field1558.field8636 = (this.field1558.field10075.field7241 * -351587003 << 3) * 1728303081;
				this.field1558.field8600 = ((class144.field1530 += -1252884095) * -1362116991 - 1) * -232323261;
			} else {
				this.field1562 = new class902(client.field8980.method6098(), 25);
				this.field1562.method16116(Statics.field416);
				this.field1562.field8593 = this.field1559 * 1012769289;
				this.field1562.field8618 = client.field9213 * -343671217;
				this.field1562.field8600 = ((class144.field1530 += -1252884095) * -1362116991 - 1) * -232323261;
			}
		}
		if (this.field1560 * -2100847797 >= 0) {
	...
	public boolean method2860() {
		...
		class611 var1 = Statics.field3774.method12565(this.field1560 * -2100847797);
		boolean var2 = var1.method12513();
		if (this.field1564 == null) {
			class439 var3 = Statics.field3769.method7784(var1.field7217 * -1527467755);
