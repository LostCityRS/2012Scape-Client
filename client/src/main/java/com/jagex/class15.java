...
public abstract class class15 {
	...
	@ObfuscatedName("l.c")
	public static int field421 = -1330680579;

	@ObfuscatedName("l.m")
	public static int field422 = 698430453;
	...
	public int method836(String arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, class118[] arg10, int[] arg11, class11 arg12, int arg13, int arg14) {
	...
	public int method832(String arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, class118[] arg11, int[] arg12, class11 arg13, int arg14, int arg15) {
		if (arg0 == null) {
			return 0;
		}
		this.method843(arg5, arg6);
		if (arg9 == 0) {
			arg9 = this.field418.field7175 * 1248473579;
		}
		int[] var17;
		if (arg4 < this.field418.field7177 * -1610531499 + this.field418.field7176 * 1490085903 + arg9 && arg4 < arg9 + arg9) {
			var17 = null;
		} else {
			var17 = new int[] { arg3 };
		}
		...
		int var19;
		if (arg8 == 0) {
			var19 = this.field418.field7176 * 1490085903 + arg2;
		} else if (arg8 == 1) {
			var19 = (arg4 - this.field418.field7176 * 1490085903 - this.field418.field7177 * -1610531499 - (var18 - 1) * arg9) / 2 + this.field418.field7176 * 1490085903 + arg2;
		} else if (arg8 == 2) {
			var19 = arg2 + arg4 - this.field418.field7177 * -1610531499 - (var18 - 1) * arg9;
		} else {
			int var20 = (arg4 - this.field418.field7176 * 1490085903 - this.field418.field7177 * -1610531499 - (var18 - 1) * arg9) / (var18 + 1);
			if (var20 < 0) {
				var20 = 0;
			}
			var19 = this.field418.field7176 * 1490085903 + arg2 + var20;
			arg9 += var20;
		}
	...
	public int method841(String arg0, int arg1, int arg2, int arg3, int arg4, Random arg5, int arg6, class118[] arg7, int[] arg8) {
		if (arg0 == null) {
			return 0;
		}
	...
	public int method842(String arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, Random arg9, int arg10, int[] arg11, class118[] arg12, int[] arg13) {
		if (arg0 == null) {
			return 0;
		}
		...
		int var20 = arg1;
		int var21 = this.field418.field7176 * 1490085903 + arg2;
		int var22 = -1;
		if (arg8 == 1) {
			var21 += (arg4 - this.field418.field7176 * 1490085903 - this.field418.field7177 * -1610531499) / 2;
		} else if (arg8 == 2) {
			var21 = arg2 + arg4 - this.field418.field7177 * -1610531499;
		}
		if (arg7 == 1) {
		...
		if (arg11 != null) {
			...
			arg11[0] = var20;
			arg11[1] = var21 - this.field418.field7176 * 1490085903;
			arg11[2] = var22;
			arg11[3] = this.field418.field7177 * -1610531499 + this.field418.field7176 * 1490085903;
		}
		return var18;
	}
	...
	public void method843(int arg0, int arg1) {
		field421 = -1330680579;
		field422 = 698430453;
		field424 = (field423 = arg0 * -295281831) * -318263897;
		field427 = 0;
		field428 = 0;
		if (arg1 == -1) {
			arg1 = 0;
		}
		field426 = (field425 = arg1 * -111500309) * 202741693;
	}
	...
	public void method844(String arg0) {
		try {
			if (arg0.startsWith("col=")) {
				field424 = (field424 * -1128025361 & -16777216 | class526.method4773(arg0.substring(4), 16) & 0xFFFFFF) * -1796228081;
			} else if (arg0.equals("/col")) {
				field424 = (field424 * -1128025361 & -16777216 | field423 * -1960952599 & 0xFFFFFF) * -1796228081;
			}
			if (arg0.startsWith("argb=")) {
				field424 = class526.method4773(arg0.substring(5), 16) * -1796228081;
			} else if (arg0.equals("/argb")) {
				field424 = field423 * -318263897;
			} else if (arg0.startsWith("str=")) {
				field421 = (field424 * -1128025361 & 0xFF000000 | class526.method4773(arg0.substring(4), 16)) * 1330680579;
			} else if (arg0.equals("str")) {
				field421 = (field424 * -1128025361 & 0xFF000000 | 0x800000) * 1330680579;
			} else if (arg0.equals("/str")) {
				field421 = -1330680579;
			} else if (arg0.startsWith("u=")) {
				field422 = (field424 * -1128025361 & -16777216 | class526.method4773(arg0.substring(2), 16)) * -698430453;
			} else if (arg0.equals("u")) {
				field422 = (field424 * -1128025361 & -16777216) * -698430453;
			} else if (arg0.equals("/u")) {
				field422 = 698430453;
			} else if (arg0.equalsIgnoreCase("shad=-1")) {
				field426 = 0;
			} else if (arg0.startsWith("shad=")) {
				field426 = (field424 * -1128025361 & 0xFF000000 | class526.method4773(arg0.substring(5), 16)) * 81895807;
			} else if (arg0.equals("shad")) {
				field426 = (field424 * -1128025361 & 0xFF000000) * 81895807;
			} else if (arg0.equals("/shad")) {
				field426 = field425 * 202741693;
			} else if (arg0.equals("br")) {
				this.method843(field423 * -1960952599, field425 * 2062183619);
			}
	...
	public void method845(String arg0, int arg1) {
		...
		if (var3 > 0) {
			field427 = (arg1 - this.field418.method12418(arg0) << 8) / var3 * 1159704649;
		}
	}

	@ObfuscatedName("l.p(Ljava/lang/String;II[Lce;[ILta;III)V")
	public void method857(String arg0, int arg1, int arg2, class118[] arg3, int[] arg4, class11 arg5, int arg6, int arg7) {
		int var9 = arg2 - this.field418.field7175 * 1248473579;
		int var10 = -1;
		int var11 = -1;
		...
		for (int var13 = 0; var13 < var12; var13++) {
			...
			if (var14 == '<') {
						...
						if (!var15.equals("reg")) {
							if (var15.startsWith("img=")) {
								try {
									...
									if ((field424 * -1128025361 & -16777216) == -16777216) {
										var17.method1054(arg1, this.field418.field7175 * 1248473579 + var9 - var18, 1, -1, 1);
									} else {
										var17.method1054(arg1, this.field418.field7175 * 1248473579 + var9 - var18, 0, field424 * -1128025361 & 0xFF000000 | 0xFFFFFF, 1);
									}
				...
				if (var10 == -1) {
					...
					if (var14 == ' ') {
						if (field427 * -1961672199 > 0) {
							field428 += field427 * -1536040981;
							arg1 += field428 * -1039396693 >> 8;
							field428 = (field428 * -1039396693 & 0xFF) * -1562416637;
						}
					} else if (arg5 == null) {
						if ((field426 * -1495523713 & 0xFF000000) != 0) {
							this.method848(var14, arg1 + 1, var9 + 1, field426 * -1495523713, true);
						}
						this.method848(var14, arg1, var9, field424 * -1128025361, false);
					} else {
						if ((field426 * -1495523713 & 0xFF000000) != 0) {
							this.method867(var14, arg1 + 1, var9 + 1, field426 * -1495523713, true, arg5, arg6, arg7);
						}
						this.method867(var14, arg1, var9, field424 * -1128025361, false, arg5, arg6, arg7);
					}
					int var20 = this.field418.method12388(var14);
					if (field421 * 1778053035 != -1) {
						this.field417.method485(arg1, (int) ((double) (this.field418.field7175 * 1248473579) * 0.7D) + var9, var20, field421 * 1778053035);
					}
					if (field422 * 54812579 != -1) {
						this.field417.method485(arg1, this.field418.field7175 * 1248473579 + var9 + 1, var20, field422 * 54812579);
					}
					arg1 += var20;
					var11 = var14;
				}
	...
	public void method847(String arg0, int arg1, int arg2, class118[] arg3, int[] arg4, int[] arg5, int[] arg6) {
		int var8 = arg2 - this.field418.field7175 * 1248473579;
		int var9 = -1;
		int var10 = -1;
		int var11 = 0;
		int var12 = arg0.length();
		for (int var13 = 0; var13 < var12; var13++) {
			...
			if (var14 == '<') {
						...
						if (!var15.equals("reg")) {
							if (var15.startsWith("img=")) {
								try {
									...
									var19.method1054(arg1 + var16, this.field418.field7175 * 1248473579 + var8 - var20 + var17, 1, -1, 1);
				...
				if (var9 == -1) {
					...
					if (var14 != ' ') {
						if ((field426 * -1495523713 & 0xFF000000) != 0) {
							this.method848(var14, arg1 + 1 + var22, var8 + 1 + var23, field426 * -1495523713, true);
						}
						this.method848(var14, arg1 + var22, var8 + var23, field424 * -1128025361, false);
					} else if (field427 * -1961672199 > 0) {
						field428 += field427 * -1536040981;
						arg1 += field428 * -1039396693 >> 8;
						field428 = (field428 * -1039396693 & 0xFF) * -1562416637;
					}
					...
					if (field421 * 1778053035 != -1) {
						this.field417.method485(arg1, (int) ((double) (this.field418.field7175 * 1248473579) * 0.7D) + var8, var24, field421 * 1778053035);
					}
					if (field422 * 54812579 != -1) {
						this.field417.method485(arg1, this.field418.field7175 * 1248473579 + var8, var24, field422 * 54812579);
					}
					arg1 += var24;
					var10 = var14;
				}
