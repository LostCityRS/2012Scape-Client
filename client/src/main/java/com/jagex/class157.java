...
public class class157 {
	...
	public class157(class334 arg0, int arg1) {
		this.field1594 = arg0;
		this.field1591 = arg1 * 1454059843;
	...
	public boolean method2999() {
		class155.method7561();
		if (this.field1596 * -1942577465 == 0) {
			this.field1593 = class782.method14909(this.field1594, this.field1591 * 820831083, 0);
			if (this.field1593 == null) {
				return false;
			}
			this.field1595 = new class377(Statics.field1581, Statics.field1580);
			this.field1596 = -2093563145;
		}
		if (this.field1596 * -1942577465 == 1) {
			if (!this.field1588.method16375(this.field1593, Statics.field1586, this.field1595, 22050)) {
				return false;
			}
			this.field1596 = 107841006;
		}
		return true;
	}
	...
	public boolean method3000() {
		return this.field1596 * -1942577465 == 2;
	}
}
