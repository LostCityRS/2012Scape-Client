...
public class class169 {
	...
	public int method3294() {
		...
		for (int var2 = 0; var2 < 2; var2++) {
			var1 = (short) (var1 | (this.field1943[(this.field1942 += -202242259) * -303898459 - 1] & 0xFF) << var2 * 8);
		}
		return var1;
	}
	...
	public String method3295() {
		...
		if (var1 == -1) {
			...
			String var2 = new String(this.field1943, this.field1942 * -303898459, var1);
			this.field1942 += var1 * -202242259;
			return var2;
		}
	}
}
