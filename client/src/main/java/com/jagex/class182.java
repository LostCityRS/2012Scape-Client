...
public class class182 {
	...
	public void method3551(int arg0) {
		...
		if (var2 != null) {
			var2.method6979();
			this.field2133[var2.field9425 * 292096993] = null;
		}
	}
	...
	public void method3552(int arg0, String arg1, class786 arg2) {
		...
		if (var4 != null && var4.field9425 * 292096993 != arg0) {
		...
		if (arg0 >= this.field2133.length) {
			...
			for (int var6 = 0; var6 < this.field2133.length; var6++) {
				...
				if (var7 != null) {
					this.field2134.method11927(var7, var7.field4228 * 4763964654233859639L);
				}
			}
