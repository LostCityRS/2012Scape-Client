...
public class class332 {
	...
	public class332(byte[] arg0, int arg1, byte[] arg2) {
		this.field3546 = class814.method7834(arg0, arg0.length) * -2122351605;
		if (this.field3546 * -2031472733 != arg1) {
	...
	public void method5594(byte[] arg0) {
		...
		if (var3 >= 6) {
			this.field3547 = var2.method15379() * -1598027551;
		} else {
			this.field3547 = 0;
		}
		...
		if (var3 >= 7) {
			this.field3549 = var2.method15259() * 1976641147;
		} else {
			this.field3549 = var2.method15239() * 1976641147;
		}
		int var7 = 0;
		int var8 = -1;
		this.field3554 = new int[this.field3549 * -1267283789];
		if (var3 >= 7) {
			for (int var9 = 0; var9 < this.field3549 * -1267283789; var9++) {
			...
			for (int var10 = 0; var10 < this.field3549 * -1267283789; var10++) {
		...
		this.field3553 = (var8 + 1) * -1980906643;
		this.field3548 = new int[this.field3553 * -681329051];
		if (var6) {
			this.field3555 = new byte[this.field3553 * -681329051][];
		}
		this.field3545 = new int[this.field3553 * -681329051];
		this.field3557 = new int[this.field3553 * -681329051];
		this.field3556 = new int[this.field3553 * -681329051][];
		this.field3561 = new int[this.field3553 * -681329051];
		if (var5) {
			this.field3551 = new int[this.field3553 * -681329051];
			for (int var11 = 0; var11 < this.field3553 * -681329051; var11++) {
				this.field3551[var11] = -1;
			}
			for (int var12 = 0; var12 < this.field3549 * -1267283789; var12++) {
				this.field3551[this.field3554[var12]] = var2.method15379();
			}
			this.field3560 = new class183(this.field3551);
		}
		for (int var13 = 0; var13 < this.field3549 * -1267283789; var13++) {
			this.field3548[this.field3554[var13]] = var2.method15379();
		}
		if (var6) {
			for (int var14 = 0; var14 < this.field3549 * -1267283789; var14++) {
				byte[] var15 = new byte[64];
				var2.method15263(var15, 0, 64);
				this.field3555[this.field3554[var14]] = var15;
			}
		}
		for (int var16 = 0; var16 < this.field3549 * -1267283789; var16++) {
			this.field3545[this.field3554[var16]] = var2.method15379();
		}
		if (var3 >= 7) {
			for (int var17 = 0; var17 < this.field3549 * -1267283789; var17++) {
				this.field3557[this.field3554[var17]] = var2.method15259();
			}
			for (int var18 = 0; var18 < this.field3549 * -1267283789; var18++) {
			...
			for (int var25 = 0; var25 < this.field3549 * -1267283789; var25++) {
				this.field3557[this.field3554[var25]] = var2.method15239();
			}
			for (int var26 = 0; var26 < this.field3549 * -1267283789; var26++) {
		...
		for (int var33 = 0; var33 < this.field3549 * -1267283789; var33++) {
