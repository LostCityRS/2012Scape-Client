...
public final class class334 {
	...
	public synchronized boolean method5689() {
		if (this.field3572 == null) {
			...
			this.field3564 = new Object[this.field3572.field3553 * -681329051];
			this.field3565 = new Object[this.field3572.field3553 * -681329051][];
		}
		return true;
	}
	...
	public int method5622() {
		...
		return this.field3572.field3546 * -2031472733;
	}
	...
	public synchronized boolean method5640(int arg0, int arg1, int[] arg2) {
		if (!this.method5623(arg0)) {
			...
			try {
				...
				throw class983.method15876(var48, (arg2 != null) + " " + arg0 + " " + var10.length + " " + class814.method7834(var10, var10.length) + " " + class814.method7834(var10, var10.length - 2) + " " + this.field3572.field3548[arg0] + " " + this.field3572.field3546 * -2031472733);
			}
			if (this.field3574) {
			...
			if (var4 <= 1) {
				...
				if (this.field3571 * 2108057055 == 0) {
				...
				int var34 = 0;
				int var35 = 0;
				var33.field9626 = var32 * -1748220013;
				...
				var17.field9626 = var16 * -1748220013;
