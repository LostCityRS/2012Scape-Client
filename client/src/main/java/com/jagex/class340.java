...
public class class340 {
	...
	@ObfuscatedName("lq.u")
	public class484 field3692;

	@ObfuscatedName("lq.j")
	public class563 field3668;

	@ObfuscatedName("lq.a")
	public class338 field3618;
	...
	public class340(class423 arg0, int arg1, int arg2, int arg3, boolean arg4, class484 arg5, class563 arg6, class338 arg7) {
		this.field3619 = arg0;
		this.field3628 = arg1 * -1476207795;
		this.field3627 = arg2 * -294996379;
		this.field3643 = arg3 * -1575023141;
		this.field3644 = arg4;
		this.field3692 = arg5;
		this.field3668 = arg6;
		this.field3618 = arg7;
		this.field3635 = new byte[this.field3628 * -2050894459][this.field3627 * 993135469][this.field3643 * -241162669];
		this.field3636 = new byte[this.field3628 * -2050894459][this.field3627 * 993135469][this.field3643 * -241162669];
		this.field3703 = new byte[this.field3628 * -2050894459][this.field3627 * 993135469][this.field3643 * -241162669];
		this.field3621 = new byte[this.field3628 * -2050894459][this.field3627 * 993135469][this.field3643 * -241162669];
		this.field3697 = new int[this.field3628 * -2050894459][this.field3627 * 993135469 + 1][this.field3643 * -241162669 + 1];
		this.field3659 = new byte[this.field3628 * -2050894459][this.field3627 * 993135469 + 1][this.field3643 * -241162669 + 1];
	}
	...
	public final void method5836(int arg0, int arg1, int arg2, int arg3) {
		for (int var5 = 0; var5 < this.field3628 * -2050894459; var5++) {
	...
	public final void method5837(int arg0, int arg1, int arg2, int arg3, int arg4) {
		for (int var6 = arg2; var6 < arg2 + arg4; var6++) {
			for (int var7 = arg1; var7 < arg1 + arg3; var7++) {
				if (var7 >= 0 && var7 < this.field3627 * 993135469 && var6 >= 0 && var6 < this.field3643 * -241162669) {
					this.field3697[arg0][var7][var6] = arg0 > 0 ? this.field3697[arg0 - 1][var7][var6] - 960 : 0;
				}
			}
		}
		if (arg1 > 0 && arg1 < this.field3627 * 993135469) {
			for (int var8 = arg2 + 1; var8 < arg2 + arg4; var8++) {
				if (var8 >= 0 && var8 < this.field3643 * -241162669) {
					this.field3697[arg0][arg1][var8] = this.field3697[arg0][arg1 - 1][var8];
				}
			}
		}
		if (arg2 > 0 && arg2 < this.field3643 * -241162669) {
			for (int var9 = arg1 + 1; var9 < arg1 + arg3; var9++) {
				if (var9 >= 0 && var9 < this.field3627 * 993135469) {
					this.field3697[arg0][var9][arg2] = this.field3697[arg0][var9][arg2 - 1];
				}
			}
		}
		if (arg1 < 0 || arg2 < 0 || arg1 >= this.field3627 * 993135469 || arg2 >= this.field3643 * -241162669) {
			return;
		}
		if (arg0 == 0) {
	...
	public final void method5838(class814 arg0, int arg1, int arg2, int arg3, int arg4, class361[] arg5) {
			...
			for (int var7 = 0; var7 < 4; var7++) {
				...
				for (int var9 = 0; var9 < 64; var9++) {
					for (int var10 = 0; var10 < 64; var10++) {
						...
						if (var11 >= 0 && var11 < this.field3627 * 993135469 && var12 >= 0 && var12 < this.field3643 * -241162669) {
		...
		int var13 = arg1 + arg3;
		int var14 = arg2 + arg4;
		for (int var15 = 0; var15 < this.field3628 * -2050894459; var15++) {
	...
	public final void method5839(class814 arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, class361[] arg8) {
		...
		if (!this.field3644) {
			...
			for (int var13 = 0; var13 < 8; var13++) {
				for (int var14 = 0; var14 < 8; var14++) {
					...
					if (var15 > 0 && var15 < this.field3627 * 993135469 - 1 && var16 > 0 && var16 < this.field3643 * -241162669 - 1) {
		...
		for (int var21 = 0; var21 < this.field3628 * -2050894459; var21++) {
					...
					if (arg4 == var21 && var22 >= var10 && var22 <= var10 + 8 && var23 >= var11 && var23 <= var11 + 8) {
						...
						if (var22 == 63 || var23 == 63) {
							...
							for (int var27 = 0; var27 < var26; var27++) {
								...
								if (var30 >= 0 && var30 < this.field3627 * 993135469 && var31 >= 0 && var31 < this.field3643 * -241162669) {
	...
	public final void method5843(class814 arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, boolean arg9) {
		...
		if (arg2 < 0 || arg2 >= this.field3627 * 993135469 || arg3 < 0 || arg3 >= this.field3643 * -241162669) {
			while (true) {
	...
	public final void method5841(int arg0, int[][] arg1) {
		...
		for (int var4 = 0; var4 < this.field3627 * 993135469 + 1; var4++) {
			for (int var5 = 0; var5 < this.field3643 * -241162669 + 1; var5++) {
	...
	public void method5842(class14 arg0, int[][][] arg1, class361[] arg2) {
		if (!this.field3644) {
			for (int var4 = 0; var4 < 4; var4++) {
				for (int var5 = 0; var5 < this.field3627 * 993135469; var5++) {
					for (int var6 = 0; var6 < this.field3643 * -241162669; var6++) {
		...
		for (int var8 = 0; var8 < this.field3628 * -2050894459; var8++) {
			int var9 = 0;
			int var10 = 0;
			if (!this.field3644) {
				if (this.field3622) {
				...
				if (this.field3629 * -1867585901 != 0) {
					var9 |= 0x1;
					var10 |= 0x10;
				}
			}
			...
			this.field3619.method7409(var8, arg0.method521(this.field3627 * 993135469, this.field3643 * -241162669, this.field3697[var8], var11, 512, var9, var10));
		}
	}

	@ObfuscatedName("lq.d(Lra;Lxa;Lxa;B)V")
	public final void method5833(class14 arg0, class12 arg1, class12 arg2) {
		int[][] var4 = new int[this.field3627 * 993135469][this.field3643 * -241162669];
		if (this.field3634 == null || this.field3643 * -241162669 != this.field3634.length) {
			this.field3634 = new int[this.field3643 * -241162669];
			this.field3639 = new int[this.field3643 * -241162669];
			this.field3640 = new int[this.field3643 * -241162669];
			this.field3641 = new int[this.field3643 * -241162669];
			this.field3642 = new int[this.field3643 * -241162669];
		}
		for (int var5 = 0; var5 < this.field3628 * -2050894459; var5++) {
			for (int var6 = 0; var6 < this.field3643 * -241162669; var6++) {
			...
			for (int var7 = -5; var7 < this.field3627 * 993135469; var7++) {
				for (int var8 = 0; var8 < this.field3643 * -241162669; var8++) {
					int var9 = var7 + 5;
					int var10002;
					if (var9 < this.field3627 * 993135469) {
						int var10 = this.field3635[var5][var9][var8] & 0xFF;
						if (var10 > 0) {
							class564 var11 = this.field3668.method11895(var10 - 1);
							this.field3634[var8] += var11.field6718 * 1911651271;
							this.field3639[var8] += var11.field6714 * -1826258191;
							this.field3640[var8] += var11.field6720 * 1981045915;
							this.field3641[var8] += var11.field6721 * -123822535;
					...
					if (var12 >= 0) {
						...
						if (var13 > 0) {
							class564 var14 = this.field3668.method11895(var13 - 1);
							this.field3634[var8] -= var14.field6718 * 1911651271;
							this.field3639[var8] -= var14.field6714 * -1826258191;
							this.field3640[var8] -= var14.field6720 * 1981045915;
							this.field3641[var8] -= var14.field6721 * -123822535;
							var10002 = this.field3642[var8]--;
						}
					}
				}
				if (var7 >= 0) {
					...
					int var18 = 0;
					int var19 = 0;
					for (int var20 = -5; var20 < this.field3643 * -241162669; var20++) {
						int var21 = var20 + 5;
						if (var21 < this.field3643 * -241162669) {
						...
						if (var20 >= 0 && var18 > 0 && var19 > 0) {
							var4[var7][var20] = class482.method6323(var15 * 256 / var18, var16 / var19, var17 / var19);
						}
					}
				}
			}
		...
		for (int var23 = 0; var23 < this.field3628 * -2050894459; var23++) {
	...
	public void method5897(class14 arg0, class12 arg1, int arg2, int[][] arg3, class12 arg4, class12 arg5) {
		for (int var7 = 0; var7 < this.field3627 * 993135469; var7++) {
			for (int var8 = 0; var8 < this.field3643 * -241162669; var8++) {
				...
				class483 var13 = var11 == 0 ? null : this.field3692.method8503(var11 - 1);
				class564 var14 = var12 == 0 ? null : this.field3668.method11895(var12 - 1);
				if (var9 == 0 && var13 == null) {
					var9 = 12;
				}
				class483 var15 = var13;
				if (var13 != null && var13.field5094 * -1036738889 == -1 && var13.field5091 * 842046125 == -1) {
					var15 = var13;
					var13 = null;
				}
				if (var13 != null || var14 != null) {
					this.field3698 = field3658[var9] * -218573595;
					this.field3681 = field3657[var9] * 954548999;
					int var16 = (var14 == null ? 0 : this.field3698 * 1058064621) + (var13 == null ? 0 : this.field3681 * 1187429047);
					int var17 = 0;
					this.field3688 = 0;
					this.field3691 = (var13 == null ? -1 : var13.field5092 * -1620490387) * 1755447885;
					int var18 = var14 == null ? -1 : var14.field6713 * -2038540817;
					...
					int[] var25 = var13 == null || var13.field5091 * 842046125 == -1 ? null : new int[var16];
					if (var13 == null) {
						this.field3688 += this.field3681 * 1829363991;
					} else {
						for (int var26 = 0; var26 < this.field3681 * 1187429047; var26++) {
							var19[var17] = field3667[var9][this.field3688 * 1166522209];
							var20[var17] = field3673[var9][this.field3688 * 1166522209];
							var21[var17] = field3651[var9][this.field3688 * 1166522209];
							var23[var17] = this.field3691 * -1000143227;
							var24[var17] = var13.field5087 * 2049789267;
							var22[var17] = var13.field5094 * -1036738889;
							if (var25 != null) {
								var25[var17] = var13.field5091 * 842046125;
							}
							var17++;
							this.field3688 += -222221151;
						}
						if (!this.field3644 && arg2 == 0) {
							this.field3619.method7416(var7, var8, var13.field5102 * 1562962487, var13.field5099 * 1322381256, var13.field5100 * 2125299745, var13.field5101 * 287703823, var13.field5090 * -349960453, var13.field5098 * -1371749611);
						}
					}
					if (var14 != null) {
						for (int var27 = 0; var27 < this.field3698 * 1058064621; var27++) {
							var19[var17] = field3667[var9][this.field3688 * 1166522209];
							var20[var17] = field3673[var9][this.field3688 * 1166522209];
							var21[var17] = field3651[var9][this.field3688 * 1166522209];
							var23[var17] = var18;
							var24[var17] = var14.field6715 * -209489615;
					...
					class137 var50 = new class137();
					if (this.field3644) {
						var50.field1475 = this.field3619.method7411(var7, var8) * 366102675;
						var50.field1471 = this.field3619.method7410(var7, var8) * 714616553;
						var50.field1474 = this.field3619.method7489(var7, var8) * 388922513;
						var50.field1470 = this.field3619.method7413(var7, var8) * 682931301;
						var50.field1476 = this.field3619.method7505(var7, var8) * -1687556705;
						var50.field1472 = this.field3619.method7501(var7, var8) * 1648006647;
					}
	...
	public void method5845(class14 arg0, class12 arg1, int arg2, int[][] arg3, class12 arg4, class12 arg5) {
		...
		for (int var12 = 0; var12 < this.field3627 * 993135469; var12++) {
			int var13 = var12 < this.field3627 * 993135469 - 1 ? var12 + 1 : var12;
			for (int var14 = 0; var14 < this.field3643 * -241162669; var14++) {
				int var15 = var14 < this.field3643 * -241162669 - 1 ? var14 + 1 : var14;
				this.field3669 = var7[var12][var14] * -442740791;
				this.field3688 = var8[var12][var14] * -222221151;
				int var16 = var10[var12][var14] & 0xFF;
				int var17 = var9[var12][var14] & 0xFF;
				if (var16 != 0 || var17 != 0) {
					class483 var18 = var16 == 0 ? null : this.field3692.method8503(var16 - 1);
					class564 var19 = var17 == 0 ? null : this.field3668.method11895(var17 - 1);
					if (this.field3669 * -1684735367 == 0 && var18 == null) {
						this.field3669 = -1017922196;
					}
					...
					var11[1] = false;
					var11[0] = false;
					class483 var23 = var18;
					if (var18 != null) {
						if (var18.field5094 * -1036738889 == -1 && var18.field5091 * 842046125 == -1) {
							var23 = var18;
							var18 = null;
						} else if (var19 != null && this.field3669 * -1684735367 != 0) {
							this.field3695 = var18.field5097;
						}
					}
					this.field3688 = this.method5905(var17, var12, var14, var13, var15, arg1, var9) * -222221151;
					...
					int var25 = this.field3698 * 1058064621 + this.field3681 * 1187429047;
					if (var25 <= 0) {
						...
						class137 var38 = new class137();
						if (this.field3644) {
							var38.field1475 = this.field3619.method7411(var12, var14) * 366102675;
							var38.field1471 = this.field3619.method7410(var12, var14) * 714616553;
							var38.field1474 = this.field3619.method7489(var12, var14) * 388922513;
							var38.field1470 = this.field3619.method7413(var12, var14) * 682931301;
							var38.field1476 = this.field3619.method7505(var12, var14) * -1687556705;
							var38.field1472 = this.field3619.method7501(var12, var14) * 1648006647;
						}
	...
	public int method5905(int arg0, int arg1, int arg2, int arg3, int arg4, class12 arg5, byte[][] arg6) {
		if (this.field3669 * -1684735367 != 0 && this.field3669 * -1684735367 != 12 || arg1 <= 0 || arg2 <= 0 || arg1 >= this.field3627 * 993135469 || arg2 >= this.field3643 * -241162669) {
			return this.field3688 * 1166522209;
		}
		byte var8 = 0;
		byte var9 = 0;
		byte var10 = 0;
	...
	public void method5835(class14 arg0, class483 arg1, class564 arg2, int arg3, int arg4, byte[][] arg5, byte[][] arg6, byte[][] arg7, boolean[] arg8) {
		boolean[] var10 = arg1 != null && arg1.field5097 ? field3675[this.field3669 * -1684735367] : field3670[this.field3669 * -1684735367];
		this.method5851(arg0, arg1, arg2, arg3, arg4, this.field3627 * 993135469, this.field3643 * -241162669, arg7, arg5, arg6, arg8);
		this.field3685 = arg1 != null && arg1.field5094 * -1036738889 != arg1.field5091 * 842046125;
		if (!this.field3685) {
		...
		if (!var10[this.field3688 * 1166522209 + 1 & 0x3]) {
			arg8[1] |= (this.field3686[2] & this.field3686[4]) == 0;
		}
		if (!var10[this.field3688 * 1166522209 + 3 & 0x3]) {
			arg8[3] |= (this.field3686[6] & this.field3686[0]) == 0;
		}
		if (!var10[this.field3688 * 1166522209 & 0x3]) {
			arg8[0] |= (this.field3686[0] & this.field3686[2]) == 0;
		}
		if (!var10[this.field3688 * 1166522209 + 2 & 0x3]) {
			arg8[2] |= (this.field3686[4] & this.field3686[6]) == 0;
		}
		if (this.field3695 || this.field3669 * -1684735367 != 0 && this.field3669 * -1684735367 != 12) {
			return;
		}
		if (arg8[0] && !arg8[1] && !arg8[2] && arg8[3]) {
			arg8[3] = false;
			arg8[0] = false;
			this.field3669 = (this.field3669 * -1684735367 == 0 ? 13 : 14) * -442740791;
			this.field3688 = 0;
		} else if (arg8[0] && arg8[1] && !arg8[2] && !arg8[3]) {
			arg8[1] = false;
			arg8[0] = false;
			this.field3669 = (this.field3669 * -1684735367 == 0 ? 13 : 14) * -442740791;
			this.field3688 = -666663453;
		} else if (!arg8[0] && arg8[1] && arg8[2] && !arg8[3]) {
			arg8[2] = false;
			arg8[1] = false;
			this.field3669 = (this.field3669 * -1684735367 == 0 ? 13 : 14) * -442740791;
			this.field3688 = -444442302;
		} else if (!arg8[0] && !arg8[1] && arg8[2] && arg8[3]) {
			arg8[3] = false;
			arg8[2] = false;
			this.field3669 = (this.field3669 * -1684735367 == 0 ? 13 : 14) * -442740791;
	...
	public void method5872(class483 arg0, class564 arg1) {
		if (this.field3678) {
			this.field3700 = field3667[this.field3669 * -1684735367];
			this.field3638 = field3673[this.field3669 * -1684735367];
			this.field3702 = field3651[this.field3669 * -1684735367];
			this.field3681 = (arg0 == null ? 0 : field3657[this.field3669 * -1684735367]) * 954548999;
			this.field3698 = (arg1 == null ? 0 : field3658[this.field3669 * -1684735367]) * -218573595;
		} else if (this.field3695) {
			this.field3700 = field3677[this.field3669 * -1684735367];
			this.field3638 = field3687[this.field3669 * -1684735367];
			this.field3702 = field3679[this.field3669 * -1684735367];
			this.field3681 = (arg0 == null ? 0 : field3661[this.field3669 * -1684735367]) * 954548999;
			this.field3698 = (arg1 == null ? 0 : field3662[this.field3669 * -1684735367]) * -218573595;
			this.field3693 = field3676[this.field3669 * -1684735367];
		} else {
			this.field3700 = field3637[this.field3669 * -1684735367];
			this.field3638 = field3616[this.field3669 * -1684735367];
			this.field3702 = field3674[this.field3669 * -1684735367];
			this.field3681 = (arg0 == null ? 0 : field3699[this.field3669 * -1684735367]) * 954548999;
			this.field3698 = (arg1 == null ? 0 : field3660[this.field3669 * -1684735367]) * -218573595;
			this.field3693 = field3671[this.field3669 * -1684735367];
		}
	}
	...
	public void method5849(class14 arg0, int arg1, int arg2, int arg3, class483 arg4, boolean[] arg5, int[] arg6, int[] arg7, int[] arg8, int[] arg9, int[] arg10, int[] arg11, int[] arg12, int[] arg13, class12 arg14, class12 arg15, class12 arg16) {
		this.field3633 = -1917254293;
		this.field3691 = -1755447885;
		this.field3617 = 1192571648;
		if (arg4 != null) {
			this.field3633 = arg4.field5094 * 1336481411;
			this.field3691 = arg4.field5092 * 1077106121;
			this.field3617 = arg4.field5087 * 476264073;
			int var18 = method5549(arg0, arg4);
			for (int var19 = 0; var19 < this.field3681 * 1187429047; var19++) {
				boolean var20 = false;
				byte var21;
				if (arg5[-(this.field3688 * 1166522209) & 0x3] && this.field3626 * 799512803 == this.field3693[0]) {
					this.field3680[0] = this.field3700[this.field3626 * 799512803];
					this.field3680[1] = 1;
					this.field3680[2] = this.field3702[this.field3626 * 799512803];
					this.field3680[3] = 1;
					this.field3680[4] = this.field3638[this.field3626 * 799512803];
					this.field3680[5] = this.field3702[this.field3626 * 799512803];
					var21 = 6;
				} else if (arg5[2 - this.field3688 * 1166522209 & 0x3] && this.field3626 * 799512803 == this.field3693[2]) {
					this.field3680[0] = this.field3700[this.field3626 * 799512803];
					this.field3680[1] = 5;
					this.field3680[2] = this.field3702[this.field3626 * 799512803];
					this.field3680[3] = 5;
					...
					this.field3680[5] = this.field3702[this.field3626 * 799512803];
					var21 = 6;
				} else if (arg5[1 - this.field3688 * 1166522209 & 0x3] && this.field3626 * 799512803 == this.field3693[1]) {
					this.field3680[0] = this.field3700[this.field3626 * 799512803];
					this.field3680[1] = 3;
					this.field3680[2] = this.field3702[this.field3626 * 799512803];
					this.field3680[3] = 3;
					...
					this.field3680[5] = this.field3702[this.field3626 * 799512803];
					var21 = 6;
				} else if (arg5[3 - this.field3688 * 1166522209 & 0x3] && this.field3626 * 799512803 == this.field3693[3]) {
					this.field3680[0] = this.field3700[this.field3626 * 799512803];
					this.field3680[1] = 7;
					this.field3680[2] = this.field3702[this.field3626 * 799512803];
					this.field3680[3] = 7;
					...
					this.field3680[0] = this.field3700[this.field3626 * 799512803];
					this.field3680[1] = this.field3638[this.field3626 * 799512803];
					this.field3680[2] = this.field3702[this.field3626 * 799512803];
					var21 = 3;
				}
				for (int var22 = 0; var22 < var21; var22++) {
					int var23 = this.field3680[var22];
					int var24 = var23 - this.field3688 * -1961922878 & 0x7;
					int var25 = field3663[var23];
					int var26 = field3664[var23];
					int var27;
					int var28;
					if (this.field3688 * 1166522209 == 1) {
						var27 = var26;
						var28 = 512 - var25;
					} else if (this.field3688 * 1166522209 == 2) {
						var27 = 512 - var25;
						var28 = 512 - var26;
					} else if (this.field3688 * 1166522209 == 3) {
						var27 = 512 - var26;
						var28 = var25;
					} else {
						var27 = var25;
					...
					arg7[this.field3690 * 546123115] = var27;
					arg8[this.field3690 * 546123115] = var28;
					if (arg12 != null && field3665[this.field3669 * -1684735367][var23]) {
						int var29 = (arg2 << 9) + var27;
						int var30 = (arg3 << 9) + var28;
						arg12[this.field3690 * 546123115] = arg15.method196(var29, var30) - arg14.method196(var29, var30);
					}
					if (arg13 != null) {
						if (arg15 != null && !field3665[this.field3669 * -1684735367][var23]) {
							int var31 = (arg2 << 9) + var27;
							int var32 = (arg3 << 9) + var28;
							arg13[this.field3690 * 546123115] = arg14.method196(var31, var32) - arg15.method196(var31, var32);
						} else if (arg16 != null && !field3666[this.field3669 * -1684735367][var23]) {
							int var33 = (arg2 << 9) + var27;
							int var34 = (arg3 << 9) + var28;
							arg13[this.field3690 * 546123115] = arg16.method196(var33, var34) - arg14.method196(var33, var34);
						}
					}
					if (var23 < 8 && this.field3648[var24] > arg4.field5096 * 1680330727) {
						if (arg6 != null) {
							arg6[this.field3690 * 546123115] = this.field3682[var24];
						}
						arg11[this.field3690 * 546123115] = this.field3684[var24];
						arg10[this.field3690 * 546123115] = this.field3696[var24];
						arg9[this.field3690 * 546123115] = this.field3689[var24];
					} else {
						if (arg6 != null) {
							arg6[this.field3690 * 546123115] = var18;
						}
						arg10[this.field3690 * 546123115] = arg4.field5092 * -1620490387;
						arg11[this.field3690 * 546123115] = arg4.field5087 * 2049789267;
						arg9[this.field3690 * 546123115] = this.field3633 * 1307902141;
					}
					this.field3690 += 1971951427;
				}
				this.field3626 += -1122079541;
			}
			if (!this.field3644 && arg1 == 0) {
				this.field3619.method7416(arg2, arg3, arg4.field5102 * 1562962487, arg4.field5099 * 1322381256, arg4.field5100 * 2125299745, arg4.field5101 * 287703823, arg4.field5090 * -349960453, arg4.field5098 * -1371749611);
			}
			if (this.field3669 * -1684735367 != 12 && arg4.field5094 * -1036738889 != -1 && arg4.field5095) {
				this.field3694 = true;
			}
		} else if (this.field3678) {
			this.field3626 += field3657[this.field3669 * -1684735367] * -1122079541;
		} else if (this.field3695) {
			this.field3626 += field3661[this.field3669 * -1684735367] * -1122079541;
		} else {
			this.field3626 += field3699[this.field3669 * -1684735367] * -1122079541;
		}
	}
	...
	public void method5867(class14 arg0, int arg1, int arg2, int arg3, int arg4, int arg5, class564 arg6, int arg7, int arg8, int arg9, int arg10, boolean[] arg11, int[] arg12, int[] arg13, int[] arg14, int[] arg15, int[] arg16, int[] arg17, int[] arg18, int[] arg19, int[][] arg20, class12 arg21, class12 arg22, class12 arg23) {
		...
		class564 var25 = this.field3668.method11895(arg7 - 1);
		class564 var26 = this.field3668.method11895(arg8 - 1);
		class564 var27 = this.field3668.method11895(arg9 - 1);
		class564 var28 = this.field3668.method11895(arg10 - 1);
		for (int var29 = 0; var29 < this.field3698 * 1058064621; var29++) {
			boolean var30 = false;
			byte var31;
			if (arg11[-(this.field3688 * 1166522209) & 0x3] && this.field3626 * 799512803 == this.field3693[0]) {
				this.field3680[0] = this.field3700[this.field3626 * 799512803];
				this.field3680[1] = 1;
				this.field3680[2] = this.field3702[this.field3626 * 799512803];
				this.field3680[3] = 1;
				...
				this.field3680[5] = this.field3702[this.field3626 * 799512803];
				var31 = 6;
			} else if (arg11[2 - this.field3688 * 1166522209 & 0x3] && this.field3626 * 799512803 == this.field3693[2]) {
				this.field3680[0] = this.field3700[this.field3626 * 799512803];
				this.field3680[1] = 5;
				this.field3680[2] = this.field3702[this.field3626 * 799512803];
				this.field3680[3] = 5;
				...
				this.field3680[5] = this.field3702[this.field3626 * 799512803];
				var31 = 6;
			} else if (arg11[1 - this.field3688 * 1166522209 & 0x3] && this.field3626 * 799512803 == this.field3693[1]) {
				this.field3680[0] = this.field3700[this.field3626 * 799512803];
				this.field3680[1] = 3;
				this.field3680[2] = this.field3702[this.field3626 * 799512803];
				this.field3680[3] = 3;
				...
				this.field3680[5] = this.field3702[this.field3626 * 799512803];
				var31 = 6;
			} else if (arg11[3 - this.field3688 * 1166522209 & 0x3] && this.field3626 * 799512803 == this.field3693[3]) {
				this.field3680[0] = this.field3700[this.field3626 * 799512803];
				this.field3680[1] = 7;
				this.field3680[2] = this.field3702[this.field3626 * 799512803];
				this.field3680[3] = 7;
			...
			for (int var32 = 0; var32 < var31; var32++) {
				...
				int var34 = var33 - this.field3688 * -1961922878 & 0x7;
				...
				arg13[this.field3690 * 546123115] = var37;
				arg14[this.field3690 * 546123115] = var38;
				if (arg18 != null && field3665[this.field3669 * -1684735367][var33]) {
					int var39 = (arg2 << 9) + var37;
					int var40 = (arg3 << 9) + var38;
					arg18[this.field3690 * 546123115] = arg22.method196(var39, var40) - arg21.method196(var39, var40);
				}
				if (arg19 != null) {
					if (arg22 != null && !field3665[this.field3669 * -1684735367][var33]) {
						int var41 = (arg2 << 9) + var37;
						int var42 = (arg3 << 9) + var38;
						arg19[this.field3690 * 546123115] = arg21.method196(var41, var42) - arg22.method196(var41, var42);
					} else if (arg23 != null && !field3666[this.field3669 * -1684735367][var33]) {
						int var43 = (arg2 << 9) + var37;
						int var44 = (arg3 << 9) + var38;
						arg19[this.field3690 * 546123115] = arg23.method196(var43, var44) - arg21.method196(var43, var44);
					}
				}
				if (var33 < 8 && this.field3648[var34] >= 0) {
					if (arg12 != null) {
						arg12[this.field3690 * 546123115] = this.field3682[var34];
					}
					arg17[this.field3690 * 546123115] = this.field3684[var34];
					arg16[this.field3690 * 546123115] = this.field3696[var34];
					arg15[this.field3690 * 546123115] = this.field3689[var34];
				} else {
					if (this.field3695 && field3665[this.field3669 * -1684735367][var33]) {
						arg16[this.field3690 * 546123115] = this.field3691 * -1000143227;
						arg17[this.field3690 * 546123115] = this.field3617 * -711266821;
						arg15[this.field3690 * 546123115] = this.field3633 * 1307902141;
					} else if (var37 == 0 && var38 == 0) {
						arg15[this.field3690 * 546123115] = arg20[arg2][arg3];
						arg16[this.field3690 * 546123115] = var25.field6713 * -2038540817;
						arg17[this.field3690 * 546123115] = var25.field6715 * -209489615;
					} else if (var37 == 0 && var38 == 512) {
						arg15[this.field3690 * 546123115] = arg20[arg2][arg5];
						arg16[this.field3690 * 546123115] = var26.field6713 * -2038540817;
						arg17[this.field3690 * 546123115] = var26.field6715 * -209489615;
					} else if (var37 == 512 && var38 == 512) {
						arg15[this.field3690 * 546123115] = arg20[arg4][arg5];
						arg16[this.field3690 * 546123115] = var27.field6713 * -2038540817;
						arg17[this.field3690 * 546123115] = var27.field6715 * -209489615;
					} else if (var37 == 512 && var38 == 0) {
						arg15[this.field3690 * 546123115] = arg20[arg4][arg3];
						arg16[this.field3690 * 546123115] = var28.field6713 * -2038540817;
						arg17[this.field3690 * 546123115] = var28.field6715 * -209489615;
					} else {
						if (var37 < 256) {
							if (var38 < 256) {
								arg16[this.field3690 * 546123115] = var25.field6713 * -2038540817;
						...
						arg15[this.field3690 * 546123115] = method5029(var45, var46, var38 << 7 >> 9);
					}
					if (arg12 != null) {
						arg12[this.field3690 * 546123115] = arg15[this.field3690 * 546123115];
					}
				}
				this.field3690 += 1971951427;
			}
		...
		if (this.field3669 * -1684735367 != 0 && arg6.field6719) {
			this.field3694 = true;
		}
	}
	...
	public void method5894(class12 arg0, class564 arg1, class483 arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
		...
		if (arg1 != null && !arg1.field6717) {
			var16 = false;
		} else if (arg8 == 0 && this.field3669 * -1684735367 != 0) {
			var16 = false;
	...
	public final void method5851(class14 arg0, class483 arg1, class564 arg2, int arg3, int arg4, int arg5, int arg6, byte[][] arg7, byte[][] arg8, byte[][] arg9, boolean[] arg10) {
		boolean[] var12 = arg1 != null && arg1.field5097 ? field3675[this.field3669 * -1684735367] : field3670[this.field3669 * -1684735367];
		if (arg4 > 0) {
			if (arg3 > 0) {
				int var13 = arg7[arg3 - 1][arg4 - 1] & 0xFF;
				if (var13 > 0) {
					class483 var14 = this.field3692.method8503(var13 - 1);
					if (var14.field5094 * -1036738889 != -1 && var14.field5097) {
						byte var15 = arg8[arg3 - 1][arg4 - 1];
						int var16 = arg9[arg3 - 1][arg4 - 1] * 2 + 4 & 0x7;
						int var17 = method5549(arg0, var14);
						if (field3665[var15][var16]) {
							this.field3689[0] = var14.field5094 * -1036738889;
							this.field3682[0] = var17;
							this.field3696[0] = var14.field5092 * -1620490387;
							this.field3684[0] = var14.field5087 * 2049789267;
							this.field3648[0] = var14.field5096 * 1680330727;
			...
			if (arg3 < arg5 - 1) {
				...
				if (var18 > 0) {
					class483 var19 = this.field3692.method8503(var18 - 1);
					if (var19.field5094 * -1036738889 != -1 && var19.field5097) {
						byte var20 = arg8[arg3 + 1][arg4 - 1];
						int var21 = arg9[arg3 + 1][arg4 - 1] * 2 + 6 & 0x7;
						int var22 = method5549(arg0, var19);
						if (field3665[var20][var21]) {
							this.field3689[2] = var19.field5094 * -1036738889;
							this.field3682[2] = var22;
							this.field3696[2] = var19.field5092 * -1620490387;
							this.field3684[2] = var19.field5087 * 2049789267;
							this.field3648[2] = var19.field5096 * 1680330727;
		...
		if (arg4 < arg6 - 1) {
			if (arg3 > 0) {
				...
				if (var23 > 0) {
					class483 var24 = this.field3692.method8503(var23 - 1);
					if (var24.field5094 * -1036738889 != -1 && var24.field5097) {
						byte var25 = arg8[arg3 - 1][arg4 + 1];
						int var26 = arg9[arg3 - 1][arg4 + 1] * 2 + 2 & 0x7;
						int var27 = method5549(arg0, var24);
						if (field3665[var25][var26]) {
							this.field3689[6] = var24.field5094 * -1036738889;
							this.field3682[6] = var27;
							this.field3696[6] = var24.field5092 * -1620490387;
							this.field3684[6] = var24.field5087 * 2049789267;
							this.field3648[6] = var24.field5096 * 1680330727;
							this.field3686[6] = 64;
						}
					}
				}
			...
			if (arg3 < arg5 - 1) {
				...
				if (var28 > 0) {
					class483 var29 = this.field3692.method8503(var28 - 1);
					if (var29.field5094 * -1036738889 != -1 && var29.field5097) {
						byte var30 = arg8[arg3 + 1][arg4 + 1];
						int var31 = arg9[arg3 + 1][arg4 + 1] * 2 & 0x7;
						int var32 = method5549(arg0, var29);
						if (field3665[var30][var31]) {
							this.field3689[4] = var29.field5094 * -1036738889;
							this.field3682[4] = var32;
							this.field3696[4] = var29.field5092 * -1620490387;
							this.field3684[4] = var29.field5087 * 2049789267;
							this.field3648[4] = var29.field5096 * 1680330727;
		...
		if (arg4 > 0) {
			...
			if (var33 > 0) {
				class483 var34 = this.field3692.method8503(var33 - 1);
				if (var34.field5094 * -1036738889 != -1) {
					...
					if (var34.field5097) {
						...
						for (int var40 = 0; var40 < 3; var40++) {
							var38 &= 0x7;
							var37 &= 0x7;
							if (field3665[var35][var38] && this.field3648[var37] <= var34.field5096 * 1680330727) {
								this.field3689[var37] = var34.field5094 * -1036738889;
								this.field3682[var37] = var39;
								this.field3696[var37] = var34.field5092 * -1620490387;
								this.field3684[var37] = var34.field5087 * 2049789267;
								if (var34.field5096 * 1680330727 == this.field3648[var37]) {
									this.field3686[var37] |= 0x20;
								} else {
									this.field3686[var37] = 32;
								}
								this.field3648[var37] = var34.field5096 * 1680330727;
							}
							var38++;
							var37--;
						}
						if (!var12[this.field3688 * 1166522209 & 0x3]) {
							arg10[0] = field3675[var35][var36 + 2 & 0x3];
						}
					} else if (!var12[this.field3688 * 1166522209 & 0x3]) {
		...
		if (arg4 < arg6 - 1) {
			...
			if (var41 > 0) {
				class483 var42 = this.field3692.method8503(var41 - 1);
				if (var42.field5094 * -1036738889 != -1) {
					...
					if (var42.field5097) {
						...
						for (int var48 = 0; var48 < 3; var48++) {
							var46 &= 0x7;
							var45 &= 0x7;
							if (field3665[var43][var46] && this.field3648[var45] <= var42.field5096 * 1680330727) {
								this.field3689[var45] = var42.field5094 * -1036738889;
								this.field3682[var45] = var47;
								this.field3696[var45] = var42.field5092 * -1620490387;
								this.field3684[var45] = var42.field5087 * 2049789267;
								if (var42.field5096 * 1680330727 == this.field3648[var45]) {
									this.field3686[var45] |= 0x10;
								} else {
									this.field3686[var45] = 16;
								}
								this.field3648[var45] = var42.field5096 * 1680330727;
							}
							var46--;
							var45++;
						}
						if (!var12[this.field3688 * 1166522209 + 2 & 0x3]) {
							arg10[2] = field3675[var43][var44 & 0x3];
						}
					} else if (!var12[this.field3688 * 1166522209 + 2 & 0x3]) {
		...
		if (arg3 > 0) {
			...
			if (var49 > 0) {
				class483 var50 = this.field3692.method8503(var49 - 1);
				if (var50.field5094 * -1036738889 != -1) {
					...
					if (var50.field5097) {
						...
						for (int var56 = 0; var56 < 3; var56++) {
							var54 &= 0x7;
							var53 &= 0x7;
							if (field3665[var51][var54] && this.field3648[var53] <= var50.field5096 * 1680330727) {
								this.field3689[var53] = var50.field5094 * -1036738889;
								this.field3682[var53] = var55;
								this.field3696[var53] = var50.field5092 * -1620490387;
								this.field3684[var53] = var50.field5087 * 2049789267;
								if (var50.field5096 * 1680330727 == this.field3648[var53]) {
									this.field3686[var53] |= 0x8;
								} else {
									this.field3686[var53] = 8;
								}
								this.field3648[var53] = var50.field5096 * 1680330727;
							}
							var54--;
							var53++;
						}
						if (!var12[this.field3688 * 1166522209 + 3 & 0x3]) {
							arg10[3] = field3675[var51][var52 + 1 & 0x3];
						}
					} else if (!var12[this.field3688 * 1166522209 + 3 & 0x3]) {
		...
		if (arg3 < arg5 - 1) {
			...
			if (var57 > 0) {
				class483 var58 = this.field3692.method8503(var57 - 1);
				if (var58.field5094 * -1036738889 != -1) {
					...
					if (var58.field5097) {
						...
						for (int var64 = 0; var64 < 3; var64++) {
							var62 &= 0x7;
							var61 &= 0x7;
							if (field3665[var59][var62] && this.field3648[var61] <= var58.field5096 * 1680330727) {
								this.field3689[var61] = var58.field5094 * -1036738889;
								this.field3682[var61] = var63;
								this.field3696[var61] = var58.field5092 * -1620490387;
								this.field3684[var61] = var58.field5087 * 2049789267;
								if (var58.field5096 * 1680330727 == this.field3648[var61]) {
									this.field3686[var61] |= 0x4;
								} else {
									this.field3686[var61] = 4;
								}
								this.field3648[var61] = var58.field5096 * 1680330727;
							}
							var62++;
							var61--;
						}
						if (!var12[this.field3688 * 1166522209 + 1 & 0x3]) {
							arg10[1] = field3675[var59][var60 + 3 & 0x3];
						}
					} else if (!var12[this.field3688 * 1166522209 + 1 & 0x3]) {
		...
		for (int var66 = 0; var66 < 8; var66++) {
			int var67 = var66 - this.field3688 * -1961922878 & 0x7;
			if (field3665[this.field3669 * -1684735367][var66] && this.field3648[var67] <= arg1.field5096 * 1680330727) {
				this.field3689[var67] = arg1.field5094 * -1036738889;
				this.field3682[var67] = var65;
				this.field3696[var67] = arg1.field5092 * -1620490387;
				this.field3684[var67] = arg1.field5087 * 2049789267;
				if (arg1.field5096 * 1680330727 == this.field3648[var67]) {
					this.field3686[var67] |= 0x2;
				} else {
					this.field3686[var67] = 2;
				}
				this.field3648[var67] = arg1.field5096 * 1680330727;
			}
		}
	}
	...
	public static final int method5549(class14 arg0, class483 arg1) {
		if (arg1.field5091 * 842046125 != -1) {
			return arg1.field5091 * 842046125;
		}
		if (arg1.field5092 * -1620490387 != -1) {
			class120 var2 = arg0.field400.method889(arg1.field5092 * -1620490387);
			if (!var2.field1250) {
				return var2.field1260;
			}
		}
		return arg1.field5094 * -1036738889;
	}
