...
public final class class344 {
	...
	public class344(long arg0, int arg1, class342 arg2) {
		this.field3720 = arg0 * -1877638512853033941L;
		this.field3722 = arg1 * 459562889;
		this.field3721 = arg2;
		if (this.field3722 * -1640249671 == -1) {
			...
			this.field3717 = new HashMap(this.field3722 * -1640249671);
			this.field3718 = new class978(this.field3722 * -1640249671);
			this.field3719 = new class978(this.field3722 * -1640249671);
		}
	}

	@ObfuscatedName("lc.u(B)Z")
	public boolean method5953() {
		return this.field3722 * -1640249671 != -1;
	}

	@ObfuscatedName("lc.j(Ljava/lang/Object;I)Ljava/lang/Object;")
	public Object method5949(Object arg0) {
		synchronized (this) {
			if (this.field3720 * -3700417057610497405L != -1L) {
				this.method5952();
			}
	...
	public Object method5954(Object arg0, Object arg1) {
		synchronized (this) {
			...
			if (this.method5953() && this.field3717.size() == this.field3722 * -1640249671) {
	...
	public void method5951(class343 arg0, boolean arg1) {
		...
		arg0.field3714 = System.currentTimeMillis() * -3851075030700084475L;
		if (this.method5953()) {
			switch(this.field3721.field3711 * -502552377) {
				case 0:
					arg0.field3712 = arg0.field3714 * -6576964548882420431L;
					break;
				case 1:
					arg0.field3712 += 6096710624339338485L;
			}
	...
	public void method5952() {
		...
		long var1 = System.currentTimeMillis() - this.field3720 * -3700417057610497405L;
		while (!this.field3718.isEmpty()) {
			class343 var3 = (class343) this.field3718.peek();
			if (var3.field3714 * -1646577731312606771L >= var1) {
				return;
			}
