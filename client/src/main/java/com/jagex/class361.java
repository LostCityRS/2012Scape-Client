...
public class class361 {
	...
	public static class361 method4718(int arg0, int arg1) {
		class361 var2 = new class361();
		var2.field3857 = 819512165;
		var2.field3893 = 508319701;
		var2.field3894 = (arg0 + 1 + 5) * 2027382289;
		var2.field3895 = (arg1 + 1 + 5) * -1360277089;
		var2.field3896 = new int[var2.field3894 * 1178094321][var2.field3895 * 1049823839];
		var2.method6294();
		return var2;
	}
	...
	public void method6294() {
		for (int var1 = 0; var1 < this.field3894 * 1178094321; var1++) {
			for (int var2 = 0; var2 < this.field3895 * 1049823839; var2++) {
				if (var1 == 0 || var2 == 0 || var1 >= this.field3894 * 1178094321 - 5 || var2 >= this.field3895 * 1049823839 - 5) {
	...
	public void method6296(int arg0, int arg1, int arg2, int arg3, boolean arg4, boolean arg5) {
		int var7 = arg0 - this.field3857 * 529549715;
		int var8 = arg1 - this.field3893 * -1275603325;
		if (arg2 == 0) {
			if (arg3 == 0) {
	...
	public void method6264(int arg0, int arg1, int arg2, int arg3, boolean arg4, boolean arg5) {
		...
		int var8 = arg0 - this.field3857 * 529549715;
		int var9 = arg1 - this.field3893 * -1275603325;
		for (int var10 = var8; var10 < arg2 + var8; var10++) {
			if (var10 >= 0 && var10 < this.field3894 * 1178094321) {
				for (int var11 = var9; var11 < arg3 + var9; var11++) {
					if (var11 >= 0 && var11 < this.field3895 * 1049823839) {
	...
	public void method6274(int arg0, int arg1) {
		int var3 = arg0 - this.field3857 * 529549715;
		int var4 = arg1 - this.field3893 * -1275603325;
	...
	public void method6269(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5, boolean arg6) {
		...
		int var9 = arg0 - this.field3857 * 529549715;
		int var10 = arg1 - this.field3893 * -1275603325;
		if (arg4 == 1 || arg4 == 3) {
			int var11 = arg2;
			arg2 = arg3;
			arg3 = var11;
		...
		for (int var12 = var9; var12 < arg2 + var9; var12++) {
			if (var12 >= 0 && var12 < this.field3894 * 1178094321) {
				for (int var13 = var10; var13 < arg3 + var10; var13++) {
					if (var13 >= 0 && var13 < this.field3895 * 1049823839) {
	...
	public boolean method6273(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
		...
		int var8 = arg0 - this.field3857 * 529549715;
		int var9 = arg1 - this.field3893 * -1275603325;
		int var10 = arg3 - this.field3857 * 529549715;
		int var11 = arg4 - this.field3893 * -1275603325;
		if (arg2 == 1) {
			if (arg5 == 0) {
				if (arg6 == 0) {
	...
	public boolean method6290(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
		...
		if (arg0 >= arg3 && arg0 <= var9 && arg1 >= arg4 && arg1 <= var10) {
			return true;
		} else if (arg3 - 1 == arg0 && arg1 >= arg4 && arg1 <= var10 && (this.field3896[arg0 - this.field3857 * 529549715][arg1 - this.field3893 * -1275603325] & 0x8) == 0 && (arg7 & 0x8) == 0) {
			return true;
		} else if (var9 + 1 == arg0 && arg1 >= arg4 && arg1 <= var10 && (this.field3896[arg0 - this.field3857 * 529549715][arg1 - this.field3893 * -1275603325] & 0x80) == 0 && (arg7 & 0x2) == 0) {
			return true;
		} else if (arg4 - 1 == arg1 && arg0 >= arg3 && arg0 <= var9 && (this.field3896[arg0 - this.field3857 * 529549715][arg1 - this.field3893 * -1275603325] & 0x2) == 0 && (arg7 & 0x4) == 0) {
			return true;
		} else {
			return var10 + 1 == arg1 && arg0 >= arg3 && arg0 <= var9 && (this.field3896[arg0 - this.field3857 * 529549715][arg1 - this.field3893 * -1275603325] & 0x20) == 0 && (arg7 & 0x1) == 0;
		}
	}
	...
	public boolean method6275(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
		...
		if (arg0 == var12 && (arg8 & 0x2) == 0) {
			...
			while (var14 < var15) {
				if ((this.field3896[var12 - 1 - this.field3857 * 529549715][var14 - this.field3893 * -1275603325] & 0x8) == 0) {
					return true;
				}
				var14++;
			}
			...
			while (var16 < var17) {
				if ((this.field3896[arg4 - this.field3857 * 529549715][var16 - this.field3893 * -1275603325] & 0x80) == 0) {
					return true;
				}
				var16++;
			}
			...
			while (var18 < var19) {
				if ((this.field3896[var18 - this.field3857 * 529549715][var13 - 1 - this.field3893 * -1275603325] & 0x2) == 0) {
					return true;
				}
				var18++;
			}
			...
			while (var20 < var21) {
				if ((this.field3896[var20 - this.field3857 * 529549715][arg5 - this.field3893 * -1275603325] & 0x20) == 0) {
					return true;
				}
				var20++;
			}
