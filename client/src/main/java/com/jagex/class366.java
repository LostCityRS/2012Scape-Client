...
public class class366 {
	...
	@ObfuscatedName("mq.l")
	public int field3933 = 219085753;
	...
	public class366(int arg0, class367[] arg1, int arg2, int arg3, int arg4, int arg5, class420 arg6, int arg7) {
		this.field3934 = arg3 * -512010337;
		this.field3926 = arg4 * 506436959;
		this.field3936 = arg5 * -1834658969;
		this.field3927 = arg0 * -1600815635;
		this.field3946 = arg1;
		this.field3930 = arg6;
		if (arg1 == null) {
			this.field3931 = null;
	...
	public void method6378(int arg0, int arg1) {
		...
		this.field3947 = ((arg1 - this.field3949 * 1596816317) * arg0 / 255 + this.field3949 * 1596816317) * 1851787541;
	}

	@ObfuscatedName("mq.s(Lmq;B)V")
	public void method6386(class366 arg0) {
		if (this.field3945) {
			this.field3949 = this.field3947 * 401568897;
		} else if (arg0 != null && arg0.field3945) {
			this.field3949 = -1661305493 - arg0.field3947 * 401568897;
		} else {
			this.field3949 = 0;
		}
		this.field3945 = true;
	...
	public boolean method6366(class14 arg0, int arg1, int arg2) {
		if (this.field3933 * -788437641 != arg1) {
			this.field3933 = arg1 * -219085753;
			...
			if (this.field3928 * -1337726515 != var4) {
				this.field3928 = var4 * 218311429;
				this.field3937 = null;
			}
			if (this.field3946 != null) {
				...
				for (int var6 = 0; var6 < this.field3946.length; var6++) {
					...
					if (var7.method6407(this.field3934 * 1017381983, this.field3926 * -648544609, this.field3936 * -1381427113, this.field3933 * -788437641)) {
						var5[this.field3932 * 361842433] = var7.field3964;
						this.field3931[(this.field3932 += 1428142337) * 361842433 - 1] = var7;
					}
				}
				class485.method15811(var5, this.field3931, 0, this.field3932 * 361842433 - 1);
			}
			this.field3938 = true;
		}
		boolean var8 = false;
		if (this.field3938) {
			...
			for (int var9 = this.field3932 * 361842433 - 1; var9 >= 0; var9--) {
		...
		if (arg2 == 0 || !arg0.method451()) {
			this.field3943 = null;
		} else if (this.field3943 == null && this.field3942 * 574521377 >= 0) {
	...
	public void method6372(class14 arg0) {
		try {
			boolean var2 = Statics.field549.method5631(this.field3942 * 574521377);
			if (var2) {
				arg0.method530(16777215, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F);
				class129 var3 = class129.method2664(Statics.field549, this.field3942 * 574521377, 0);
	...
	public void method6369(class14 arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, boolean arg10, boolean arg11) {
		int var13 = 0;
		if (this.field3945) {
			var13 = this.field3947 * 309329469;
		}
	...
	public void method6370(class14 arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, boolean arg10, boolean arg11, int arg12) {
		...
		if (this.field3943 == null) {
			...
			if (this.field3927 * -745773083 == -1 || this.field3928 * -1337726515 == 0) {
				arg0.method489(arg2, arg3, arg4, arg5, var14 << 24 | arg9, 1);
			} else {
				class120 var15 = Statics.field6785.method889(this.field3927 * -745773083);
				if (this.field3937 == null && Statics.field6785.method898(this.field3927 * -745773083, class456.field4853 == var15.field1262 ? class455.field4848 : class455.field4849, 0.7F, this.field3928 * -1337726515, this.field3928 * -1337726515, false)) {
					int[] var16 = class456.field4853 == var15.field1262 ? Statics.field6785.method887(this.field3927 * -745773083, 0.7F, this.field3928 * -1337726515, this.field3928 * -1337726515, false) : Statics.field6785.method886(this.field3927 * -745773083, 0.7F, this.field3928 * -1337726515, this.field3928 * -1337726515, false);
					this.field3941 = var16[0] * 442711429;
					this.field3940 = var16[var16.length - 1] * 2089066035;
					this.field3937 = arg0.method506(var16, 0, var15.field1252 * 424629663, var15.field1252 * 424629663, var15.field1252 * 424629663);
				}
				...
				if (this.field3937 != null) {
					...
					if (class420.field4467 == this.field3930) {
						...
						if ((this.field3941 * 635515725 & 0xFF000000) != 0) {
							arg0.method496(0, 0, arg4, arg3 + var18 + 1, this.field3941 * 635515725);
						}
						if ((this.field3940 * 2142735611 & 0xFF000000) != 0) {
							arg0.method496(0, arg3 + var18 + arg5, arg4, arg5 - (arg3 + var18 + arg5), this.field3940 * 2142735611);
						}
					} else {
						while (var18 > arg5) {
							var18 -= arg5;
		...
		for (int var25 = this.field3932 * 361842433 - 1; var25 >= 0; var25--) {
			this.field3931[var25].method6409(arg0, arg2, arg3, arg4, arg5, arg6, arg7, this.field3934 * 1017381983, this.field3926 * -648544609, this.field3936 * -1381427113, var14);
		}
		arg0.method505(2, 0);
		arg0.method511();
	}
	...
	public void method6375(class14 arg0, int arg1, int arg2, int arg3, int arg4) {
		...
		if (this.field3939 * -867041371 != arg4) {
			this.field3943.method288((byte) arg4, this.field3944);
			this.field3939 = arg4 * -1201614803;
		}
