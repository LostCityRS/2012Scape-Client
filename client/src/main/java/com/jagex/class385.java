...
public abstract class class385 implements class388, Runnable, FocusListener, WindowListener {
	...
	@ObfuscatedName("nv.j")
	public static long field4120 = -7658251320809404160L;
	...
	@ObfuscatedName("nv.e")
	public static int field4130 = 120302868;
	...
	public static int field4152 = -684047923;

	@ObfuscatedName("nv.bt")
	public static int field4144 = 1172161047;
	...
	public final void method6717(class392 arg0, String arg1, String arg2, int arg3, int arg4, int arg5, int arg6, boolean arg7) {
		try {
			...
			Statics.field2204 = (Statics.field4125 = arg0.method6856() * 1160902017) * -2139306449;
			Statics.field10343 = (Statics.field4677 = arg0.method6868() * -57605145) * -188224457;
			field4147 = 0;
			field4127 = 0;
			if (Statics.method5937() == class384.field4116) {
				Statics.field2204 += arg0.method6855() * -2062306978;
				Statics.field10343 += arg0.method6859() * 1319343426;
	...
	public final void method6652(String arg0, String arg1, int arg2, int arg3, int arg4, int arg5) throws Exception {
		Statics.field2304 = arg3 * 1537655083;
		Statics.field1597 = arg2 * -573173061;
		Statics.field10528 = arg4 * 390508185;
		Statics.field10530 = arg5 * 1406062027;
		...
		Statics.field2339 = new String[] { ".jagex_cache_" + Statics.field1597 * -1084333453, ".file_store_" + Statics.field1597 * -1084333453 };
		int var14 = 0;
		...
		Statics.field4245 = new class577[Statics.field2304 * 535295363];
		for (int var19 = 0; var19 < Statics.field2304 * 535295363; var19++) {
	...
	public File method6738(String arg0, String arg1, int arg2) {
		...
		if (Statics.field3918.exists()) {
			try {
				...
				while (var9.field9626 * 803401371 < var9.field9629.length) {
					int var10 = var8.method12078(var9.field9629, var9.field9626 * 803401371, var9.field9629.length - var9.field9626 * 803401371);
					if (var10 == -1) {
						throw new IOException();
					}
					var9.field9626 += var10 * -1748220013;
				}
				var9.field9626 = 0;
	...
	public void method6654(File arg0, File arg1) {
		try {
			...
			var3.method12075(var4.field9629, 0, var4.field9626 * 803401371);
			var3.method12076();
	...
	public static class576 method4031(String arg0, String arg1, boolean arg2) {
		...
		String var6 = "";
		if (Statics.field1597 * -1084333453 == 33) {
			var6 = "_rc";
		} else if (Statics.field1597 * -1084333453 == 34) {
			var6 = "_wip";
		}
	...
	public synchronized void method6725(String arg0) {
		...
		Statics.field1197.setSize(Statics.field2204 * -500138417 + var2.left + var2.right, Statics.field10343 * -689399455 + var2.top + var2.bottom);
	}
	...
	public void method6667(Container arg0) {
		...
		if (Statics.field1197 == arg0) {
			Insets var2 = Statics.field1197.getInsets();
			Statics.field1231.setLocation(field4147 * 1328831319 + var2.left, field4127 * -706785813 + var2.top);
		} else {
		...
		field4143 = true;
		field4131 = false;
		field4132 = class153.method5554() * 7989951653121470233L;
	}
	...
	public void method6755() {
		...
		field4152 = ((int) (Runtime.getRuntime().maxMemory() / 1048576L) + 1) * 684047923;
		field4144 = Runtime.getRuntime().availableProcessors() * 1172161047;
		this.method6657();
		this.method6671();
		Statics.field8481 = Statics.method4777();
		while (field4149 * 4232273627914728215L == 0L || class153.method5554() < field4149 * 4232273627914728215L) {
			Statics.field4138 = Statics.field8481.method6831(field4120 * 9167635860410370245L) * -2124224569;
			for (int var5 = 0; var5 < Statics.field4138 * -856643081; var5++) {
				this.method6661();
			}
			this.method6662();
	...
	public void method6661() {
		...
		long var3 = field4145[Statics.field6664 * -866535585];
		field4145[Statics.field6664 * -866535585] = var1;
		Statics.field6664 = (Statics.field6664 * -866535585 + 1 & 0x1F) * 924476575;
	...
	public void method6662() {
		long var1 = class153.method5554();
		long var3 = field4123[Statics.field1198 * 197706311];
		field4123[Statics.field1198 * 197706311] = var1;
		Statics.field1198 = (Statics.field1198 * 197706311 + 1 & 0x1F) * -472627337;
		if (var3 != 0L && var1 > var3) {
			int var5 = (int) (var1 - var3);
			field4121 = ((var5 >> 1) + 32000) / var5 * -781250541;
		}
		if ((field4130 += 1005262953) * -629934119 - 1 > 50) {
			field4130 -= -1276459902;
			field4143 = true;
			Statics.field1231.setSize(Statics.field4125 * -1227076991, Statics.field4677 * 1204117463);
			Statics.field1231.setVisible(true);
			if (Statics.field1197 != null && Statics.field1587 == null) {
				Insets var6 = Statics.field1197.getInsets();
				Statics.field1231.setLocation(field4147 * 1328831319 + var6.left, field4127 * -706785813 + var6.top);
			} else {
				Statics.field1231.setLocation(field4147 * 1328831319, field4127 * -706785813);
			}
		}
	...
	public final void method6664(boolean arg0) {
		...
		try {
			...
			for (int var5 = 0; var5 < Statics.field2304 * 535295363; var5++) {
	...
	public static final int method2809() {
		return (int) (1000000000L / (field4120 * 9167635860410370245L));
	}
	...
	public void stop() {
		if (!field4153) {
			field4149 = (class153.method5554() + 4000L) * -7092199084809128793L;
		}
	}

	public void destroy() {
		if (!field4153) {
			field4149 = class153.method5554() * -7092199084809128793L;
	...
	public final synchronized void paint(Graphics arg0) {
		...
		field4143 = true;
		if (class153.method5554() - field4132 * 6542825800079129897L > 1000L) {
			Rectangle var2 = arg0.getClipBounds();
			if (var2 == null || var2.width >= Statics.field2204 * -500138417 && var2.height >= Statics.field10343 * -689399455) {
				field4131 = true;
			}
		}
	}
	...
	public static final void method4801(int arg0, String arg1, Color arg2, Color arg3, Color arg4) {
		try {
			...
			try {
				...
				var6.fillRect(0, 0, Statics.field4125 * -1227076991, Statics.field4677 * 1204117463);
				int var7 = Statics.field4125 * -1227076991 / 2 - 152;
				int var8 = Statics.field4677 * 1204117463 / 2 - 18;
				var6.setColor(arg3);
				...
				if (field4128 != null) {
					var6.setFont(Statics.field2112);
					var6.setColor(arg4);
					var6.drawString(field4128, Statics.field4125 * -1227076991 / 2 - field4128.length() * 6 / 2, Statics.field4677 * 1204117463 / 2 - 26);
				}
				var5.drawImage(Statics.field1209, 0, 0, null);
			} catch (Exception var13) {
				var5.setColor(Color.black);
				var5.fillRect(0, 0, Statics.field4125 * -1227076991, Statics.field4677 * 1204117463);
				int var10 = Statics.field4125 * -1227076991 / 2 - 152;
				int var11 = Statics.field4677 * 1204117463 / 2 - 18;
				var5.setColor(arg3);
				...
				if (field4128 != null) {
					var5.setFont(Statics.field2112);
					var5.setColor(arg4);
					var5.drawString(field4128, Statics.field4125 * -1227076991 / 2 - field4128.length() * 6 / 2, Statics.field4677 * 1204117463 / 2 - 26);
				}
