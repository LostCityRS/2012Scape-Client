...
public class class395 {
	...
	@ObfuscatedName("ne.l")
	public static int field4202 = 651188029;

	@ObfuscatedName("ne.f")
	public static boolean field4203 = false;

	@ObfuscatedName("ne.n")
	public static int field4205 = -727877005;

	@ObfuscatedName("ne.i")
	public static int field4209 = 0;

	@ObfuscatedName("ne.v")
	public static class393[] field4195 = new class393[50];

	@ObfuscatedName("ne.k")
	public static class394 field4196 = null;

	@ObfuscatedName("ne.h")
	public static class394 field4212 = null;

	public class395() throws Throwable {
		throw new Error();
	}
	...
	public static final void method1677() {
		method16504();
		for (int var0 = 0; var0 < field4209 * -1434526257; var0++) {
			class393 var1 = field4195[var0];
			boolean var2 = false;
			if (var1.field4188 == null) {
				var1.field4179 -= 1249080019;
				if (var1.field4179 * 1908258139 >= (var1.method6878() ? -1500 : -10)) {
					if (var1.field4186 == 1 && var1.field4176 == null) {
						var1.field4176 = class370.method6466(Statics.field5197, var1.field4173 * -141609519, 0);
						if (var1.field4176 == null) {
							continue;
						}
						var1.field4179 += var1.field4176.method6462() * 1249080019;
					} else if (var1.method6878() && (var1.field4184 == null || var1.field4185 == null)) {
						if (var1.field4184 == null) {
							var1.field4184 = class796.method15066(Statics.field3156, var1.field4173 * -141609519);
						}
						if (var1.field4184 == null) {
							continue;
						}
					...
					if (var1.field4179 * 1908258139 < 0) {
						int var3 = 8192;
						int var13;
						if (var1.field4177 * -1063002935 == 0) {
							var13 = var1.field4181 * 1485750739 * (var1.field4186 == 3 ? Statics.field4961.field9653.method15899() : Statics.field4961.field9654.method15899()) >> 2;
						} else {
							int var4 = var1.field4177 * -1063002935 >> 24 & 0x3;
							if (Statics.field2119.field9807 == var4) {
								int var5 = (var1.field4177 * -1063002935 & 0xFF) << 9;
								int var6 = Statics.field2119.method13954() << 8;
								class317 var7 = Statics.field2119.method8565().field3464;
								int var8 = var1.field4177 * -1063002935 >> 16 & 0xFF;
								int var9 = (var8 << 9) + 256 - (int) var7.field3475 + var6;
								int var10 = var1.field4177 * -1063002935 >> 8 & 0xFF;
								int var11 = (var10 << 9) + 256 - (int) var7.field3477 + var6;
								int var12 = Math.abs(var9) + Math.abs(var11) - 512;
								if (var12 > var5) {
									var1.field4179 = -513917709;
									continue;
								}
								if (var12 < 0) {
									var12 = 0;
								}
								var13 = (var5 - var12) * Statics.field4961.field9672.method15899() * var1.field4181 * 1485750739 / var5 >> 2;
								if (var1.field4180 * -874866599 != -1) {
									int var14 = var1.field4180 * -874866599;
									int var15 = var1.field4187 * 1699302563;
								}
								if (var9 != 0 || var11 != 0) {
									int var16 = -(Statics.field664 * 1681127997) - (int) (Math.atan2((double) var9, (double) var11) * 2607.5945876176133D) - 4096 & 0x3FFF;
									if (var16 > 8192) {
										var16 = 16384 - var16;
									}
									int var17;
						...
						if (var13 > 0) {
							if (var1.field4186 == 1) {
								Object var18 = null;
								class997 var19 = var1.field4176.method6463().method17108(Statics.field3160);
								var1.field4188 = var19.method16502(var1.field4182 * -932623601, var13, var3);
							} else if (var1.method6878()) {
								var1.field4188 = var1.field4185.method16502(var1.field4182 * -932623601, var13, var3);
							}
							var1.field4188.method16384(var1.field4178 * -958327117 - 1);
			...
			if (var2) {
				field4209 -= 1606879535;
				for (int var20 = var0; var20 < field4209 * -1434526257; var20++) {
		...
		if (field4203 && !class155.method13899()) {
			if (Statics.field4961.field9674.method15899() != 0 && field4202 * 1772505067 != -1) {
				if (Statics.field2327 == null) {
					class155.method3986(Statics.field9367, field4202 * 1772505067, 0, Statics.field4961.field9674.method15899(), false);
				} else {
					class155.method6359(Statics.field9367, field4202 * 1772505067, 0, Statics.field4961.field9674.method15899(), false, Statics.field2327);
				}
			}
			field4203 = false;
			Statics.field2327 = null;
		} else if (Statics.field4961.field9674.method15899() != 0 && field4202 * 1772505067 != -1 && !class155.method13899()) {
			class792 var21 = class792.method14781(class280.field2868, client.field8975.field834);
			var21.field9467.method15223(field4202 * 1772505067);
	...
	public static class393 method14082(int arg0, int arg1, int arg2, int arg3, int arg4) {
		if (Statics.field4961.field9654.method15899() == 0 || arg1 == 0 || field4209 * -1434526257 >= 50 || arg0 == -1) {
			return null;
		} else {
			class393 var5 = new class393((byte) 1, arg0, arg1, arg2, arg3, 0, arg4, null);
			field4195[(field4209 += 1606879535) * -1434526257 - 1] = var5;
			return var5;
		}
	}
	...
	public static class393 method1356(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		if (Statics.field4961.field9654.method15899() == 0 || arg1 == 0 || field4209 * -1434526257 >= 50 || arg0 == -1) {
			...
			field4195[(field4209 += 1606879535) * -1434526257 - 1] = var6;
			return var6;
		}
	}
	...
	public static class393 method1717(int arg0, int arg1, int arg2, int arg3, boolean arg4, int arg5) {
		if ((arg4 ? Statics.field4961.field9653.method15899() : Statics.field4961.field9654.method15899()) == 0 || arg1 == 0 || field4209 * -1434526257 >= 50 || arg0 == -1) {
			return null;
		} else {
	...
	public static class393 method12739(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5, int arg6) {
		if ((arg5 ? Statics.field4961.field9653.method15899() : Statics.field4961.field9654.method15899()) == 0 || arg1 == 0 || field4209 * -1434526257 >= 50 || arg0 == -1) {
			return null;
		} else {
			class393 var7 = new class393((byte) (arg5 ? 3 : 2), arg0, arg1, arg2, arg3, arg4, arg6, null);
			field4195[(field4209 += 1606879535) * -1434526257 - 1] = var7;
			return var7;
		}
	}
	...
	public static void method15962(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
		...
		field4212 = new class394(arg0, arg1 << 9, arg2 << 9, arg3 << 8, arg4 * 8);
	}
	...
	public static void method15770() {
		...
		var0.field3475 += var1.field4836 * 401083797 << 9;
		var0.field3477 += var1.field4838 * -526848045 << 9;
		var0.method5346((float) (field4196.field4190 * 2105129409), var0.field3476, (float) (field4196.field4189 * -1913499381));
		float var2 = var0.method5338();
		var0.method5291();
		float var3 = 0.0F;
		float var4;
		if (var2 < (float) (field4196.field4191 * 399209699)) {
			var4 = 1.0F;
		} else if (var2 > (float) (field4196.field4192 * -1427899851)) {
			var4 = 0.0F;
		} else {
			float var5 = var2 - (float) (field4196.field4191 * 399209699);
			var4 = 1.0F - var5 / (float) (field4196.field4193 * 362898699);
		}
		class155.method4553((int) (var4 * 256.0F));
	}
	...
	public static void method3225() {
		if (field4196 != null) {
			field4196 = null;
			class155.method4553(256);
		}
	}

	@ObfuscatedName("rb.i(IIIB)V")
	public static void method11057(int arg0, int arg1, int arg2) {
		if (Statics.field4206 != null && Statics.field4206.method3000() && Statics.field4206.field1591 * 820831083 == arg0) {
			method4800(Statics.field4206, arg1);
			field4202 = arg0 * -651188029;
		...
		if (arg0 == -1 && !field4203) {
			class155.method8662();
		} else if (arg0 != -1 && (field4202 * 1772505067 != arg0 || !class155.method13899()) && var4 != 0 && !field4203) {
			class155.method16250(arg2, Statics.field9367, arg0, 0, var4, false, new class714());
			method2572();
		}
		if (field4202 * 1772505067 != arg0) {
			Statics.field2327 = null;
		}
		field4202 = arg0 * -651188029;
		field4212 = null;
	...
	public static void method5596(int arg0, int arg1, int arg2) {
		...
		if (!field4203 && field4202 * 1772505067 != -1 && class155.method13899() && !class155.method15138()) {
	...
	public static void method1349(int arg0, int arg1) {
		class155.method11835(arg0, arg1);
	}
	...
	public static void method16504() {
		if (Statics.field4206 != null && !Statics.field4206.method3000() && Statics.field4206.method2999()) {
			...
			var0.field9467.method15223(Statics.field4206.field1591 * 820831083);
