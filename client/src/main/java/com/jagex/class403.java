...
public abstract class class403 {
	...
	@ObfuscatedName("nw.z")
	public class958 field4240;

	@ObfuscatedName("nw.n")
	public class957 field4243;

	@ObfuscatedName("nw.o")
	public class959 field4241;
	...
	public class803 method7005() throws IOException {
		if (this.field4238) {
			...
			if (!this.field4236.isBOS()) {
				class803 var9 = (class803) this.field4234.method11923((long) var2);
			...
			if (!var3.pageIn(this.field4236)) {
				...
				if (this.field4240 == null && this.field4230.isTheora()) {
					this.field4240 = new class958(var3);
					var4 = this.field4240;
				} else if (this.field4243 == null && this.field4230.isVorbis()) {
					this.field4243 = new class957(var3);
					var4 = this.field4243;
				} else {
	...
	public void method7006() throws IOException {
		...
		while (!this.field4238) {
			class803 var1;
			if (this.field4237) {
				var1 = (class803) this.field4234.method11923((long) this.field4236.getSerialNumber());
			} else {
			...
			} else if (var1 instanceof class959) {
				this.method7008();
			} else if (this.field4240 != var1) {
				while (var1.field9557.packetOut(this.field4230) == 1) {
					if (var1.field9558 * -352769937 == 1 && var1 instanceof class959) {
	...
	public void method7008() {
		for (class803 var1 = (class803) this.field4234.method11928(); var1 != null; var1 = (class803) this.field4234.method11929()) {
			if (var1 instanceof class959) {
				class959 var2 = (class959) var1;
				while ((var2.field9558 * -352769937 <= 8 || this.method7039() > (double) var2.method16826()) && var2.field9557.packetOut(this.field4230) == 1) {
	...
	public void method7003(String arg0) {
		...
		for (class803 var2 = (class803) this.field4234.method11928(); var2 != null; var2 = (class803) this.field4234.method11929()) {
			if (var2 instanceof class959) {
				class959 var3 = (class959) var2;
	...
	public void method7018(boolean arg0) {
		if (this.field4243 != null) {
			class940 var2 = this.field4243.method16795();
			if (var2 != null) {
