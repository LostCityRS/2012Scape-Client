...
public class class408 {
	...
	public static void method7080(class334 arg0, class484 arg1, class563 arg2, class541 arg3, class444 arg4, class609 arg5, class567 arg6) {
		...
		if (var8 != null) {
			for (int var9 = 0; var9 < var8.length; var9++) {
				...
				field4272.method11927(var10, (long) (var10.field10370 * -1049347157));
			}
		}
	...
	public static void method7106() {
		...
		Statics.field4267 = new int[Statics.field4278.field5105 * -73365853 + 1];
	}
	...
	public static void method7087(class16 arg0, int arg1, int arg2) {
		for (int var3 = 0; var3 < Statics.field4278.field5105 * -73365853; var3++) {
	...
	public static int method7088(class16 arg0, int arg1, int arg2, int arg3) {
		...
		int var5 = var4.field5092 * -1620490387;
		if (var5 >= 0 && arg0.method889(var5).field1250) {
			var5 = -1;
		}
		int var9;
		if (var4.field5091 * 842046125 >= 0) {
			int var6 = var4.field5091 * 842046125;
		...
		} else if (var4.field5094 * -1036738889 == -1) {
			var9 = 0;
		} else {
			int var10 = var4.field5094 * -1036738889;
	...
	public static void method7120(class14 arg0, int arg1, int arg2) {
		...
		while (true) {
			while (var3.field9626 * 803401371 < var3.field9629.length) {
					...
					if (var2 instanceof class805) {
						...
						if (var3 != null) {
							for (int var4 = 0; var4 < var3.field9562.length; var4++) {
								...
								int var6 = var5.field6495 * 1232906271;
								if (var5.field6534 != null) {
									class540 var7 = var5.method11431(Statics.field4299);
									if (var7 != null) {
										var6 = var7.field6495 * 1232906271;
									}
								}
								if (var6 != -1) {
									class806 var8 = new class806(var6);
									var8.field9566 = var0 * 1226217667;
									var8.field9567 = var1 * 1535986195;
						...
						int var11 = var10.field6495 * 1232906271;
						if (var10.field6534 != null) {
							class540 var12 = var10.method11431(Statics.field4299);
							if (var12 != null) {
								var11 = var12.field6495 * 1232906271;
							}
						}
						if (var11 != -1) {
							class806 var13 = new class806(var11);
							var13.field9566 = var0 * 1226217667;
							var13.field9567 = var1 * 1535986195;
					...
					if (var17 != null) {
						...
						while (true) {
							...
							for (int var20 = 0; var20 < var19.field4251.length; var20++) {
								...
								int var22 = var21.field6495 * 1232906271;
								if (var21.field6534 != null) {
									class540 var23 = var21.method11431(Statics.field4299);
									if (var23 != null) {
										var22 = var23.field6495 * 1232906271;
									}
								}
								if (var22 != -1) {
									class806 var24 = new class806(var22);
									var24.field9566 = (((Statics.field4283 >> 6) + var15) * 64 + var19.field4248 - Statics.field4283) * 1226217667;
									var24.field9567 = (((Statics.field4284 >> 6) + var16) * 64 + var19.field4247 - Statics.field4284) * 1535986195;
			...
			for (int var13 = 0; var13 < Statics.field4282; var13++) {
				...
				if (var11 < Statics.field4285) {
					...
					if (var14 > 0) {
						...
						var5[var13] += var15.field6718 * 1911651271;
						var6[var13] += var15.field6714 * -1826258191;
						var7[var13] += var15.field6720 * 1981045915;
						var8[var13] += var15.field6721 * -123822535;
						var10002 = var9[var13]++;
					}
				}
				if (var12 >= 0) {
					...
					if (var16 > 0) {
						...
						var5[var13] -= var17.field6718 * 1911651271;
						var6[var13] -= var17.field6714 * -1826258191;
						var7[var13] -= var17.field6720 * 1981045915;
						var8[var13] -= var17.field6721 * -123822535;
						var10002 = var9[var13]--;
					}
				}
			}
	...
	public static void method7093() {
		int[] var0 = new int[3];
		for (int var1 = 0; var1 < Statics.field4281.field4255 * -390905657; var1++) {
			...
			if (var2) {
				...
				var3.field9566 = (var0[1] - Statics.field4283) * 1226217667;
				var3.field9567 = (var0[2] - Statics.field4284) * 1535986195;
			...
			if (var10 > 0) {
				...
				if (var11 >= 0 && var11 < Statics.field4285) {
					for (int var12 = 0; var12 < var6; var12++) {
						...
						if (var15 > 0) {
							...
							if (var18 == 0 && var19 == 0 && var20 == null) {
								int var21;
								if (Statics.field4292.field10366 * 100392893 != -1) {
									var21 = Statics.field4292.field10366 * 100392893 | 0xFF000000;
								} else if ((Statics.field4297 + var12 & 0x4) == (Statics.field4296 + var7 & 0x4)) {
									var21 = Statics.field4267[Statics.field4278.field5108 * -1225886641 + 1];
								} else {
									var21 = -11840664;
								}
								if (var21 == 0) {
					...
					for (int var24 = 0; var24 < var6; var24++) {
						...
						int var28;
						if (Statics.field4292.field10366 * 100392893 != -1) {
							var28 = Statics.field4292.field10366 * 100392893 | 0xFF000000;
						} else if ((Statics.field4297 + var24 & 0x4) == (Statics.field4296 + var7 & 0x4)) {
							var28 = Statics.field4267[Statics.field4278.field5108 * -1225886641 + 1];
						} else {
							var28 = -11840664;
						}
						if (var28 == 0) {
	...
	public static void method7079(class14 arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int[] arg8, byte[] arg9, boolean arg10) {
		...
		for (int var16 = 0; var16 < arg8.length; var16++) {
			...
			if (class542.field6591.field6590 * -1082126853 == var17 || class542.field6569.field6590 * -1082126853 == var17 || class542.field6570.field6590 * -1082126853 == var17 || class542.field6567.field6590 * -1082126853 == var17) {
				class540 var18 = Statics.field4266.method11471(arg8[var16]);
				if (var18.field6508 * 932509469 == -1) {
					int var19 = -3355444;
					if (var18.field6493 * -1110036101 == 1) {
						var19 = -3407872;
					}
					int var20 = arg9[var16] >> 6 & 0x3;
					if (class542.field6591.field6590 * -1082126853 == var17) {
						if (var20 == 0) {
					...
					} else if (class542.field6569.field6590 * -1082126853 == var17) {
						if (var20 == 0) {
					...
					} else if (class542.field6570.field6590 * -1082126853 == var17) {
						if (var20 == 0) {
	...
	public static void method7098(class14 arg0, int arg1, int arg2, int arg3, int arg4, int[] arg5, byte[] arg6) {
		...
		for (int var7 = 0; var7 < arg5.length; var7++) {
			...
			int var9 = var8.field6508 * 932509469;
			if (var9 != -1) {
				...
				if (var11 != null) {
					...
					if (var10.field7195) {
						int var14 = var8.field6489 * -1620436983;
						int var15 = var8.field6503 * -1166461741;
					...
					if (var12 != 0 && var13 != 0) {
						if (var10.field7194 * 1417532383 == 0) {
							var11.method2513(arg1, arg2 - var13 + arg4, var12, var13);
						} else {
							var11.method2502(arg1, arg2 - var13 + arg4, var12, var13, 0, var10.field7194 * 1417532383 | 0xFF000000, 1);
						}
					}
				}
			}
	...
	public static void method7101(class14 arg0, class806 arg1, int arg2, int arg3, int arg4, int arg5) {
		arg1.field9568 = (((arg1.field9566 * 181589995 - Statics.field4296) * arg2 + arg4 >> 16) + Statics.field4300) * 1489720439;
		arg1.field9569 = (Statics.field4303 - ((arg1.field9567 * 1571295259 - Statics.field4302) * arg3 + arg5 >> 16)) * -1022846315;
	}
	...
	public static void method7102(class14 arg0, class806 arg1, class443 arg2) {
		...
		for (int var4 = 0; var4 < var3.length / 2; var4++) {
			int var5 = arg1.field9566 * 181589995 + arg2.field4788[var4 * 2];
			int var6 = arg1.field9567 * 1571295259 + arg2.field4788[var4 * 2 + 1];
		...
		class133.method2697(arg0, var3, arg2.field4785 * 951310949);
		if (arg2.field4795 * -2014496423 <= 0) {
		...
		for (int var7 = 0; var7 < var3.length / 2 - 1; var7++) {
			...
			arg0.method497(var8, var9, var10, var11, arg2.field4800[arg2.field4762[var7] & 0xFF], 1, arg2.field4795 * -2014496423, arg2.field4796 * 1877851825, arg2.field4794 * -1572298357);
		}
		...
		arg0.method497(var15, var16, var17, var18, arg2.field4800[arg2.field4762[arg2.field4762.length - 1] & 0xFF], 1, arg2.field4795 * -2014496423, arg2.field4796 * 1877851825, arg2.field4794 * -1572298357);
	}
}
