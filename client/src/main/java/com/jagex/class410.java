...
public final class class410 {
	...
	@ObfuscatedName("on.c")
	public int field4312 = -268857128;

	public class410(int arg0, class577 arg1, class577 arg2, int arg3) {
		this.field4315 = arg0 * 2063830855;
		this.field4313 = arg1;
		this.field4314 = arg2;
		this.field4312 = arg3 * 318352055;
	}
	...
	public byte[] method7168(int arg0) {
		...
		synchronized (this.field4313) {
			...
			try {
				...
				if (var3 < 0 || var3 > this.field4312 * 650466055) {
					var10000 = null;
					return (byte[]) var10000;
				}
				if (var4 > 0 && (long) var4 <= this.field4313.method12096() / 520L) {
					...
					while (var6 < var3) {
						...
						if (arg0 == var10 && var7 == var11 && this.field4315 * -61642121 == var13) {
	...
	public boolean method7169(int arg0, byte[] arg1, int arg2) {
		...
		synchronized (this.field4313) {
			if (arg2 < 0 || arg2 > this.field4312 * 650466055) {
					...
					if (var7 < arg2) {
						label148: {
							...
							if (arg3) {
								...
								if (arg0 != var11 || var8 != var12 || this.field4315 * -61642121 != var13) {
									var10000 = false;
									return var10000;
								}
							...
							if (arg0 > 65535) {
								...
								field4316[9] = (byte) (this.field4315 * -61642121);
								this.field4313.method12109((long) (var6 * 520));
								...
								field4316[7] = (byte) (this.field4315 * -61642121);
								this.field4313.method12109((long) (var6 * 520));
	...
	public String toString() {
		return "" + this.field4315 * -61642121;
	}
}
