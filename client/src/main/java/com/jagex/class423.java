...
public class class423 {
	...
	@ObfuscatedName("oo.m")
	public final class14 field4489;
	...
	@ObfuscatedName("oo.q")
	public class424[][][] field4497;

	@ObfuscatedName("oo.p")
	public class12[] field4498;

	@ObfuscatedName("oo.w")
	public class424[][][] field4500;

	@ObfuscatedName("oo.b")
	public class12[] field4527;

	@ObfuscatedName("oo.x")
	public class424[][][] field4508;

	@ObfuscatedName("oo.i")
	public class12[] field4502;
	...
	public final class836[] field4513;

	@ObfuscatedName("oo.ap")
	public final class836[] field4514;

	@ObfuscatedName("oo.ag")
	public final class836[] field4536;
	...
	public final class836[] field4528;

	@ObfuscatedName("oo.al")
	public final class836[] field4519;

	@ObfuscatedName("oo.at")
	public final class974[] field4506;
	...
	public final class780[] field4535 = new class780[8];

	@ObfuscatedName("oo.bq")
	public final int field4545 = 65459;
	...
	public class423(class14 arg0, int arg1, int arg2, int arg3, int arg4, int arg5, boolean arg6, boolean arg7) {
		this.field4489 = arg0;
		this.field4491 = this.field4489.method768() > 0;
		this.field4510 = arg1 * -2049842331;
		this.field4499 = (0x1 << this.field4510 * -1694394771) * -1941178205;
		this.field4487 = (this.field4499 * -855475445 >> 1) * -578453889;
		this.field4494 = arg2 * 1931296105;
		this.field4495 = arg3 * 906667669;
		this.field4496 = arg4 * -2016687549;
		this.field4531 = arg5 * 2031942787;
		this.field4490 = new class583();
		this.field4493 = new class428(this);
		this.field4500 = new class424[arg2][this.field4495 * 1336538301][this.field4496 * 583225963];
		this.field4527 = new class12[arg2];
		if (arg6) {
			this.field4488 = new int[this.field4495 * 1336538301][this.field4496 * 583225963];
			this.field4505 = new byte[this.field4495 * 1336538301][this.field4496 * 583225963];
			this.field4517 = new short[this.field4495 * 1336538301][this.field4496 * 583225963];
			this.field4530 = new byte[this.field4495 * 1336538301][this.field4496 * 583225963];
			this.field4534 = new byte[this.field4495 * 1336538301][this.field4496 * 583225963];
			this.field4524 = new byte[this.field4495 * 1336538301][this.field4496 * 583225963];
			this.field4508 = new class424[1][this.field4495 * 1336538301][this.field4496 * 583225963];
			this.field4502 = new class12[1];
		}
		if (arg7) {
		...
		this.field4513 = new class836[2];
		this.field4514 = new class836[2];
		this.field4536 = new class836[2];
		this.field4519 = new class836[10038];
		this.field4516 = 0;
		this.field4528 = new class836[5063];
		this.field4485 = 0;
		this.field4506 = new class974[5091];
		this.field4509 = 0;
		this.field4544 = new boolean[this.field4531 * 1827680811 + this.field4531 * 1827680811 + 1][this.field4531 * 1827680811 + this.field4531 * 1827680811 + 1];
		this.field4542 = new boolean[this.field4531 * 1827680811 + this.field4531 * 1827680811 + 2][this.field4531 * 1827680811 + this.field4531 * 1827680811 + 2];
		this.field4543 = new int[this.field4531 * 1827680811 + this.field4531 * 1827680811 + 2];
		this.field4541 = new class421(false);
	}
	...
	public void method7404(boolean arg0) {
		...
		this.field4494 = this.field4497.length * 1931296105;
	}

	@ObfuscatedName("oo.s(B)V")
	public void method7405() {
		for (int var1 = 0; var1 < this.field4495 * 1336538301; var1++) {
			for (int var2 = 0; var2 < this.field4496 * 583225963; var2++) {
				if (this.field4497[0][var1][var2] == null) {
					this.field4497[0][var1][var2] = new class424(0);
				}
			}
		}
	}
	...
	public void method7466(int arg0, int arg1) {
		class424 var3 = this.field4497[0][arg0][arg1];
		for (int var4 = 0; var4 < 3; var4++) {
			class424 var5 = this.field4497[var4][arg0][arg1] = this.field4497[var4 + 1][arg0][arg1];
			if (var5 != null) {
		...
		if (this.field4497[0][arg0][arg1] == null) {
			this.field4497[0][arg0][arg1] = new class424(0);
	...
	public class424 method7406(int arg0, int arg1, int arg2) {
		if (this.field4497[arg0][arg1][arg2] == null) {
			...
			if (var4 && arg0 >= this.field4494 * 79110873 - 1) {
				return null;
			}
	...
	public void method7408(int arg0, int arg1, int arg2) {
		...
		for (int var5 = arg0; var5 >= 0; var5--) {
			if (this.field4497[var5][arg1][arg2] == null) {
				class424 var6 = this.field4497[var5][arg1][arg2] = new class424(var5);
				if (var4) {
					var6.field4549++;
				}
			}
	...
	public void method7409(int arg0, class12 arg1) {
	...
	public void method7512(int arg0, int arg1, int arg2, class970 arg3) {
		class424 var5 = this.method7406(arg0, arg1, arg2);
		if (var5 == null) {
			return;
		}
		var5.field4552 = arg3;
	...
	public void method7499(int arg0, int arg1, int arg2, int arg3, class973 arg4) {
		class424 var6 = this.method7406(arg0, arg1, arg2);
		if (var6 == null) {
			return;
		}
		arg4.method8551(new class317((float) ((arg1 << this.field4510 * -1694394771) + this.field4487 * 1180189055), (float) arg3, (float) ((arg2 << this.field4510 * -1694394771) + this.field4487 * 1180189055)));
		var6.field4553 = arg4;
	...
	public void method7402(int arg0, int arg1, int arg2, class972 arg3, class972 arg4) {
		class424 var6 = this.method7406(arg0, arg1, arg2);
		if (var6 == null) {
			return;
		}
	...
	public void method7420(int arg0, int arg1, int arg2, class971 arg3, class971 arg4) {
		class424 var6 = this.method7406(arg0, arg1, arg2);
		if (var6 == null) {
			return;
		}
	...
	public boolean method7412(class974 arg0, boolean arg1) {
		boolean var3 = this.field4502 == this.field4498;
		int var4 = 0;
		short var5 = 0;
		byte var6 = 0;
		arg0.method14006();
		if (arg0.field10510 < 0 || arg0.field10509 < 0 || arg0.field10508 >= this.field4495 * 1336538301 || arg0.field10511 >= this.field4496 * 583225963) {
			return false;
		}
		short var7 = 0;
		for (int var8 = arg0.field10510; var8 <= arg0.field10508; var8++) {
			for (int var9 = arg0.field10509; var9 <= arg0.field10511; var9++) {
				class424 var10 = this.method7406(arg0.field9807, var8, var9);
				if (var10 != null) {
					class430 var11 = class430.method11871(arg0);
					class430 var12 = var10.field4554;
					if (var12 == null) {
		...
		if (arg1) {
			this.field4506[(this.field4509 += 737777043) * -115748709 - 1] = arg0;
			arg0.field9808 = this;
		} else {
	...
	public void method7422(int arg0, int arg1, int arg2, int arg3) {
		class424 var5 = this.field4497[arg0][arg1][arg2];
		if (var5 == null) {
			return;
		}
		class971 var6 = var5.field4546;
		class971 var7 = var5.field4551;
		if (var6 != null) {
			var6.field10496 = (short) (var6.field10496 * arg3 / (0x10 << this.field4510 * -1694394771 - 7));
			var6.field10497 = (short) (var6.field10497 * arg3 / (0x10 << this.field4510 * -1694394771 - 7));
		}
		if (var7 != null) {
			var7.field10496 = (short) (var7.field10496 * arg3 / (0x10 << this.field4510 * -1694394771 - 7));
			var7.field10497 = (short) (var7.field10497 * arg3 / (0x10 << this.field4510 * -1694394771 - 7));
		}
	}

	@ObfuscatedName("oo.h(B)V")
	public void method7423() {
		for (int var1 = 0; var1 < this.field4509 * -115748709; var1++) {
			class974 var2 = this.field4506[var1];
	...
	public class972 method7462(int arg0, int arg1, int arg2) {
		class424 var4 = this.field4497[arg0][arg1][arg2];
		if (var4 != null) {
			this.method7432(var4.field4548);
			if (var4.field4548 != null) {
				class972 var5 = var4.field4548;
				var4.field4548 = null;
				return var5;
			}
		}
	...
	public class972 method7425(int arg0, int arg1, int arg2) {
		class424 var4 = this.field4497[arg0][arg1][arg2];
		if (var4 != null) {
			this.method7432(var4.field4550);
			if (var4.field4550 != null) {
				class972 var5 = var4.field4550;
				var4.field4550 = null;
				return var5;
			}
		}
	...
	public class971 method7426(int arg0, int arg1, int arg2) {
		class424 var4 = this.field4497[arg0][arg1][arg2];
		if (var4 != null) {
			this.method7432(var4.field4546);
			if (var4.field4546 != null) {
				class971 var5 = var4.field4546;
				var4.field4546 = null;
				return var5;
			}
		}
	...
	public class971 method7461(int arg0, int arg1, int arg2) {
		class424 var4 = this.field4497[arg0][arg1][arg2];
		if (var4 != null) {
			this.method7432(var4.field4551);
			if (var4.field4551 != null) {
				class971 var5 = var4.field4551;
				var4.field4551 = null;
				return var5;
			}
		}
	...
	public class970 method7428(int arg0, int arg1, int arg2) {
		class424 var4 = this.field4497[arg0][arg1][arg2];
		if (var4 == null) {
			return null;
		}
	...
	public class973 method7429(int arg0, int arg1, int arg2) {
		class424 var4 = this.field4497[arg0][arg1][arg2];
		if (var4 == null) {
			return null;
		} else {
			class973 var5 = var4.field4553;
			var4.field4553 = null;
	...
	public class974 method7430(int arg0, int arg1, int arg2, class426 arg3) {
		class424 var5 = this.field4497[arg0][arg1][arg2];
		if (var5 == null) {
			return null;
		}
	...
	public void method7439(class974 arg0, boolean arg1) {
		for (int var3 = arg0.field10510; var3 <= arg0.field10508; var3++) {
			for (int var4 = arg0.field10509; var4 <= arg0.field10511; var4++) {
				class424 var5 = this.field4497[arg0.field9807][var3][var4];
				if (var5 != null) {
					class430 var6 = var5.field4554;
					class430 var7 = null;
					while (var6 != null) {
	...
	public void method7432(class836 arg0) {
		if (arg0 == null) {
			return;
		}
		arg0.method8566();
		for (int var2 = 0; var2 < 2; var2++) {
			class836 var3 = null;
			for (class836 var4 = this.field4513[var2]; var4 != null; var4 = var4.field9806) {
				if (arg0 == var4) {
					if (var3 == null) {
			...
			class836 var5 = null;
			for (class836 var6 = this.field4514[var2]; var6 != null; var6 = var6.field9806) {
				if (arg0 == var6) {
					if (var5 == null) {
			...
			class836 var7 = null;
			for (class836 var8 = this.field4536[var2]; var8 != null; var8 = var8.field9806) {
				if (arg0 == var8) {
					if (var7 == null) {
	...
	public class972 method7433(int arg0, int arg1, int arg2) {
		class424 var4 = this.field4497[arg0][arg1][arg2];
		return var4 == null ? null : var4.field4548;
	}

	@ObfuscatedName("oo.as(IIII)Lakr;")
	public class972 method7442(int arg0, int arg1, int arg2) {
		class424 var4 = this.field4497[arg0][arg1][arg2];
		return var4 == null ? null : var4.field4550;
	}

	@ObfuscatedName("oo.ai(IIIB)Lakv;")
	public class971 method7435(int arg0, int arg1, int arg2) {
		class424 var4 = this.field4497[arg0][arg1][arg2];
		return var4 == null ? null : var4.field4546;
	}

	@ObfuscatedName("oo.ao(IIII)Lakb;")
	public class973 method7436(int arg0, int arg1, int arg2) {
		class424 var4 = this.field4497[arg0][arg1][arg2];
		return var4 == null ? null : var4.field4553;
	}

	@ObfuscatedName("oo.al(IIILoj;I)Laku;")
	public class974 method7437(int arg0, int arg1, int arg2, class426 arg3) {
		class424 var5 = this.field4497[arg0][arg1][arg2];
		if (var5 == null) {
			return null;
		}
	...
	public class430 method7438(int arg0, int arg1, int arg2) {
		class424 var4 = this.field4497[arg0][arg1][arg2];
		return var4 == null ? null : var4.field4554;
	}

	@ObfuscatedName("oo.ax(IIII)Lakm;")
	public class970 method7517(int arg0, int arg1, int arg2) {
		class424 var4 = this.field4497[arg0][arg1][arg2];
	...
	public void method7440() {
		for (int var1 = 0; var1 < this.field4494 * 79110873; var1++) {
			for (int var2 = 0; var2 < this.field4495 * 1336538301; var2++) {
				for (int var3 = 0; var3 < this.field4496 * 583225963; var3++) {
					class424 var4 = this.field4497[var1][var2][var3];
					if (var4 != null) {
						class972 var5 = var4.field4548;
						class972 var6 = var4.field4550;
						...
						for (class430 var7 = var4.field4554; var7 != null; var7 = var7.field4641) {
							class974 var8 = var7.field4642;
	...
	public void method7441(class836 arg0, int arg1, int arg2, int arg3) {
		if (arg2 < this.field4495 * 1336538301) {
			class424 var5 = this.field4497[arg1][arg2 + 1][arg3];
			if (var5 != null && var5.field4552 != null && var5.field4552.method12815()) {
				...
				arg0.method12816(this.field4489, var5.field4552, this.field4499 * -855475445, var6, 0, true);
			}
		}
		if (arg3 < this.field4495 * 1336538301) {
			class424 var7 = this.field4497[arg1][arg2][arg3 + 1];
			if (var7 != null && var7.field4552 != null && var7.field4552.method12815()) {
				...
				arg0.method12816(this.field4489, var7.field4552, 0, var8, this.field4499 * -855475445, true);
			}
		}
		if (arg2 < this.field4495 * 1336538301 && arg3 < this.field4496 * 583225963) {
			class424 var9 = this.field4497[arg1][arg2 + 1][arg3 + 1];
			if (var9 != null && var9.field4552 != null && var9.field4552.method12815()) {
				...
				arg0.method12816(this.field4489, var9.field4552, this.field4499 * -855475445, var10, this.field4499 * -855475445, true);
			}
		}
		if (arg2 >= this.field4495 * 1336538301 || arg3 <= 0) {
			return;
		}
		class424 var11 = this.field4497[arg1][arg2 + 1][arg3 - 1];
		if (var11 != null && var11.field4552 != null && var11.field4552.method12815()) {
			...
			arg0.method12816(this.field4489, var11.field4552, this.field4499 * -855475445, var12, -(this.field4499 * -855475445), true);
		}
	}

	@ObfuscatedName("oo.am(Laes;IIIII)V")
	public void method7443(class836 arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		boolean var7 = true;
		int var8 = arg2;
		int var9 = arg2 + arg4;
		int var10 = arg3 - 1;
		...
		for (int var12 = arg1; var12 <= arg1 + 1; var12++) {
			if (this.field4494 * 79110873 != var12) {
				for (int var13 = var8; var13 <= var9; var13++) {
					if (var13 >= 0 && var13 < this.field4495 * 1336538301) {
						for (int var14 = var10; var14 <= var11; var14++) {
							if (var14 >= 0 && var14 < this.field4496 * 583225963 && (!var7 || var13 >= var9 || var14 >= var11 || var14 < arg3 && arg2 != var13)) {
								class424 var15 = this.field4497[var12][var13][var14];
								if (var15 != null) {
									...
									class972 var17 = var15.field4548;
									class972 var18 = var15.field4550;
									if (var17 != null && var17.method12815()) {
										arg0.method12816(this.field4489, var17, this.field4499 * -855475445 * (var13 - arg2) + this.field4487 * 1180189055 * (1 - arg4), var16, this.field4499 * -855475445 * (var14 - arg3) + this.field4487 * 1180189055 * (1 - arg5), var7);
									}
									if (var18 != null && var18.method12815()) {
										arg0.method12816(this.field4489, var18, this.field4499 * -855475445 * (var13 - arg2) + this.field4487 * 1180189055 * (1 - arg4), var16, this.field4499 * -855475445 * (var14 - arg3) + this.field4487 * 1180189055 * (1 - arg5), var7);
									}
									for (class430 var19 = var15.field4554; var19 != null; var19 = var19.field4641) {
										class974 var20 = var19.field4642;
										if (var20 != null && var20.method12815() && (var20.field10510 == var13 || var8 == var13) && (var20.field10509 == var14 || var10 == var14)) {
											...
											arg0.method12816(this.field4489, var20, this.field4499 * -855475445 * (var20.field10510 - arg2) + this.field4487 * 1180189055 * (var21 - arg4), var16, this.field4499 * -855475445 * (var20.field10509 - arg3) + this.field4487 * 1180189055 * (var22 - arg5), var7);
										}
									}
								}
							}
	...
	public void method7419(int arg0, int arg1, int arg2, int arg3, byte[][][] arg4, int[] arg5, int[] arg6, int[] arg7, int[] arg8, int[] arg9, int arg10, byte arg11, int arg12, int arg13, boolean arg14, boolean arg15, int arg16, boolean arg17) {
		...
		this.field4521 = (arg1 >> this.field4510 * -1694394771) * 560387095;
		this.field4503 = (arg3 >> this.field4510 * -1694394771) * 1789986899;
		this.field4523 = arg1 * 1958119741;
		this.field4515 = arg3 * 302020633;
		this.field4525 = arg2 * 1873456483;
		this.field4486 = this.field4521 * -2033021221 - this.field4531 * -1955978737;
		if (this.field4486 * -1084204507 < 0) {
			this.field4518 = -(this.field4486 * 1483476649);
			this.field4486 = 0;
		} else {
			this.field4518 = 0;
		}
		this.field4532 = this.field4503 * -488183445 - this.field4531 * 1679394491;
		if (this.field4532 * 969089873 < 0) {
			this.field4529 = -(this.field4532 * -1742758939);
			this.field4532 = 0;
		} else {
			this.field4529 = 0;
		}
		this.field4484 = this.field4531 * -968301663 + this.field4521 * 456157845;
		if (this.field4484 * 556155467 > this.field4495 * 1336538301) {
			this.field4484 = this.field4495 * -345112553;
		}
		this.field4533 = this.field4531 * -784064855 + this.field4503 * 642369081;
		if (this.field4533 * 496759475 > this.field4496 * 583225963) {
			this.field4533 = this.field4496 * -1263035031;
		}
		boolean[][] var19 = this.field4544;
		boolean[][] var20 = this.field4542;
		if (this.field4492) {
			for (int var21 = 0; var21 < this.field4531 * 1827680811 + this.field4531 * 1827680811 + 2; var21++) {
				int var22 = 0;
				int var23 = 0;
				for (int var24 = 0; var24 < this.field4531 * 1827680811 + this.field4531 * 1827680811 + 2; var24++) {
					if (var24 > 1) {
						this.field4543[var24 - 2] = var22;
					}
					var22 = var23;
					int var25 = this.field4521 * 2043126695 - this.field4531 * 1827680811 + var21;
					int var26 = this.field4503 * -59081765 - this.field4531 * 1827680811 + var24;
					if (var25 >= 0 && var26 >= 0 && var25 < this.field4495 * 1336538301 && var26 < this.field4496 * 583225963) {
						int var27 = var25 << this.field4510 * -1694394771;
						int var28 = var26 << this.field4510 * -1694394771;
						int var29 = this.field4527[this.field4527.length - 1].method199(var25, var26) - (0x3E8 << this.field4510 * -1694394771 - 7);
						int var30 = (this.field4502 == null ? this.field4527[0].method199(var25, var26) + this.field4499 * -855475445 : this.field4502[0].method199(var25, var26) + this.field4499 * -855475445) + (0x3E8 << this.field4510 * -1694394771 - 7);
				...
				this.field4543[this.field4531 * 1827680811 + this.field4531 * 1827680811] = var22;
				this.field4543[this.field4531 * 1827680811 + this.field4531 * 1827680811 + 1] = var23;
			}
			if (arg17) {
			...
			if (this.field4507 == null) {
				this.field4507 = new boolean[this.field4531 * 1827680811 + this.field4531 * 1827680811 + 2][this.field4531 * 1827680811 + this.field4531 * 1827680811 + 2];
			}
		...
		if (!this.field4541.field4473) {
			...
			while (var34.hasNext()) {
				class425 var35 = (class425) var34.next();
				var34.remove();
				class425.method2573(var35);
			}
		}
		if (this.field4491) {
			for (int var36 = 0; var36 < this.field4537 * 219349077; var36++) {
	...
	public void method7503(boolean arg0, byte[][][] arg1, int arg2, byte arg3, int arg4) {
		...
		this.field4516 = 0;
		this.field4485 = 0;
		this.field4520 += -751586157;
		if ((arg4 & 0x2) == 0) {
			for (class836 var7 = this.field4513[var6]; var7 != null; var7 = var7.field9806) {
				this.method7491(var7);
				if (var7.field9810 * -1722027899 != -1 && !this.method7448(var7, arg0, arg1, arg2, arg3)) {
					this.field4519[(this.field4516 += 1845235393) * 80838977 - 1] = var7;
				}
			}
		}
		if ((arg4 & 0x1) == 0) {
			for (class836 var8 = this.field4514[var6]; var8 != null; var8 = var8.field9806) {
				this.method7491(var8);
				if (var8.field9810 * -1722027899 != -1 && !this.method7448(var8, arg0, arg1, arg2, arg3)) {
					this.field4528[(this.field4485 += -2110977391) * 2013787761 - 1] = var8;
				}
			}
			for (class836 var9 = this.field4536[var6]; var9 != null; var9 = var9.field9806) {
				this.method7491(var9);
				if (var9.field9810 * -1722027899 != -1 && !this.method7448(var9, arg0, arg1, arg2, arg3)) {
					if (var9.method12808()) {
						this.field4528[(this.field4485 += -2110977391) * 2013787761 - 1] = var9;
					} else {
						this.field4519[(this.field4516 += 1845235393) * 80838977 - 1] = var9;
					}
				}
			}
			if (!arg0) {
				for (int var10 = 0; var10 < this.field4509 * -115748709; var10++) {
					this.method7491(this.field4506[var10]);
					if (this.field4506[var10].field9810 * -1722027899 != -1 && !this.method7448(this.field4506[var10], arg0, arg1, arg2, arg3)) {
						if (this.field4506[var10].method12808()) {
							this.field4528[(this.field4485 += -2110977391) * 2013787761 - 1] = this.field4506[var10];
						} else {
							this.field4519[(this.field4516 += 1845235393) * 80838977 - 1] = this.field4506[var10];
						}
					}
				}
			}
		}
		if (this.field4516 * 80838977 > 0) {
			this.method7509(this.field4519, 0, this.field4516 * 80838977 - 1);
			for (int var11 = 0; var11 < this.field4516 * 80838977; var11++) {
		...
		if ((arg4 & 0x2) == 0) {
			for (int var12 = 0; var12 < this.field4494 * 79110873; var12++) {
				if (var12 < arg2 || arg1 == null) {
					int var21 = this.field4544.length;
					if (this.field4486 * -1084204507 + this.field4544.length > this.field4495 * 1336538301) {
						var21 -= this.field4486 * -1084204507 + this.field4544.length - this.field4495 * 1336538301;
					}
					int var22 = this.field4544[0].length;
					if (this.field4532 * 969089873 + this.field4544[0].length > this.field4496 * 583225963) {
						var22 -= this.field4532 * 969089873 + this.field4544[0].length - this.field4496 * 583225963;
					}
					boolean[][] var23 = this.field4542;
					if (this.field4492) {
						for (int var24 = this.field4518 * 715180317; var24 < var21; var24++) {
							int var25 = this.field4486 * -1084204507 + var24 - this.field4518 * 715180317;
							for (int var26 = this.field4529 * 16820989; var26 < var22; var26++) {
								if (this.field4544[var24][var26] && !this.field4493.method7599(var12, var25, this.field4532 * 969089873 + var26 - this.field4529 * 16820989)) {
					...
					this.field4498[var12].method212(this.field4521 * 2043126695, this.field4503 * -59081765, this.field4531 * 1827680811, this.field4542, true, arg4);
				} else {
					int var13 = this.field4544.length;
					if (this.field4486 * -1084204507 + this.field4544.length > this.field4495 * 1336538301) {
						var13 -= this.field4486 * -1084204507 + this.field4544.length - this.field4495 * 1336538301;
					}
					int var14 = this.field4544[0].length;
					if (this.field4532 * 969089873 + this.field4544[0].length > this.field4496 * 583225963) {
						var14 -= this.field4532 * 969089873 + this.field4544[0].length - this.field4496 * 583225963;
					}
					boolean[][] var15 = this.field4542;
					if (this.field4492) {
						for (int var16 = this.field4518 * 715180317; var16 < var13; var16++) {
							int var17 = this.field4486 * -1084204507 + var16 - this.field4518 * 715180317;
							for (int var18 = this.field4529 * 16820989; var18 < var14; var18++) {
								var15[var16][var18] = false;
								if (this.field4544[var16][var18]) {
									int var19 = this.field4532 * 969089873 + var18 - this.field4529 * 16820989;
					...
					this.field4498[var12].method212(this.field4521 * 2043126695, this.field4503 * -59081765, this.field4531 * 1827680811, this.field4542, false, arg4);
				}
			}
		}
		if (this.field4485 * 2013787761 > 0) {
			this.method7446(this.field4528, 0, this.field4485 * 2013787761 - 1);
			for (int var27 = 0; var27 < this.field4485 * 2013787761; var27++) {
	...
	public void method7491(class836 arg0) {
		...
		arg0.field9810 = (int) this.field4522[2] * -689272755;
	}

	@ObfuscatedName("oo.av([Laes;II)V")
	public void method7446(class836[] arg0, int arg1, int arg2) {
		if (arg1 >= arg2) {
			return;
		}
		int var4 = (arg1 + arg2) / 2;
		int var5 = arg1;
		class836 var6 = arg0[var4];
		arg0[var4] = arg0[arg2];
		arg0[arg2] = var6;
		int var7 = var6.field9810 * -1722027899;
		for (int var8 = arg1; var8 < arg2; var8++) {
			if (arg0[var8].field9810 * -1722027899 > (var8 & 0x1) + var7) {
				class836 var9 = arg0[var8];
				arg0[var8] = arg0[var5];
				arg0[var5++] = var9;
			}
		}
	...
	public void method7509(class836[] arg0, int arg1, int arg2) {
		if (arg1 >= arg2) {
			return;
		}
		int var4 = (arg1 + arg2) / 2;
	...
	public boolean method7448(class836 arg0, boolean arg1, byte[][][] arg2, int arg3, byte arg4) {
		if (!this.field4492) {
			return false;
		} else if (arg0 instanceof class974) {
			short var6 = ((class974) arg0).field10508;
			short var7 = ((class974) arg0).field10511;
			short var8 = ((class974) arg0).field10510;
			short var9 = ((class974) arg0).field10509;
			for (int var10 = var8; var10 <= var6; var10++) {
				for (int var11 = var9; var11 <= var7; var11++) {
					if (arg0.field9809 < this.field4494 * 79110873 && var10 >= this.field4486 * -1084204507 && var10 < this.field4484 * 556155467 && var11 >= this.field4532 * 969089873 && var11 < this.field4533 * 496759475) {
						if ((arg2 == null || arg0.field9807 < arg3 || arg2[arg0.field9807][var10][var11] != arg4) && arg0.method15635() && !arg0.method15634(this.field4489)) {
							return false;
						}
						if (!arg1 && var10 >= this.field4521 * 2043126695 - 16 && var10 <= this.field4521 * 2043126695 + 16 && var11 >= this.field4503 * -59081765 - 16 && var11 <= this.field4503 * -59081765 + 16) {
			...
			int var13 = (int) var12.field3475 >> this.field4510 * -1694394771;
			int var14 = (int) var12.field3477 >> this.field4510 * -1694394771;
			if (arg0.field9809 >= this.field4494 * 79110873 || var13 < this.field4486 * -1084204507 || var13 >= this.field4484 * 556155467 || var14 < this.field4532 * 969089873 || var14 >= this.field4533 * 496759475) {
				return true;
				...
				if (!arg1 && var13 >= this.field4521 * 2043126695 - 16 && var13 <= this.field4521 * 2043126695 + 16 && var14 >= this.field4503 * -59081765 - 16 && var14 <= this.field4503 * -59081765 + 16) {
					arg0.method12851(this.field4489);
				}
				return true;
			}
	...
	public void method7449(class836 arg0, class780[] arg1) {
		if (this.field4491) {
		...
		if (this.field4502 == this.field4498) {
			...
			if (arg0 instanceof class974) {
				var7 = ((class974) arg0).field10510;
				var8 = ((class974) arg0).field10509;
			} else {
				var7 = (int) var6.field3475 >> this.field4510 * -1694394771;
				var8 = (int) var6.field3477 >> this.field4510 * -1694394771;
			}
			class137 var9 = new class137();
			var9.field1475 = this.method7411(var7, var8) * 366102675;
			var9.field1471 = this.method7410(var7, var8) * 714616553;
			var9.field1474 = this.method7489(var7, var8) * 388922513;
			var9.field1470 = this.method7413(var7, var8) * 682931301;
			var9.field1476 = this.method7505(var7, var8) * -1687556705;
			var9.field1472 = this.method7501(var7, var8) * 1648006647;
			this.field4489.method547(this.field4527[0].method196((int) var6.field3475, (int) var6.field3477), var9);
		}
		class425 var10 = arg0.method12812(this.field4489);
		if (var10 == null) {
			return;
		}
		if (var10.field4564) {
	...
	public boolean method7445(class30 arg0, int arg1, int arg2, int arg3, boolean[] arg4) {
		...
		if (this.field4502 != this.field4498) {
			...
			for (int var8 = 0; var8 <= arg1; var8++) {
				class12 var9 = this.field4527[var8];
				if (var9 != null) {
	...
	public void method7451(class30 arg0, int arg1, int arg2, int arg3, boolean[] arg4) {
		...
		for (int var7 = 0; var7 <= arg1; var7++) {
			if (arg4 == null || arg4[var7]) {
				class12 var8 = this.field4527[var7];
				if (var8 != null) {
	...
	public void method7452(int arg0, int arg1) {
		...
		for (int var4 = arg0; var4 < arg1; var4++) {
			class12 var5 = this.field4527[var4];
			if (var5 != null) {
				for (int var6 = 0; var6 < this.field4496 * 583225963; var6++) {
					for (int var7 = 0; var7 < this.field4495 * 1336538301; var7++) {
						var3 = var5.method200(var7, var6, var3);
						if (var3 != null) {
							int var8 = var7 << this.field4510 * -1694394771;
							int var9 = var6 << this.field4510 * -1694394771;
							for (int var10 = var4 - 1; var10 >= 0; var10--) {
								class12 var11 = this.field4527[var10];
								if (var11 != null) {
	...
	public void method7453() {
		this.method7452(1, this.field4494 * 79110873);
	}

	@ObfuscatedName("oo.bq(Lor;I)V")
	public void method7454(class427 arg0) {
		if (this.field4537 * 219349077 >= 65459) {
			return;
		}
		class780 var2 = arg0.field4588;
		this.field4539[this.field4537 * 219349077] = arg0;
		this.field4540[this.field4537 * 219349077] = false;
		this.field4537 += 827456765;
		int var3 = arg0.field4592 * 1258433447;
		if (arg0.field4591) {
			var3 = 0;
		}
		int var4 = arg0.field4592 * 1258433447;
		if (arg0.field4587) {
			var4 = this.field4494 * 79110873 - 1;
		}
		for (int var5 = var3; var5 <= var4; var5++) {
			int var6 = 0;
			int var7 = var2.method14879() - var2.method14880() + this.field4487 * 1180189055 >> this.field4510 * -1694394771;
			if (var7 < 0) {
				var6 -= var7;
				var7 = 0;
			}
			int var8 = var2.method14879() + var2.method14880() - this.field4487 * 1180189055 >> this.field4510 * -1694394771;
			if (var8 >= this.field4496 * 583225963) {
				var8 = this.field4496 * 583225963 - 1;
			}
			for (int var9 = var7; var9 <= var8; var9++) {
				short var10 = arg0.field4597[var6++];
				int var11 = (var2.method14888() - var2.method14880() + this.field4487 * 1180189055 >> this.field4510 * -1694394771) + (var10 >>> 8);
				int var12 = (var10 & 0xFF) + var11 - 1;
				if (var11 < 0) {
					var11 = 0;
				}
				if (var12 >= this.field4495 * 1336538301) {
					var12 = this.field4495 * 1336538301 - 1;
				}
				for (int var13 = var11; var13 <= var12; var13++) {
					long var14 = this.field4526[var5][var13][var9];
					if ((var14 & 0xFFFFL) == 0L) {
						this.field4526[var5][var13][var9] = var14 | (long) (this.field4537 * 219349077);
					} else if ((var14 & 0xFFFF0000L) == 0L) {
						this.field4526[var5][var13][var9] = var14 | (long) (this.field4537 * 219349077) << 16;
					} else if ((var14 & 0xFFFF00000000L) == 0L) {
						this.field4526[var5][var13][var9] = var14 | (long) (this.field4537 * 219349077) << 32;
					} else if ((var14 & 0xFFFF000000000000L) == 0L) {
						this.field4526[var5][var13][var9] = var14 | (long) (this.field4537 * 219349077) << 48;
					}
				}
			}
		}
	...
	public void method7455() {
		for (int var1 = 0; var1 < this.field4537 * 219349077; var1++) {
			if (!this.field4540[var1]) {
				class427 var2 = this.field4539[var1];
				class780 var3 = var2.field4588;
				int var4 = var2.field4592 * 1258433447;
				int var5 = var3.method14880() - this.field4487 * 1180189055;
				int var6 = (var5 * 2 >> this.field4510 * -1694394771) + 1;
				int var7 = 0;
				int[] var8 = new int[var6 * var6];
				int var9 = var3.method14888() - var5 >> this.field4510 * -1694394771;
				int var10 = var3.method14879() - var5 >> this.field4510 * -1694394771;
				int var11 = var3.method14879() + var5 >> this.field4510 * -1694394771;
				if (var10 < 0) {
					var7 -= var10;
					var10 = 0;
				}
				if (var11 >= this.field4496 * 583225963) {
					var11 = this.field4496 * 583225963 - 1;
				}
				for (int var12 = var10; var12 <= var11; var12++) {
					...
					if (var17 >= this.field4495 * 1336538301) {
						var17 = this.field4495 * 1336538301 - 1;
					}
					for (int var18 = var16; var18 <= var17; var18++) {
						byte var19 = 1;
						class974 var20 = this.method7437(var4, var18, var12, null);
