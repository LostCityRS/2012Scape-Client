...
public class class428 {
	...
	public class428(class423 arg0) {
		this.field4608 = arg0.field4499 * -855475445;
		this.field4612 = arg0.field4499 * -855475445;
		this.field4605 = arg0;
		...
		this.field4617 = 0;
		this.field4611 = new int[this.field4605.field4494 * 79110873][this.field4605.field4495 * 1336538301 + 1][this.field4605.field4496 * 583225963 + 1];
	...
	public void method7615(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		if (arg0 != 8 && arg0 != 16) {
			...
			int var8 = arg2 << this.field4605.field4510 * -1694394771;
			int var9 = this.field4605.field4499 * -855475445 + var8;
			int var10 = arg3 << this.field4605.field4510 * -1694394771;
			int var11 = this.field4605.field4499 * -855475445 + var10;
			...
			int var14 = (arg2 << this.field4605.field4510 * -1694394771) + this.field4605.field4499 * -855475445;
			int var15 = var14 - this.field4605.field4499 * -855475445;
			int var16 = arg3 << this.field4605.field4510 * -1694394771;
			int var17 = this.field4605.field4499 * -855475445 + var16;
	...
	public void method7593() {
		...
		this.field4614 = 0;
		for (int var2 = 0; var2 < this.field4605.field4494 * 79110873; var2++) {
			for (int var3 = 0; var3 < this.field4605.field4495 * 1336538301; var3++) {
				for (int var4 = 0; var4 < this.field4605.field4496 * 583225963; var4++) {
		...
		for (int var6 = 0; var6 < this.field4605.field4494 * 79110873; var6++) {
			for (int var7 = 0; var7 < this.field4605.field4495 * 1336538301; var7++) {
				for (int var8 = 0; var8 < this.field4605.field4496 * 583225963; var8++) {
					...
					if (var9 != null) {
						...
						if (var9.field4555 < 0) {
							...
							for (class424 var17 = this.field4605.field4497[var6][var8][var12 + 1]; var12 < this.field4605.field4496 * 583225963 && var17 != null && var17.field4555 < 0 && var9.field4555 == var17.field4555 && var9.field4556 == var17.field4556 && var16 == this.field4605.field4527[var6].method199(var8, var12 + 1) && (var12 + 1 >= this.field4605.field4496 * 583225963 || var16 == this.field4605.field4527[var6].method199(var8, var12 + 2)) && var12 - var11 <= 10; var17 = this.field4605.field4497[var6][var8][var12 + 1]) {
								var12++;
							}
							...
							int var23 = var8 << this.field4605.field4510 * -1694394771;
							int var24 = var11 << this.field4605.field4510 * -1694394771;
							int var25 = (var12 << this.field4605.field4510 * -1694394771) + this.field4605.field4499 * -855475445;
						...
						if (var9.field4557 < 0) {
							...
							for (class424 var34 = this.field4605.field4497[var6][var29 + 1][var7]; var29 < this.field4605.field4495 * 1336538301 && var34 != null && var34.field4557 < 0 && var9.field4557 == var34.field4557 && var9.field4558 == var34.field4558 && var33 == this.field4605.field4527[var6].method199(var29 + 1, var7) && (var29 + 1 >= this.field4605.field4495 * 1336538301 || var33 == this.field4605.field4527[var6].method199(var29 + 2, var7)) && var29 - var28 <= 10; var34 = this.field4605.field4497[var6][var29 + 1][var7]) {
								var29++;
							}
							...
							int var40 = var28 << this.field4605.field4510 * -1694394771;
							int var41 = (var29 << this.field4605.field4510 * -1694394771) + this.field4605.field4499 * -855475445;
							int var42 = var7 << this.field4605.field4510 * -1694394771;
	...
	public void method7596(class14 arg0, class431 arg1, int arg2) {
		...
		if (arg1.field4651 == 1) {
			int var5 = this.field4605.field4531 * 1827680811 + (arg1.field4654 - this.field4605.field4521 * 2043126695);
			if (var5 >= 0 && var5 <= this.field4605.field4531 * 1827680811 + this.field4605.field4531 * 1827680811) {
				int var6 = this.field4605.field4531 * 1827680811 + (arg1.field4660 - this.field4605.field4503 * -59081765);
				if (var6 < 0) {
					var6 = 0;
				} else if (var6 > this.field4605.field4531 * 1827680811 + this.field4605.field4531 * 1827680811) {
					return;
				}
				int var7 = this.field4605.field4531 * 1827680811 + (arg1.field4656 - this.field4605.field4503 * -59081765);
				if (var7 > this.field4605.field4531 * 1827680811 + this.field4605.field4531 * 1827680811) {
					var7 = this.field4605.field4531 * 1827680811 + this.field4605.field4531 * 1827680811;
				} else if (var7 < 0) {
					return;
				}
				boolean var8 = false;
				...
				if (var8) {
					float var9 = (float) (this.field4605.field4523 * -488532459 - arg1.field4655[0]);
					if (var9 < 0.0F) {
						var9 *= -1.0F;
					}
			...
			int var10 = this.field4605.field4531 * 1827680811 + (arg1.field4660 - this.field4605.field4503 * -59081765);
			if (var10 >= 0 && var10 <= this.field4605.field4531 * 1827680811 + this.field4605.field4531 * 1827680811) {
				int var11 = this.field4605.field4531 * 1827680811 + (arg1.field4654 - this.field4605.field4521 * 2043126695);
				if (var11 < 0) {
					var11 = 0;
				} else if (var11 > this.field4605.field4531 * 1827680811 + this.field4605.field4531 * 1827680811) {
					return;
				}
				int var12 = this.field4605.field4531 * 1827680811 + (arg1.field4647 - this.field4605.field4521 * 2043126695);
				if (var12 > this.field4605.field4531 * 1827680811 + this.field4605.field4531 * 1827680811) {
					var12 = this.field4605.field4531 * 1827680811 + this.field4605.field4531 * 1827680811;
				} else if (var12 < 0) {
					return;
				}
				boolean var13 = false;
				...
				if (var13) {
					float var14 = (float) (this.field4605.field4515 * 1937466409 - arg1.field4659[0]);
					if (var14 < 0.0F) {
						var14 *= -1.0F;
					}
			...
			int var23 = this.field4605.field4531 * 1827680811 + (arg1.field4654 - this.field4605.field4521 * 2043126695);
			if (var23 >= 0 && var23 <= this.field4605.field4531 * 1827680811 + this.field4605.field4531 * 1827680811) {
				int var24 = this.field4605.field4531 * 1827680811 + (arg1.field4660 - this.field4605.field4503 * -59081765);
				if (var24 >= 0 && var24 <= this.field4605.field4531 * 1827680811 + this.field4605.field4531 * 1827680811 && this.field4605.field4544[var23][var24]) {
					float var25 = (float) (this.field4605.field4523 * -488532459 - arg1.field4655[0]);
					if (var25 < 0.0F) {
						var25 *= -1.0F;
					}
					float var26 = (float) (this.field4605.field4515 * 1937466409 - arg1.field4659[0]);
					if (var26 < 0.0F) {
						var26 *= -1.0F;
					}
			...
			float var15 = (float) (arg1.field4650[0] - this.field4605.field4525 * -1024181173);
			if (!(var15 <= (float) this.field4612)) {
				int var16 = this.field4605.field4531 * 1827680811 + (arg1.field4660 - this.field4605.field4503 * -59081765);
				if (var16 < 0) {
					var16 = 0;
				} else if (var16 > this.field4605.field4531 * 1827680811 + this.field4605.field4531 * 1827680811) {
					return;
				}
				int var17 = this.field4605.field4531 * 1827680811 + (arg1.field4656 - this.field4605.field4503 * -59081765);
				if (var17 > this.field4605.field4531 * 1827680811 + this.field4605.field4531 * 1827680811) {
					var17 = this.field4605.field4531 * 1827680811 + this.field4605.field4531 * 1827680811;
				} else if (var17 < 0) {
					return;
				}
				int var18 = this.field4605.field4531 * 1827680811 + (arg1.field4654 - this.field4605.field4521 * 2043126695);
				if (var18 < 0) {
					var18 = 0;
				} else if (var18 > this.field4605.field4531 * 1827680811 + this.field4605.field4531 * 1827680811) {
					return;
				}
				int var19 = this.field4605.field4531 * 1827680811 + (arg1.field4647 - this.field4605.field4521 * 2043126695);
				if (var19 > this.field4605.field4531 * 1827680811 + this.field4605.field4531 * 1827680811) {
					var19 = this.field4605.field4531 * 1827680811 + this.field4605.field4531 * 1827680811;
				} else if (var19 < 0) {
					return;
				}
				boolean var20 = false;
	...
	public boolean method7599(int arg0, int arg1, int arg2) {
		if (!this.field4624 || !this.field4613) {
			...
			if (-(this.field4605.field4520 * 1276479899) == var4) {
				return false;
			} else if (this.field4605.field4520 * 1276479899 == var4) {
				return true;
			} else if (this.field4605.field4502 == this.field4605.field4498) {
				return false;
			} else {
				int var5 = arg1 << this.field4605.field4510 * -1694394771;
				int var6 = arg2 << this.field4605.field4510 * -1694394771;
				if (this.method7605(var5 + 1, this.field4605.field4498[arg0].method199(arg1, arg2), var6 + 1, this.field4605.field4499 * -855475445 + var5 - 1, this.field4605.field4498[arg0].method199(arg1 + 1, arg2 + 1), this.field4605.field4499 * -855475445 + var6 - 1, var5 + 1, this.field4605.field4498[arg0].method199(arg1, arg2 + 1), this.field4605.field4499 * -855475445 + var6 - 1) && this.method7605(var5 + 1, this.field4605.field4498[arg0].method199(arg1, arg2), var6 + 1, this.field4605.field4499 * -855475445 + var5 - 1, this.field4605.field4498[arg0].method199(arg1 + 1, arg2), var6 + 1, this.field4605.field4499 * -855475445 + var5 - 1, this.field4605.field4498[arg0].method199(arg1 + 1, arg2 + 1), this.field4605.field4499 * -855475445 + var6 - 1)) {
					this.field4611[arg0][arg1][arg2] = this.field4605.field4520 * 1276479899;
					return true;
				} else {
					this.field4611[arg0][arg1][arg2] = -(this.field4605.field4520 * 1276479899);
					return false;
	...
	public boolean method7600(class972 arg0, int arg1, int arg2, int arg3) {
		if (!this.field4624 || !this.field4613) {
			...
			int var5 = arg2 << this.field4605.field4510 * -1694394771;
			int var6 = arg3 << this.field4605.field4510 * -1694394771;
			int var7 = this.field4605.field4498[arg1].method199(arg2, arg3) - 1;
			int var8 = var7 + arg0.method12809();
			if (arg0.field10507 == 1) {
				if (this.method7605(var5, var7, var6, var5, var8, var6, var5, var8, this.field4605.field4499 * -855475445 + var6)) {
					return this.method7605(var5, var7, var6, var5, var8, this.field4605.field4499 * -855475445 + var6, var5, var7, this.field4605.field4499 * -855475445 + var6);
				} else {
					return false;
				}
			} else if (arg0.field10507 == 2) {
				if (this.method7605(var5, var7, this.field4605.field4499 * -855475445 + var6, this.field4605.field4499 * -855475445 + var5, var8, this.field4605.field4499 * -855475445 + var6, var5, var8, this.field4605.field4499 * -855475445 + var6)) {
					return this.method7605(var5, var7, this.field4605.field4499 * -855475445 + var6, this.field4605.field4499 * -855475445 + var5, var7, this.field4605.field4499 * -855475445 + var6, this.field4605.field4499 * -855475445 + var5, var8, this.field4605.field4499 * -855475445 + var6);
				} else {
					return false;
				}
			} else if (arg0.field10507 == 4) {
				if (this.method7605(this.field4605.field4499 * -855475445 + var5, var7, var6, this.field4605.field4499 * -855475445 + var5, var8, var6, this.field4605.field4499 * -855475445 + var5, var8, this.field4605.field4499 * -855475445 + var6)) {
					return this.method7605(this.field4605.field4499 * -855475445 + var5, var7, var6, this.field4605.field4499 * -855475445 + var5, var8, this.field4605.field4499 * -855475445 + var6, this.field4605.field4499 * -855475445 + var5, var7, this.field4605.field4499 * -855475445 + var6);
				} else {
					return false;
				}
			} else if (arg0.field10507 == 8) {
				if (this.method7605(var5, var7, var6, this.field4605.field4499 * -855475445 + var5, var8, var6, var5, var8, var6)) {
					return this.method7605(var5, var7, var6, this.field4605.field4499 * -855475445 + var5, var7, var6, this.field4605.field4499 * -855475445 + var5, var8, var6);
				} else {
					return false;
				}
			} else if (arg0.field10507 == 16) {
				return this.method7604(var5, var7, this.field4605.field4487 * 1180189055 + var6, this.field4605.field4487 * 1180189055, var8, this.field4605.field4487 * 1180189055);
			} else if (arg0.field10507 == 32) {
				return this.method7604(this.field4605.field4487 * 1180189055 + var5, var7, this.field4605.field4487 * 1180189055 + var6, this.field4605.field4487 * 1180189055, var8, this.field4605.field4487 * 1180189055);
			} else if (arg0.field10507 == 64) {
				return this.method7604(this.field4605.field4487 * 1180189055 + var5, var7, var6, this.field4605.field4487 * 1180189055, var8, this.field4605.field4487 * 1180189055);
			} else if (arg0.field10507 == 128) {
				return this.method7604(var5, var7, var6, this.field4605.field4487 * 1180189055, var8, this.field4605.field4487 * 1180189055);
			} else {
				return true;
			}
		} else {
	...
	public boolean method7590(int arg0, int arg1, int arg2, int arg3) {
		if (!this.field4624 || !this.field4613) {
			...
			int var5 = arg1 << this.field4605.field4510 * -1694394771;
			int var6 = arg2 << this.field4605.field4510 * -1694394771;
			return this.method7604(var5, this.field4605.field4498[arg0].method199(arg1, arg2), var6, this.field4605.field4499 * -855475445, arg3, this.field4605.field4499 * -855475445);
		} else {
			return false;
		}
	}
		...
		if (!this.field4624 || !this.field4613) {
			...
			for (int var7 = arg1; var7 <= arg2; var7++) {
				for (int var8 = arg3; var8 <= arg4; var8++) {
					if (this.field4611[arg0][var7][var8] == -(this.field4605.field4520 * 1276479899)) {
						return false;
					}
				}
			}
	...
	public final boolean method7604(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		...
		if (!this.method7605(arg0, var8, arg2, var7, var8, var9, arg0, var8, var9)) {
			...
			if (arg0 < this.field4605.field4523 * -488532459) {
			...
			if (arg2 < this.field4605.field4515 * 1937466409) {
