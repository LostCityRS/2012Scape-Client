...
public class class446 implements class445 {
	...
	public class446(int arg0, int arg1, int[] arg2) {
		this.field4811 = arg0 * -1471520107;
		this.field4812 = arg1 * -1485909479;
		this.field4813 = arg2;
	}
	...
	public boolean method7884(class809 arg0, class415[] arg1, int arg2, class413 arg3) {
		if (arg0 != null) {
			if (this.field4811 * 132798653 != arg0.method15181()) {
				return false;
			}
			if (this.field4812 * -1970116055 > arg0.method15184()) {
				return false;
			}
		...
		} else if (this.field4811 * 132798653 != -1) {
			return false;
		}
		return true;
	}
