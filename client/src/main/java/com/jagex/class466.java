...
public class class466 {
	...
	@ObfuscatedName("qr.n")
	public static int field4929 = -1623551918;
	...
	public static void method12208(class334 arg0) {
		...
		Statics.field4927 = new class467[class130.field1351[field4929 * -1894591463] + 1];
		field4923 = 0;
		field4928 = 0;
	...
	public static void method2847(class14 arg0, long arg1) {
		field4926 = field4925 * -478137133;
		field4925 = 0;
		class153.method5554();
		Iterator var3 = Statics.field4686.iterator();
		while (var3.hasNext()) {
			class467 var4 = (class467) var3.next();
			boolean var5 = var4.method8104(arg0, arg1);
			if (!var5) {
				var3.remove();
				Statics.field4927[field4928 * -787821015] = var4;
				field4928 = (field4928 * -787821015 + 1 & class130.field1351[field4929 * -1894591463]) * -981291495;
			}
		}
	}
