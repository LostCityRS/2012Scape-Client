...
public class class467 {
	...
	@ObfuscatedName("qw.q")
	public class128 field4940 = new class128();
	...
	public static class467 method8123(int arg0, boolean arg1) {
		if (class466.field4928 * -787821015 == class466.field4923 * 1443125605) {
			return new class467(arg0, arg1);
		} else {
			class467 var2 = Statics.field4927[class466.field4923 * 1443125605];
			class466.field4923 = (class466.field4923 * 1443125605 + 1 & class130.field1351[class466.field4929 * -1894591463]) * -1658376083;
	...
	public void method8101() {
		...
		while (var1.hasNext()) {
			...
			if (var2.field9602.field2760 * -2140973065 == 1) {
				var2.method6979();
			}
		}
	...
	public boolean method8104(class14 arg0, long arg1) {
		...
		if (this.field4939) {
			...
			while (var5.hasNext()) {
				...
				for (int var7 = 0; var7 < var6.field4901.field2709 * -1634875141; var7++) {
	...
	public void method8106(class14 arg0, long arg1, class134[] arg2, class119[] arg3, boolean arg4) {
		if (!this.field4945) {
	...
	public void method8107(class14 arg0, class134[] arg1, boolean arg2) {
	...
	public void method8098(class119[] arg0, boolean arg1) {
		...
		while (true) {
			...
			if (arg0 != null) {
				for (int var7 = 0; var7 < arg0.length && var7 != 8 && this.field4932 != 8; var7++) {
					if (!field4946[var7]) {
						class811 var8 = null;
						if (arg0[var7].method2534().field2760 * -2140973065 == 1 && class466.field4920 * -2042957663 < 32) {
							var8 = new class811(arg0[var7], this);
							class466.field4924.method11927(var8, (long) (arg0[var7].field1243 * 118295705));
							class466.field4920 += 1342370657;
						}
						if (var8 == null) {
							var8 = new class811(arg0[var7], this);
