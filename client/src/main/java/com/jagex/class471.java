...
public class class471 {
	...
	@ObfuscatedName("qc.f")
	public int field5006 = 397836229;
	...
	public void method8230(int arg0, int[] arg1, class593[] arg2, int[] arg3, boolean arg4, int arg5) {
		if (this.field5002 * 624991343 != arg0) {
			this.field5002 = arg0 * 1923891855;
		}
		this.field5001 = arg1;
		this.field5011 = arg2;
		this.field5000 = arg3;
		this.field5005 = arg4;
		this.field5006 = arg5 * -397836229;
		this.method8229();
	}
	...
	public void method8229() {
		...
		this.field5007 = 8283258498460465531L;
		this.field5007 = (this.field5007 * 6766985991377109581L >>> 8 ^ var1[(int) ((this.field5007 * 6766985991377109581L ^ (long) (this.field5002 * 624991343 >> 8)) & 0xFFL)]) * -8283258498460465531L;
		this.field5007 = (this.field5007 * 6766985991377109581L >>> 8 ^ var1[(int) ((this.field5007 * 6766985991377109581L ^ (long) (this.field5002 * 624991343)) & 0xFFL)]) * -8283258498460465531L;
		for (int var2 = 0; var2 < this.field5001.length; var2++) {
			this.field5007 = (this.field5007 * 6766985991377109581L >>> 8 ^ var1[(int) ((this.field5007 * 6766985991377109581L ^ (long) (this.field5001[var2] >> 24)) & 0xFFL)]) * -8283258498460465531L;
			this.field5007 = (this.field5007 * 6766985991377109581L >>> 8 ^ var1[(int) ((this.field5007 * 6766985991377109581L ^ (long) (this.field5001[var2] >> 16)) & 0xFFL)]) * -8283258498460465531L;
			this.field5007 = (this.field5007 * 6766985991377109581L >>> 8 ^ var1[(int) ((this.field5007 * 6766985991377109581L ^ (long) (this.field5001[var2] >> 8)) & 0xFFL)]) * -8283258498460465531L;
			this.field5007 = (this.field5007 * 6766985991377109581L >>> 8 ^ var1[(int) ((this.field5007 * 6766985991377109581L ^ (long) this.field5001[var2]) & 0xFFL)]) * -8283258498460465531L;
		}
				...
				if (this.field5011[var3] != null) {
					...
					if (var4 != null) {
						for (int var6 = 0; var6 < var4.length; var6++) {
							this.field5007 = (this.field5007 * 6766985991377109581L >>> 8 ^ var1[(int) ((this.field5007 * 6766985991377109581L ^ (long) (var4[var6] >> 8)) & 0xFFL)]) * -8283258498460465531L;
							this.field5007 = (this.field5007 * 6766985991377109581L >>> 8 ^ var1[(int) ((this.field5007 * 6766985991377109581L ^ (long) var4[var6]) & 0xFFL)]) * -8283258498460465531L;
						}
					}
					if (var5 != null) {
						for (int var7 = 0; var7 < var5.length; var7++) {
							this.field5007 = (this.field5007 * 6766985991377109581L >>> 8 ^ var1[(int) ((this.field5007 * 6766985991377109581L ^ (long) (var5[var7] >> 8)) & 0xFFL)]) * -8283258498460465531L;
							this.field5007 = (this.field5007 * 6766985991377109581L >>> 8 ^ var1[(int) ((this.field5007 * 6766985991377109581L ^ (long) var5[var7]) & 0xFFL)]) * -8283258498460465531L;
						}
					}
					if (this.field5011[var3].field7134 != null) {
						for (int var8 = 0; var8 < this.field5011[var3].field7134.length; var8++) {
							this.field5007 = (this.field5007 * 6766985991377109581L >>> 8 ^ var1[(int) ((this.field5007 * 6766985991377109581L ^ (long) (this.field5011[var3].field7134[var8] >> 8)) & 0xFFL)]) * -8283258498460465531L;
							this.field5007 = (this.field5007 * 6766985991377109581L >>> 8 ^ var1[(int) ((this.field5007 * 6766985991377109581L ^ (long) this.field5011[var3].field7134[var8]) & 0xFFL)]) * -8283258498460465531L;
						}
					}
					if (this.field5011[var3].field7135 != null) {
						for (int var9 = 0; var9 < this.field5011[var3].field7135.length; var9++) {
							this.field5007 = (this.field5007 * 6766985991377109581L >>> 8 ^ var1[(int) ((this.field5007 * 6766985991377109581L ^ (long) (this.field5011[var3].field7135[var9] >> 8)) & 0xFFL)]) * -8283258498460465531L;
							this.field5007 = (this.field5007 * 6766985991377109581L >>> 8 ^ var1[(int) ((this.field5007 * 6766985991377109581L ^ (long) this.field5011[var3].field7135[var9]) & 0xFFL)]) * -8283258498460465531L;
						}
					}
				}
			}
		...
		for (int var10 = 0; var10 < 10; var10++) {
			this.field5007 = (this.field5007 * 6766985991377109581L >>> 8 ^ var1[(int) ((this.field5007 * 6766985991377109581L ^ (long) this.field5000[var10]) & 0xFFL)]) * -8283258498460465531L;
		}
		this.field5007 = (this.field5007 * 6766985991377109581L >>> 8 ^ var1[(int) ((this.field5007 * 6766985991377109581L ^ (long) (this.field5005 ? 1 : 0)) & 0xFFL)]) * -8283258498460465531L;
	}
	...
	public class13 method8244(class14 arg0, int arg1, class440 arg2, class205 arg3, class612 arg4, class594 arg5, class510 arg6, class567 arg7, class553 arg8, class553 arg9, class553[] arg10, int[] arg11, int arg12, boolean arg13, class493 arg14) {
		if (this.field5006 * 1728403699 != -1) {
			return arg4.method12565(this.field5006 * 1728403699).method12510(arg0, arg1, arg2, arg7, arg8, arg9, arg10, arg11, arg12, null);
		}
		int var16 = arg1;
		long var17 = this.field5007 * 6766985991377109581L;
		int[] var19 = this.field5001;
		boolean var20 = false;
		boolean var21 = false;
		if (arg8 != null) {
			class509 var22 = arg8.method11804();
			if (var22 != null && (var22.field6326 * -496727379 >= 0 || var22.field6327 * 1487461945 >= 0)) {
				var19 = new int[this.field5001.length];
				for (int var23 = 0; var23 < var19.length; var23++) {
					var19[var23] = this.field5001[var23];
				}
				if (var22.field6326 * -496727379 >= 0 && arg14.field5173 * -2016013971 != -1) {
					var20 = true;
					if (var22.field6326 * -496727379 == 65535) {
						var19[arg14.field5173 * -2016013971] = 0;
						for (int var24 = 0; var24 < arg14.field5176.length; var24++) {
							var19[arg14.field5176[var24]] = 0;
						}
						var17 ^= 0xFFFFFFFF00000000L;
					} else {
						var19[arg14.field5173 * -2016013971] = var22.field6326 * -496727379 | 0x40000000;
						for (int var25 = 0; var25 < arg14.field5176.length; var25++) {
							var19[arg14.field5176[var25]] = 0;
						}
						var17 ^= (long) var19[arg14.field5173 * -2016013971] << 32;
					}
				}
				if (var22.field6327 * 1487461945 >= 0 && arg14.field5174 * 1269938071 != -1) {
					var21 = true;
					if (var22.field6327 * 1487461945 == 65535) {
						var19[arg14.field5174 * 1269938071] = 0;
						for (int var26 = 0; var26 < arg14.field5172.length; var26++) {
							var19[arg14.field5172[var26]] = 0;
						}
						var17 ^= 0xFFFFFFFFL;
					} else {
						var19[arg14.field5174 * 1269938071] = var22.field6327 * 1487461945 | 0x40000000;
						for (int var27 = 0; var27 < arg14.field5172.length; var27++) {
							var19[arg14.field5172[var27]] = 0;
						}
						var17 ^= var19[arg14.field5174 * 1269938071];
					}
				}
			}
		}
		...
		class439 var36 = null;
		if (this.field5002 * 624991343 != -1) {
			var36 = arg2.method7784(this.field5002 * 624991343);
		}
		if (var34 == null || arg0.method519(var34.method329(), var16) != 0) {
			...
			while (true) {
				if (var39 >= var19.length) {
					if (var38) {
						if (this.field5008 * 7881245277840976085L != -1L) {
							class451 var45 = field5012;
							synchronized (field5012) {
								var34 = (class13) field5012.method7916(this.field5008 * 7881245277840976085L);
							}
						}
						if (var34 != null && arg0.method519(var34.method329(), var16) == 0) {
							break;
					...
					var34 = arg0.method625(var61, var62, Statics.field3537 * -316841981, 64, 850);
					...
					if (arg13) {
						...
						this.field5008 = var17 * 493380325235773565L;
					}
					break;
				}
				...
				boolean var42 = false;
				if (var20) {
					if (arg14.field5173 * -2016013971 == var39) {
						var42 = true;
					} else {
				...
				if (var21) {
					if (arg14.field5174 * 1269938071 == var39) {
						var42 = true;
					} else {
	...
	public class13 method8237(class14 arg0, int arg1, class205 arg2, class612 arg3, class594 arg4, class510 arg5, class567 arg6, class553 arg7) {
		if (this.field5006 * 1728403699 != -1) {
			return arg3.method12565(this.field5006 * 1728403699).method12512(arg0, arg1, arg6, arg7, null);
		}
		int var9 = arg7 == null ? arg1 : arg1 | arg7.method11779();
		class451 var10 = field4998;
		class13 var11;
		synchronized (field4998) {
			var11 = (class13) field4998.method7916(this.field5007 * 6766985991377109581L);
		}
		if (var11 == null || arg0.method519(var11.method329(), var9) != 0) {
			...
			var11 = arg0.method625(var25, var26, Statics.field3537 * -316841981, 64, 768);
			...
			synchronized (field4998) {
				field4998.method7937(var11, this.field5007 * 6766985991377109581L);
			}
		}
		if (arg7 == null) {
			return var11;
	...
	public class13 method8257(class14 arg0, int arg1, class205 arg2, class510 arg3, class553 arg4, int arg5, int arg6, int arg7) {
		...
		if (var13 == null || arg0.method519(var13.method329(), var9) != 0) {
			...
			var13 = arg0.method625(var21, var22, Statics.field3537 * -316841981, 64, 768);
