...
public class class480 {
	...
	public class480(class527 arg0, class519 arg1, class334 arg2, boolean arg3) {
		...
		if (this.field5054 == null) {
			...
			this.field5053 = this.field5054.method5637(class161.field1660.field1668 * 734175259) * 1481057621;
		}
		if (arg3) {
			this.field5055 = new class481[this.field5053 * 847228925];
			for (int var5 = 0; var5 < this.field5053 * 847228925; var5++) {
				class334 var6 = this.field5054;
				byte[] var7;
				synchronized (this.field5054) {
					var7 = this.field5054.method5627(class161.field1660.field1668 * 734175259, var5);
				}
	...
	public int method8402(class567 arg0) {
		int var2 = 0;
		for (int var3 = 0; var3 < this.field5053 * 847228925; var3++) {
			class481 var4 = this.method8401(var3);
			if (var4.method8429(arg0)) {
				var2 += var4.field5065 * -1927173183;
			}
		}
		return var2;
	}
