...
public class class492 {
	...
	@ObfuscatedName("rh.j")
	public int field5147 = 121825412;
	...
	@ObfuscatedName("rh.m")
	public int field5151 = -1383778884;

	@ObfuscatedName("rh.l")
	public int field5160 = -1963911756;

	@ObfuscatedName("rh.d")
	public int field5164 = -1061525333;

	@ObfuscatedName("rh.z")
	public int field5156 = 784626609;
	...
	@ObfuscatedName("rh.x")
	public int field5163 = -254296386;

	@ObfuscatedName("rh.i")
	public boolean field5157 = true;

	@ObfuscatedName("rh.v")
	public int field5165 = -1336880911;

	@ObfuscatedName("rh.k")
	public int field5166 = 2020038783;

	@ObfuscatedName("rh.h")
	public int field5167 = -389833571;

	public class492(class334 arg0) {
		byte[] var2 = arg0.method5635(class491.field5141.field5145 * -1832333129);
		...
		while (true) {
			while (true) {
				...
				if (var3 == 1) {
					...
					this.field5156 = arg0.method15411() * -784626609;
				} else if (var3 == 3) {
					this.field5147 = arg0.method15220() * -2117027295;
					this.field5155 = new int[this.field5147 * 223955425];
					this.field5148 = new int[this.field5147 * 223955425];
				} else if (var3 == 4) {
					this.field5159 = false;
				} else if (var3 == 5) {
					this.field5162 = arg0.method15241() * -1529716007;
				} else if (var3 == 6) {
					this.field5158 = arg0.method15241() * -504348183;
				} else if (var3 == 7) {
					...
					this.field5163 = arg0.method15220() * -127148193;
				} else if (var3 == 10) {
					this.field5157 = false;
				} else if (var3 == 11) {
					this.field5165 = arg0.method15220() * 986028795;
				} else if (var3 == 12) {
					this.field5166 = arg0.method15239() * -2020038783;
					this.field5167 = arg0.method15239() * 389833571;
				} else if (var3 == 13) {
					this.field5160 = arg0.method15220() * 1656505709;
				} else if (var3 == 14) {
					this.field5151 = arg0.method15220() * 1801538927;
				} else if (var3 == 15) {
					this.field5164 = arg0.method15220() * 1075487037;
				}
			}
		}
	}
