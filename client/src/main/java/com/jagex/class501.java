...
public class class501 {
	...
	public class501(class453 arg0, int arg1, int arg2, int arg3) {
		this.field5196 = arg0;
		this.field5195 = arg1 * 220219155;
		this.field5194 = arg3 * 375438379;
	}

	@ObfuscatedName("ro.u(I)I")
	public int method8722() {
		return client.field8986[this.field5195 * 623942427];
	}
	...
	public class113 method8725() {
		...
		if (var1 == null) {
			return null;
		} else if (var1.method2401() == this.field5194 * 528884355) {
			return var1;
		} else {
			return null;
		}
	...
	public class113 method8723() {
		int var1 = this.field5196.field4837 * -1918843867;
		class453 var2 = client.field8980.method6214();
		int var3 = this.field5196.field4836 * 401083797 - var2.field4836 * 401083797;
		int var4 = this.field5196.field4838 * -526848045 - var2.field4838 * -526848045;
