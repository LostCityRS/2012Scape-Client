...
public class class509 {
	...
	@ObfuscatedName("so.l")
	public int field6336 = 1868335677;

	@ObfuscatedName("so.f")
	public boolean[] field6324;

	@ObfuscatedName("so.d")
	public int field6325 = -867817507;

	@ObfuscatedName("so.z")
	public int field6326 = -1993566501;

	@ObfuscatedName("so.n")
	public int field6327 = -1133621257;

	@ObfuscatedName("so.o")
	public int field6328 = 1969418597;

	@ObfuscatedName("so.q")
	public int field6323 = -1953513431;

	@ObfuscatedName("so.p")
	public int field6330 = 417034067;

	@ObfuscatedName("so.w")
	public int field6331 = 1958937210;
	...
	@ObfuscatedName("so.g")
	public int field6339 = -176895671;
	...
	public void method11123(class814 arg0, int arg1) {
		if (arg1 == 1) {
			...
			this.field6336 = arg0.method15239() * -1868335677;
		} else if (arg1 == 3) {
			...
			this.field6325 = arg0.method15220() * 1544423417;
		} else if (arg1 == 6) {
			this.field6326 = arg0.method15239() * 1993566501;
		} else if (arg1 == 7) {
			this.field6327 = arg0.method15239() * 1133621257;
		} else if (arg1 == 8) {
			this.field6328 = arg0.method15220() * 2015534487;
		} else if (arg1 == 9) {
			this.field6323 = arg0.method15220() * 1953513431;
		} else if (arg1 == 10) {
			this.field6330 = arg0.method15220() * -417034067;
		} else if (arg1 == 11) {
			this.field6331 = arg0.method15220() * 979468605;
		} else if (arg1 == 12) {
			...
			if (arg1 == 18) {
				...
				this.field6339 = arg0.method15220() * 176895671;
			} else if (arg1 == 249) {
	...
	public void method11124() {
		if (this.field6323 * -899406873 == -1) {
			if (this.field6324 == null) {
				this.field6323 = 0;
			} else {
				this.field6323 = -387940434;
			}
		}
		if (this.field6330 * 1726698277 != -1) {
			return;
		}
		if (this.field6324 == null) {
			this.field6330 = 0;
		} else {
			this.field6330 = -834068134;
		}
	}
