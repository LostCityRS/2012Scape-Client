...
public class class529 {
	...
	public class529(class527 arg0, class519 arg1, class334 arg2) {
		...
		if (this.field6414 != null) {
			this.field6414.method5637(class161.field1650.field1668 * 734175259);
		}
	}
	...
	public class528 method11311(int arg0) {
		...
		byte[] var5 = this.field6414.method5627(class161.field1650.field1668 * 734175259, arg0);
		class528 var6 = new class528();
		if (var5 != null) {
			var6.method11304(new class814(var5));
		}
