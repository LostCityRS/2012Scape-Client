...
public class class532 {
	...
	public class532() throws Throwable {
		throw new Error();
	}

	@ObfuscatedName("of.j([BI)V")
	public static synchronized void method7068(byte[] arg0) {
		if (arg0.length == 100 && field6417 * 242823223 < 1000) {
			field6418[(field6417 += -1798470265) * 242823223 - 1] = arg0;
		} else if (arg0.length == 5000 && field6415 * -997196967 < 250) {
			field6416[(field6415 += -1562731287) * -997196967 - 1] = arg0;
		} else if (arg0.length == 30000 && field6419 * 1281494137 < 50) {
			field6420[(field6419 += -1127309879) * 1281494137 - 1] = arg0;
