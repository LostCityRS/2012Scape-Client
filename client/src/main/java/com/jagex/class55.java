...
public class class55 {
	...
	@ObfuscatedName("ag.d")
	public static class39[] field733 = new class39[2048];
	...
	public static final void method12667(class964 arg0) {
		...
		Statics.field7324 = (var2.field9807 = var2.field9809 = var4) * 1246573567;
		...
		field732 = 0;
		field727[(field732 += 1838079723) * -605693501 - 1] = var1;
		field729[var1] = 0;
		field736 = 0;
		for (int var8 = 1; var8 < 2048; var8++) {
			if (var1 != var8) {
				...
				int var12 = var9 & 0xFF;
				class39 var13 = field733[var8] = new class39();
				var13.field570 = ((var10 << 28) + (var11 << 14) + var12) * 354749879;
				var13.field572 = 0;
				var13.field569 = 1480252667;
				var13.field571 = false;
				var13.field568 = false;
				field735[(field736 += -1469912603) * -1068225555 - 1] = var8;
				field729[var8] = 0;
			}
		}
		arg0.method16881();
	...
	public static final void method1805(class964 arg0, int arg1) {
		...
		method11491(arg0);
		method15865(arg0);
		if (arg0.field9626 * 803401371 != arg1) {
			throw new RuntimeException(arg0.field9626 * 803401371 + " " + arg1);
		}
	}
	...
	public static final void method11491(class964 arg0) {
		int var1 = 0;
		arg0.method16862();
		for (int var2 = 0; var2 < field732 * -605693501; var2++) {
		...
		arg0.method16862();
		for (int var5 = 0; var5 < field732 * -605693501; var5++) {
		...
		arg0.method16862();
		for (int var8 = 0; var8 < field736 * -1068225555; var8++) {
		...
		arg0.method16862();
		for (int var11 = 0; var11 < field736 * -1068225555; var11++) {
		...
		for (int var14 = 1; var14 < 2048; var14++) {
			...
			if (var15 == null) {
				field735[(field736 += -1469912603) * -1068225555 - 1] = var14;
			} else {
				field727[(field732 += 1838079723) * -605693501 - 1] = var14;
			}
		}
	}
	...
	public static final void method15865(class964 arg0) {
		for (int var1 = 0; var1 < field728 * -1736437031; var1++) {
	...
	public static final void method11159(class964 arg0, int arg1, class902 arg2, int arg3) {
		...
		if ((arg3 & 0x4) != 0) {
			...
			if (var5 > 0) {
				for (int var6 = 0; var6 < var5; var6++) {
					...
					arg2.method13953(var10, var11, var7, var9, client.field9213 * 1194705519, var12);
				}
			}
			...
			if (var13 > 0) {
				for (int var14 = 0; var14 < var13; var14++) {
					...
					if (var16 == 32767) {
						...
						arg2.method13944(var15, client.field9213 * 1194705519, var16, var17, var18, var19);
					}
				}
			}
		}
		if ((arg3 & 0x40000) != 0) {
			...
			arg2.field8626 = (client.field9213 * 1194705519 + arg0.method15281()) * 1013492567;
			arg2.field8632 = (client.field9213 * 1194705519 + arg0.method15239()) * 288428173;
		}
		if ((arg3 & 0x100000) != 0) {
			int var20 = arg0.field9629[(arg0.field9626 += -1748220013) * 803401371 - 1] & 0xFF;
		...
		if ((arg3 & 0x10) != 0) {
			...
			arg2.field8624 = var24 * -1342544125;
		}
		if ((arg3 & 0x40) != 0) {
		...
		if ((arg3 & 0x80000) != 0) {
			...
			int var28 = arg0.field9629[(arg0.field9626 += -1748220013) * 803401371 - 1] & 0xFF;
		...
		if ((arg3 & 0x2) != 0) {
			arg2.field10058 = arg0.method15391() * -1084435625;
			if (arg2.field8628 * 2126611325 == 0) {
				arg2.method14013(arg2.field10058 * -1276262297);
				arg2.field10058 = 1084435625;
			}
		}
		if ((arg3 & 0x1) != 0) {
		...
		if ((arg3 & 0x200) != 0) {
			arg2.field8619 = arg0.method15238() * -1795775899;
			arg2.field8621 = arg0.method15238() * -1490433585;
			arg2.field8591 = arg0.method15392() * -895834281;
			arg2.field8605 = arg0.method15238() * 1745529363;
			arg2.field8649 = (arg0.method15391() + client.field9213 * 1194705519) * 1276030889;
			arg2.field8620 = (arg0.method15391() + client.field9213 * 1194705519) * 1884085313;
			arg2.field8625 = arg0.method15239() * -247742187;
			if (arg2.field10062) {
				arg2.field8619 += arg2.field10052 * -1800663845;
				arg2.field8621 += arg2.field10064 * 972556991;
				arg2.field8591 += arg2.field10052 * 1582571625;
				arg2.field8605 += arg2.field10064 * -1737334973;
				arg2.field8628 = 0;
			} else {
				arg2.field8619 += arg2.field8642[0] * -1795775899;
				arg2.field8621 += arg2.field8643[0] * -1490433585;
				arg2.field8591 += arg2.field8642[0] * -895834281;
				arg2.field8605 += arg2.field8643[0] * 1745529363;
				arg2.field8628 = 1057312213;
			}
			arg2.field8646 = 0;
		}
		if ((arg3 & 0x4000) != 0) {
		...
		if (var4 == 127) {
			arg2.method16123(arg2.field10052 * 954555967, arg2.field10064 * 447814673);
			return;
		}
		byte var73;
		if (class365.field3923.field3924 == var4) {
			var73 = field730[arg1];
		} else {
			var73 = var4;
		}
		client.method12736(arg2, var73);
		arg2.method16131(arg2.field10052 * 954555967, arg2.field10064 * 447814673, var73);
	}
	...
	public static void method15786() {
		...
		for (int var0 = 0; var0 < 2048; var0++) {
			field731[var0] = null;
			field730[var0] = class365.field3921.field3924;
			field733[var0] = null;
		}
	}
}
