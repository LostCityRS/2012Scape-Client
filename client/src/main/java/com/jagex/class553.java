...
public class class553 {
	...
	public final int method11812() {
		return this.field6671 == null ? -1 : this.field6671.field6318 * -730727511;
	}
	...
	public final void method11775(int arg0, int arg1, int arg2, boolean arg3, boolean arg4) {
		...
		if (arg0 == -1) {
			...
			if (this.field6671 == null || this.field6671.field6318 * -730727511 != arg0) {
				this.field6671 = Statics.field8530.method11144(arg0);
			} else if (this.field6671.field6331 * -75735531 == 0) {
				return;
			}
			this.field6678 = 0;
			this.field6673 = arg1 * -1735944583;
			this.field6679 = arg2 * 2036416805;
			this.field6680 = arg4;
			if (arg3) {
				this.field6670 = (int) (Math.random() * (double) this.field6671.field6329.length) * -809781803;
				this.field6672 = (int) (Math.random() * (double) this.field6671.field6321[this.field6670 * 404740989]) * 1246942937;
			} else {
				this.field6670 = 0;
				this.field6672 = 0;
			}
			this.field6675 = this.field6670 * 629849387 + 1201130439;
			if (this.field6675 * 2062845431 < 0 || this.field6675 * 2062845431 >= this.field6671.field6329.length) {
				this.field6675 = -1201130439;
			}
			if (this.field6673 * -504958007 == 0) {
				this.method11789(this.field6671, this.field6670 * 404740989);
			}
	...
	public final int method11779() {
		...
		int var1 = 0;
		if (this.method11790()) {
			var1 |= this.field6681.field6685 * 1502633191;
			if (this.field6677 && this.field6671.field6320 != null) {
				var1 |= this.field6682.field6685 * 1502633191;
			}
		}
		return var1;
	}
	...
	public final void method11780(class13 arg0, int arg1) {
		if (this.field6671 != null && (this.field6671.field6329 != null && this.method11790())) {
			arg0.method375(this.field6681.field6687, this.field6681.field6689 * -744637829, this.field6681.field6688, this.field6681.field6686 * -1498610537, this.field6672 * 630344041, this.field6671.field6321[this.field6670 * 404740989], arg1, this.field6671.field6332);
			if (this.field6677 && this.field6671.field6320 != null && this.field6682.field6684) {
				arg0.method375(this.field6682.field6687, this.field6682.field6689 * -744637829, this.field6682.field6688, this.field6682.field6686 * -1498610537, this.field6672 * 630344041, this.field6671.field6321[this.field6670 * 404740989], arg1, this.field6671.field6332);
			}
		}
	}
	...
	public final void method11765(class13 arg0, int arg1, int arg2) {
		if (this.field6671.field6329 != null && this.method11790()) {
			arg0.method260(this.field6681.field6687, this.field6681.field6689 * -744637829, this.field6681.field6688, this.field6681.field6686 * -1498610537, this.field6672 * 630344041, this.field6671.field6321[this.field6670 * 404740989], arg1, arg2, this.field6671.field6332, null);
			if (this.field6677 && this.field6671.field6320 != null && this.field6682.field6684) {
				arg0.method260(this.field6682.field6687, this.field6682.field6689 * -744637829, this.field6682.field6688, this.field6682.field6686 * -1498610537, this.field6672 * 630344041, this.field6671.field6321[this.field6670 * 404740989], arg1, arg2, this.field6671.field6332, null);
			}
		}
	}
	...
	public final void method11782(class13 arg0) {
		if (this.field6671.field6329 != null && this.method11790()) {
			arg0.method262(this.field6681.field6687, this.field6681.field6689 * -744637829);
			if (this.field6677 && this.field6671.field6320 != null && this.field6682.field6684) {
				arg0.method262(this.field6682.field6687, this.field6682.field6689 * -744637829);
			}
		}
	}
	...
	public final boolean method11787(int arg0) {
		...
		if (this.field6673 * -504958007 > 0) {
			if (this.field6673 * -504958007 >= arg0) {
				this.field6673 -= arg0 * -1735944583;
				return false;
			}
			arg0 -= this.field6673 * -504958007;
			this.field6673 = 0;
			this.method11789(this.field6671, this.field6670 * 404740989);
		}
		int var2 = this.field6672 * 630344041 + arg0;
		boolean var3 = this.field6671.field6333 | class509.field6319;
		if (var2 > 100 && this.field6671.field6336 * -226155797 > 0) {
			int var4 = this.field6671.field6329.length - this.field6671.field6336 * -226155797;
			while (this.field6670 * 404740989 < var4 && var2 > this.field6671.field6321[this.field6670 * 404740989]) {
				var2 -= this.field6671.field6321[this.field6670 * 404740989];
				this.field6670 += -809781803;
			}
			if (this.field6670 * 404740989 >= var4) {
				int var5 = 0;
				for (int var6 = var4; var6 < this.field6671.field6329.length; var6++) {
					var5 += this.field6671.field6321[var6];
				}
				if (this.field6679 * -783617363 == 0) {
					this.field6678 += var2 / var5 * 2059044979;
				}
				var2 %= var5;
			}
			this.field6675 = this.field6670 * 629849387 + 1201130439;
			if (this.field6675 * 2062845431 >= this.field6671.field6329.length) {
				if (this.field6671.field6336 * -226155797 == -1 && this.field6680) {
					this.field6675 = 0;
				} else {
					this.field6675 -= this.field6671.field6336 * -573866579;
				}
				if (this.field6675 * 2062845431 < 0 || this.field6675 * 2062845431 >= this.field6671.field6329.length) {
					this.field6675 = -1201130439;
				}
		...
		while (var2 > this.field6671.field6321[this.field6670 * 404740989]) {
			var3 = true;
			var2 -= this.field6671.field6321[(this.field6670 += -809781803) * 404740989 - 1];
			if (this.field6670 * 404740989 >= this.field6671.field6329.length) {
				if (this.field6671.field6336 * -226155797 != -1 && this.field6679 * -783617363 != 2) {
					this.field6670 -= this.field6671.field6336 * 1897870471;
					if (this.field6679 * -783617363 == 0) {
						this.field6678 += 2059044979;
					}
				}
				if (this.field6678 * 3628219 >= this.field6671.field6328 * -1427000793 || this.field6670 * 404740989 < 0 || this.field6670 * 404740989 >= this.field6671.field6329.length) {
					this.field6668 = true;
					break;
				}
			}
		...
		this.field6672 = var2 * 1246942937;
		if (var3) {
			this.method11801();
		}
		return var3;
	...
	public final boolean method11788(int arg0) {
		int var2;
		return this.field6671 == null | (var2 = arg0 - this.field6673 * -504958007) <= 0 ? false : this.field6671.field6333 | this.field6672 * 630344041 + var2 > this.field6671.field6321[this.field6670 * 404740989];
	}
	...
	public final boolean method11790() {
		...
		boolean var1 = this.field6681.method11837(Statics.field8530, this.field6671, this.field6670 * 404740989, this.field6675 * 2062845431, this.field6671.field6329);
		if (var1 && this.field6677 && this.field6671.field6320 != null) {
			this.field6682.method11837(Statics.field8530, this.field6671, this.field6670 * 404740989, this.field6675 * 2062845431, this.field6671.field6320);
		}
		return var1;
	}
