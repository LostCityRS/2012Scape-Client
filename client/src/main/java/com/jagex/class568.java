...
public final class class568 {
	...
	public final int method11968() {
		if (this.field6733 * -363750565 == 0) {
			this.method11969();
			this.field6733 = 1830605568;
		}
		return this.field6736[(this.field6733 -= 611130579) * -363750565];
	}
	...
	public final int method11963() {
		...
		return this.field6736[this.field6733 * -363750565 - 1];
	}

	@ObfuscatedName("ue.a(I)V")
	public final void method11969() {
		this.field6740 += (this.field6735 += 2088553709) * 1703260379;
		for (int var1 = 0; var1 < 256; var1++) {
			int var2 = this.field6737[var1];
			if ((var1 & 0x2) == 0) {
				if ((var1 & 0x1) == 0) {
					this.field6739 = (this.field6739 * -2133116189 ^ this.field6739 * -2133116189 << 13) * -2040407349;
				} else {
					this.field6739 = (this.field6739 * -2133116189 ^ this.field6739 * -2133116189 >>> 6) * -2040407349;
				}
			} else if ((var1 & 0x1) == 0) {
				this.field6739 = (this.field6739 * -2133116189 ^ this.field6739 * -2133116189 << 2) * -2040407349;
			} else {
				this.field6739 = (this.field6739 * -2133116189 ^ this.field6739 * -2133116189 >>> 16) * -2040407349;
			}
			this.field6739 += this.field6737[var1 + 128 & 0xFF] * -2040407349;
			int var3;
			this.field6737[var1] = var3 = this.field6740 * 1934307647 + this.field6739 * -2133116189 + this.field6737[var2 >> 2 & 0xFF];
			this.field6736[var1] = (this.field6740 = (this.field6737[var3 >> 8 >> 2 & 0xFF] + var2) * 1137131199) * 1934307647;
		}
	}
