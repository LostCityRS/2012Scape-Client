...
public class class574 {
	...
	@ObfuscatedName("uu.z")
	public static int field6780 = 639929161;
	...
	public static void method11538() {
		...
		if (field6783 * 906647541 < Statics.field4871 * 784360307) {
			field6783 = Statics.field4871 * 261059783;
		}
		while (true) {
			while (field6783 * 906647541 < Statics.field4875 * 782396265) {
				class832 var0 = class461.method3630(field6783 * 906647541);
				if (var0 != null && var0.field9800 * -323553733 == -1) {
					if (field6781 == null) {
						field6781 = client.field9192.method8637(var0.field9797);
					}
					int var1 = field6781.field5178 * 546704077;
					if (var1 == -1) {
						return;
					}
					var0.field9800 = var1 * 1563063027;
					field6783 += -1059431331;
					field6781 = null;
				} else {
					field6783 += -1059431331;
				}
	...
	public static boolean method8621(int arg0, String arg1) {
		...
		Statics.field6772.field6768 = arg0 * -1308300843;
		Statics.field6772.field6765 = arg1;
		if (Statics.field6683 != class515.field6368) {
			Statics.field6772.field6764 = Statics.field6772.field6768 * -2091197685 + -851669568;
			Statics.field6772.field6766 = Statics.field6772.field6768 * -1966902117 + 123249200;
		}
		return true;
	}
	...
	public static void method1716(String arg0, int arg1) {
		...
		Statics.field6782.field6768 = (arg1 + 1099) * -1308300843;
	...
	public static void method2587(boolean arg0, byte[] arg1) {
		...
		class461.method6034(Statics.field6778.field9629);
		field6771 = new class832[Statics.field4876 * -2046190821];
		int var2 = 0;
		for (int var3 = Statics.field4871 * 784360307; var3 <= Statics.field4875 * 782396265; var3++) {
		...
		field6777 = false;
		Statics.field6356 = class153.method5554() * 3107337940677782605L;
	...
	public static class832 method3647() {
		return field6780 * -903072157 < field6771.length ? field6771[(field6780 += -231474357) * -903072157 - 1] : null;
	}

	@ObfuscatedName("rc.l(S)Laex;")
	public static class832 method8609() {
		return class461.method3630(Statics.field6772.field6768 * 971048829);
	}
	...
	public static int method3101(class832 arg0, class832 arg1, int arg2, boolean arg3) {
		if (arg2 == 1) {
			int var4 = arg0.field4868 * -124093853;
			int var5 = arg1.field4868 * -124093853;
			if (!arg3) {
				if (var4 == -1) {
					var4 = 2001;
				}
			...
			int var6 = arg0.field9800 * -323553733;
			int var7 = arg1.field9800 * -323553733;
			if (arg3) {
				if (var6 == 1000) {
					var6 = -1;
				}
			...
			return arg0.field9799 * 2071785161 - arg1.field9799 * 2071785161;
		}
	}
}
