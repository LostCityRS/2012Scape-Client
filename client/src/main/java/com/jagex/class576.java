...
public final class class576 {
	...
	public class576(File arg0, String arg1, long arg2) throws IOException {
		if (arg2 == -1L) {
			arg2 = Long.MAX_VALUE;
		}
		if (arg0.length() > arg2) {
		...
		this.field6786 = arg2 * -3681653282245964093L;
		this.field6788 = 0L;
	...
	public final void method12074(long arg0) throws IOException {
		...
		this.field6788 = arg0 * 7792947097860527641L;
	}

	@ObfuscatedName("un.j([BIIB)V")
	public final void method12075(byte[] arg0, int arg1, int arg2) throws IOException {
		if (this.field6788 * 1579585847722485289L + (long) arg2 > this.field6786 * -3663250914858331669L) {
			this.field6787.seek(this.field6786 * -3663250914858331669L);
			this.field6787.write(1);
			throw new EOFException();
		} else {
			this.field6787.write(arg0, arg1, arg2);
			this.field6788 += (long) arg2 * 7792947097860527641L;
		}
	}
	...
	public final int method12078(byte[] arg0, int arg1, int arg2) throws IOException {
		...
		if (var4 > 0) {
			this.field6788 += (long) var4 * 7792947097860527641L;
		}
		return var4;
	}
