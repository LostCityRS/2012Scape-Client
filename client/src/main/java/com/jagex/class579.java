...
public class class579 {
	...
	public void method12122(class814 arg0, int arg1) {
		if (arg1 == 1) {
			...
			this.field6809 = arg0.method15379() * 896336895;
		} else if (arg1 == 5 || arg1 == 6) {
			this.field6812 = arg0.method15239() * 1044153607;
			this.field6810 = new HashMap(this.field6812 * 13228215);
			for (int var6 = 0; var6 < this.field6812 * 13228215; var6++) {
			...
			for (int var4 = 0; var4 < this.field6812 * 13228215; var4++) {
	...
	public int method12123(int arg0) {
		...
		return var2 == null ? this.field6809 * 579009535 : (Integer) var2;
	}
	...
	public int method12128() {
		return this.field6812 * 13228215;
	}
