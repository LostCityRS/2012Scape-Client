...
public class class589 {
	...
	@ObfuscatedName("vg.m")
	public static class344 field7043 = new class344(16, class342.field3710);

	public class589() throws Throwable {
		throw new Error();
	}

	@ObfuscatedName("vg.u(III)V")
	public static void method12214(int arg0, int arg1) {
		if (Statics.field7038 * 1661849899 != arg0) {
			Statics.field7040 = new int[arg0];
			for (int var2 = 0; var2 < arg0; var2++) {
				Statics.field7040[var2] = (var2 << 12) / arg0;
			}
			Statics.field7038 = arg0 * -784833149;
		}
		if (Statics.field7037 * 239749573 == arg1) {
			return;
		}
		if (Statics.field7038 * 1661849899 == arg1) {
		...
		Statics.field7037 = arg1 * 411192589;
	}
