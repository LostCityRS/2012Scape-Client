...
public class class592 implements class464 {
	...
	public void method12237(Packet arg0, int arg1) {
		if (arg1 == 1) {
			...
			for (int var23 = 0; var23 < var21; var23++) {
				...
				class399 var26;
				if (var24) {
					var26 = new class798(arg0.gjstr());
				} else {
					var26 = new IntNode(arg0.g4s());
				}
				this.field7055.pushNode(var26, (long) var25);
			}
		}
	}
	...
	public final class13 method12241(class14 arg0, int arg1, int arg2, class471 arg3, class553 arg4, int arg5, int arg6, int arg7, int arg8) {
		...
		synchronized (this.field7061.field7146) {
			var14 = (class13) this.field7061.field7146.method7916((long) (this.field7062 | arg0.field397 << 29));
		}
	...
	public int[] method12276(class14 arg0, class14 arg1, int arg2, int arg3, int arg4, boolean arg5, int arg6, class15 arg7, class471 arg8) {
		...
		class13 var17 = arg0.method625(var10, var15, 64, this.field7114 + 64, this.field7115 * 5 + 768);
		if (!var17.method291()) {
			return null;
		}
		if (var16) {
		...
		var23.method5106(0.0F, 0.0F, 1.0F, class312.method5096(-this.field7088 << 3));
		var23.method5178(0.0F, 1.0F, 0.0F, class312.method5096(this.field7077 << 3));
		var23.method5116((float) (this.field7076 << 2), (float) ((class312.field3439[this.field7073 << 3] * var19 >> 14) - var17.method278() / 2 + (this.field7075 << 2)), (float) ((this.field7075 << 2) + (class312.field3447[this.field7073 << 3] * var19 >> 14)));
		var23.method5178(1.0F, 0.0F, 0.0F, class312.method5096(this.field7073 << 3));
