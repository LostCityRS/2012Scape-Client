...
public class class594 implements class463 {
	...
	public class594(class527 arg0, class519 arg1, boolean arg2, class614 arg3, class334 arg4, class334 arg5) {
		...
		if (this.field7143 == null) {
			...
			this.field7144 = (var7 * class161.field1675.method3071() + this.field7143.method5637(var7)) * 387993309;
		}
	...
	public class592 method12316(int arg0) {
		...
		var8.field7061 = this;
		var8.field7062 = arg0 * -1221484725;
		...
		var8.method12235();
		if (var8.field7108 * -1478617517 != -1) {
			var8.method12238(this.method12316(var8.field7108 * -1478617517), this.method12316(var8.field7107 * 1050386587));
		}
		if (var8.field7064 * -1014988067 != -1) {
			var8.method12258(this.method12316(var8.field7064 * -1014988067), this.method12316(var8.field7109 * 767442155));
		}
		if (var8.field7123 * 63580447 != -1) {
			var8.method12240(this.method12316(var8.field7123 * 63580447), this.method12316(var8.field7122 * 1903043789));
		}
		if (!this.field7142 && var8.field7099) {
			...
			if (var8.field7055 != null) {
				...
				for (class399 var10 = var8.field7055.method11928(); var10 != null; var10 = var8.field7055.method11929()) {
					class613 var11 = this.field7141.method12600((int) (var10.field4228 * 4763964654233859639L));
					if (var11.field7289) {
						var10.method6979();
					} else {
						var9 = true;
	...
	public class118 method12293(class14 arg0, int arg1, int arg2, int arg3, int arg4, int arg5, class471 arg6) {
		this.field7148.field7047 = arg0.field397 * -285262137;
		this.field7148.field7052 = arg1 * 988893929;
		this.field7148.field7049 = arg2 * -266349153;
		this.field7148.field7050 = arg3 * -1985717939;
		this.field7148.field7048 = arg4 * 1260360335;
		this.field7148.field7051 = arg5 * -558290179;
	...
	public class118 method12294(class14 arg0, class14 arg1, int arg2, int arg3, int arg4, int arg5, boolean arg6, boolean arg7, int arg8, class15 arg9, class471 arg10) {
		...
		if (!arg7) {
			...
			var18.field7047 = arg1.field397 * -285262137;
			var18.field7052 = arg2 * 988893929;
			var18.field7049 = arg3 * -266349153;
			var18.field7050 = arg4 * -1985717939;
			var18.field7048 = arg5 * 1260360335;
			var18.field7051 = arg8 * -558290179;
