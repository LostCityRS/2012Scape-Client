...
public class class601 {
	...
	public class601(class527 arg0, class519 arg1, class334 arg2, boolean arg3) {
		this.field7172 = arg2;
		this.field7171 = this.field7172.method5637(class161.field1651.field1668 * 734175259) * -1575194103;
		if (arg3) {
			this.field7170 = new class956[this.field7171 * 797752377];
			for (int var5 = 0; var5 < this.field7171 * 797752377; var5++) {
				class334 var6 = this.field7172;
				byte[] var7;
				synchronized (this.field7172) {
					var7 = this.field7172.method5627(class161.field1651.field1668 * 734175259, var5);
				}
