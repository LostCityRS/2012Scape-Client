...
public class class603 {
	...
	public class603(byte[] arg0) {
		...
		if (var4) {
			...
			this.field7175 = (var5[32] + var6[32]) * 1807445699;
		} else {
			this.field7175 = var2.method15220() * 1807445699;
		}
		var2.method15220();
		var2.method15220();
		this.field7176 = var2.method15220() * -1995897105;
		this.field7177 = var2.method15220() * -483076099;
	}
	...
	public int method12395(String arg0, int arg1, int arg2, class602[] arg3) {
		if (arg2 == 0) {
			arg2 = this.field7175 * 1248473579;
		}
		int var5 = this.method12398(arg0, new int[] { arg1 }, field7174, arg3);
		int var6 = (var5 - 1) * arg2;
		return this.field7177 * -1610531499 + this.field7176 * 1490085903 + var6;
	}
	...
	public Point method12396(String arg0, int arg1, int arg2, int arg3, class602[] arg4) {
		if (arg3 <= 0) {
			return new Point(0, this.field7176 * 1490085903 + arg2);
		}
		if (arg3 > arg0.length()) {
			arg3 = arg0.length();
		}
		...
		for (int var8 = 0; var8 < var6; var8++) {
			...
			if (var7 + var9 > arg3 || var6 - 1 == var8 && arg3 == arg0.length()) {
				...
				int var13 = this.field7176 * 1490085903 + arg2 * var8;
