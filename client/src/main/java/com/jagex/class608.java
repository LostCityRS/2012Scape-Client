...
public class class608 {
	...
	public void method12483(class814 arg0, int arg1) {
		if (arg1 == 1) {
			this.field7192 = arg0.method15411() * 303995191;
		} else if (arg1 == 2) {
			this.field7194 = arg0.method15241() * 1835509791;
		} else if (arg1 == 3) {
			this.field7195 = true;
		} else if (arg1 == 4) {
			this.field7192 = -303995191;
		}
	}

	@ObfuscatedName("vc.a(Lra;IZI)Lce;")
	public class118 method12484(class14 arg0, int arg1, boolean arg2) {
		long var4 = (long) (this.field7192 * -711562105 | arg1 << 16 | (arg2 ? 262144 : 0) | arg0.field397 * 1002839359 << 19);
		class118 var6 = (class118) this.field7193.field7202.method7916(var4);
		if (var6 != null) {
			return var6;
		} else if (this.field7193.field7199.method5630(this.field7192 * -711562105)) {
			class140 var7 = class125.method2590(this.field7193.field7199, this.field7192 * -711562105, 0);
			if (var7 != null) {
				var7.method2776();
				if (arg2) {
					var7.method2778();
	...
	public boolean method12485() {
		return this.field7193.field7199.method5630(this.field7192 * -711562105);
	}
}
