...
public class class611 {
	...
	@ObfuscatedName("wq.d")
	public int field7217 = -454170173;
	...
	@ObfuscatedName("wq.g")
	public int field7222 = 573299901;

	@ObfuscatedName("wq.y")
	public boolean field7232 = true;

	@ObfuscatedName("wq.e")
	public int field7233 = 1284195561;

	@ObfuscatedName("wq.ay")
	public int field7235 = 1846634624;

	@ObfuscatedName("wq.af")
	public int field7208 = 911331200;
	...
	public int field7231 = 724916303;

	@ObfuscatedName("wq.ao")
	public int field7242 = 1313380851;

	@ObfuscatedName("wq.al")
	public int field7241 = -1910328928;

	@ObfuscatedName("wq.at")
	public int[] field7244;

	@ObfuscatedName("wq.ax")
	public int field7245 = -768152701;

	@ObfuscatedName("wq.aw")
	public int field7219 = -1994343401;
	...
	public int field7257 = 2087158535;

	@ObfuscatedName("wq.aq")
	public int field7258 = 58337981;

	@ObfuscatedName("wq.ab")
	public int field7223 = 91827077;

	@ObfuscatedName("wq.bq")
	public int field7260 = -954648655;
	...
	public int field7263 = 1196530033;

	@ObfuscatedName("wq.bf")
	public boolean field7264;

	@ObfuscatedName("wq.bt")
	public class565 field7265;

	@ObfuscatedName("wq.bg")
	public int field7266 = 781829403;

	@ObfuscatedName("wq.bl")
	public class364 field7243 = class364.field3912;

	@ObfuscatedName("wq.bk")
	public int field7268 = -1209505519;
	...
	public int field7229 = -256535573;

	@ObfuscatedName("wq.bd")
	public int field7250 = -1020083968;

	@ObfuscatedName("wq.bc")
	public int field7273 = -690533120;
	...
	public void method12507(class814 arg0) {
		while (true) {
	...
	public void method12508(class814 arg0, int arg1) {
		if (arg1 == 1) {
			...
			this.field7213 = arg0.method15220() * 66103571;
			...
			this.field7233 = arg0.method15239() * -1284195561;
		} else if (arg1 == 97) {
			this.field7235 = arg0.method15239() * 886842065;
		} else if (arg1 == 98) {
			this.field7208 = arg0.method15239() * 40674207;
		} else if (arg1 == 99) {
			this.field7246 = true;
		} else if (arg1 == 100) {
			this.field7239 = arg0.method15238() * -628207263;
		} else if (arg1 == 101) {
			this.field7240 = arg0.method15238() * 1584054435;
		} else if (arg1 == 102) {
			this.field7231 = arg0.method15239() * -724916303;
		} else if (arg1 == 103) {
			this.field7241 = arg0.method15239() * 1819350413;
		} else if (arg1 == 106 || arg1 == 118) {
			this.field7245 = arg0.method15239() * 768152701;
			if (this.field7245 * 249562325 == 65535) {
				this.field7245 = -768152701;
			}
			this.field7219 = arg0.method15239() * 1994343401;
			if (this.field7219 * 1248576601 == 65535) {
				this.field7219 = -1994343401;
			}
			int var36 = -1;
			if (arg1 == 118) {
			...
			this.field7266 = arg0.method15239() * -781829403;
		} else if (arg1 == 125) {
			this.field7243 = (class364) class518.method8032(Statics.method3921(), arg0.method15238());
		} else if (arg1 == 127) {
			this.field7217 = arg0.method15239() * 454170173;
		} else if (arg1 == 128) {
			class518.method8032(class365.method2553(), arg0.method15220());
		} else if (arg1 == 134) {
			this.field7257 = arg0.method15239() * -2087158535;
			if (this.field7257 * -569408183 == 65535) {
				this.field7257 = 2087158535;
			}
			this.field7258 = arg0.method15239() * -58337981;
			if (this.field7258 * -106668181 == 65535) {
				this.field7258 = 58337981;
			}
			this.field7223 = arg0.method15239() * -91827077;
			if (this.field7223 * 1932782259 == 65535) {
				this.field7223 = 91827077;
			}
			this.field7260 = arg0.method15239() * 954648655;
			if (this.field7260 * -1321513297 == 65535) {
				this.field7260 = -954648655;
			}
			this.field7261 = arg0.method15220() * 1636177691;
		} else if (arg1 == 135 || arg1 == 136) {
			arg0.method15220();
			arg0.method15239();
		} else if (arg1 == 137) {
			this.field7222 = arg0.method15239() * -573299901;
		} else if (arg1 == 138) {
			this.field7242 = arg0.method15411() * -1313380851;
		} else if (arg1 == 140) {
			this.field7263 = arg0.method15220() * 1554249103;
		} else if (arg1 == 141) {
			this.field7238 = true;
		} else if (arg1 == 142) {
			this.field7268 = arg0.method15239() * 1209505519;
		} else if (arg1 == 143) {
			this.field7237 = true;
			...
			this.field7229 = arg0.method15220() * 256535573;
		} else if (arg1 == 164) {
			this.field7250 = arg0.method15239() * -792513855;
			this.field7273 = arg0.method15239() * 433510221;
		} else if (arg1 == 165) {
			this.field7274 = arg0.method15220() * -2119776461;
		} else if (arg1 == 168) {
			this.field7262 = arg0.method15220() * 826597593;
		} else if (arg1 == 169) {
			...
			if (this.field7265 == null) {
				int var31 = class595.method2839(var30);
				this.field7265 = new class565(var31);
			}
			for (int var32 = 0; var32 < var30; var32++) {
				...
				class399 var35;
				if (var33) {
					var35 = new class798(arg0.method15337());
				} else {
	...
	public final class13 method12510(class14 arg0, int arg1, class440 arg2, class567 arg3, class553 arg4, class553 arg5, class553[] arg6, int[] arg7, int arg8, class610 arg9) {
		return this.method12541(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, this.field7217 * -1527467755, true);
	}

	@ObfuscatedName("wq.c(Lra;ILpn;Lug;Ltt;Ltt;[Ltt;[IILwf;IZB)Lqa;")
	public final class13 method12541(class14 arg0, int arg1, class440 arg2, class567 arg3, class553 arg4, class553 arg5, class553[] arg6, int[] arg7, int arg8, class610 arg9, int arg10, boolean arg11) {
		if (this.field7244 != null) {
			class611 var13 = this.method12516(arg3);
			return var13 == null ? null : var13.method12541(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
		}
		int var14 = arg1;
		if (this.field7208 * -1681147809 != 128) {
			var14 = arg1 | 0x2;
		}
		if (this.field7235 * -1761511887 != 128) {
			var14 |= 0x5;
		}
		boolean var15 = false;
		...
		long var18 = (long) (this.field7211 * -965898599 | arg0.field397 * 1002839359 << 16);
		if (arg9 != null) {
			var18 |= arg9.field7203 * -7522638899288553177L << 24;
		}
		class451 var20 = this.field7210.field7285;
		class13 var21;
		synchronized (this.field7210.field7285) {
			var21 = (class13) this.field7210.field7285.method7916(var18);
		}
		class439 var23 = null;
		if (!arg11 && arg10 != -1) {
			var23 = arg2.method7784(arg10);
		} else if (this.field7217 * -1527467755 != -1) {
			var23 = arg2.method7784(this.field7217 * -1527467755);
		}
		if (var21 == null || (var21.method329() & var14) != var14) {
			...
			var21 = arg0.method625(var41, var24, this.field7210.field7276 * 1247010861, this.field7239 * 847647393 + 64, this.field7240 * 1404944183 + 850);
			if (this.field7218 != null) {
				short[] var42;
		...
		class13 var48 = var21.method295((byte) 4, var14, true);
		boolean var49 = false;
		if (arg7 != null) {
		...
		if (var49) {
			for (int var55 = 0; var55 < 12; var55++) {
				if (arg7[var55] != -1) {
					...
					class314 var58 = new class314();
					var58.method5106(0.0F, 1.0F, 0.0F, class312.method5096(var57));
		...
		if (this.field7235 * -1761511887 != 128 || this.field7208 * -1681147809 != 128) {
			var48.method245(this.field7235 * -1761511887, this.field7208 * -1681147809, this.field7235 * -1761511887);
		}
	...
	public final class13 method12512(class14 arg0, int arg1, class567 arg2, class553 arg3, class610 arg4) {
		if (this.field7244 != null) {
			class611 var6 = this.method12516(arg2);
			...
			long var8 = (long) (this.field7211 * -965898599 | arg0.field397 * 1002839359 << 16);
			if (arg4 != null) {
				var8 |= arg4.field7203 * -7522638899288553177L << 24;
			}
			class451 var10 = this.field7210.field7283;
			class13 var11;
			synchronized (this.field7210.field7283) {
				var11 = (class13) this.field7210.field7283.method7916(var8);
			}
			if (var11 == null || (var11.method329() & var7) != var7) {
				...
				var11 = arg0.method625(var24, var13, this.field7210.field7276 * 1247010861, 64, 768);
				if (this.field7218 != null) {
					short[] var25;
	...
	public String method12515(int arg0, String arg1) {
		if (this.field7265 == null) {
			...
			class798 var3 = (class798) this.field7265.method11923((long) arg0);
			return var3 == null ? arg1 : (String) var3.field9550;
		}
	}

	@ObfuscatedName("wq.d(Lug;I)Lwq;")
	public final class611 method12516(class567 arg0) {
		int var2 = -1;
		if (this.field7245 * 249562325 != -1) {
			var2 = arg0.method1646(this.field7245 * 249562325);
		} else if (this.field7219 * 1248576601 != -1) {
			var2 = arg0.method1664(this.field7219 * 1248576601);
		}
	...
	public boolean method12511() {
		if (this.field7244 == null) {
			return this.field7257 * -569408183 != -1 || this.field7223 * 1932782259 != -1 || this.field7260 * -1321513297 != -1;
		}
		for (int var1 = 0; var1 < this.field7244.length; var1++) {
			if (this.field7244[var1] != -1) {
				class611 var2 = this.field7210.method12565(this.field7244[var1]);
				if (var2.field7257 * -569408183 != -1 || var2.field7223 * 1932782259 != -1 || var2.field7260 * -1321513297 != -1) {
					return true;
				}
			}
		}
