...
public final class class615 {
	...
	public void method12611(Object arg0, Object arg1) {
		...
		if (var5 == null) {
			...
			this.field7295 += 1290119649;
			if (this.field7295 * -433300959 >= this.field7294.length) {
				this.method12610();
			}
			return;
		}
	...
	public ArrayList method12609() {
		this.method12607();
		ArrayList var1 = new ArrayList(this.field7295 * -433300959);
	...
	public void method12610() {
		...
		for (int var3 = 0; var3 < var2.length; var3++) {
			for (class980 var4 = var2[var3]; var4 != null; var4 = var5) {
				...
				int var6 = var4.field10525 * -548239483 & this.field7294.length - 1;
	...
	public void method12607() {
		while (true) {
			...
			int var2 = var1.field10525 * -548239483 & this.field7294.length - 1;
