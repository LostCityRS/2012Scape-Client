...
public class class62 {
	...
	@ObfuscatedName("aw.o")
	public static int field802 = -18880095;
	...
	public static boolean method5548() {
		return !Statics.method2888(client.field8923 * 1964982599);
	}
	...
	public static void method11854() {
		Statics.field803 = Statics.field2399.field7177 * 726551043 + Statics.field2399.field7176 * -154219143 + 2085049326;
		Statics.field794 = Statics.field9813.field7177 * 1037271257 + Statics.field9813.field7176 * -2126853669 + -1532941590;
	...
	public static void method14213(String[] arg0) {
		if (arg0.length <= 1) {
			...
			field806 += arg0[0].length() * 1067648243;
			return;
		}
		for (int var1 = 0; var1 < arg0.length; var1++) {
			if (arg0[var1].startsWith("pause")) {
				...
				field802 = (var1 + 1) * 18880095;
				Statics.field3306 = (class153.method5554() + (long) (var2 * 1000)) * -293602296364706359L;
				return;
			}
			field798 = arg0[var1];
			method11379(false);
	...
	public static void method12621() {
		if (field793 * 1973407421 < 102) {
			field793 += -1321161858;
		}
		if (field802 * 1409664415 != -1 && Statics.field3306 * 5157984658298033273L < class153.method5554()) {
			for (int var0 = field802 * 1409664415; var0 < Statics.field4817.length; var0++) {
				if (Statics.field4817[var0].startsWith("pause")) {
					...
					field802 = (var0 + 1) * 18880095;
					Statics.field3306 = (class153.method5554() + (long) (var1 * 1000)) * -293602296364706359L;
					return;
				}
		...
		if (client.field9002 * -1046532647 != 0) {
			field797 -= client.field9002 * 820458423;
			if (field797 * -1898285397 >= field796 * -712753993) {
				field797 = field796 * 1275806245 - -679357437;
			}
			if (field797 * -1898285397 < 0) {
				field797 = 0;
			}
			client.field9002 = 0;
		}
		for (int var3 = 0; var3 < client.field8950 * 1674335201; var3++) {
			...
			} else if (var5 == 85 && field806 * -889080773 > 0) {
				field798 = field798.substring(0, field806 * -889080773 - 1) + field798.substring(field806 * -889080773);
				field806 -= 1067648243;
			} else if (var5 == 101 && field806 * -889080773 < field798.length()) {
				field798 = field798.substring(0, field806 * -889080773) + field798.substring(field806 * -889080773 + 1);
			} else if (var5 == 96 && field806 * -889080773 > 0) {
				field806 -= 1067648243;
			} else if (var5 == 97 && field806 * -889080773 < field798.length()) {
				field806 += 1067648243;
			} else if (var5 == 102) {
				field806 = 0;
			} else if (var5 == 103) {
				field806 = field798.length() * 1067648243;
			} else if (var5 == 104 && field799 * -2033797211 < Statics.field792.length) {
				field799 += -715302867;
				method7737();
				field806 = field798.length() * 1067648243;
			} else if (var5 == 105 && field799 * -2033797211 > 0) {
				field799 -= -715302867;
				method7737();
				field806 = field798.length() * 1067648243;
			} else if (class526.method8060(var6) || "\\/.:, _-+[]~@".indexOf(var6) != -1) {
				field798 = field798.substring(0, field806 * -889080773) + client.field8951[var3].method7298() + field798.substring(field806 * -889080773);
				field806 += 1067648243;
			}
		}
		client.field8950 = 0;
	...
	public static void method1958(String arg0) {
		...
		for (int var6 = 0; var6 < var5.length; var6++) {
			for (int var7 = field796 * -712753993; var7 > 0; var7--) {
			...
			if (field796 * -712753993 < Statics.field792.length - 1) {
				field796 += 631726343;
				if (field797 * -1898285397 > 0) {
					field797 += -679357437;
				}
	...
	public static void method12188(class14 arg0) {
		arg0.method659(0, 0, Statics.field4125 * -1227076991, 350);
		arg0.method489(0, 0, Statics.field4125 * -1227076991, 350, field793 * 1973407421 << 24 | 0x332277, 1);
		int var1 = 350 / (Statics.field794 * 1390531293);
		if (field796 * -712753993 > 0) {
			int var2 = 346 - Statics.field794 * 1390531293 - 4;
			int var3 = var1 * var2 / (field796 * -712753993 + var1 - 1);
			int var4 = 4;
			if (field796 * -712753993 > 1) {
				var4 += (field796 * -712753993 - 1 - field797 * -1898285397) * (var2 - var3) / (field796 * -712753993 - 1);
			}
			arg0.method489(Statics.field4125 * -1227076991 - 16, var4, 12, var3, field793 * 1973407421 << 24 | 0x332277, 2);
			for (int var5 = field797 * -1898285397; var5 < field797 * -1898285397 + var1 && var5 < field796 * -712753993; var5++) {
				String[] var6 = class526.method11508(Statics.field792[var5], '\b');
				int var7 = (Statics.field4125 * -1227076991 - 8 - 16) / var6.length;
				for (int var8 = 0; var8 < var6.length; var8++) {
					int var9 = var7 * var8 + 8;
					arg0.method659(var9, 0, var7 + var9 - 8, 350);
					Statics.field560.method833(method3505(var6[var8]), var9, 350 - Statics.field803 * -920655929 - 2 - Statics.field9813.field7177 * -1610531499 - Statics.field794 * 1390531293 * (var5 - field797 * -1898285397), -1, -16777216);
				}
			}
		}
		Statics.field2163.method862("742 1", Statics.field4125 * -1227076991 - 25, 330, -1, -16777216);
		arg0.method659(0, 0, Statics.field4125 * -1227076991, 350);
		arg0.method485(0, 350 - Statics.field803 * -920655929, Statics.field4125 * -1227076991, -1);
		Statics.field670.method833("--> " + method3505(field798), 10, 350 - Statics.field2399.field7177 * -1610531499 - 1, -1, -16777216);
		if (Statics.field578) {
			int var10 = -1;
			if (client.field9213 * 1194705519 % 30 > 15) {
				var10 = 16777215;
			}
			arg0.method486(Statics.field2399.method12418("--> " + method3505(field798).substring(0, field806 * -889080773)) + 10, 350 - Statics.field2399.field7177 * -1610531499 - 11, 12, var10);
		}
		arg0.method753();
		Statics.method4693();
	}
	...
	public static void method7065(String arg0, boolean arg1, boolean arg2) {
		try {
			...
			if (arg0.equals("renderer")) {
				...
				method1958("Vendor: " + var3.field1285 * 510060795);
				method1958("Name: " + var3.field1288);
				method1958("Version: " + var3.field1281 * -188179809);
				method1958("Device: " + var3.field1280);
				method1958("Driver Version: " + var3.field1289 * 5879725974288142749L);
				return;
			}
			if (arg0.equals("heap")) {
				method1958("Heap: " + class385.field4152 * -879006469 + "MB");
				return;
			}
			if (arg0.equalsIgnoreCase("getcamerapos")) {
				class453 var4 = client.field8980.method6214();
				method1958("Pos: " + Statics.field2119.field9807 + "," + ((Statics.field6769 * -1985663873 >> 9) + var4.field4836 * 401083797 >> 6) + "," + ((Statics.field8424 * -1872881929 >> 9) + var4.field4838 * -526848045 >> 6) + "," + ((Statics.field6769 * -1985663873 >> 9) + var4.field4836 * 401083797 & 0x3F) + "," + ((Statics.field8424 * -1872881929 >> 9) + var4.field4838 * -526848045 & 0x3F) + " Height: " + (client.method8663(Statics.field6769 * -1985663873, Statics.field8424 * -1872881929, Statics.field2119.field9807) - Statics.field8423 * -59248273));
				method1958("Look: " + Statics.field2119.field9807 + "," + (Statics.field2799 * 688849399 + var4.field4836 * 401083797 >> 6) + "," + (Statics.field4855 * -1789957067 + var4.field4838 * -526848045 >> 6) + "," + (Statics.field2799 * 688849399 + var4.field4836 * 401083797 & 0x3F) + "," + (Statics.field4855 * -1789957067 + var4.field4838 * -526848045 & 0x3F) + " Height: " + (client.method8663(Statics.field2799 * 688849399, Statics.field4855 * -1789957067, Statics.field2119.field9807) - Statics.field9680 * -1223414389));
				return;
			}
		...
		if (Statics.field6683 != class515.field6368 || client.field9074 * -1124661323 >= 2) {
			try {
				...
				if (arg0.equalsIgnoreCase("clientdrop")) {
					if (client.field8923 * 1964982599 == 1) {
						client.method8047();
					} else if (client.field8923 * 1964982599 == 16) {
				...
				if (client.field8923 * 1964982599 == 1 || client.field8923 * 1964982599 == 15) {
		...
		if (arg0 == 7) {
			...
			try {
				if (arg0 == 25) {
					...
					method1958("" + class385.field4121 * -1738065381);
				} else if (arg0 == 19) {
					...
					Statics.field1231.setLocation(class385.field4147 * 1328831319, class385.field4127 * -706785813);
				} else if (arg0 == 8) {
					method1623();
				} else if (arg0 == 28) {
					client.field8980.field3789 = class153.method5554() * -3009439819985875413L;
					...
					client.field8943 = 1594336147;
					client.field8980.method6102();
				} else if (arg0 == 5) {
					client.field8943 = -1106295002;
					client.field8980.method6102();
				}
