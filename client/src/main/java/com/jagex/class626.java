...
public class class626 {
	...
	public class626(class527 arg0, class519 arg1, class334 arg2) {
		...
		if (this.field7344 == null) {
			...
			this.field7345 = this.field7344.method5637(class161.field1672.field1668 * 734175259) * -1416725645;
		}
	}
	...
	public class627 method12669(int arg0) {
		...
		synchronized (this.field7344) {
			var6 = this.field7344.method5627(class161.field1672.field1668 * 734175259, arg0);
		}
		class627 var8 = new class627();
		if (var6 != null) {
			var8.method12682(new class814(var6));
		}
