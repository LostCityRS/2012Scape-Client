...
public class class64 {
	...
	public final void method1912() throws IOException {
		if (this.field827 == null || this.field826 * -1865152227 <= 0) {
			return;
		}
		this.field830.field9626 = 0;
		while (true) {
			class792 var1 = (class792) this.field829.method11563();
			if (var1 == null || var1.field9465 * -566437591 > this.field830.field9629.length - this.field830.field9626 * 803401371) {
				this.field827.method7193(this.field830.field9629, 0, this.field830.field9626 * 803401371);
				this.field845 += this.field830.field9626 * 444877521;
				this.field839 = 0;
				break;
			}
			this.field830.method15276(var1.field9467.field9629, 0, var1.field9465 * -566437591);
			this.field826 -= var1.field9465 * -1245766019;
			var1.method6979();
	...
	public final void method1913(class792 arg0) {
		...
		arg0.field9465 = arg0.field9467.field9626 * -985067997;
		arg0.field9467.field9626 = 0;
		this.field826 += arg0.field9465 * -1245766019;
	}

	@ObfuscatedName("ad.s(I)V")
	public void method1933() {
		if (client.field9213 * 1194705519 % 50 == 0) {
			this.field841 = this.field845 * -282623269;
			this.field845 = 0;
			this.field838 = this.field842 * 1701145335;
			this.field842 = 0;
		}
	}
