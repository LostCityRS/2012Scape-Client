...
@ObfuscatedName("yj")
public class class672 extends class12 {

	@ObfuscatedName("yj.l")
	public final class682 field7688;
	...
	@ObfuscatedName("yj.g")
	public class100 field7704;

	@ObfuscatedName("yj.y")
	public class547 field7705 = new class547();

	@ObfuscatedName("yj.e")
	public class399[] field7703;

	@ObfuscatedName("yj.ay")
	public class90 field7707;

	@ObfuscatedName("yj.af")
	public class93 field7708;

	@ObfuscatedName("yj.ar")
	public class93 field7715;

	@ObfuscatedName("yj.an")
	public class93 field7710;

	@ObfuscatedName("yj.ap")
	public class93 field7701;
	...
	public class672(class682 arg0, int arg1, int arg2, int arg3, int arg4, int[][] arg5, int[][] arg6, int arg7) {
		super(arg3, arg4, arg7, arg5);
		this.field7688 = arg0;
		this.field7689 = this.field388 * -452021343 - 2;
		this.field7695 = 0x1 << this.field7689;
		this.field7686 = arg1;
		this.field7692 = arg2;
		this.field7706 = new int[arg3][arg4][];
		this.field7696 = new class778[arg3][arg4][];
		...
		this.field7693 = new float[this.field387 * 569721097 + 1][this.field386 * -1903733271 + 1];
		this.field7716 = new float[this.field387 * 569721097 + 1][this.field386 * -1903733271 + 1];
		this.field7717 = new float[this.field387 * 569721097 + 1][this.field386 * -1903733271 + 1];
		for (int var9 = 1; var9 < this.field386 * -1903733271; var9++) {
			for (int var10 = 1; var10 < this.field387 * 569721097; var10++) {
	...
	public void method193(int arg0, int arg1, int[] arg2, int[] arg3, int[] arg4, int[] arg5, int[] arg6, int[] arg7, int[] arg8, int[] arg9, class137 arg10, boolean arg11) {
		...
		if (arg5 != null && this.field7702 == null) {
			this.field7702 = new int[this.field387 * 569721097][this.field386 * -1903733271][];
		}
		if (arg3 != null && this.field7706 == null) {
			this.field7706 = new int[this.field387 * 569721097][this.field386 * -1903733271][];
		}
		...
		class778[] var14 = this.field7696[arg0][arg1] = new class778[arg6.length];
	...
	public void method195() {
		if (this.field7712 > 0) {
			...
			this.field7703 = new class399[this.field7697.method11926()];
			this.field7697.method11933(this.field7703);
			for (int var4 = 0; var4 < this.field7703.length; var4++) {
				((class778) this.field7703[var4]).method14874(this.field7712);
			}
			int var5 = 24;
			if (this.field7702 != null) {
				var5 += 4;
			...
			for (int var12 = 0; var12 < this.field387 * 569721097; var12++) {
				for (int var13 = 0; var13 < this.field386 * -1903733271; var13++) {
					if (this.field7691[var12][var13] != null) {
						class778[] var14 = this.field7696[var12][var13];
						...
						short[] var41 = this.field7687[this.field387 * 569721097 * var13 + var12] = new short[var18.length];
						for (int var42 = 0; var42 < var18.length; var42++) {
							int var43 = (var12 << this.field388 * -452021343) + var15[var42];
							int var44 = (var13 << this.field388 * -452021343) + var16[var42];
							...
							if (var52 == 0 && var53 == 0) {
								...
								float var61 = (float) var52 / (float) (this.field385 * 1570646497);
								float var62 = (float) var53 / (float) (this.field385 * 1570646497);
								...
								int var69 = ((var36 - var33) * var52 >> this.field388 * -452021343) + var33;
								int var70 = ((var35 - var34) * var52 >> this.field388 * -452021343) + var34;
								var60 = var54 - (((var70 - var69) * var53 >> this.field388 * -452021343) + var69);
							}
							if (var47 != -1) {
							...
							if (var73 == null) {
								...
								if (var47 != -1 && var14[var42].field4228 * 4763964654233859639L < var8[var84].field4228 * 4763964654233859639L) {
									var8[var84] = var14[var42];
								}
							}
			...
			for (int var86 = 0; var86 < this.field7709; var86++) {
				class778 var87 = var8[var86];
				if (var87 != null) {
					var87.method14870(var86);
				}
			}
			for (int var88 = 0; var88 < this.field387 * 569721097; var88++) {
				for (int var89 = 0; var89 < this.field386 * -1903733271; var89++) {
					short[] var90 = this.field7687[this.field387 * 569721097 * var89 + var88];
					if (var90 != null) {
						int var91 = 0;
						int var92 = 0;
						while (var92 < var90.length) {
							...
							class778 var96 = var8[var93];
							class778 var97 = var8[var94];
							class778 var98 = var8[var95];
							class778 var99 = null;
							if (var96 != null) {
							...
							if (var97 != null) {
								...
								if (var99 == null || var97.field4228 * 4763964654233859639L < var99.field4228 * 4763964654233859639L) {
									var99 = var97;
								}
							}
							if (var98 != null) {
								var98.method14866(var88, var89, var91);
								if (var99 == null || var98.field4228 * 4763964654233859639L < var99.field4228 * 4763964654233859639L) {
									var99 = var98;
								}
							}
							if (var99 != null) {
			...
			this.field7708 = new class93(this.field7707, 5126, 3, 0);
			this.field7715 = new class93(this.field7707, 5121, 4, 12);
			byte var100;
			if (this.field7702 == null) {
				this.field7701 = new class93(this.field7707, 5126, 2, 16);
				var100 = 24;
			} else {
				this.field7701 = new class93(this.field7707, 5126, 3, 16);
				var100 = 28;
			}
			if ((this.field7692 & 0x7) != 0) {
				this.field7710 = new class93(this.field7707, 5126, 3, var100);
			}
			long[] var101 = new long[this.field7703.length];
			for (int var102 = 0; var102 < this.field7703.length; var102++) {
				class778 var103 = (class778) this.field7703[var102];
				var101[var102] = var103.field4228 * 4763964654233859639L;
	...
	public void method12973(int arg0, int arg1, int arg2, boolean[][] arg3, boolean arg4, int arg5) {
		...
		for (int var17 = var9; var17 <= var13; var17++) {
			...
			for (int var19 = var11; var19 <= var14; var19++) {
				if (var18[var19 - var12]) {
					var16[var15++] = this.field387 * 569721097 * var19 + var17;
				}
			}
		}
		...
		for (int var20 = 0; var20 < this.field7703.length; var20++) {
			((class778) this.field7703[var20]).method14862(var16, var15);
		}
		if (!this.field7705.method11585()) {
			...
			for (class399 var23 = this.field7705.method11563(); var23 != null; var23 = this.field7705.method11567()) {
	...
	public void method191(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, boolean[][] arg7) {
		class126 var9 = this.field7688.method457();
		...
		this.field7688.method13312(-2);
		this.field7688.method13315(null);
		field7719[0] = (float) arg2 / ((float) (this.field385 * 1570646497) * 128.0F * (float) var9.method921());
		field7719[1] = 0.0F;
		field7719[2] = 0.0F;
		field7719[3] = 0.0F;
		field7719[4] = 0.0F;
		field7719[5] = (float) arg2 / ((float) (this.field385 * 1570646497) * 128.0F * (float) var9.method922());
		field7719[6] = 0.0F;
		field7719[7] = 0.0F;
		field7719[8] = 0.0F;
		field7719[9] = 0.0F;
		...
		if (this.field7688.field8149) {
			for (int var12 = arg4; var12 < arg6; var12++) {
				int var13 = this.field387 * 569721097 * var12 + arg3;
			...
			for (int var17 = arg4; var17 < arg6; var17++) {
				int var18 = this.field387 * 569721097 * var17 + arg3;
		...
		if (var10 > 0) {
			class655 var22 = new class655(this.field7688, 5123, var11.field9629, var11.field9626 * 803401371);
	...
	public class30 method200(int arg0, int arg1, class30 arg2) {
		...
		int var4 = this.field385 * 1570646497 >> this.field7688.field8092;
