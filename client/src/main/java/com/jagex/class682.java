...
@ObfuscatedName("yq")
public class class682 extends class14 {
	...
	public class320 field8086 = new class320();

	@ObfuscatedName("yq.bh")
	public class320 field8087 = new class320();

	@ObfuscatedName("yq.by")
	public class314 field8089 = new class314();

	@ObfuscatedName("yq.bu")
	public class103 field8090;
	...
	public class547 field8170 = new class547();
	...
	public class547 field8099 = new class547();

	@ObfuscatedName("yq.cr")
	public class547 field8039 = new class547();

	@ObfuscatedName("yq.cp")
	public class547 field8198 = new class547();

	@ObfuscatedName("yq.ci")
	public class547 field8102 = new class547();

	@ObfuscatedName("yq.ca")
	public class547 field8103 = new class547();

	@ObfuscatedName("yq.ch")
	public class547 field8194 = new class547();

	@ObfuscatedName("yq.cv")
	public class547 field8105 = new class547();
	...
	public class314 field8088 = new class314();

	@ObfuscatedName("yq.dl")
	public class320 field8116 = new class320();

	@ObfuscatedName("yq.dj")
	public class320 field8117 = new class320();

	@ObfuscatedName("yq.dp")
	public class320 field8118 = new class320();

	@ObfuscatedName("yq.dw")
	public class320 field8119 = new class320();

	@ObfuscatedName("yq.di")
	public class320 field8120 = new class320();
	...
	public class314 field8077 = new class314();

	@ObfuscatedName("yq.dy")
	public class320 field8132 = new class320();

	@ObfuscatedName("yq.dt")
	public class320 field8133 = new class320();
	...
	public class780[] field8161 = new class780[field8147];
	...
	public class93 field8221;

	@ObfuscatedName("yq.hy")
	public class93 field8211;

	@ObfuscatedName("yq.ho")
	public class90 field8223;
	...
	public class682(Canvas arg0, class16 arg1, int arg2) {
		super(arg1);
		try {
			this.field8080 = arg2;
			if (!class618.method11710().method6800("jaclib")) {
				...
				if (this.field8084.indexOf("radeon") != -1) {
					...
					boolean var8 = false;
					boolean var9 = false;
					String[] var10 = class526.method11508(this.field8084.replace('/', ' '), ' ');
					for (int var11 = 0; var11 < var10.length; var11++) {
						String var12 = var10[var11];
						try {
							if (var12.length() > 0) {
								if (var12.charAt(0) == 'x' && var12.length() >= 3 && class526.method7735(var12.substring(1, 3))) {
								...
								if (var12.equals("hd")) {
									...
									if (var12.length() >= 4 && class526.method7735(var12.substring(0, 4))) {
										var7 = class526.method5598(var12.substring(0, 4));
										break;
									}
								}
							}
				...
				this.method462(arg0);
				this.field8082 = new class87(this);
				this.method13265();
				this.method587();
			} else {
				throw new RuntimeException("");
	...
	public int method13264() {
		...
		String[] var3 = class526.method11508(var2.replace('.', ' '), ' ');
		if (var3.length >= 2) {
			try {
				int var4 = class526.method5598(var3[0]);
				int var5 = class526.method5598(var3[1]);
		...
		this.field8149 = Statics.method42();
		...
		this.field8199 = class616.field7296.startsWith("mac");
	...
	public void method13475() {
		this.field8185 = new class81[this.field8195];
	...
	public void method443() {
		for (class399 var1 = this.field8170.method11563(); var1 != null; var1 = this.field8170.method11567()) {
	...
	public void method748(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, byte[] arg6, int arg7, int arg8) {
		...
		if (this.field8204 == null || this.field8204.field7440 < arg2 || this.field8204.field7441 < arg3) {
			...
			this.field8204.method12769(0, 0, arg2, arg3, arg6, class124.field1297, 0, 0, false);
	...
	public void method502(class28 arg0) {
		...
		this.field8223 = this.method13301(20, var2.field9629, var2.field9626 * 803401371, false);
	...
	public class12 method521(int arg0, int arg1, int[][] arg2, int[][] arg3, int arg4, int arg5, int arg6) {
		return new class672(this, arg5, arg6, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public final void method13282(class320 arg0) {
		OpenGL.glPushMatrix();
		OpenGL.glMultMatrixf(arg0.field3480, 0);
	}

	@ObfuscatedName("yq.ob(Lka;)V")
	public final void method13360(class320 arg0) {
	...
	public class314 method525() {
		return new class314(this.field8088);
	}
	...
	public final class320 method528() {
		return new class320(this.field8118);
	}
	...
	public void method13291() {
		...
		for (var1 = 0; var1 < this.field8163; var1++) {
			class780 var2 = this.field8161[var1];
			int var3 = var1 + 16386;
	...
	public class127 method537(class127 arg0, class127 arg1, float arg2, class127 arg3) {
		if (arg0 != null && arg1 != null && this.field8206 && this.field8176) {
			...
			class641 var8 = var6.method13186();
			class641 var9 = var7.method13186();
	...
	public final class641 method13297() {
	...
	public final class90 method13301(int arg0, byte[] arg1, int arg2, boolean arg3) {
		return (class90) (this.field8181 && (!arg3 || this.field8049) ? new class653(this, arg0, arg1, arg2, arg3) : new class652(this, arg0, arg1, arg2));
	}

	@ObfuscatedName("yq.pe(ILjaclib/memory/Buffer;IZ)Lbi;")
	public final class90 method13302(int arg0, Buffer arg1, int arg2, boolean arg3) {
		return (class90) (this.field8181 && (!arg3 || this.field8049) ? new class653(this, arg0, arg1, arg2, arg3) : new class652(this, arg0, arg1));
	}

	@ObfuscatedName("yq.pp(Lbi;)V")
	public final void method13365(class90 arg0) {
	...
	public final void method13305(class93 arg0, class93 arg1, class93 arg2, class93 arg3) {
		if (arg0 == null) {
	...
	public final void method13473(int arg0, boolean arg1, boolean arg2) {
		if (this.field8180 != arg0 || this.field8175 != this.field8174) {
			...
			if (arg0 < 0) {
				...
				if (!this.field8174) {
					var6 = var9.field1248;
					var7 = var9.field1264 * -1918643969;
					var8 = var9.field1270;
				}
				var5 = var9.field1278 * 1452609413;
			}
	...
	public final void method13315(class81 arg0) {
		class81 var2 = this.field8185[this.field8076];
		if (arg0 != var2) {
			if (arg0 == null) {
	...
	public final synchronized void method444(int arg0) {
		...
		while (!this.field8039.method11585()) {
			...
			field8228[var2++] = (int) (var4.field4228 * 4763964654233859639L);
			this.field8157 -= var4.field9556 * 1720545541;
			if (var2 == 1000) {
		...
		while (!this.field8198.method11585()) {
			...
			field8228[var2++] = (int) (var5.field4228 * 4763964654233859639L);
			this.field8096 -= var5.field9556 * 1720545541;
			if (var2 == 1000) {
		...
		while (!this.field8102.method11585()) {
			...
			field8228[var2++] = var6.field9556 * 1720545541;
			if (var2 == 1000) {
		...
		while (!this.field8103.method11585()) {
			...
			field8228[var2++] = (int) (var7.field4228 * 4763964654233859639L);
			this.field8098 -= var7.field9556 * 1720545541;
			if (var2 == 1000) {
		...
		while (!this.field8099.method11585()) {
			...
			OpenGL.glDeleteLists((int) (var9.field4228 * 4763964654233859639L), var9.field9556 * 1720545541);
		}
		while (!this.field8194.method11585()) {
			class399 var10 = this.field8194.method11560();
			OpenGL.glDeleteProgramARB((int) (var10.field4228 * 4763964654233859639L));
		}
		while (!this.field8105.method11585()) {
			class399 var11 = this.field8105.method11560();
			OpenGL.glDeleteShader((int) (var11.field4228 * 4763964654233859639L));
		}
		while (!this.field8099.method11585()) {
			class802 var12 = (class802) this.field8099.method11560();
			OpenGL.glDeleteLists((int) (var12.field4228 * 4763964654233859639L), var12.field9556 * 1720545541);
		}
		this.field8083.method2326();
		if (this.method552() > 100663296 && class153.method5554() > this.field8078 + 60000L) {
			System.gc();
			this.field8078 = class153.method5554();
		}
		this.field8109 = var3;
	}
	...
	public final synchronized void method13332(long arg0) {
		...
		var3.field4228 = arg0 * -6168139600691503225L;
		this.field8105.method11558(var3);
	}

	@ObfuscatedName("yq.qf(I)V")
	public final synchronized void method13333(int arg0) {
		class399 var2 = new class399();
		var2.field4228 = (long) arg0 * -6168139600691503225L;
		this.field8194.method11558(var2);
	}

	@ObfuscatedName("yq.qc(Lcy;)I")
	public static int method13334(class124 arg0) {
		switch(arg0.field1305 * -567137681) {
			case 0:
				return 6410;
			case 1:
				return 6408;
