...
@ObfuscatedName("aap")
public class class718 extends class172 {

	@ObfuscatedName("aap.f")
	public final class899 field8590;

	@ObfuscatedName("aap.d")
	public class716 field8588;

	@ObfuscatedName("aap.z")
	public int field8589;

	public class718(class899 arg0, class173 arg1) {
		super(arg0, arg1);
		this.field8590 = arg0;
	}
	...
	public boolean method3335(class168 arg0) {
		if (this.field8588 == arg0) {
			...
			this.field8588 = (class716) arg0;
			this.field2079 = this.method3345(arg0) * -1906347829;
			if (this.field2079 * -580291357 == -1) {
	...
	public void method3363() {
		for (int var1 = 0; var1 < this.method3331(); var1++) {
			((class716) this.method3332(var1)).method168();
		}
		super.method3363();
	}
