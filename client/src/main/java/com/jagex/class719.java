...
public abstract class class719 extends class974 implements class198 {
	...
	public class874 field8616;

	@ObfuscatedName("aay.at")
	public class553 field8597;
	...
	public final class977[] field8633;
	...
	public class40 field8638;

	@ObfuscatedName("aay.bg")
	public class40 field8639;

	@ObfuscatedName("aay.bl")
	public class40 field8611;
	...
	public class719(class423 arg0, int arg1) {
		...
		this.field8594 = -1166202519;
		this.field8622 = -2048425984;
		this.field8634 = true;
		this.field8598 = 0;
		this.field8635 = -215734609;
		this.field8600 = 0;
		this.field8604 = 0;
		this.field8606 = 0;
		this.field8607 = new int[Statics.field4825.field5147 * 223955425];
		this.field8608 = new int[Statics.field4825.field5147 * 223955425];
		this.field8609 = new int[Statics.field4825.field5147 * 223955425];
		this.field8610 = new int[Statics.field4825.field5147 * 223955425];
		this.field8623 = new int[Statics.field4825.field5147 * 223955425];
		this.field8612 = new class548();
		this.field8624 = 1342544125;
		this.field8615 = null;
		this.field8616 = new class874(this, false);
		this.field8597 = new class875(this, false);
		this.field8626 = -1013492567;
		this.field8632 = -288428173;
		this.field8631 = 0;
		this.field8618 = 0;
		this.field8599 = 0;
		this.field8636 = 63957248;
		this.field8638 = new class40();
		this.field8639 = new class40();
		this.field8611 = new class40();
		this.field8628 = 0;
		this.field8648 = 0;
		this.field8646 = 0;
		this.field8647 = 0;
	...
	public int method12809() {
		return this.field8622 * -2042239791 == -32768 ? 0 : this.field8622 * -2042239791;
	}
	...
	public void method14013(int arg0) {
		class439 var2 = this.method13959();
		if (var2.field4723 * -149393761 == 0 && this.field8636 * -850659239 == 0) {
			return;
		}
		this.field8638.method1388();
		int var3 = arg0 - this.field8638.field574 * 1394071457 & 0x3FFF;
		if (var3 > 8192) {
			this.field8637 = (this.field8638.field574 * 1394071457 - (16384 - var3)) * 458058665;
		} else {
			this.field8637 = (this.field8638.field574 * 1394071457 + var3) * 458058665;
		}
	}

	@ObfuscatedName("aay.d(IZI)V")
	public void method13946(int arg0, boolean arg1) {
		class439 var3 = this.method13959();
		if (arg1 || var3.field4723 * -149393761 != 0 || this.field8636 * -850659239 != 0) {
			this.field8637 = (arg0 & 0x3FFF) * 458058665;
			this.field8638.method1386(this.field8637 * 1909352601);
		}
	}

	@ObfuscatedName("aay.z(I)I")
	public int method13947() {
		class439 var1 = this.method13959();
		int var2 = this.field8638.field574 * 1394071457;
		boolean var3;
		if (var1.field4723 * -149393761 == 0) {
			var3 = this.field8638.method1385(this.field8637 * 1909352601, this.field8636 * -850659239, this.field8636 * -850659239);
		} else {
			var3 = this.field8638.method1385(this.field8637 * 1909352601, var1.field4723 * -149393761, var1.field4722 * -1626041487);
		}
		int var4 = this.field8638.field574 * 1394071457 - var2;
		if (var4 == 0) {
			this.field8599 = 0;
			this.field8638.method1386(this.field8637 * 1909352601);
		} else {
			this.field8599 += -1008015511;
		}
		if (var3) {
			if (var1.field4687 * -570426355 != 0) {
				if (var4 > 0) {
					this.field8639.method1385(var1.field4725 * -1524151789, var1.field4687 * -570426355, var1.field4724 * 1316834005);
				} else {
					this.field8639.method1385(-(var1.field4725 * -1524151789), var1.field4687 * -570426355, var1.field4724 * 1316834005);
				}
			}
			if (var1.field4721 * 620995773 != 0) {
				this.field8611.method1385(var1.field4728 * 728261879, var1.field4721 * 620995773, var1.field4727 * -1857156827);
			}
		} else {
			if (var1.field4687 * -570426355 == 0) {
				this.field8639.method1386(0);
			} else {
				this.field8639.method1385(0, var1.field4687 * -570426355, var1.field4724 * 1316834005);
			}
			if (var1.field4721 * 620995773 == 0) {
				this.field8611.method1386(0);
			} else {
				this.field8611.method1385(0, var1.field4721 * 620995773, var1.field4727 * -1857156827);
			}
		}
		return var4;
	}
	...
	public void method13948(int[] arg0, int[] arg1) {
		if (this.field8614 == null && arg0 != null) {
			this.field8614 = new int[Statics.field3226.field5171.length];
		} else if (arg0 == null) {
			this.field8614 = null;
			return;
		}
	...
	public boolean method13949(int arg0, int arg1) {
		if (this.field8654 == null) {
			...
			this.field8654 = new int[Statics.field3226.field5171.length];
			for (int var3 = 0; var3 < Statics.field3226.field5171.length; var3++) {
		...
		if (arg1 != -1) {
			...
			for (int var9 = 0; var9 < Statics.field3226.field5171.length; var9++) {
	...
	public void method14023(class14 arg0, class13[] arg1, class314 arg2, boolean arg3) {
		if (!arg3) {
			int var5 = 0;
			int var6 = 0;
			int var7 = 0;
			...
			int var9 = -1;
			int var10 = -1;
			class134[][] var11 = new class134[arg1.length][];
			class119[][] var12 = new class119[arg1.length][];
			...
			if ((this.field8640 == null || this.field8640.field4945) && (var6 > 0 || var8 > 0)) {
				this.field8640 = class467.method8123(client.field9213 * 1194705519, true);
			}
			if (this.field8640 != null) {
				...
				this.field8640.method8106(arg0, (long) (client.field9213 * 1194705519), var15, var19, false);
				this.field8613 = true;
			}
		} else if (this.field8640 != null) {
			this.field8640.method8105((long) (client.field9213 * 1194705519));
		}
		if (this.field8640 != null) {
	...
	public final void method13950(int arg0, int arg1, int arg2, int arg3, boolean arg4, int arg5) {
		...
		int var8 = var7.field1204 * 869063161;
		if (arg0 != -1 && var8 != -1) {
			if (arg0 == var8) {
				class507 var9 = Statics.field4213.method11082(arg0);
				if (var9.field5264 && var9.field5252 * 627575481 != -1) {
					class509 var10 = Statics.field566.method11144(var9.field5252 * 627575481);
					int var11 = var10.field6331 * -75735531;
					if (var11 == 0) {
						return;
					}
					if (var11 == 2) {
				...
				class507 var12 = Statics.field4213.method11082(arg0);
				class507 var13 = Statics.field4213.method11082(var8);
				if (var12.field5252 * 627575481 != -1 && var13.field5252 * 627575481 != -1) {
					class509 var14 = Statics.field566.method11144(var12.field5252 * 627575481);
					class509 var15 = Statics.field566.method11144(var13.field5252 * 627575481);
					if (var14.field6325 * -1657796023 < var15.field6325 * -1657796023) {
						return;
					}
				}
			}
		...
		var7.field1204 = arg0 * -1661298615;
		var7.field1206 = arg3 * -986954383;
		var7.field1205 = (arg1 >> 16) * -2145943705;
		var7.field1207 = arg2 * 1682286087;
		var7.field1203.method11803(arg0 == -1 ? -1 : Statics.field4213.method11082(arg0).field5252 * 627575481, arg1 & 0xFFFF, var16, false);
	}
	...
	public final void method13953(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		boolean var7 = true;
		boolean var8 = true;
		for (int var9 = 0; var9 < Statics.field4825.field5147 * 223955425; var9++) {
		...
		if (arg0 >= 0) {
			...
			var11 = var13.field4743 * -1197074565;
			var12 = var13.field4750 * -1175277031;
		}
		if (var8) {
			if (var11 == -1) {
				return;
			...
			for (int var15 = 1; var15 < Statics.field4825.field5147 * 223955425; var15++) {
				if (var11 == 0) {
			...
			for (int var16 = 0; var16 < Statics.field4825.field5147 * 223955425; var16++) {
				byte var17 = this.field8606;
				this.field8606 = (byte) ((this.field8606 + 1) % (Statics.field4825.field5147 * 223955425));
	...
	public final void method13944(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		class416 var7 = Statics.field6705.method7334(arg0);
		class767 var8 = null;
		class767 var9 = null;
		int var10 = var7.field4442 * -535814595;
		int var11 = 0;
		for (class767 var12 = (class767) this.field8612.method11649(); var12 != null; var12 = (class767) this.field8612.method11644()) {
			var11++;
			if (var12.field9268 == var7) {
				var12.method14733(arg1 + arg3, arg4, arg5, arg2);
				return;
			}
			if (var12.field9268.field4446 * -387295229 <= var7.field4446 * -387295229) {
				var8 = var12;
			}
			if (var12.field9268.field4442 * -535814595 > var10) {
				var9 = var12;
				var10 = var12.field9268.field4442 * -535814595;
			}
		}
		if (var9 == null && var11 >= Statics.field4825.field5160 * 556108901) {
			return;
		}
		class767 var13 = new class767(var7);
		if (var8 == null) {
			this.field8612.method11641(var13);
		} else {
			class548.method1968(var13, var8);
		}
		var13.method14733(arg1 + arg3, arg4, arg5, arg2);
		if (var11 >= Statics.field4825.field5160 * 556108901) {
			var9.method6975();
		}
	}
	...
	public final void method13990(int arg0) {
		class416 var2 = Statics.field6705.method7334(arg0);
		for (class767 var3 = (class767) this.field8612.method11649(); var3 != null; var3 = (class767) this.field8612.method11644()) {
	...
	public int method12811() {
		class439 var1 = this.method13959();
		int var2;
		if (var1.field4730 * -1798314143 != -1) {
			var2 = var1.field4730 * -1798314143;
		} else if (this.field8622 * -2042239791 == -32768) {
			var2 = 200;
		} else {
			var2 = -(this.field8622 * -2042239791);
		}
	...
	public void method13979(int arg0) {
		this.field8594 = arg0 * -1166202519;
	}

	@ObfuscatedName("aay.k(I)I")
	public int method13954() {
		return this.field8594 * -1399458087;
	}

	@ObfuscatedName("aay.dz(I)V")
	public void method14006() {
		int var1 = (this.field8594 * -1399458087 - 1 << 8) + 240;
	...
	public void method13972(class13 arg0) {
		int var2 = this.field8639.field574 * 1394071457;
		int var3 = this.field8611.field574 * 1394071457;
		if (var2 == 0 && var3 == 0) {
			return;
		}
	...
	public void method13957(class14 arg0, class439 arg1, int arg2, int arg3, int arg4, int arg5) {
		for (int var7 = 0; var7 < this.field8641.length; var7++) {
			byte var8 = 0;
			if (var7 == 0) {
				var8 = 2;
			} else if (var7 == 1) {
			...
			if (var9.field1204 * 869063161 == -1 || var9.field1203.method11776()) {
				this.field8651[var7 + 1] = null;
			} else {
				class507 var10 = Statics.field4213.method11082(var9.field1204 * 869063161);
				boolean var11 = var10.field5262 == 3 && (arg3 != 0 || arg4 != 0);
				int var12 = arg2;
				if (var11) {
					var12 = arg2 | 0x7;
				} else {
					if (var9.field1207 * -773134409 != 0) {
						var12 = arg2 | 0x5;
					}
					if (var9.field1205 * -1808651177 != 0) {
						var12 |= 0x2;
					}
					if (var9.field1206 * -1537877103 >= 0) {
						var12 |= 0x7;
					}
				}
				class13 var13 = this.field8651[var7 + 1] = var10.method11102(arg0, var12, var9.field1203, var8);
				if (var13 != null) {
					if (var9.field1206 * -1537877103 >= 0 && arg1.field4716 != null && arg1.field4716[var9.field1206 * -1537877103] != null) {
						int var14 = 0;
						int var15 = 0;
						int var16 = 0;
						if (arg1.field4716 != null && arg1.field4716[var9.field1206 * -1537877103] != null) {
							var14 += arg1.field4716[var9.field1206 * -1537877103][0];
							var15 += arg1.field4716[var9.field1206 * -1537877103][1];
							var16 += arg1.field4716[var9.field1206 * -1537877103][2];
						}
						if (arg1.field4729 != null && arg1.field4729[var9.field1206 * -1537877103] != null) {
							var14 += arg1.field4729[var9.field1206 * -1537877103][0];
							var15 += arg1.field4729[var9.field1206 * -1537877103][1];
							var16 += arg1.field4729[var9.field1206 * -1537877103][2];
						}
						if (var16 != 0 || var14 != 0) {
							int var17 = arg5;
							if (this.field8654 != null && this.field8654[var9.field1206 * -1537877103] != -1) {
								var17 = this.field8654[var9.field1206 * -1537877103];
							}
							int var18 = var9.field1207 * 1463662592 + var17 - arg5 & 0x3FFF;
							if (var18 != 0) {
								var13.method246(var18);
							}
							int var19 = class312.field3439[var18];
							int var20 = class312.field3447[var18];
							int var21 = var14 * var20 + var16 * var19 >> 14;
							var16 = var16 * var20 - var14 * var19 >> 14;
							var14 = var21;
						}
						var13.method353(var14, var15, var16);
					} else if (var9.field1207 * -773134409 != 0) {
						var13.method246(var9.field1207 * 1463662592);
					}
					if (var9.field1205 * -1808651177 != 0) {
						var13.method353(0, -(var9.field1205 * -1808651177) << 2, 0);
					}
					if (var11) {
						if (this.field8601 * -2047932903 != 0) {
							var13.method397(this.field8601 * -2047932903);
						}
						if (this.field8644 * 497815129 != 0) {
							var13.method284(this.field8644 * 497815129);
						}
						if (this.field8603 * -910583861 != 0) {
							var13.method353(0, this.field8603 * -910583861, 0);
						}
					}
				}
			}
	...
	public void method13958(int arg0, int arg1, int arg2, int arg3, int arg4) {
		...
		int var10 = class312.field3447[arg0];
		int var11 = -arg1 / 2;
		int var12 = -arg2 / 2;
		...
		this.field8601 = ((int) (Math.atan2((double) (var31 - var32), (double) arg2) * 2607.5945876176133D) & 0x3FFF) * -952306135;
		this.field8644 = ((int) (Math.atan2((double) (var34 - var33), (double) arg1) * 2607.5945876176133D) & 0x3FFF) * 796547561;
		if (this.field8601 * -2047932903 != 0 && arg3 != 0) {
			int var35 = 16384 - arg3;
			if (this.field8601 * -2047932903 > 8192) {
				if (this.field8601 * -2047932903 < var35) {
					this.field8601 = var35 * -952306135;
				}
			} else if (this.field8601 * -2047932903 > arg3) {
				this.field8601 = arg3 * -952306135;
			}
		}
		if (this.field8644 * 497815129 != 0 && arg4 != 0) {
			int var36 = 16384 - arg4;
			if (this.field8644 * 497815129 > 8192) {
				if (this.field8644 * 497815129 < var36) {
					this.field8644 = var36 * 796547561;
				}
			} else if (this.field8644 * 497815129 > arg4) {
				this.field8644 = arg4 * 796547561;
			}
		}
		this.field8603 = (var15 + var30) * 303584739;
		if (var20 + var25 < this.field8603 * -910583861) {
			this.field8603 = (var20 + var25) * 303584739;
		}
		this.field8603 = ((this.field8603 * -910583861 >> 1) - (int) var6.field3476) * 303584739;
	}

	@ObfuscatedName("aay.bd(I)Lps;")
	public class439 method13959() {
		int var1 = this.method13960();
		return var1 == -1 ? class440.field4733 : Statics.field3769.method7784(var1);
	}

	@ObfuscatedName("aay.cn(B)V")
	public void method13962() {
		if (this.field8629 != null && this.field8629.field1232 != null) {
			this.field8629.field1236 -= 1067076481;
			if (this.field8629.field1236 * 466220161 == 0) {
	...
	public void method13998(String arg0, int arg1, int arg2, int arg3) {
		if (this.field8629 == null) {
			this.field8629 = new class117();
		}
		this.field8629.field1232 = arg0;
		this.field8629.field1233 = arg1 * 567805993;
		this.field8629.field1234 = arg2 * -890999599;
		this.field8629.field1236 = (this.field8629.field1235 = arg3 * 1890005551) * -731750065;
	}

	@ObfuscatedName("aay.cg(II)V")
	public void method13965(int arg0) {
		if (this.field8653 * 311017441 != this.field8630 * -1621685693) {
			this.method14002();
		}
		this.field8630 = arg0 * 958534251;
	}

	@ObfuscatedName("aay.cj(I)Z")
	public boolean method13976() {
		return this.field8630 * -1621685693 == -1 ? false : this.method13966(this.field8630 * -1621685693);
	}

	@ObfuscatedName("aay.cy(II)Z")
	public boolean method13966(int arg0) {
		if (this.field8653 * 311017441 == arg0) {
			return true;
		}
		this.field8652 = class165.method3971(arg0, null, null, true);
		if (this.field8652 == null) {
			return false;
		} else {
			this.field8653 = arg0 * -1474903007;
	...
	public void method14002() {
		if (this.field8653 * 311017441 != -1) {
			class165.method7691(this.field8653 * 311017441);
			this.field8652 = null;
			this.field8653 = 1474903007;
		}
	}
	...
	public abstract class117 method13963();
