...
public class class720 extends class199 {
	...
	public int method14032() {
		this.field8657 += -1153632357;
		if (this.field8657 * 1909167763 == 126) {
			this.field8657 = 0;
		}
		return this.field8657 * 1909167763;
	}

	@ObfuscatedName("aax.ep(Laet;IB)V")
	public void method14033(class814 arg0, int arg1) {
		int var3 = arg0.field9626 * 803401371;
		...
		if ((var4 >> 7 & 0x1) == 1) {
			...
			if ((var9 >> class189.field2180.field2186 * 1029412775 & 0x1) == 1) {
				this.field2229.method5292(arg0);
			}
			if ((var9 >> class189.field2181.field2186 * 1029412775 & 0x1) == 1) {
				this.field2230.method5292(arg0);
			}
			if ((var9 >> class189.field2173.field2186 * 1029412775 & 0x1) == 1) {
				this.field2232.method5292(arg0);
			}
			if ((var9 >> class189.field2174.field2186 * 1029412775 & 0x1) == 1) {
				this.field2233.method5292(arg0);
			}
			if ((var9 >> class189.field2177.field2186 * 1029412775 & 0x1) == 1) {
				this.field2223 = arg0.method15324();
				this.field2239 = arg0.method15324();
			}
			if ((var9 >> class189.field2176.field2186 * 1029412775 & 0x1) == 1) {
				this.field2218 = arg0.method15324();
				this.field2241 = arg0.method15324();
			}
			if ((var9 >> class189.field2171.field2186 * 1029412775 & 0x1) == 1) {
				this.field2220 = class194.method8664(arg0.method15220());
			}
			if ((var9 >> class189.field2178.field2186 * 1029412775 & 0x1) == 1) {
				this.field2238 = arg0.method15241() * 1625273133;
				arg0.method15220();
			}
			if ((var9 >> class189.field2179.field2186 * 1029412775 & 0x1) == 1) {
				int var10 = arg0.method15220();
				this.field2242 = (var10 & 0x1) == 1;
				this.field2243 = (var10 & 0x2) == 2;
			}
			if ((var9 >> class189.field2175.field2186 * 1029412775 & 0x1) == 1) {
				...
				for (int var12 = 0; var12 < var11; var12++) {
					...
					if (var13 == 0) {
						...
						while (var17.hasNext()) {
							...
							if (var18.field10351 * -373977603 == var14) {
			...
			if ((var9 >> class189.field2172.field2186 * 1029412775 & 0x1) == 1) {
				this.field2244 = arg0.method15239() * -637119501;
				this.field2236 = arg0.method15324();
			}
			if ((var9 >> class189.field2182.field2186 * 1029412775 & 0x1) == 1) {
				this.field2226 = class192.method1955(arg0.method15220());
			}
			if ((var9 >> class189.field2183.field2186 * 1029412775 & 0x1) == 1) {
			...
			if ((var9 >> class189.field2184.field2186 * 1029412775 & 0x1) == 1) {
				arg0.method15324();
			}
			if ((var9 >> class189.field2185.field2186 * 1029412775 & 0x1) == 1) {
		...
		if (arg0.field9626 * 803401371 - var3 != arg1) {
			throw new RuntimeException(arg0.field9626 * 803401371 - var3 + "," + arg1);
		}
	}
}
