...
public class class737 extends class300 implements class225 {
	...
	public class737(class898 arg0, class124 arg1, int arg2, int arg3, int arg4, boolean arg5, byte[] arg6) {
		...
		var8.clear();
		var8.put(arg6);
		IDirect3DVolumeTexture.Upload(this.field3325, 0, 0, 0, 0, this.field8779, this.field8780, this.field8781, arg1.field1306 * 834722433 * this.field8779, 0, this.field3326.field8245);
	}
