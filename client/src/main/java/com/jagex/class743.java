...
public class class743 extends class300 implements class239 {
	...
	public class743(class898 arg0, int arg1, int arg2, boolean arg3, int[] arg4, int arg5, int arg6) {
		...
		IDirect3DTexture.Upload(this.field3325, 0, 0, 0, this.field8806, this.field8810, this.field3327.field1306 * 834722433 * arg6, 0, this.field3326.field8245);
	}
	...
	public class743(class898 arg0, class124 arg1, int arg2, int arg3, boolean arg4, byte[] arg5, int arg6, int arg7) {
		...
		if (this.field3326.field10002) {
			...
			if (this.field8806 != arg2 || this.field8810 != arg3) {
				arg5 = this.method14186(arg2, arg3, this.field8806, this.field8810, arg5, arg6, arg7, arg1.field1306 * 834722433);
				arg6 = 0;
				arg7 = this.field8806;
			}
		}
		...
		if (this.field3327 == class124.field1303) {
			...
			if (this.field3327 == class124.field1295) {
				...
				IDirect3DTexture.Upload(this.field3325, 0, 0, 0, this.field8806, this.field8810, this.field3327.field1306 * 834722433 * arg7, 0, this.field3326.field8245);
			}
		}
	}
	...
	public class743(class898 arg0, class124 arg1, int arg2, int arg3, boolean arg4, float[] arg5, int arg6, int arg7) {
		...
		if (this.field3326.field10002) {
			...
			this.field8809 = (float) arg3 / (float) this.field8810;
			if (this.field8806 != arg2 || this.field8810 != arg3) {
				arg5 = this.method14181(arg2, arg3, this.field8806, this.field8810, arg5, arg6, arg7, arg1.field1306 * 834722433);
				arg6 = 0;
				arg7 = this.field8806;
			}
		}
		...
		ByteBuffer var9 = this.field3326.field8244;
		var9.clear();
		var9.asFloatBuffer().put(arg5, arg6, this.field3327.field1306 * 834722433 * this.field8810 * arg7);
		IDirect3DTexture.Upload(this.field3325, 0, 0, 0, this.field8806, this.field8810, this.field3327.field1306 * 834722433 * arg7 * 4, 0, this.field3326.field8245);
	}
	...
	public void method4413(int arg0, int arg1, int arg2, int arg3, int[] arg4, int arg5, int arg6) {
		...
		IDirect3DTexture.Upload(this.field3325, 0, arg0, arg1, arg2, arg3, this.field3327.field1306 * 834722433 * arg6, 0, this.field3326.field8245);
	}
	...
	public void method4414(int arg0, int arg1, int arg2, int arg3, byte[] arg4, class124 arg5, int arg6, int arg7) {
		...
		IDirect3DTexture.Upload(this.field3325, 0, arg0, arg1, arg2, arg3, this.field3327.field1306 * 834722433 * arg7, 0, this.field3326.field8245);
	}
