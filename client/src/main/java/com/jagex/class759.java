...
@ObfuscatedName("abo")
public class class759 extends class340 {
	...
	public int field8893 = -1705102319;
	...
	public final void method14269(class14 arg0, class814 arg1, int arg2, int arg3) {
		...
		class470 var6 = null;
		while (true) {
			while (arg1.field9626 * 803401371 < arg1.field9629.length) {
				...
				if (var7 == 0) {
					...
					if (var8 > 0) {
						for (int var9 = 0; var9 < var8; var9++) {
							class427 var10 = new class427(arg0, this.field3619.field4510 * -1694394771, arg1, 2);
							if (var10.field4594 * 1059050649 == 31) {
								class607 var11 = Statics.field785.method12453(arg1.method15239());
								var10.method7577(var11.field7188 * -1790885167, var11.field7191 * 1093830991, var11.field7189 * -2063238991, var11.field7190 * -1414697127);
							}
							if (arg0.method768() > 0) {
								...
								int var15 = var13 >> 9;
								int var16 = var14 >> 9;
								if (var15 >= 0 && var16 >= 0 && var15 < this.field3627 * 993135469 && var16 < this.field3643 * -241162669) {
									var12.method14884(var13, this.field3697[var10.field4592 * 1258433447][var15][var16] - var12.method14882(), var14);
					...
					for (int var17 = 0; var17 < 4; var17++) {
						...
						if (var18 == 0 && this.field3631[var17] != null) {
							...
							if (arg2 < 0) {
								var19 = 0;
							} else if (arg2 >= this.field3627 * 993135469) {
								var19 = this.field3627 * 993135469;
							}
							if (var20 < 0) {
								var20 = 0;
							} else if (var20 >= this.field3627 * 993135469) {
								var20 = this.field3627 * 993135469;
							}
							if (arg3 < 0) {
								var21 = 0;
							} else if (arg3 >= this.field3643 * -241162669) {
								var21 = this.field3643 * -241162669;
							}
							if (var22 < 0) {
								var22 = 0;
							} else if (var22 >= this.field3643 * -241162669) {
								var22 = this.field3643 * -241162669;
							}
							while (var19 < var20) {
								while (var21 < var22) {
							...
							if (this.field3631[var17] == null) {
								this.field3631[var17] = new byte[this.field3627 * 993135469 + 1][this.field3643 * -241162669 + 1];
							}
								...
								for (int var24 = 0; var24 < 64; var24 += 4) {
									...
									for (int var26 = arg2 + var23; var26 < arg2 + var23 + 4; var26++) {
										for (int var27 = arg3 + var24; var27 < arg3 + var24 + 4; var27++) {
											if (var26 >= 0 && var26 < this.field3627 * 993135469 && var27 >= 0 && var27 < this.field3643 * -241162669) {
							...
							if (var17 > 0) {
								...
								if (arg2 < 0) {
									...
									var28 = this.field3627 * 993135469;
								}
								if (var29 < 0) {
									var29 = 0;
								} else if (var29 >= this.field3627 * 993135469) {
									var29 = this.field3627 * 993135469;
								}
								if (arg3 < 0) {
									var30 = 0;
								} else if (arg3 >= this.field3643 * -241162669) {
									var30 = this.field3643 * -241162669;
								}
								if (var31 < 0) {
									var31 = 0;
								} else if (var31 >= this.field3643 * -241162669) {
									var31 = this.field3643 * -241162669;
								}
								while (var28 < var29) {
									while (var30 < var31) {
			...
			if (var6 != null) {
				for (int var32 = 0; var32 < 8; var32++) {
					for (int var33 = 0; var33 < 8; var33++) {
						...
						if (var34 >= 0 && var34 < this.field3627 * 993135469 >> 3 && var35 >= 0 && var35 < this.field3643 * -241162669 >> 3) {
				...
				if (var14 == 0) {
					...
					if (var15 > 0) {
						for (int var16 = 0; var16 < var15; var16++) {
							class427 var17 = new class427(arg0, this.field3619.field4510 * -1694394771, arg1, 2);
							if (var17.field4594 * 1059050649 == 31) {
								class607 var18 = Statics.field785.method12453(arg1.method15239());
								var17.method7577(var18.field7188 * -1790885167, var18.field7191 * 1093830991, var18.field7189 * -2063238991, var18.field7190 * -1414697127);
							}
							if (arg0.method768() > 0) {
								class780 var19 = var17.field4588;
								int var20 = var19.method14888() >> 9;
								int var21 = var19.method14879() >> 9;
								if (var17.field4592 * 1258433447 == arg5 && var20 >= var12 && var20 < var12 + 8 && var21 >= var13 && var21 < var13 + 8) {
									...
									int var24 = var22 >> 9;
									int var25 = var23 >> 9;
									if (var24 >= 0 && var25 >= 0 && var24 < this.field3627 * 993135469 && var25 < this.field3643 * -241162669) {
					...
					for (int var26 = 0; var26 < 4; var26++) {
						...
						if (var27 == 0 && this.field3631[arg2] != null) {
							if (var26 <= arg5) {
								...
								if (arg3 < 0) {
									var28 = 0;
								} else if (arg3 >= this.field3627 * 993135469) {
									var28 = this.field3627 * 993135469;
								}
								if (var29 < 0) {
									var29 = 0;
								...
								if (arg4 < 0) {
									var30 = 0;
								} else if (arg4 >= this.field3643 * -241162669) {
									var30 = this.field3643 * -241162669;
								}
								if (var31 < 0) {
									var31 = 0;
							...
							if (this.field3631[arg2] == null) {
								this.field3631[arg2] = new byte[this.field3627 * 993135469 + 1][this.field3643 * -241162669 + 1];
							}
										...
										for (int var35 = var32; var35 < var32 + 4; var35++) {
											for (int var36 = var33; var36 < var33 + 4; var36++) {
												if (var35 >= var12 && var35 < var12 + 8 && var36 >= var13 && var36 < var13 + 8) {
													...
													if (var37 >= 0 && var37 < this.field3627 * 993135469 && var38 >= 0 && var38 < this.field3643 * -241162669) {
			...
			while (true) {
				while (!var11) {
					...
					if (var17 > 0 && var18 > 0 && var17 < arg4 - 1 && var18 < arg5 - 1) {
						...
						if (class542.field6589.field6590 * -1082126853 != var16 || Statics.field4961.field9671.method15725() != 0 || var19.field6493 * -1110036101 != 0 || var19.field6491 * -420372767 == 1 || var19.field6523) {
	...
	public final void method14271(class14 arg0, byte[] arg1, int arg2, int arg3, class361[] arg4) {
		...
		while (true) {
			...
			while (true) {
				...
				if (var17 > 0 && var18 > 0 && var17 < this.field3627 * 993135469 - 1 && var18 < this.field3643 * -241162669 - 1) {
					class361 var19 = null;
					if (!this.field3644) {
						int var20 = var13;
		...
		while (true) {
			...
			while (true) {
				...
				if (arg5 == var18 && var17 >= arg6 && var17 < arg6 + 8 && var16 >= arg7 && var16 < arg7 + 8) {
					...
					int var23 = arg3 + class339.method14717(var17 & 0x7, var16 & 0x7, arg8, var22.field6489 * -1620436983, var22.field6503 * -1166461741, var21);
					int var24 = arg4 + class339.method7051(var17 & 0x7, var16 & 0x7, arg8, var22.field6489 * -1620436983, var22.field6503 * -1166461741, var21);
					if (var23 > 0 && var24 > 0 && var23 < this.field3627 * 993135469 - 1 && var24 < this.field3643 * -241162669 - 1) {
						class361 var25 = null;
						if (!this.field3644) {
							int var26 = arg2;
	...
	public final void method14304(class14 arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, class361 arg8, int arg9) {
		if (arg2 < this.field8893 * -304180941) {
			this.field8893 = arg2 * -1362112005;
		}
		...
		int var13;
		if (arg6 == 1 || arg6 == 3) {
			var12 = var11.field6503 * -1166461741;
			var13 = var11.field6489 * -1620436983;
		} else {
			var12 = var11.field6489 * -1620436983;
			var13 = var11.field6503 * -1166461741;
		}
		int var14;
		int var15;
		if (arg3 + var12 <= this.field3627 * 993135469) {
			var14 = (var12 >> 1) + arg3;
		...
		int var16;
		int var17;
		if (arg4 + var13 <= this.field3643 * -241162669) {
			var16 = (var13 >> 1) + arg4;
		...
		if (field8895 && (class542.method2616(arg7) && var11.field6497 * 1412299553 != 1 || !(!class542.method11327(arg7) || var11.field6497 * 1412299553 != 0))) {
			return;
		}
		if (class542.field6589.field6590 * -1082126853 == arg7) {
			if (Statics.field4961.field9671.method15725() != 0 || var11.field6493 * -1110036101 != 0 || var11.field6491 * -420372767 == 1 || var11.field6523) {
				class970 var25;
				if (var23) {
					...
					var25 = new class658(this.field3619, arg0, this.field8894, var11, arg2, arg1, var20, var19, var21, this.field3644, arg6, arg9);
				}
				this.field3619.method7512(arg2, arg3, arg4, var25);
				if (var11.field6491 * -420372767 == 1 && arg8 != null) {
					arg8.method6266(arg3, arg4);
				}
			}
		} else if (class542.field6572.field6590 * -1082126853 == arg7 || class542.field6588.field6590 * -1082126853 == arg7) {
			class659 var28 = null;
			int var30;
			class974 var31;
			if (var23) {
				...
				var31 = new class657(this.field3619, arg0, this.field8894, var11, arg2, arg1, var20, var19, var21, this.field3644, arg3, arg3 + var12 - 1, arg4, arg4 + var13 - 1, arg7, arg6, arg9);
				var30 = 15;
			}
			...
			if (var11.field6491 * -420372767 != 0 && arg8 != null) {
			...
			if (var23) {
				...
				var27 = new class657(this.field3619, arg0, this.field8894, var11, arg2, arg1, var20, var19, var21, this.field3644, arg3, arg3 + var12 - 1, arg4, arg4 + var13 - 1, arg7, arg6, arg9);
			}
			this.field3619.method7412(var27, false);
			if (this.field3632 && !this.field3644 && class542.method11327(arg7) && class542.field6568.field6590 * -1082126853 != arg7 && arg2 > 0 && var11.field6497 * 1412299553 != 0) {
	...
	public boolean method14285(class14 arg0, int arg1, int arg2, boolean arg3, class540 arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, boolean arg13, class12 arg14, class361 arg15, int arg16, int arg17) {
		if (class542.field6591.field6590 * -1082126853 == arg1) {
			int var19 = arg4.field6497 * 1412299553;
			if (field8884 && arg4.field6497 * 1412299553 == -1) {
				var19 = 1;
			}
			class972 var21;
			if (arg3) {
				...
				var21 = new class663(this.field3619, arg0, this.field8894, arg4, arg6, arg7, arg8, arg9, arg10, this.field3644, arg1, arg2, arg5);
			}
			...
			if (arg2 == 0) {
				...
				if (var19 == 1 && !this.field3644) {
					this.field3619.field4493.method7615(1, arg6, arg11, arg12, arg4.field6535 * 50356813, arg4.field6499 * 47876929);
				}
			} else if (arg2 == 1) {
				if (this.field3632 && arg4.field6513) {
					arg14.method192(arg11, arg12 + 1, 50);
				...
				if (var19 == 1 && !this.field3644) {
					this.field3619.field4493.method7615(2, arg6, arg11, arg12 + 1, arg4.field6535 * 50356813, -(arg4.field6499 * 47876929));
				}
			} else if (arg2 == 2) {
				if (this.field3632 && arg4.field6513) {
				...
				if (var19 == 1 && !this.field3644) {
					this.field3619.field4493.method7615(1, arg6, arg11 + 1, arg12, arg4.field6535 * 50356813, -(arg4.field6499 * 47876929));
				}
			} else if (arg2 == 3) {
				if (this.field3632 && arg4.field6513) {
					arg14.method192(arg11, arg12, 50);
				...
				if (var19 == 1 && !this.field3644) {
					this.field3619.field4493.method7615(2, arg6, arg11, arg12, arg4.field6535 * 50356813, arg4.field6499 * 47876929);
				}
			}
			if (arg4.field6491 * -420372767 != 0 && arg15 != null) {
				arg15.method6296(arg11, arg12, arg1, arg2, arg4.field6492, !arg4.field6481);
			}
			if (arg4.field6502 * -855067211 != 64) {
				this.field3619.method7422(arg6, arg11, arg12, arg4.field6502 * -855067211);
			}
			return true;
		} else if (class542.field6575.field6590 * -1082126853 == arg1) {
			class972 var23;
			if (arg3) {
				...
				var23 = new class663(this.field3619, arg0, this.field8894, arg4, arg6, arg7, arg8, arg9, arg10, this.field3644, arg1, arg2, arg5);
			}
			...
			return true;
		} else if (class542.field6569.field6590 * -1082126853 == arg1) {
			...
			if (arg3) {
				...
				var27 = new class663(this.field3619, arg0, this.field8894, arg4, arg6, arg7, arg8, arg9, arg10, this.field3644, arg1, arg2 + 4, arg5);
				var28 = new class663(this.field3619, arg0, this.field8894, arg4, arg6, arg7, arg8, arg9, arg10, this.field3644, arg1, var24, arg5);
			}
			this.field3619.method7402(arg6, arg11, arg12, var27, var28);
			if ((arg4.field6497 * 1412299553 == 1 || field8884 && arg4.field6497 * 1412299553 == -1) && !this.field3644) {
				if (arg2 == 0) {
					this.field3619.field4493.method7615(1, arg6, arg11, arg12, arg4.field6535 * 50356813, arg4.field6499 * 47876929);
					this.field3619.field4493.method7615(2, arg6, arg11, arg12 + 1, arg4.field6535 * 50356813, arg4.field6499 * 47876929);
				} else if (arg2 == 1) {
			...
			return true;
		} else if (class542.field6570.field6590 * -1082126853 == arg1) {
			class972 var30;
			if (arg3) {
				...
				var30 = new class663(this.field3619, arg0, this.field8894, arg4, arg6, arg7, arg8, arg9, arg10, this.field3644, arg1, arg2, arg5);
			}
			...
			return true;
		} else if (class542.field6567.field6590 * -1082126853 == arg1) {
			class974 var32;
			if (arg3) {
				...
				var32 = new class657(this.field3619, arg0, this.field8894, arg4, arg6, arg7, arg8, arg9, arg10, this.field3644, arg11, arg11 + arg16 - 1, arg12, arg12 + arg17 - 1, arg1, arg2, arg5);
			}
			this.field3619.method7412(var32, false);
			if (arg4.field6497 * 1412299553 == 1 && !this.field3644) {
				byte var33;
				if ((arg2 & 0x1) == 0) {
					var33 = 8;
				} else {
				...
				this.field3619.field4493.method7615(var33, arg6, arg11, arg12, arg4.field6535 * 50356813, 0);
			}
			if (arg4.field6491 * -420372767 != 0 && arg15 != null) {
	...
	public boolean method14275(class14 arg0, int arg1, int arg2, boolean arg3, class540 arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12) {
		if (class542.field6577.field6590 * -1082126853 == arg1) {
			class971 var15;
			if (arg3) {
				...
				var15 = new class662(this.field3619, arg0, this.field8894, arg4, arg6, arg7, arg8, arg9, arg10, this.field3644, 0, 0, arg1, arg2, arg5);
			}
			this.field3619.method7420(arg6, arg11, arg12, var15, null);
			return true;
		} else if (class542.field6573.field6590 * -1082126853 == arg1) {
			int var16 = 65;
			class113 var17 = (class113) this.field3619.method7433(arg6, arg11, arg12);
			if (var17 != null) {
				var16 = this.field8894.method11471(var17.method2401()).field6502 * -855067211 + 1;
			}
			class971 var19;
			if (arg3) {
				...
				var19 = new class662(this.field3619, arg0, this.field8894, arg4, arg6, arg7, arg8, arg9, arg10, this.field3644, field8890[arg2] * var16, field8886[arg2] * var16, arg1, arg2, arg5);
			}
			this.field3619.method7420(arg6, arg11, arg12, var19, null);
			return true;
		} else if (class542.field6574.field6590 * -1082126853 == arg1) {
			int var20 = 33;
			class113 var21 = (class113) this.field3619.method7433(arg6, arg11, arg12);
			if (var21 != null) {
				var20 = this.field8894.method11471(var21.method2401()).field6502 * -855067211 / 2 + 1;
			}
			class971 var23;
			if (arg3) {
				...
				var23 = new class662(this.field3619, arg0, this.field8894, arg4, arg6, arg7, arg8, arg9, arg10, this.field3644, field8891[arg2] * var20, field8892[arg2] * var20, arg1, arg2 + 4, arg5);
			}
			this.field3619.method7420(arg6, arg11, arg12, var23, null);
			return true;
		} else if (class542.field6581.field6590 * -1082126853 == arg1) {
			...
			if (arg3) {
				...
				var26 = new class662(this.field3619, arg0, this.field8894, arg4, arg6, arg7, arg8, arg9, arg10, this.field3644, 0, 0, arg1, var24 + 4, arg5);
			}
			this.field3619.method7420(arg6, arg11, arg12, var26, null);
			return true;
		} else if (class542.field6576.field6590 * -1082126853 == arg1) {
			int var27 = arg2 + 2 & 0x3;
			int var28 = 33;
			class113 var29 = (class113) this.field3619.method7433(arg6, arg11, arg12);
			if (var29 != null) {
				var28 = this.field8894.method11471(var29.method2401()).field6502 * -855067211 / 2 + 1;
			}
			class971 var32;
			class971 var33;
			if (arg3) {
				...
				class662 var34 = new class662(this.field3619, arg0, this.field8894, arg4, arg6, arg7, arg8, arg9, arg10, this.field3644, field8891[arg2] * var28, field8892[arg2] * var28, arg1, arg2 + 4, arg5);
				class662 var35 = new class662(this.field3619, arg0, this.field8894, arg4, arg6, arg7, arg8, arg9, arg10, this.field3644, 0, 0, arg1, var27 + 4, arg5);
				var32 = var34;
				var33 = var35;
			}
	...
	public void method14280(class14 arg0, int arg1, int arg2, int arg3, int arg4, class361 arg5) {
		...
		if (arg2 == 0) {
			...
			if (var8.field6491 * -420372767 != 0 && var8.field6489 * -1620436983 + arg3 < this.field3627 * 993135469 && var8.field6489 * -1620436983 + arg4 < this.field3643 * -241162669 && var8.field6503 * -1166461741 + arg3 < this.field3627 * 993135469 && var8.field6503 * -1166461741 + arg4 < this.field3643 * -241162669) {
				arg5.method6269(arg3, arg4, var8.field6489 * -1620436983, var8.field6503 * -1166461741, var10, var8.field6492, !var8.field6481);
			}
			if (class542.field6567.field6590 * -1082126853 == var9) {
				if ((var10 & 0x1) == 0) {
	...
	public final void method14291(class14 arg0, boolean arg1) {
		...
		if (!arg1) {
			if (this.field3628 * -2050894459 > 1) {
				for (int var3 = 0; var3 < this.field3627 * 993135469; var3++) {
					for (int var4 = 0; var4 < this.field3643 * -241162669; var4++) {
				...
				for (int var6 = 0; var6 <= this.field3643 * -241162669; var6++) {
					for (int var7 = 0; var7 <= this.field3627 * 993135469; var7++) {
						if ((this.field3659[var5][var7][var6] & 0x4) != 0) {
							...
							while (var11 < this.field3643 * -241162669 && (this.field3659[var5][var7][var11 + 1] & 0x4) != 0 && var11 - var10 < 10) {
								var11++;
							}
							...
							label95: while (var9 < this.field3627 * 993135469 && var9 - var8 < 10) {
