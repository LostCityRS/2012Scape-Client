...
public class class769 extends class399 {
	...
	public static int method12480(int arg0, int arg1, boolean arg2) {
		class769 var3 = method11708(arg0, arg2);
		if (var3 == null) {
			return -1;
	...
	public static int method1946(int arg0, int arg1, boolean arg2, boolean arg3) {
		class769 var4 = method11708(arg0, arg3);
		if (var4 == null) {
			return 0;
		}
		int var5 = 0;
		for (int var6 = 0; var6 < var4.field9276.length; var6++) {
			if (var4.field9276[var6] >= 0 && var4.field9276[var6] < Statics.field3492.field7144 * 28572021) {
				class592 var7 = Statics.field3492.method12316(var4.field9276[var6]);
				int var8 = var7.method12250(arg1, Statics.field4464.method12600(arg1).field7287 * -800027367);
				if (arg2) {
	...
	public static int method11844(int arg0, boolean arg1) {
		...
		class769 var2 = method11708(arg0, arg1);
		if (var2 == null) {
			return Statics.field495.method12644(arg0).field9802 * -1118342953;
		}
		int var3 = 0;
		...
		return var3 + (Statics.field495.method12644(arg0).field9802 * -1118342953 - var2.field9276.length);
	}

	@ObfuscatedName("th.m(IZB)Lacx;")
	public static class769 method11708(int arg0, boolean arg1) {
		long var2 = (long) (arg0 | (arg1 ? Integer.MIN_VALUE : 0));
		return (class769) field9273.method11923(var2);
	}
	...
	public final class13 method14751(class14 arg0, int arg1, class553 arg2, int arg3, boolean arg4, class471 arg5) {
		...
		if (var7 == null || arg0.method519(var7.method329(), var8) != 0) {
			...
			var7 = arg0.method625(var27, var15, Statics.field2101 * -1428645065, 65, 855);
			if (arg5 != null) {
	...
	public static void method1319(int arg0) {
		Statics.field2101 = arg0 * 318376583;
