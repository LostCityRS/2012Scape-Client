...
public class class777 extends class399 {
	...
	public class777(class682 arg0, class672 arg1, class780 arg2, int[] arg3) {
		...
		this.field9324 = arg2;
		this.field9333 = arg1;
		int var5 = this.field9324.method14880() - (arg1.field385 * 1570646497 >> 1);
		this.field9325 = this.field9324.method14888() - var5 >> arg1.field388 * -452021343;
		this.field9326 = this.field9324.method14888() + var5 >> arg1.field388 * -452021343;
		this.field9327 = this.field9324.method14879() - var5 >> arg1.field388 * -452021343;
		this.field9328 = this.field9324.method14879() + var5 >> arg1.field388 * -452021343;
		...
		for (int var8 = 0; var8 <= var7; var8++) {
			...
			if (var9 > 0 && var9 < this.field9333.field386 * -1903733271 - 1) {
				for (int var10 = 0; var10 <= var6; var10++) {
					int var11 = this.field9325 + var10;
					if (var11 > 0 && var11 < this.field9333.field387 * 569721097 - 1) {
		...
		for (int var16 = this.field9327; var16 <= this.field9328; var16++) {
			if (var16 >= 0 && var16 < arg1.field386 * -1903733271) {
				for (int var17 = this.field9325; var17 <= this.field9326; var17++) {
					if (var17 >= 0 && var17 < arg1.field387 * 569721097) {
		...
		if (this.field9336 > 0) {
			...
			for (int var23 = this.field9327; var23 <= this.field9328; var23++) {
				if (var23 >= 0 && var23 < arg1.field386 * -1903733271) {
					int var24 = 0;
					for (int var25 = this.field9325; var25 <= this.field9326; var25++) {
						if (var25 >= 0 && var25 < arg1.field387 * 569721097) {
							...
							if (var27 != null && var26 != 0) {
								if (var26 == 1) {
									...
									this.method14856(var24, var21, var25, var23, arg1.field385 * 1570646497, 0);
									this.method14856(var24, var21, var25, var23, 0, arg1.field385 * 1570646497);
								} else if (var26 == 2) {
									this.method14856(var24, var21, var25, var23, arg1.field385 * 1570646497, 0);
									this.method14856(var24, var21, var25, var23, arg1.field385 * 1570646497, arg1.field385 * 1570646497);
									this.method14856(var24, var21, var25, var23, 0, 0);
								} else if (var26 == 5) {
									this.method14856(var24, var21, var25, var23, arg1.field385 * 1570646497, arg1.field385 * 1570646497);
									this.method14856(var24, var21, var25, var23, 0, arg1.field385 * 1570646497);
			...
			this.field9322 = this.field9330.method13345(5123, this.field9338.field9629, this.field9338.field9626 * 803401371, false);
			this.field9332 = this.field9330.method13301(16, this.field9339.field9629, this.field9339.field9626 * 803401371, false);
	...
	public void method14856(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		long var7 = -1L;
		int var9 = (arg2 << this.field9333.field388 * -452021343) + arg4;
		int var10 = (arg3 << this.field9333.field388 * -452021343) + arg5;
		...
		} else if (this.field9333.field385 * 1570646497 == arg4 && arg5 == 0) {
			var14 = this.field9335[arg0 + 1][arg1];
			var15 = this.field9329[arg0 + 1][arg1];
			var16 = this.field9337[arg0 + 1][arg1];
		} else if (this.field9333.field385 * 1570646497 == arg4 && this.field9333.field385 * 1570646497 == arg5) {
			var14 = this.field9335[arg0 + 1][arg1 + 1];
			var15 = this.field9329[arg0 + 1][arg1 + 1];
			var16 = this.field9337[arg0 + 1][arg1 + 1];
		} else if (arg4 == 0 && this.field9333.field385 * 1570646497 == arg5) {
			var14 = this.field9335[arg0][arg1 + 1];
			var15 = this.field9329[arg0][arg1 + 1];
			var16 = this.field9337[arg0][arg1 + 1];
		} else {
			float var17 = (float) arg4 / (float) (this.field9333.field385 * 1570646497);
			float var18 = (float) arg5 / (float) (this.field9333.field385 * 1570646497);
