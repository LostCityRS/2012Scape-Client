...
@ObfuscatedName("ace")
public final class class785 extends class399 {

	@ObfuscatedName("ace.z")
	public static final class785 field9419 = new class785(0, -1);
	...
	public class785(int arg0, int arg1) {
		this.field9416 = arg0 * 380566261;
		this.field9423 = arg1 * -174945983;
	}

	@ObfuscatedName("ace.u(S)Z")
	public final boolean method14927() {
		return (this.field9416 * -117939875 & 0x1) != 0;
	}

	@ObfuscatedName("ace.j(IB)Z")
	public final boolean method14948(int arg0) {
		return (this.field9416 * -117939875 >> arg0 + 1 & 0x1) != 0;
	}

	@ObfuscatedName("ace.a(I)I")
	public final int method14928() {
		return method15568(this.field9416 * -117939875);
	}
