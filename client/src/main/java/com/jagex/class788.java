...
public class class788 extends class399 {
	...
	public void method14978(int arg0) {
		if (this.field9429 == null) {
			...
			class531.method11338(this.field9429, 0, this.field9429 = new class217[arg0], 0, this.field9430 * 2083669757);
		}
	}
	...
	public int[] method14965() {
		if (this.field9431 == null) {
			String[] var1 = new String[this.field9430 * 2083669757];
			this.field9431 = new int[this.field9430 * 2083669757];
			int var2 = 0;
			while (var2 < this.field9430 * 2083669757) {
	...
	public void method14981(class217 arg0) {
		if (this.field9429 == null || this.field9430 * 2083669757 >= this.field9429.length) {
			this.method14978(this.field9430 * 2083669757 + 5);
		}
		this.field9429[(this.field9430 += -895580587) * 2083669757 - 1] = arg0;
		this.field9431 = null;
	}

	@ObfuscatedName("adh.s(IB)V")
	public void method14964(int arg0) {
		this.field9430 -= -895580587;
		if (this.field9430 * 2083669757 == 0) {
			this.field9429 = null;
		} else {
			class531.method11338(this.field9429, arg0 + 1, this.field9429, arg0, this.field9430 * 2083669757 - arg0);
		}
		this.field9431 = null;
	}
	...
	public int method14963(String arg0) {
		for (int var2 = 0; var2 < this.field9430 * 2083669757; var2++) {
	...
	public void method14967(class814 arg0) {
		...
		this.field4228 = arg0.method15246() * -6168139600691503225L;
		this.field9435 = arg0.method15246() * 3857494019174481845L;
		this.field9427 = arg0.method15337();
		arg0.method15220();
		this.field9432 = arg0.method15238();
		this.field9434 = arg0.method15238();
		this.field9430 = arg0.method15239() * -895580587;
		if (this.field9430 * 2083669757 <= 0) {
			return;
		}
		this.field9429 = new class217[this.field9430 * 2083669757];
		for (int var3 = 0; var3 < this.field9430 * 2083669757; var3++) {
			...
			var4.field2341 = arg0.method15239() * -527818015;
