...
public class class791 extends class399 {
	...
	public class791(class683 arg0, class673 arg1, class780 arg2, int[] arg3) {
		...
		this.field9450 = arg2;
		this.field9448 = arg1;
		int var5 = this.field9450.method14880() - (arg1.field385 * 1570646497 >> 1);
		this.field9451 = this.field9450.method14888() - var5 >> arg1.field388 * -452021343;
		this.field9452 = this.field9450.method14888() + var5 >> arg1.field388 * -452021343;
		this.field9453 = this.field9450.method14879() - var5 >> arg1.field388 * -452021343;
		this.field9454 = this.field9450.method14879() + var5 >> arg1.field388 * -452021343;
		...
		for (int var8 = 0; var8 <= var7; var8++) {
			...
			if (var9 > 0 && var9 < this.field9448.field386 * -1903733271 - 1) {
				for (int var10 = 0; var10 <= var6; var10++) {
					int var11 = this.field9451 + var10;
					if (var11 > 0 && var11 < this.field9448.field387 * 569721097 - 1) {
						...
						if (var25 >= 0 && var25 < arg1.field387 * 569721097) {
							...
							if (var27 != null && var26 != 0) {
								if (var26 == 1) {
									...
									this.method15016(var24, var21, var25, var23, arg1.field385 * 1570646497, 0);
									this.method15016(var24, var21, var25, var23, 0, arg1.field385 * 1570646497);
								} else if (var26 == 2) {
									this.method15016(var24, var21, var25, var23, arg1.field385 * 1570646497, 0);
									this.method15016(var24, var21, var25, var23, arg1.field385 * 1570646497, arg1.field385 * 1570646497);
									this.method15016(var24, var21, var25, var23, 0, 0);
								} else if (var26 == 5) {
									this.method15016(var24, var21, var25, var23, arg1.field385 * 1570646497, arg1.field385 * 1570646497);
									this.method15016(var24, var21, var25, var23, 0, arg1.field385 * 1570646497);
	...
	public void method15016(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		long var7 = -1L;
		int var9 = (arg2 << this.field9448.field388 * -452021343) + arg4;
		int var10 = (arg3 << this.field9448.field388 * -452021343) + arg5;
		...
		} else if (this.field9448.field385 * 1570646497 == arg4 && arg5 == 0) {
			var15 = this.field9457[arg0 + 1][arg1];
			var16 = this.field9458[arg0 + 1][arg1];
			var17 = this.field9462[arg0 + 1][arg1];
		} else if (this.field9448.field385 * 1570646497 == arg4 && this.field9448.field385 * 1570646497 == arg5) {
			var15 = this.field9457[arg0 + 1][arg1 + 1];
			var16 = this.field9458[arg0 + 1][arg1 + 1];
			var17 = this.field9462[arg0 + 1][arg1 + 1];
		} else if (arg4 == 0 && this.field9448.field385 * 1570646497 == arg5) {
			var15 = this.field9457[arg0][arg1 + 1];
			var16 = this.field9458[arg0][arg1 + 1];
			var17 = this.field9462[arg0][arg1 + 1];
		} else {
			float var18 = (float) arg4 / (float) (this.field9448.field385 * 1570646497);
			float var19 = (float) arg5 / (float) (this.field9448.field385 * 1570646497);
