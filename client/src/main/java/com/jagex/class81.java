...
public abstract class class81 {
	...
	@ObfuscatedName("bg.t")
	public final class682 field1054;
	...
	public class81(class682 arg0, int arg1, class124 arg2, class139 arg3, int arg4, boolean arg5) {
		this.field1054 = arg0;
		this.field1049 = arg1;
		this.field1050 = arg2;
		this.field1051 = arg3;
	...
	public int method2052() {
		int var1 = this.field1051.field1508 * 177989933 * this.field1050.field1306 * 834722433 * this.field1052;
	...
	public static void method2054(int arg0, int arg1, int arg2, int arg3, class124 arg4, byte[] arg5) {
		if (arg2 > 0 && !class595.method11258(arg2)) {
			...
			int var6 = arg4.field1306 * 834722433;
			int var7 = 0;
			int var8 = arg2 < arg3 ? arg2 : arg3;
			int var9 = arg2 >> 1;
			int var10 = arg3 >> 1;
			...
			while (true) {
				OpenGL.glTexImage2Dub(arg0, var7, arg1, arg2, arg3, 0, class682.method13334(arg4), 5121, var11, 0);
				if (var8 <= 1) {
					return;
				}
				int var13 = arg2 * var6;
	...
	public static void method2059(int arg0, int arg1, int arg2, int arg3, class124 arg4, float[] arg5) {
		if (arg2 > 0 && !class595.method11258(arg2)) {
			...
			while (true) {
				OpenGL.glTexImage2Df(arg0, var7, arg1, arg2, arg3, 0, class682.method13334(arg4), 5126, var11, 0);
				if (var8 <= 1) {
					return;
				}
				int var13 = arg2 * var6;
