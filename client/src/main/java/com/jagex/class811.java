...
public class class811 extends class399 {
	...
	public void method15214() {
		this.field9601 = this.field9600.field1240 * -1233535653;
		this.field9603 = this.field9600.field1241 * -453593973;
		this.field9599 = this.field9600.field1242 * 98661067;
		if (this.field9600.field1237 != null) {
			this.field9600.field1237.method5392((float) (this.field9602.field2754 * 2118202961), (float) (this.field9602.field2763 * -1469725003), (float) (this.field9602.field2765 * 1368717711), field9606);
		}
