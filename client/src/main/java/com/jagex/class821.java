...
public class class821 extends class403 {
	...
	public class821(int arg0, class334 arg1, int arg2) {
		super(arg0);
		this.field9747 = arg1;
		this.field9748 = arg2 * 1549419187;
	}

	@ObfuscatedName("aeh.u([BI)I")
	public int method7032(byte[] arg0) throws IOException {
		if (this.field9750 == null) {
			if (!this.field9747.method5629(this.field9748 * 587218043, 0)) {
				return 0;
			}
			byte[] var2 = this.field9747.method5627(this.field9748 * 587218043, 0);
			if (var2 == null) {
		...
		if (this.field9746 * -1318738379 >= this.field9750.length) {
			return -1;
		}
		this.method15486();
		...
		this.field9752.field9626 = 0;
		do {
			if (this.field9752.field9626 * 803401371 >= this.field9752.field9629.length) {
			...
			if (this.field9751.field9629 == null) {
				if (this.field9749[0] == null) {
					this.field9752.field9629 = null;
					return this.field9752.field9626 * 803401371;
				}
				this.field9751.field9629 = this.field9749[0];
			}
			int var5 = this.field9752.field9629.length - this.field9752.field9626 * 803401371;
			int var6 = this.field9751.field9629.length - this.field9751.field9626 * 803401371;
			if (var5 < var6) {
				this.field9751.method15263(this.field9752.field9629, this.field9752.field9626 * 803401371, var5);
				this.field9752.field9629 = null;
				return arg0.length;
			}
			this.field9752.method15276(this.field9751.field9629, this.field9751.field9626 * 803401371, var6);
			this.field9751.field9629 = null;
			this.field9751.field9626 = 0;
			this.field9746 += -194970595;
			for (int var7 = 0; var7 < 9; var7++) {
				this.field9749[var7] = this.field9749[var7 + 1];
			}
			this.field9749[9] = null;
		} while (this.field9746 * -1318738379 < this.field9750.length);
		this.field9752.field9629 = null;
		return this.field9752.field9626 * 803401371;
	}
	...
	public void method15486() {
		...
		for (int var1 = 0; var1 < 10 && this.field9746 * -1318738379 + var1 < this.field9750.length; var1++) {
			if (this.field9749[var1] == null && this.field9747.method5629(this.field9750[this.field9746 * -1318738379 + var1], 0)) {
				this.field9749[var1] = this.field9747.method5627(this.field9750[this.field9746 * -1318738379 + var1], 0);
			}
		}
	}
}
