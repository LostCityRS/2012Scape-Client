...
@ObfuscatedName("aem")
public final class class824 extends class413 implements KeyListener, FocusListener {

	@ObfuscatedName("aem.di")
	public class547 field9773 = new class547();

	@ObfuscatedName("aem.dg")
	public class547 field9771 = new class547();
	...
	public class824(Component arg0) {
		method14809();
	...
	public void method15571(int arg0, char arg1, int arg2) {
		class808 var4 = new class808();
		var4.field9581 = arg0 * -277599349;
		var4.field9582 = arg1;
		var4.field9583 = arg2 * 342236439;
		var4.field9584 = class153.method5554() * 5477716073694604789L;
		this.field9771.method11558(var4);
	}

	@ObfuscatedName("aem.s(I)Lox;")
	public class415 method7237() {
		return (class415) this.field9773.method11560();
	}
	...
	public synchronized void method7231() {
		this.field9773.method11557();
		for (class808 var1 = (class808) this.field9771.method11560(); var1 != null; var1 = (class808) this.field9771.method11560()) {
			var1.field9580 = this.method15572() * 2118621063;
			if (var1.field9581 * -255089629 == 0) {
				if (!this.field9775[var1.field9583 * -1290474841]) {
					class808 var2 = new class808();
					var2.field9581 = 0;
					...
					this.field9775[var1.field9583 * -1290474841] = true;
				}
				var1.field9581 = -555198698;
				this.field9773.method11558(var1);
			} else if (var1.field9581 * -255089629 == 1) {
				if (this.field9775[var1.field9583 * -1290474841]) {
					this.field9773.method11558(var1);
					this.field9775[var1.field9583 * -1290474841] = false;
				}
			} else if (var1.field9581 * -255089629 == -1) {
				for (int var3 = 0; var3 < 112; var3++) {
					if (this.field9775[var3]) {
						class808 var4 = new class808();
						var4.field9581 = -277599349;
						var4.field9582 = (char) 65535;
						var4.field9583 = var3 * 342236439;
			...
			} else if (var1.field9581 * -255089629 == 3) {
				this.field9773.method11558(var1);
			}
		}
	}
	...
	public synchronized void keyTyped(KeyEvent arg0) {
		...
		if (var2 != 65535 && class524.method11687(var2)) {
