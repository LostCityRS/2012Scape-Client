...
@ObfuscatedName("afd")
public class class842 extends class537 {

	public class842(class815 arg0) {
		super(arg0);
	}

	public class842(int arg0, class815 arg1) {
		super(arg0, arg1);
	}

	@ObfuscatedName("afd.z(I)V")
	public void method15695() {
		if (this.field6461 * -402581687 != 0 && this.field6462.field9647.method15843() != 1) {
			this.field6461 = 0;
		}
		if (this.field6461 * -402581687 != 0 && this.field6462.field9641.method15741() == 2) {
			this.field6461 = 0;
		}
