...
@ObfuscatedName("agm")
public class class877 extends class580 {
	...
	public Socket method12150() throws IOException {
		...
		boolean var2 = this.field6815 * -1889081851 == 443;
		List var3;
		List var4;
		try {
	...
	public Socket method15951(Proxy arg0) throws IOException {
		...
		if (arg0.type() == Type.HTTP) {
			...
			var14.connect(new InetSocketAddress(this.field6814, this.field6815 * -1889081851));
			return var14;
		} else {
			return null;
		}
	...
	public Socket method15954(String arg0, int arg1, String arg2) throws IOException {
		...
		if (arg2 == null) {
			var5.write(("CONNECT " + this.field6814 + ":" + this.field6815 * -1889081851 + " HTTP/1.0\n\n").getBytes(Charset.forName("ISO-8859-1")));
		} else {
			var5.write(("CONNECT " + this.field6814 + ":" + this.field6815 * -1889081851 + " HTTP/1.0\n" + arg2 + "\n\n").getBytes(Charset.forName("ISO-8859-1")));
		}
		var5.flush();
