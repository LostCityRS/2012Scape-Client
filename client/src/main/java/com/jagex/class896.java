	...
	public class641 method13186() {
		if (this.field9953 == null) {
			...
			for (int var4 = 0; var4 < 6; var4++) {
				...
				int var6 = var5.field1252 * 424629663;
				if (var6 > var3) {
					var3 = var6;
				}
			...
			for (int var7 = 0; var7 < 6; var7++) {
				...
				if (var3 * var3 != field9959[var7].length) {
					...
					int var9 = var3 / (var8.field1252 * 424629663);
					int[] var10 = new int[var3 * var3];
					for (int var11 = 0; var11 < var8.field1252 * 424629663; var11++) {
						for (int var12 = 0; var12 < var8.field1252 * 424629663; var12++) {
							int var13 = var8.field1252 * 424629663 * var12 + var11;
