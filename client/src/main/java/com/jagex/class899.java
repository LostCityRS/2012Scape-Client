...
public final class class899 extends class683 {
	...
	public class739[] field10017 = new class739[16];

	@ObfuscatedName("ahv.he")
	public class747 field10026;

	@ObfuscatedName("ahv.hk")
	public int[] field10018;

	@ObfuscatedName("ahv.hy")
	public class716 field10027;
	...
	public class899(OpenGL arg0, Canvas arg1, long arg2, class16 arg3, class334 arg4, int arg5) {
		...
		try {
			...
			this.field10024 = Statics.method42() ? 33639 : 5121;
	...
	public class122 method456() {
		...
		return new class122(var1, "OpenGL", this.field10023, this.field10022, 0L);
	}
	...
	public class259 method13553(int arg0, boolean arg1, int[][] arg2) {
		return new class749(this, arg0, arg1, arg2);
	}
	...
	public class225 method13554(class124 arg0, int arg1, int arg2, int arg3, boolean arg4, byte[] arg5) {
		return new class738(this, arg0, arg1, arg2, arg3, arg4, arg5);
	}
	...
	public final class258 method13797(boolean arg0) {
		return new class747(this, class139.field1502, arg0);
	}
	...
	public void method13688(class230 arg0) {
		...
		for (int var7 = 0; var7 < var2.length; var7++) {
			...
			class739 var9 = this.field10017[var7];
			int var10 = 0;
	...
	public final void method13595(class258 arg0, class255 arg1, int arg2, int arg3, int arg4, int arg5) {
		...
		class747 var10 = (class747) arg0;
		var10.method5996();
		OpenGL.glDrawElements(var7, var8, method16090(var9), var10.method5995() + (long) (var9.field1508 * 177989933 * arg4));
	}
	...
	public final void method13596(class255 arg0, int arg1, int arg2, int arg3, int arg4) {
		...
		OpenGL.glDrawElements(var6, var7, method16090(var8), this.field10026.method5995() + (long) (var8.field1508 * 177989933 * arg3));
	}
	...
	public final synchronized void method444(int arg0) {
		...
		while (!this.field10005.method11585()) {
			...
			this.field10012[var2++] = (int) (var4.field4228 * 4763964654233859639L);
			this.field8252 -= var4.field9556 * 1720545541;
			if (var2 == 1000) {
		...
		while (!this.field10010.method11585()) {
			...
			this.field10012[var2++] = (int) (var5.field4228 * 4763964654233859639L);
			this.field8325 -= var5.field9556 * 1720545541;
			if (var2 == 1000) {
		...
		while (!this.field10007.method11585()) {
			...
			this.field10012[var2++] = var6.field9556 * 1720545541;
			if (var2 == 1000) {
		...
		while (!this.field10008.method11585()) {
			...
			this.field10012[var2++] = (int) (var7.field4228 * 4763964654233859639L);
			this.field8334 -= var7.field9556 * 1720545541;
			if (var2 == 1000) {
		...
		while (!this.field10009.method11585()) {
			...
			OpenGL.glDeleteProgram((int) (var10.field4228 * 4763964654233859639L));
		}
	...
	public static final int method16090(class139 arg0) {
		switch(arg0.field1507 * -1880950577) {
			case 0:
				return 5123;
			case 1:
			default:
	...
	public static int method16093(class124 arg0) {
