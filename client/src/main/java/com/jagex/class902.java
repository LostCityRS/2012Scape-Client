...
public class class902 extends class719 {
	...
	public int field10045 = -523537063;

	@ObfuscatedName("ahg.cb")
	public int field10053 = 1859268683;
	...
	public int field10054 = 798820501;

	@ObfuscatedName("ahg.ci")
	public int field10059 = -831898421;

	@ObfuscatedName("ahg.ca")
	public int field10056 = -726439911;

	@ObfuscatedName("ahg.ch")
	public int field10057 = 1398664255;
	...
	public int field10060 = 1508543679;
	...
	public final void method16116(class814 arg0) {
		...
		this.field10045 = arg0.method15238() * 523537063;
		this.field10053 = arg0.method15238() * -1859268683;
		this.field10066 = arg0.method15238() == 1;
		if (Statics.field6683 == class515.field6368 && client.field9074 * -1124661323 >= 2) {
			...
			if (Statics.field3226.field5171[var13] != 1) {
				...
				if (var14 == 0) {
					...
					if (var13 == 0 && var16 == 65535) {
						...
						this.field10061 = arg0.method15220() * -578609187;
						break;
					}
					if (var16 >= 16384) {
						...
						int var18 = var12[var13].field7116 * 507263829;
						if (var18 != 0) {
							this.field10061 = var18 * -578609187;
						}
					} else {
		...
		this.field10068 = arg0.method15239() * -1224160625;
		...
		this.field10047 = arg0.method15220() * 400232719;
		if (var4) {
			this.field10046 = arg0.method15239() * -812055325;
			if (this.field10046 * 1562140875 == 65535) {
				this.field10046 = 812055325;
			}
			this.field10048 = this.field10047 * -1994213099;
			this.field10049 = -1366251073;
		} else {
			this.field10046 = 0;
			this.field10048 = arg0.method15220() * -1890960069;
			this.field10049 = arg0.method15220() * 1366251073;
			if (this.field10049 * -1795442239 == 255) {
				this.field10049 = -1366251073;
			}
		}
		int var25 = this.field10039 * -1081290325;
		this.field10039 = arg0.method15220() * 829923587;
		if (this.field10039 * -1081290325 == 0) {
			class797.method7377(this);
		} else {
			int var26 = this.field10054 * 1583250755;
			int var27 = this.field10059 * -2025408739;
			int var28 = this.field10056 * 1677626327;
			int var29 = this.field10057 * -584582079;
			int var30 = this.field10060 * -1629725759;
			this.field10054 = arg0.method15239() * -798820501;
			this.field10059 = arg0.method15239() * 831898421;
			this.field10056 = arg0.method15239() * 726439911;
			this.field10057 = arg0.method15239() * -1398664255;
			this.field10060 = arg0.method15220() * 1875489857;
			if (this.field10051 != var3 || this.field10039 * -1081290325 != var25 || this.field10054 * 1583250755 != var26 || this.field10059 * -2025408739 != var27 || this.field10056 * 1677626327 != var28 || this.field10057 * -584582079 != var29 || this.field10060 * -1629725759 != var30) {
		...
		int var31 = this.field10044.field5006 * 1728403699;
		...
		if (client.field9071 * -663794775 == this.field8593 * 743663679 && var32 != null) {
	...
	public class425 method12812(class14 arg0) {
		...
		if (var6 == null || var6.field4552 == null) {
			this.field8604 = (int) ((float) (this.field8604 * -1333895207) - (float) (this.field8604 * -1333895207) / 10.0F) * 1854025833;
		} else {
			int var7 = this.field8604 * -1333895207 - var6.field4552.field10495;
			this.field8604 = (int) ((float) (this.field8604 * -1333895207) - (float) var7 / 10.0F) * 1854025833;
		}
		var2.method5115(var3);
		var2.method5116(0.0F, (float) (-20 - this.field8604 * -1333895207), 0.0F);
		class425 var8 = null;
		this.field8650 = false;
		if (Statics.field4961.field9658.method15709() == 1) {
			class439 var9 = this.method13959();
			if (var9.field4714 && (this.field10044.field5006 * 1728403699 == -1 || Statics.field3774.method12565(this.field10044.field5006 * 1728403699).field7249)) {
				...
				class13 var12 = class48.method1417(arg0, var5, this.field8601 * -2047932903, this.field8644 * 497815129, this.field8603 * -910583861, 1, this.field8651[0], 0, 0, 160, 240, var11 == null ? var10 : var11);
				if (var12 != null) {
		...
		if (Statics.field2119 == this) {
			for (int var13 = client.field8936.length - 1; var13 >= 0; var13--) {
				...
				if (var14 != null && var14.field779 * -139239579 != -1) {
					if (var14.field776 * 1409697523 == 1) {
						class798 var15 = (class798) client.field8964.method11923((long) (var14.field772 * -963193957));
						if (var15 != null) {
							...
							this.method16118(arg0, var2, this.field8651[0], (long) var18, (long) var19, var14.field779 * -139239579, 92160000L);
						}
					}
					if (var14.field776 * 1409697523 == 2) {
						class317 var20 = Statics.field2119.method8565().field3464;
						long var21 = (long) (var14.field778 * 1740366633 - (int) var20.field3475);
						long var23 = (long) (var14.field777 * -420786437 - (int) var20.field3477);
						long var25 = (long) (var14.field780 * 232650909 << 9);
						long var27 = var25 * var25;
						this.method16118(arg0, var2, this.field8651[0], var21, var23, var14.field779 * -139239579, var27);
					}
					if (var14.field776 * 1409697523 == 10 && var14.field772 * -963193957 >= 0 && var14.field772 * -963193957 < client.field9070.length) {
						class902 var29 = client.field9070[var14.field772 * -963193957];
						if (var29 != null) {
							...
							this.method16118(arg0, var2, this.field8651[0], (long) var31, (long) var32, var14.field779 * -139239579, 92160000L);
						}
					}
				}
			}
		...
		var2.method5115(var3);
		var2.method5116(0.0F, (float) (-5 - this.field8604 * -1333895207), 0.0F);
		...
		this.field9810 = client.field9042 * 337925345;
		return var8;
	}
	...
	public void method16118(class14 arg0, class314 arg1, class13 arg2, long arg3, long arg4, int arg5, long arg6) {
		...
		class13 var14 = class60.method8588(arg0, var13, this.field8601 * -2047932903, this.field8644 * 497815129, this.field8603 * -910583861, arg5);
		if (var14 != null) {
			arg0.method526(false);
	...
	public boolean method16119(class14 arg0, int arg1) {
		...
		int var7 = var4.field4712 * 155688425;
		int var8 = var4.field4713 * 527857753;
		if (var7 != 0 || var8 != 0 || var4.field4725 * -1524151789 != 0 || var4.field4728 * 728261879 != 0) {
			arg1 |= 0x7;
		}
		int var9 = this.field8638.method1387();
		boolean var10 = this.field8631 != 0 && client.field9213 * 1194705519 >= this.field8626 * -1722060697 && client.field9213 * 1194705519 < this.field8632 * 863449669;
		if (var10) {
			arg1 |= 0x80000;
		}
		...
		if (class385.field4152 * -879006469 < 96 && var12 > 50) {
			class59.method16899();
		}
		if (Statics.field6683 != class515.field6368 && var12 < 50) {
			int var13 = 50 - var12;
			while (var13 > client.field8930 * -1497647903) {
				Statics.field2391[client.field8930 * -1497647903] = new byte[102400];
				client.field8930 += 474255137;
			}
			while (var13 < client.field8930 * -1497647903) {
				client.field8930 -= 474255137;
				Statics.field2391[client.field8930 * -1497647903] = null;
			}
		...
		this.field8622 = var11.method278() * 134804529;
		var11.method275();
		this.method13972(var11);
		if (var7 == 0 && var8 == 0) {
			this.method13958(var9, this.method13954() << 9, this.method13954() << 9, 0, 0);
		} else {
			this.method13958(var9, var7, var8, var4.field4700 * 1077583527, var4.field4715 * 1127326567);
			if (this.field8601 * -2047932903 != 0) {
				var11.method397(this.field8601 * -2047932903);
			}
			if (this.field8644 * 497815129 != 0) {
				var11.method284(this.field8644 * 497815129);
			}
			if (this.field8603 * -910583861 != 0) {
				var11.method353(0, this.field8603 * -910583861, 0);
			}
		}
		if (var10) {
	...
	public final void method16131(int arg0, int arg1, byte arg2) {
		if (this.field8597.method11767() && this.field8597.method11804().field6330 * 1726698277 == 1) {
			this.field8615 = null;
			this.field8597.method11769(-1);
		}
		for (int var4 = 0; var4 < this.field8641.length; var4++) {
			if (this.field8641[var4].field1204 * 869063161 != -1) {
				class507 var5 = Statics.field4213.method11082(this.field8641[var4].field1204 * 869063161);
				if (var5.field5264 && var5.field5252 * 627575481 != -1 && Statics.field566.method11144(var5.field5252 * 627575481).field6330 * 1726698277 == 1) {
					this.field8641[var4].field1203.method11769(-1);
					this.field8641[var4].field1204 = 1661298615;
				}
			}
		}
		this.field10058 = 1084435625;
	...
	public final void method16124(int arg0, int arg1, byte arg2) {
		if (this.field8628 * 2126611325 < this.field8642.length - 1) {
			this.field8628 += 1057312213;
		}
		for (int var4 = this.field8628 * 2126611325; var4 > 0; var4--) {
	...
	public int method13954() {
		return this.field10044 == null || this.field10044.field5006 * 1728403699 == -1 ? super.method13954() : Statics.field3774.method12565(this.field10044.field5006 * 1728403699).field7213 * 665946395;
	}

	@ObfuscatedName("ahg.bm(I)I")
	public int method13960() {
		return this.field10068 * -917302161;
	}
	...
	public class117 method13963() {
		if (this.field8629 != null) {
			...
			if (client.field9177 * -1293107399 == 0 || client.field9177 * -1293107399 == 3 || client.field9177 * -1293107399 == 1 && client.method3546(this.field10040)) {
	...
	public void method16127(String arg0, int arg1, int arg2) {
		this.method13998(arg0, arg1, arg2, class385.method2809() * Statics.field4825.field5165 * 709648435);
	}

	@ObfuscatedName("ahg.u(I)Ladu;")
	public class810 method3684() {
		class453 var1 = client.field8980.method6214();
		return class810.method8611(this.field9807, (int) this.method8565().field3464.field3475 + var1.field4836 * -803526144, -((int) this.method8565().field3464.field3476), (int) this.method8565().field3464.field3477 + var1.field4838 * 836740608);
	}

	@ObfuscatedName("ahg.j(I)Lkn;")
	public class316 method3680() {
		class316 var1 = class316.method5206();
		var1.method5217(class312.method5096(this.field8638.field574 * 1394071457), 0.0F, 0.0F);
		return var1;
	}
	...
	public int method13970() {
		return -(this.field8593 * 743663679) - 1;
	}
}
