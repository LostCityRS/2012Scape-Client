...
public class class903 extends class719 {
	...
	public int field10080 = -1238829673;

	@ObfuscatedName("ahs.by")
	public int field10070 = 2027079059;

	@ObfuscatedName("ahs.bu")
	public class610 field10073;

	@ObfuscatedName("ahs.cl")
	public static int field10076 = -1208308025;

	@ObfuscatedName("ahs.cq")
	public static int field10074 = 1693340495;

	@ObfuscatedName("ahs.co")
	public int field10069 = 462492365;
	...
	public void method16160() {
		this.field10081 = ((int) (Math.random() * 4.0D) + 32) * 1766105271;
		this.field10082 = ((int) (Math.random() * 2.0D) + 3) * 1349127109;
		this.field10083 = ((int) (Math.random() * 3.0D) + 16) * -1845755633;
		if (Statics.field4961.field9659.method15686() == 1) {
			this.field10084 = (int) (Math.random() * 6.0D) * -991686533;
		} else {
			this.field10084 = (int) (Math.random() * 12.0D) * -991686533;
		}
	}

	@ObfuscatedName("ahs.gb(Lwq;I)V")
	public void method16149(class611 arg0) {
		if (this.field10075 != arg0 && class42.field585 && class42.method11169(this.field8593 * 743663679)) {
			class42.method3561();
		}
		this.field10075 = arg0;
		if (this.field10075 != null) {
			this.field10077 = this.field10075.field7212;
			this.field10072 = this.field10075.field7233 * -253816537;
		}
	...
	public class425 method12812(class14 arg0) {
		...
		var4.method5116(0.0F, (float) (-20 - this.field8604 * -1333895207), 0.0F);
		...
		if (Statics.field4961.field9658.method15709() == 1 && var9.field7249 && var8.field4714) {
			...
			class13 var13 = class48.method1417(arg0, var5, this.field8601 * -2047932903, this.field8644 * 497815129, this.field8603 * -910583861, this.field10075.field7213 * 665946395, this.field8651[0], this.field10075.field7236 & 0xFFFF, this.field10075.field7251 & 0xFFFF, this.field10075.field7252 & 0xFF, this.field10075.field7253 & 0xFF, var12 == null ? var11 : var12);
			if (var13 != null) {
		...
		for (int var14 = 0; var14 < this.field8651.length; var14++) {
			if (this.field8651[var14] != null) {
				if (this.field10075.field7275) {
					this.field8651[var14].method290(this.field10081 * -439599865, this.field10082 * 1840986893, this.field10083 * 1694420463, this.field10084 * -1701228877);
				}
	...
	public boolean method16151(class14 arg0, int arg1) {
		...
		boolean var9 = this.field8631 != 0 && client.field9213 * 1194705519 >= this.field8626 * -1722060697 && client.field9213 * 1194705519 < this.field8632 * 863449669;
		if (var9) {
			arg1 |= 0x80000;
		}
		...
		if (var7 == 0 && var8 == 0) {
			...
			this.method13958(var10, var7, var8, var4.field4700 * 1077583527, var4.field4715 * 1127326567);
			if (this.field8601 * -2047932903 != 0) {
				this.field8651[0].method397(this.field8601 * -2047932903);
			}
			if (this.field8644 * 497815129 != 0) {
				this.field8651[0].method284(this.field8644 * 497815129);
			}
			if (this.field8603 * -910583861 != 0) {
				this.field8651[0].method353(0, this.field8603 * -910583861, 0);
			}
		}
		if (var9) {
	...
	public final void method16152(class364 arg0, int arg1) {
		...
		switch(arg0.field3916 * -892007043) {
			case 0:
				var3--;
				break;
			case 1:
		...
		for (int var5 = 0; var5 < this.field8641.length; var5++) {
			if (this.field8641[var5].field1204 * 869063161 != -1) {
				class507 var6 = Statics.field4213.method11082(this.field8641[var5].field1204 * 869063161);
				if (var6.field5264 && var6.field5252 * 627575481 != -1 && Statics.field566.method11144(var6.field5252 * 627575481).field6330 * 1726698277 == 1) {
					this.field8641[var5].field1203.method11769(-1);
					this.field8641[var5].field1204 = 1661298615;
				}
			}
		}
		...
		for (int var7 = this.field8628 * 2126611325; var7 > 0; var7--) {
	...
	public void method16153(int arg0, int arg1, int arg2, boolean arg3, int arg4) {
		...
		for (int var6 = 0; var6 < this.field8641.length; var6++) {
			if (this.field8641[var6].field1204 * 869063161 != -1) {
				class507 var7 = Statics.field4213.method11082(this.field8641[var6].field1204 * 869063161);
				if (var7.field5264 && var7.field5252 * 627575481 != -1 && Statics.field566.method11144(var7.field5252 * 627575481).field6330 * 1726698277 == 1) {
					this.field8641[var6].field1203.method11769(-1);
					this.field8641[var6].field1204 = 1661298615;
				}
			}
		}
		if (!arg3) {
			...
			if (var8 >= -8 && var8 <= 8 && var9 >= -8 && var9 <= 8) {
				...
				for (int var10 = this.field8628 * 2126611325; var10 > 0; var10--) {
	...
	public int method13960() {
		if (this.field10069 * 1083627003 != -1) {
			return this.field10069 * 1083627003;
		}
		if (this.field10075.field7244 != null) {
			class611 var1 = this.field10075.method12516(Statics.field2669);
			if (var1 != null && var1.field7217 * -1527467755 != -1) {
				return var1.field7217 * -1527467755;
			}
		}
		return this.field10075.field7217 * -1527467755;
	}
	...
	public int method13961() {
		if (this.field10075.field7244 != null) {
			class611 var1 = this.field10075.method12516(Statics.field2669);
			if (var1 != null && var1.field7242 * -2056103739 != -1) {
				return var1.field7242 * -2056103739;
			}
		}
		return this.field10075.field7242 * -2056103739;
	}
	...
	public int method12811() {
		if (this.field10075.field7244 != null) {
			class611 var1 = this.field10075.method12516(Statics.field2669);
			if (var1 != null && var1.field7266 * -1878789395 != -1) {
				return var1.field7266 * -1878789395;
			}
		}
		return this.field10075.field7266 * -1878789395 == -1 ? super.method12811() : this.field10075.field7266 * -1878789395;
	}
	...
	public int method15633() {
		return this.field10075 == null ? 0 : this.field10075.field7274 * 929467387;
	}
	...
	public boolean method12814(class14 arg0, int arg1, int arg2) {
		...
		for (int var6 = 0; var6 < this.field8651.length; var6++) {
			if (this.field8651[var6] != null) {
				...
				label42: {
					label41: {
						if (this.field10075.field7274 * 929467387 <= 0) {
							if (this.field10075.field7229 * -1946156227 == -1) {
								if (this.field10075.field7213 * 665946395 != 1) {
									break label41;
								}
							} else if (this.field10075.field7229 * -1946156227 != 1) {
								break label41;
							}
						}
						var10000 = true;
				...
				boolean var8 = this.field8651[var6].method272(arg1, arg2, var4, var7, this.field10075.field7274 * 929467387);
				if (var8) {
					var5 = true;
					break;
				}
	...
	public void method16148(String arg0, int arg1, int arg2) {
		int var4 = class385.method2809() * Statics.field4825.field5163 * 1662663839;
