...
public class class936 extends class793 {
	...
	public void method15034(int[] arg0, int arg1, int arg2) {
		...
		for (class783 var4 = (class783) this.field10227.method11563(); var4 != null; var4 = (class783) this.field10227.method11567()) {
			if (!this.field10226.method16296(var4)) {
				...
				int var6 = arg2;
				do {
					if (var6 <= var4.field9392 * -2006945571) {
						this.method16255(var4, arg0, var5, var6, var5 + var6);
						var4.field9392 -= var6 * -627447947;
						break;
					}
					this.method16255(var4, arg0, var5, var4.field9392 * -2006945571, var5 + var6);
					var5 += var4.field9392 * -2006945571;
					var6 -= var4.field9392 * -2006945571;
	...
	public void method15046(int arg0) {
		...
		for (class783 var2 = (class783) this.field10227.method11563(); var2 != null; var2 = (class783) this.field10227.method11567()) {
			if (!this.field10226.method16296(var2)) {
				int var3 = arg0;
				do {
					if (var3 <= var2.field9392 * -2006945571) {
						this.method16256(var2, var3);
						var2.field9392 -= var3 * -627447947;
						break;
					}
					this.method16256(var2, var2.field9392 * -2006945571);
					var3 -= var2.field9392 * -2006945571;
	...
	public void method16255(class783 arg0, int[] arg1, int arg2, int arg3, int arg4) {
		if ((this.field10226.field10245[arg0.field9400 * 1901926767] & 0x4) != 0 && arg0.field9402 * 1653743229 < 0) {
			int var6 = this.field10226.field10250[arg0.field9400 * 1901926767] / Statics.field4015;
			while (true) {
				int var7 = (var6 + 1048575 - arg0.field9398 * 1131785337) / var6;
				if (var7 > arg3) {
					arg0.field9398 += arg3 * var6 * 208207305;
					break;
				}
				arg0.field9401.method15034(arg1, arg2, var7);
				arg2 += var7;
				arg3 -= var7;
				arg0.field9398 += (var6 * var7 - 1048576) * 208207305;
				...
				if (this.field10226.field10248[arg0.field9400 * 1901926767] == 0) {
					...
					this.field10226.method16280(arg0, arg0.field9384.field9406[arg0.field9388 * 863031185] < 0);
					arg0.field9401.method16399(var8, var10.method16442());
				}
				if (arg0.field9384.field9406[arg0.field9388 * 863031185] < 0) {
	...
	public void method16256(class783 arg0, int arg1) {
		if ((this.field10226.field10245[arg0.field9400 * 1901926767] & 0x4) != 0 && arg0.field9402 * 1653743229 < 0) {
			int var3 = this.field10226.field10250[arg0.field9400 * 1901926767] / Statics.field4015;
			int var4 = (var3 + 1048575 - arg0.field9398 * 1131785337) / var3;
			arg0.field9398 = (arg0.field9398 * 1131785337 + arg1 * var3 & 0xFFFFF) * 208207305;
			if (var4 <= arg1) {
				...
				arg1 = arg0.field9398 * 1131785337 / var3;
			}
		}
