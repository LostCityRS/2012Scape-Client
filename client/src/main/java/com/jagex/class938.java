...
public abstract class class938 extends class793 {
	...
	public final int method15049() {
		...
		if (this.field10265 == 0) {
			var2 -= this.field10266 * var2 / (((class941) this.field9474).method16496() << 8);
		} else if (this.field10265 >= 0) {
			var2 -= this.field10272 * var2 / ((class941) this.field9474).method16496();
		}
	...
	public final synchronized boolean method16393() {
		return this.field10266 < 0 || this.field10266 >= ((class941) this.field9474).method16496() << 8;
	}
