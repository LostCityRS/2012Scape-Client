...
public class class940 extends class793 {
	...
	public int field10288 = 1953176320;

	@ObfuscatedName("aiq.p")
	public int field10289 = 2030615296;
	...
	public class940(int arg0) {
		this.field10282 = arg0 * -1939979965;
	}

	@ObfuscatedName("aiq.an(II)V")
	public void method16466(int arg0) {
		this.field10288 = arg0 * -2089522405;
		this.field10289 = arg0 * 58263739;
	}
	...
	public synchronized void method15034(int[] arg0, int arg1, int arg2) {
		...
		if (this.method16468() != null) {
			...
			byte var5 = 0;
			byte var6 = 0;
			if (this.field10282 * 2091275115 == 2) {
				var6 = 1;
			}
			while (arg1 < var4) {
				...
				while (arg1 < var4 && this.field10283 * 299858255 < var8[0].length) {
					if (Statics.field4016) {
						arg0[arg1++] = this.field10288 * 1147139859 * var8[var5][this.field10283 * 299858255];
						arg0[arg1++] = this.field10289 * 67894387 * var8[var6][this.field10283 * 299858255];
					} else {
						int var10001 = arg1++;
						arg0[var10001] += this.field10289 * 67894387 * var8[var6][this.field10283 * 299858255] + this.field10288 * 1147139859 * var8[var5][this.field10283 * 299858255];
					}
					this.field10283 += 886570415;
				}
				if (this.field10283 * 299858255 >= var8[0].length) {
					this.method16465();
				}
			}
	...
	public synchronized void method15046(int arg0) {
		...
		while (true) {
			...
			if (var2.field9559[0].length - this.field10283 * 299858255 > arg0) {
				this.field10283 += arg0 * 886570415;
				return;
			}
			arg0 -= var2.field9559[0].length - this.field10283 * 299858255;
			this.method16465();
		}
	}
	...
	public synchronized int method16467() {
		return this.field10286 * 1823090897;
	}
	...
	public class804 method16470(int arg0, double arg1) {
		long var4 = (long) (this.field10282 * 2091275115 << 32 | arg0);
		class804 var6 = (class804) field10291.method5949(var4);
		if (var6 == null) {
			var6 = new class804(new short[this.field10282 * 2091275115][arg0], arg1);
		} else {
			var6.field9560 = arg1;
	...
	public synchronized void method16481(class804 arg0) {
		while (this.field10286 * 1823090897 >= 100) {
	...
	public synchronized double method16492() {
		if (this.field10286 * 1823090897 < 1) {
			return -1.0D;
		} else {
