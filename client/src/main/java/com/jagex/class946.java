...
public class class946 extends class800 {
	...
	public int method16648() {
		return this.field10345.field6662.field9552 == this.field10345.field6662 ? -1 : ((class944) this.field10345.field6662.field9552).field10340 * 1792371907;
	}
	...
	public boolean method16644(class944 arg0) {
		...
		while (var3 != null) {
			if (class42.method5825(arg0.field10340 * 1792371907, var3.field10340 * 1792371907)) {
				class552.method8542(arg0, var3);
				this.field10346 += -891285399;
				return !var2;
			}
	...
	public boolean method16650(class944 arg0) {
		...
		arg0.method15142();
		this.field10346 -= -891285399;
		if (this.field10346 * -490831911 != 0) {
			return var2 != this.method16648();
		}
		this.method6979();
		this.method15142();
		class42.field594 -= -1677134793;
		class42.field600.method7937(this, arg0.field10330 * 1051137087453776677L);
		return false;
	}
}
