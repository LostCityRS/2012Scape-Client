...
public class class947 extends class800 {
	...
	public class947(int arg0) {
		this.field10349 = arg0 * 752281343;
	}
	...
	public boolean method16652() {
		...
		if (this.field10348 == null) {
			...
			synchronized (Statics.field674) {
				if (!Statics.field674.method5631(this.field10349 * -675800833)) {
					return false;
				}
				int[] var2 = Statics.field674.method5683(this.field10349 * -675800833);
				this.field10348 = new byte[var2.length][];
				for (int var3 = 0; var3 < var2.length; var3++) {
					this.field10348[var3] = Statics.field674.method5627(this.field10349 * -675800833, var2[var3]);
				}
			}
		}
		boolean var5 = true;
