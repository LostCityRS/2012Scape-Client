...
public class class955 extends class800 {
		...
		if (arg1 == 1) {
			...
			for (int var6 = 0; var6 < var5; var6++) {
				...
				if (var8 != null) {
					...
					this.field10391[var6] = new int[var8.field5032 * 1407445239];
					for (int var9 = 0; var9 < var8.field5032 * 1407445239; var9++) {
	...
	public void method16748(class814 arg0, int[] arg1) {
		...
		for (int var3 = 0; var3 < this.field10390.length && var3 < arg1.length; var3++) {
			int var4 = this.method16752(var3).field5016 * 1434636691;
			if (var4 > 0) {
	...
	public String method16749(class814 arg0) {
		...
		if (this.field10390 != null) {
			for (int var3 = 0; var3 < this.field10390.length; var3++) {
				...
				var2.append(this.field10394.method12175(this.method16752(var3), this.field10391[var3], arg0.method15231(Statics.method15663(this.field10390[var3]).field5018 * -1333320381)));
			}
		}
