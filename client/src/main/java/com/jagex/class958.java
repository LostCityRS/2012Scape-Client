...
@ObfuscatedName("ajv")
public class class958 extends class803 {
	...
	public class958(OggStreamState arg0) {
		super(arg0);
	}
	...
	public void method15150(OggPacket arg0) {
		if (!this.field10406) {
			...
			if (var2 == 0) {
				...
				this.field10410 = this.field10420.getMaxPostProcessingLevel() * -1339352431;
				this.method16807(this.field10418 * -1790198793);
			} else if (var2 < 0) {
				throw new IllegalStateException("" + var2);
			}
			return;
		}
		this.field10414 = class153.method5554() * 5591859609110207519L;
	...
	public void method16807(int arg0) {
		this.field10418 = arg0 * 1280275911;
		if (!this.field10406) {
			return;
		}
		if (this.field10418 * -1790198793 > this.field10410 * 552330865) {
			this.field10418 = this.field10410 * 277923543;
		}
		if (this.field10418 * -1790198793 < 0) {
			this.field10418 = 0;
		}
		this.field10420.setPostProcessingLevel(this.field10418 * -1790198793);
	}
	...
	public long method16816() {
		return this.field10414 * -892683209377439777L;
	}
	...
	public Object method16817(class402 arg0) {
		if (this.field10405 == null) {
			return null;
		} else if (this.field10421 || this.field10415 == null) {
			this.field10415 = arg0.method7002(this.field10405.pixels, 0, this.field10405.field360 * -1899502241, this.field10405.field360 * -1899502241, this.field10405.field361 * 737948539, false);
