...
public final class class961 extends class809 {
	...
	public static void method1351(int arg0) {
		Statics.field10432 = arg0 * -1563335283;
	...
	public static class961 method7559(int arg0, int arg1, int arg2, long arg3, int arg4) {
		...
		synchronized (field10435) {
			class961 var7;
			if (Statics.field497 * 1105248573 == 0) {
				var7 = new class961();
			} else {
				var7 = field10435[(Statics.field497 -= -230220267) * 1105248573];
			}
			var7.field10436 = arg0 * -1650096423;
			var7.field10434 = arg1 * -383379859;
			var7.field10431 = arg2 * -1355990403;
			var7.field10433 = arg3 * 8725569792563943963L;
			var7.field10437 = arg4 * 608587729;
			return var7;
		}
	}
	...
	public void method15186() {
		...
		synchronized (field10435) {
			if (Statics.field497 * 1105248573 < Statics.field10432 * -1120180923 - 1) {
				field10435[(Statics.field497 += -230220267) * 1105248573 - 1] = this;
			}
		}
	}
}
