...
public class class964 extends class814 {
	...
	public void method16864(int arg0) {
		this.field9629[(this.field9626 += -1748220013) * 803401371 - 1] = (byte) (arg0 + this.field10473.method11968());
	}

	@ObfuscatedName("ajl.ii(I)Z")
	public boolean method16859() {
		int var1 = this.field9629[this.field9626 * 803401371] - this.field10473.method11963() & 0xFF;
		return var1 >= 128;
	}

	@ObfuscatedName("ajl.in(I)I")
	public int method16883() {
		int var1 = this.field9629[(this.field9626 += -1748220013) * 803401371 - 1] - this.field10473.method11968() & 0xFF;
		return var1 < 128 ? var1 : (var1 - 128 << 8) + (this.field9629[(this.field9626 += -1748220013) * 803401371 - 1] - this.field10473.method11968() & 0xFF);
	}

	@ObfuscatedName("ajl.ih([BIIB)V")
	public void method16861(byte[] arg0, int arg1, int arg2) {
		for (int var4 = 0; var4 < arg2; var4++) {
			arg0[arg1 + var4] = (byte) (this.field9629[(this.field9626 += -1748220013) * 803401371 - 1] - this.field10473.method11968());
		}
	}

	@ObfuscatedName("ajl.ig(I)V")
	public void method16862() {
		this.field10475 = this.field9626 * 2004570488;
	}

	@ObfuscatedName("ajl.ia(II)I")
	public int method16863(int arg0) {
		int var2 = this.field10475 * -1638669483 >> 3;
		int var3 = 8 - (this.field10475 * -1638669483 & 0x7);
		int var4 = 0;
		this.field10475 += arg0 * -798948867;
		while (arg0 > var3) {
	...
	public void method16881() {
		this.field9626 = (this.field10475 * -1638669483 + 7) / 8 * -1748220013;
	}

	@ObfuscatedName("ajl.iq(II)I")
	public int method16865(int arg0) {
		return arg0 * 8 - this.field10475 * -1638669483;
	}
}
