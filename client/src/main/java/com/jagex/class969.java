...
@ObfuscatedName("ajj")
public class class969 extends class818 {
	...
	public int field10489 = 652627724;

	@ObfuscatedName("ajj.v")
	public int field10490 = -666002020;

	@ObfuscatedName("ajj.k")
	public int field10491 = 1293379732;

	@ObfuscatedName("ajj.h")
	public int field10492 = -268678382;
	...
	public void method16887(int arg0, int[] arg1) {
		int var3 = this.field10490 * -457456553 * Statics.field7041[arg0];
		if (this.field10491 * -929517139 == 1) {
			short var4 = this.field10486[0];
			int var5 = this.field10485[0] << 12;
			int var6 = this.field10490 * -457456553 * var5 >> 12;
			int var7 = this.field10489 * 2138797291 * var5 >> 12;
			...
			if (this.field10493) {
				for (int var15 = 0; var15 < Statics.field7038 * 1661849899; var15++) {
					int var16 = this.field10489 * 2138797291 * Statics.field7040[var15];
					int var17 = this.method16892(var5 * var16 >> 12, var11, var13, var14, var12, var7);
					int var18 = var4 * var17 >> 12;
					arg1[var15] = (var18 >> 1) + 2048;
				}
			} else {
				for (int var19 = 0; var19 < Statics.field7038 * 1661849899; var19++) {
					int var20 = this.field10489 * 2138797291 * Statics.field7040[var19];
		...
		if (var22 > 8 || var22 < -8) {
			...
			int var24 = this.field10490 * -457456553 * var23 >> 12;
			int var25 = this.field10489 * 2138797291 * var23 >> 12;
			...
			for (int var33 = 0; var33 < Statics.field7038 * 1661849899; var33++) {
				int var34 = this.field10489 * 2138797291 * Statics.field7040[var33];
				int var35 = this.method16892(var23 * var34 >> 12, var29, var31, var32, var30, var25);
				arg1[var33] = var22 * var35 >> 12;
			}
		}
		for (int var36 = 1; var36 < this.field10491 * -929517139; var36++) {
			short var37 = this.field10486[var36];
			if (var37 > 8 || var37 < -8) {
				int var38 = this.field10485[var36] << 12;
				int var39 = this.field10490 * -457456553 * var38 >> 12;
				int var40 = this.field10489 * 2138797291 * var38 >> 12;
				...
				if (this.field10493 && this.field10491 * -929517139 - 1 == var36) {
					for (int var48 = 0; var48 < Statics.field7038 * 1661849899; var48++) {
						int var49 = this.field10489 * 2138797291 * Statics.field7040[var48];
					...
					for (int var52 = 0; var52 < Statics.field7038 * 1661849899; var52++) {
						int var53 = this.field10489 * 2138797291 * Statics.field7040[var52];
	...
	public void method16890() {
		this.field10487 = class589.method12215(this.field10488 * -904881431);
		this.method16891();
		for (int var1 = this.field10491 * -929517139 - 1; var1 >= 1; var1--) {
			short var2 = this.field10486[var1];
			if (var2 > 8 || var2 < -8) {
				break;
			}
			this.field10491 -= 1397086757;
		}
	}

	@ObfuscatedName("ajj.s(I)V")
	public void method16891() {
		if (this.field10492 * -126619685 > 0) {
			this.field10486 = new short[this.field10491 * -929517139];
			this.field10485 = new short[this.field10491 * -929517139];
			for (int var1 = 0; var1 < this.field10491 * -929517139; var1++) {
				this.field10486[var1] = (short) (Math.pow((double) ((float) (this.field10492 * -126619685) / 4096.0F), (double) var1) * 4096.0D);
				this.field10485[var1] = (short) Math.pow(2.0D, (double) var1);
			}
		} else if (this.field10486 != null && this.field10491 * -929517139 == this.field10486.length) {
			this.field10485 = new short[this.field10491 * -929517139];
			for (int var2 = 0; var2 < this.field10491 * -929517139; var2++) {
	...
	public static int[][] method15136(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, float arg6, boolean arg7) {
		...
		class969 var9 = new class969();
		var9.field10493 = arg7;
		var9.field10489 = arg3 * -910584893;
		var9.field10490 = arg4 * -1240242329;
		var9.field10491 = arg5 * 1397086757;
		var9.field10492 = (int) (arg6 * 4096.0F) * 256799827;
		var9.method16890();
