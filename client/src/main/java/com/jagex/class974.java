...
public abstract class class974 extends class836 {
	...
	public int method15639(class780[] arg0) {
		...
		if (this.field10513 != 0) {
			int var13 = this.field10510 - this.field9808.field4521 * 2043126695;
			int var14 = this.field10509 - this.field9808.field4503 * -59081765;
			short var15;
			int var16;
			int var17;
			short var18;
	...
	public boolean method15635() {
		for (int var1 = this.field10510; var1 <= this.field10508; var1++) {
			for (int var2 = this.field10509; var2 <= this.field10511; var2++) {
				int var3 = this.field9808.field4531 * 1827680811 + (var1 - this.field9808.field4521 * 2043126695);
				if (var3 >= 0 && var3 < this.field9808.field4544.length) {
					int var4 = this.field9808.field4531 * 1827680811 + (var2 - this.field9808.field4503 * -59081765);
