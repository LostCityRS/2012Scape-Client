...
public class class978 extends AbstractQueue {
	...
	public int size() {
		return this.field10520 * -1870242109;
	}
	...
	public boolean offer(Object arg0) {
		...
		this.field10517 += -439022545;
		int var2 = this.field10520 * -1870242109;
		if (var2 >= this.field10519.length) {
			this.method16917();
		}
		this.field10520 += 1418904043;
		if (var2 == 0) {
	...
	public Object peek() {
		return this.field10520 * -1870242109 == 0 ? null : this.field10519[0].field2774;
	}

	public Object poll() {
		if (this.field10520 * -1870242109 == 0) {
			return null;
		}
		this.field10517 += -439022545;
		...
		this.field10520 -= 1418904043;
		if (this.field10520 * -1870242109 == 0) {
			this.field10519[this.field10520 * -1870242109] = null;
		} else {
			this.field10519[0] = this.field10519[this.field10520 * -1870242109];
	...
	public boolean remove(Object arg0) {
		...
		this.field10517 += -439022545;
		this.field10520 -= 1418904043;
		if (this.field10520 * -1870242109 == var2.field2773 * 77488441) {
			this.field10519[this.field10520 * -1870242109] = null;
			return true;
		}
		class275 var3 = this.field10519[this.field10520 * -1870242109];
		this.field10519[this.field10520 * -1870242109] = null;
		this.field10519[var2.field2773 * 77488441] = var3;
		this.field10519[var2.field2773 * 77488441].field2773 = var2.field2773;
		this.method16904(var2.field2773 * 77488441);
		if (this.field10519[var2.field2773 * 77488441] == var3) {
			this.method16900(var2.field2773 * 77488441);
		}
		return true;
	}
	...
	public void method16900(int arg0) {
		...
		while (arg0 > 0) {
			...
			this.field10519[arg0].field2773 = arg0 * 392445193;
			arg0 = var3;
		}
	...
	public void method16904(int arg0) {
		class275 var2 = this.field10519[arg0];
		int var3 = this.field10520 * -1870242109 >>> 1;
		while (arg0 < var3) {
			int var4 = (arg0 << 1) + 1;
			...
			int var8;
			if (this.field10521 == null) {
				if (var6 < this.field10520 * -1870242109 && ((Comparable) var5.field2774).compareTo(var7.field2774) > 0) {
					var8 = var6;
				} else {
					var8 = var4;
				}
			} else if (var6 < this.field10520 * -1870242109 && this.field10521.compare(var5.field2774, var7.field2774) > 0) {
				var8 = var6;
			} else {
				var8 = var4;
			}
