...
public class class991 extends class914 {
	...
	public void method16975(long arg0, int arg1) {
		...
		if (var8.field2712 * -883149607 != 0) {
			if (this.field10560 - this.field10562 <= var8.field2734 * 2116282777) {
				int var9 = var8.field2736 * 1939081125 * arg1 + (this.field10559 >> 16 & 0xFF) + (this.field10144 >> 8 & 0xFF00);
				int var10 = var8.field2686 * 965712789 * arg1 + (this.field10559 >> 8 & 0xFF) + (this.field10144 & 0xFF00);
				int var11 = var8.field2738 * -725943773 * arg1 + ((this.field10144 & 0xFF) << 8) + (this.field10559 & 0xFF);
				if (var9 < 0) {
					var9 = 0;
				} else if (var9 > 65535) {
					var9 = 65535;
			...
			if (this.field10560 - this.field10562 <= var8.field2735 * 315263505) {
				int var12 = var8.field2739 * 446548983 * arg1 + (this.field10559 >> 24 & 0xFF) + (this.field10144 >> 16 & 0xFF00);
				if (var12 < 0) {
					var12 = 0;
				} else if (var12 > 65535) {
					var12 = 65535;
		...
		if (var8.field2685 * 1550475371 != -1 && this.field10560 - this.field10562 <= var8.field2740 * -1983571241) {
			this.field10563 += var8.field2741 * -674440885 * arg1;
		}
		if (var8.field2689 * 1535784783 != -1 && this.field10560 - this.field10562 <= var8.field2710 * -393313507) {
			this.field10148 += var8.field2729 * 802338257 * arg1;
		}
		double var13 = (double) this.field10564;
		double var15 = (double) this.field10565;
		double var17 = (double) this.field10566;
		boolean var19 = false;
		if (var8.field2683 * 674603273 == 1) {
			int var20 = var4 - this.field10561.field4908.field4956 * -495958955;
			int var21 = var5 - this.field10561.field4908.field4957 * 281090025;
			int var22 = var6 - this.field10561.field4908.field4958 * 1726873487;
			int var23 = (int) Math.sqrt((double) (var22 * var22 + var20 * var20 + var21 * var21)) >> 2;
			long var24 = (long) (var8.field2684 * -920262759 * var23 * arg1);
			this.field10563 = (int) ((long) this.field10563 - ((long) this.field10563 * var24 >> 18));
		} else if (var8.field2683 * 674603273 == 2) {
			int var26 = var4 - this.field10561.field4908.field4956 * -495958955;
			int var27 = var5 - this.field10561.field4908.field4957 * 281090025;
			int var28 = var6 - this.field10561.field4908.field4958 * 1726873487;
			int var29 = var28 * var28 + var26 * var26 + var27 * var27;
			long var30 = (long) (var8.field2684 * -920262759 * var29 * arg1);
		...
		if (var8.field2702 != null) {
			...
			label215: while (true) {
				...
				} while (var34.field2760 * -2140973065 == 1);
				boolean var35 = false;
				for (int var36 = 0; var36 < var8.field2702.length; var36++) {
					if (var34.field2748 * 771474227 == var8.field2702[var36]) {
						var35 = true;
						break;
					}
				}
				if (var35) {
					double var37 = (double) (var4 - var33.field9601 * -1360245021);
					double var39 = (double) (var5 - var33.field9603 * -1619657447);
					double var41 = (double) (var6 - var33.field9599 * 598201075);
					double var43 = var41 * var41 + var37 * var37 + var39 * var39;
					if (!(var43 > (double) (var34.field2771 * 51180681737109839L))) {
						double var45 = Math.sqrt(var43);
						if (var45 == 0.0D) {
							var45 = 1.0D;
						}
						double var47 = ((double) var33.field9605 * var41 + (double) var33.field9604 * var37 + (double) (var34.field2763 * -1469725003) * var39) * 65535.0D / ((double) (var34.field2770 * -931877173) * var45);
						if (!(var47 < (double) (var34.field2772 * 108989627))) {
							double var49 = 0.0D;
							if (var34.field2759 * 1776732021 == 1) {
								var49 = var45 / 16.0D * (double) (var34.field2766 * 426989679);
							} else if (var34.field2759 * 1776732021 == 2) {
								var49 = var45 / 16.0D * (var45 / 16.0D) * (double) (var34.field2766 * 426989679);
							}
							if (var34.field2768 * 1668381781 != 0) {
								double var51 = var37 / var45 * (double) (var34.field2770 * -931877173);
								double var53 = var39 / var45 * (double) (var34.field2770 * -931877173);
								double var55 = var41 / var45 * (double) (var34.field2770 * -931877173);
								if (var34.field2767 * 852642185 == 0) {
							...
							} else if (var34.field2767 * 852642185 == 0) {
								var13 += ((double) var33.field9604 - var49) * (double) arg1;
								var15 += ((double) (var34.field2763 * -1469725003) - var49) * (double) arg1;
								...
								this.field10146 = (int) ((double) this.field10146 + ((double) (var34.field2763 * -1469725003) - var49) * (double) arg1);
		...
		if (var8.field2674 != null) {
			for (int var57 = 0; var57 < var8.field2674.length; var57++) {
				...
				while (var58 != null) {
					...
					double var60 = (double) (var4 - var58.field9601 * -1360245021);
					double var62 = (double) (var5 - var58.field9603 * -1619657447);
					double var64 = (double) (var6 - var58.field9599 * 598201075);
					double var66 = var64 * var64 + var60 * var60 + var62 * var62;
					if (var66 > (double) (var59.field2771 * 51180681737109839L)) {
						...
						double var70 = ((double) var58.field9605 * var64 + (double) var58.field9604 * var60 + (double) (var59.field2763 * -1469725003) * var62) * 65535.0D / ((double) (var59.field2770 * -931877173) * var68);
						if (var70 < (double) (var59.field2772 * 108989627)) {
							var58 = (class811) class466.field4924.method11924();
						} else {
							double var72 = 0.0D;
							if (var59.field2759 * 1776732021 == 1) {
								var72 = var68 / 16.0D * (double) (var59.field2766 * 426989679);
							} else if (var59.field2759 * 1776732021 == 2) {
								var72 = var68 / 16.0D * (var68 / 16.0D) * (double) (var59.field2766 * 426989679);
							}
							if (var59.field2768 * 1668381781 != 0) {
								double var74 = var60 / var68 * (double) (var59.field2770 * -931877173);
								double var76 = var62 / var68 * (double) (var59.field2770 * -931877173);
								double var78 = var64 / var68 * (double) (var59.field2770 * -931877173);
								if (var59.field2767 * 852642185 == 0) {
							...
							} else if (var59.field2767 * 852642185 == 0) {
								var13 += ((double) var58.field9604 - var72) * (double) arg1;
								var15 += ((double) (var59.field2763 * -1469725003) - var72) * (double) arg1;
								...
								this.field10146 = (int) ((double) this.field10146 + ((double) (var59.field2763 * -1469725003) - var72) * (double) arg1);
		...
		if (var8.field2698 != null) {
			if (var8.field2705 == null) {
				...
				for (int var80 = 0; var80 < var8.field2698.length; var80++) {
					...
					var8.field2705[var80] = ((class802) class274.field2745.method11923((long) var8.field2698[var80])).field9556 * 1720545541;
				}
			}
			for (int var81 = 0; var81 < var8.field2705.length; var81++) {
				class274 var82 = class274.field2756[var8.field2705[var81]];
				if (var82.field2767 * 852642185 == 0) {
					var13 += var82.field2754 * 2118202961 * arg1;
					var15 += var82.field2763 * -1469725003 * arg1;
					var17 += var82.field2765 * 1368717711 * arg1;
					var19 = true;
				} else {
					this.field10145 += var82.field2754 * 2118202961 * arg1;
					this.field10146 += var82.field2763 * -1469725003 * arg1;
					this.field10147 += var82.field2765 * 1368717711 * arg1;
				}
			}
		}
		if (var19) {
	...
	public void method16987(class423 arg0, class14 arg1, long arg2) {
		int var5 = this.field10145 >> arg0.field4510 * -1694394771 + 12;
		int var6 = this.field10147 >> arg0.field4510 * -1694394771 + 12;
		int var7 = this.field10146 >> 12;
		if (var7 > 262144 || var7 < -262144 || var5 < 0 || var5 >= arg0.field4495 * 1336538301 || var6 < 0 || var6 >= arg0.field4496 * 583225963) {
			this.method16977();
			return;
		}
		...
		int var14;
		if (var11 < arg0.field4494 * 79110873 - 1) {
			var14 = var10[var11 + 1].method199(var5, var6);
		} else {
			var14 = var13 - (0x8 << arg0.field4510 * -1694394771);
		}
		if (var9.field2721) {
			if (var9.field2707 * -689326891 == -1 && var7 > var13) {
				this.method16977();
				return;
			}
			if (var9.field2707 * -689326891 >= 0 && var7 > var10[var9.field2707 * -689326891].method199(var5, var6)) {
				this.method16977();
				return;
			}
			if (var9.field2708 * -947025219 == -1 && var7 < var14) {
				this.method16977();
				return;
			}
			if (var9.field2708 * -947025219 >= 0 && var7 < var10[var9.field2708 * -947025219 + 1].method199(var5, var6)) {
				this.method16977();
				return;
			}
		}
		int var15;
		for (var15 = arg0.field4494 * 79110873 - 1; var15 > 0 && var7 > var10[var15].method199(var5, var6); var15--) {
		}
		if (var9.field2701 && var15 == 0 && var7 > var10[0].method199(var5, var6)) {
			this.method16977();
		} else if (arg0.field4494 * 79110873 - 1 == var15 && var10[var15].method199(var5, var6) - var7 > 0x8 << arg0.field4510 * -1694394771) {
			this.method16977();
		} else {
	...
	public void method16977() {
		...
		Statics.field4919[class466.field4921 * -1194923807] = this;
		class466.field4921 = (class466.field4921 * -1194923807 + 1 & 0x3FF) * 1209293601;
		this.method6975();
		this.method14730();
	}
}
