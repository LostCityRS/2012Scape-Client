...
import com.jagex.RebuildRequest;
import com.jagex.class36;
import com.jagex.RebuildType;
...
import com.jagex.WorldMapRelated;
...
import com.jagex.ClientScriptHelpers;
import com.jagex.ScriptFrame;
import com.jagex.ScriptRunner;
import com.jagex.ClientScriptState;
...
import com.jagex.ServerConnection;
...
import com.jagex.WorldMapAreaMetadata;
...
public class Statics {
	...
	@ObfuscatedName("ew.x")
	public static class164[] interfaces;
	...
	public static class902 localPlayerEntity;
	...
	public static class815 preferences;
	...
	public static class61[] clanChatUsers;
	...
	public static class334 clientScriptsJs5;
	...
	@ObfuscatedName("uu.j")
	public static class573 currentWorld;
	...
	@ObfuscatedName("uu.u")
	public static class573 currentLobby;
	...
	public static void method4012() {
		ClientScriptHelpers.cache.method7959();
	}
	...
	public static class815 method2808() {
		...
		try {
			...
			var1 = new class815(new Packet(var2), client.field9163, 0);
	...
	public static void method4790() {
		class374.method6512(22050, preferences.field9676.method15891() == 1, 2);
	...
	public static void method7789(String arg0, String arg1, int arg2, boolean arg3) {
		...
		class792 var4 = class792.method14781(class280.field2924, client.lobbyConnection.randomOut);
		var4.field9467.p2(0);
		...
		client.lobbyConnection.method1913(var4);
		if (arg2 < 13) {
	...
	public static void method1638() {
		class466.field4924 = new IterableMap(8);
	...
	public static void method1245() {
		...
		try {
			...
			Packet var1 = preferences.method15447();
	...
	public static final boolean method42() {
		return jaclib.memory.Stream.field367;
	}
	...
	public static boolean method2581(class14 arg0, int arg1) {
		...
		for (int var25 = var7; var25 < var2 + var7; var25 += var6) {
			for (int var26 = var8; var26 < var3 + var8; var26 += var6) {
				...
				if (class58.field755) {
					class361 var42 = client.world.method6101(arg1);
				...
				for (int var70 = 0; var70 < var68.field4255; var70++) {
					...
					if (var71 >> 28 == localPlayerEntity.level) {
						...
						if (var72 >= 0 && var72 < var2 && var73 >= 0 && var73 < var3) {
							class58.field758.method11558(new IntNode(var70));
						} else {
	...
	public static class876 method1395() {
		...
		if (var1) {
			try {
				...
				if (preferences.field9661.method15781() == 2) {
					var0.method15941(1);
				}
		...
		if (var3) {
			try {
				...
				if (preferences.field9661.method15781() == 3) {
					var0.method15941(4);
					class122 var9 = toolkit.method456();
		...
		if (var4) {
			try {
				...
				if (preferences.field9661.method15781() == 1) {
					var0.method15941(2);
				}
		...
		while (true) {
			try {
				...
				if (!var2.isErrorAny() && var3 >= 0 && var4 >= 0) {
					...
					var6.grabPixels();
					return toolkit.method506(var5, 0, var3, var3, var4);
				}
				throw new RuntimeException("");
	...
	public static void method7394(PacketBit arg0, int arg1) {
		...
		if (var4 == 0) {
			if (var3) {
				...
				var6.field570 = (var2.z + var5.field8643[0] >> 6) + (var2.x + var5.field8642[0] >> 6 << 14) + (var5.level << 28);
			...
			if (var13 == 0) {
				...
				if (client.world.getSceneLevelTileFlags().method5794(var18, var19)) {
					var5.field9809++;
				}
				...
				int var24 = (var2.x + var5.field8642[0] + var22 & 0x3FFF) - var2.x;
				int var25 = (var2.z + var5.field8643[0] + var23 & 0x3FFF) - var2.z;
				if (var3) {
				...
				if (client.world.getSceneLevelTileFlags().method5794(var24, var25)) {
					var5.field9809++;
				}
	...
	public static void method12343(class509 arg0, int arg1, class836 arg2) {
		if (class395.field4209 >= 50 || (arg0 == null || arg0.field6338 == null || arg1 >= arg0.field6338.length || arg0.field6338[arg1] == null || localPlayerEntity.level != arg2.level)) {
			return;
		}
		...
		if (var6 != 0) {
			if (localPlayerEntity == arg2) {
				if (preferences.field9654.method15899() == 0) {
					return;
				}
			} else if (preferences.field9672.method15899() == 0) {
				return;
			}
			if (arg0.field6339 != -1) {
				int var10 = 0;
	...
	public static void method5540() {
		...
		if (class43.field631 < 2) {
			currentLobby.configureSocketType();
			class43.field634 = 0;
			class43.field631++;
	...
	public static void method3529(class334 arg0, class334 arg1, class334 arg2, class334 arg3) {
		...
		field1191 = arg1;
		field1600 = arg2;
		interfaces = new class164[field1928.method5638()];
	...
	public static void method3211(int arg0, String arg1, int arg2) {
		...
		ScriptRunner.execute(var3, 200000, var4);
	}
	...
	public static boolean method3110(PacketBit arg0, int arg1) {
		...
		if (var2 == 0) {
			...
			class902 var7 = client.field9070[arg1] = new class902(client.world.getScene());
			var7.field8593 = arg1;
			...
			if (client.world.getSceneLevelTileFlags().method5794(var13, var14)) {
				var7.field9809++;
			}
	...
	public static void method7906(int arg0) {
		field3537 = arg0;
		WeightedCache var1 = class471.field4998;
		synchronized (class471.field4998) {
			class471.field4998.method7922();
		}
		WeightedCache var3 = class471.field5012;
	...
	public static void method7573() {
		WeightedCache var0 = class471.field5012;
		synchronized (class471.field5012) {
			class471.field5012.method7925();
		}
		WeightedCache var2 = class471.field4998;
		synchronized (class471.field4998) {
	...
	public static int[] method3289(class944 arg0) {
		...
		if (class42.method5562(arg0.field10340)) {
			...
			LocType var5 = client.world.getLocTypeList().method11471((int) (arg0.field10333 >>> 32 & 0x7FFFFFFFL));
		...
		if (localPlayerEntity != arg0) {
			...
			if (arg0.field10046 == 0) {
				...
				if (arg0.field10047 >= arg0.field10048) {
					var6 = arg0.method16120(true) + (var2 ? class42.method2609(arg0.field10047, localPlayerEntity.field10047) : TextUtil.method3978(16777215)) + TextUtil.field489 + var5 + arg0.field10047 + TextUtil.field487;
				} else {
					var6 = arg0.method16120(true) + (var2 ? class42.method2609(arg0.field10047, localPlayerEntity.field10047) : TextUtil.method3978(16777215)) + TextUtil.field489 + var5 + arg0.field10047 + "+" + (arg0.field10048 - arg0.field10047) + TextUtil.field487;
				}
			} else if (arg0.field10046 == -1) {
				var6 = arg0.method16120(true);
			} else {
				var6 = arg0.method16120(true) + TextUtil.field489 + class588.field6988.method12206(field2308) + arg0.field10046 + TextUtil.field487;
			}
			...
			method8140(client.field9103, client.field9151 + " " + TextUtil.field491 + " " + TextUtil.method3978(16777215) + class588.field7007.method12206(field2308), field477, 16, -1, 0L, 0, 0, true, false, (long) arg0.field8593, false);
		}
	}
	...
	public static void method15936(class944 arg0, int arg1, int arg2) {
		...
		if (var5 == 59) {
			...
			var12.field9467.p2_alt3(var9.z + var4);
			var12.field9467.p2(client.field9101);
			var12.field9467.p2(var9.x + var3);
		...
		if (var13 != null) {
			...
			var14.field9467.p2_alt1(var9.z + var4);
			var14.field9467.p2(var9.x + var3);
		...
		if (var5 == 2) {
			...
			var15.field9467.p2_alt2(var9.z + var4);
			var15.field9467.p2_alt3(var9.x + var3);
		...
		if (var16 != null) {
			...
			var17.field9467.p2_alt3(var9.z + var4);
			var17.field9467.p4_alt1((int) (var7 >>> 32) & Integer.MAX_VALUE);
			var17.field9467.p2_alt3(var9.x + var3);
		...
		if (var5 == 23) {
			if (client.field9074 > 0 && method1314()) {
				...
				if (var6 == 1) {
					...
					Vector3 var19 = localPlayerEntity.method8565().field3464;
		...
		if (var5 == 16) {
			...
			var20.field9467.p2_alt1(localPlayerEntity.field8593);
		...
		if (var5 == 17) {
			...
			var23.field9467.p2_alt3(var9.z + var4);
			...
			var23.field9467.p2(var9.x + var3);
		...
		if (var5 == 60) {
			if (client.field9074 > 0 && method1314()) {
				...
				var24.field9467.p2_alt3(var9.x + var3);
				var24.field9467.p2_alt3(var9.z + var4);
	...
	public static void method7913(int arg0) {
		if (preferences.field9640.method15908() == 0) {
			arg0 = -1;
		}
	...
	public static final void method6848() {
		...
		if (field3357 == null) {
			if (class153.method5554() >= field3307) {
				field3357 = client.field9192.method8637(currentWorld.field6765);
			}
		...
		if (class46.method14782()) {
			...
			try {
				if (field2671 != 2) {
					...
					var17.method14091(class810.method8611(currentPlayerLevel, cameraX + var18.x * 512, -field8423, cameraZ + var18.z * 512));
				...
				field1307.method3727((float) (class153.method5554() - field2633) / 1000.0F, client.world.method6101(currentPlayerLevel), client.world.getMapLoader().field3697);
		...
		if (client.field9017 > 10) {
			client.field8975.idleNetCycles++;
		}
		if (client.field8975.idleNetCycles > 2250) {
			client.method8047();
			return;
		}
		if (client.field8988 == 2) {
			...
			if (client.field8988 == 4 && class144.method2467(client.field9059)) {
				client.world.rebuildMap(new RebuildRequest(RebuildType.field3839, null));
				client.field8988 = 3;
			}
		...
		while (true) {
			...
			do {
				...
				if (var27 == null) {
					while (true) {
						...
						do {
									...
									do {
										...
										if (var33 == null) {
											...
											if (client.field9074 > 0 && field2131.method7243(82) && field2131.method7243(81) && client.field9002 != 0) {
												...
												method2617(var36, var37.x + localPlayerEntity.field8642[0], var37.z + localPlayerEntity.field8643[0]);
											}
										...
										var35 = class165.method11381(var34.layer);
							...
							var32 = class165.method11381(var31.layer);
				...
				var29 = class165.method11381(var28.layer);
			} while (var29 == null || var29.subcomponents == null || var28.id >= var29.subcomponents.length || var29.subcomponents[var28.id] != var28);
	...
	public static final void method14216(int arg0) {
		...
		Vector3 var4 = localPlayerEntity.method8565().field3464;
		client.method7768(field2297, client.method8663((int) var4.field3475, (int) var4.field3477, currentPlayerLevel) - client.field9027, field6818, var2, var3, (var2 >> 3) * 3 + 600 << 2, arg0);
	...
	public static final void method7981(ClientScriptState arg0) {
		int var1 = arg0.intOperands[arg0.pc];
		arg0.osp -= var1;
		String var2 = class526.method3527(arg0.objectStack, arg0.osp, var1);
	...
	public static final int method3510(PathingEntity arg0) {
		...
		if (arg0 instanceof class902) {
			...
			if (var7.field10080 != -1 && (var7.field8628 == 0 || var7.field8648 > 0)) {
				...
				CoordGrid var9 = client.world.method6214();
				int var10 = (int) var8.field3475 - (var7.field10080 * 256 - var9.x * 256 - var9.x * 256);
				int var11 = (int) var8.field3477 - (var7.field10070 * 256 - var9.z * 256 - var9.z * 256);
				if (var10 != 0 || var11 != 0) {
	...
	public static final void method4729(ClientScriptState arg0) {
		...
		IntNode var2 = (IntNode) var1.method11923((long) arg0.intStack[--arg0.isp]);
		if (var2 != null) {
	...
	public static final void method16642(boolean arg0, ClientScriptState arg1) {
		...
		class164 var4 = interfaces[var2 >> 16];
		if (arg0) {
	...
	public static final void method3983(class165 arg0, ClientScriptState arg1) {
		if (client.method14331(arg0).method14927() && client.field9108 == null) {
			method11509(arg0.parentLayer, arg0.id);
			client.field9108 = class165.method15145(arg0.parentLayer, arg0.id);
			client.requestRedrawComponent(client.field9108);
		}
	}
	...
	public static final void method5938(ClientScriptState arg0) {
		...
		class164 var3 = interfaces[var1 >> 16];
		ScriptRunner.method7912(var2, var3, arg0);
	}

	@ObfuscatedName("aey.di(Lew;Lej;Lrn;B)V")
	public static final void method15567(class165 arg0, class164 arg1, ClientScriptState arg2) {
	...
	public static final void method11240(int arg0, int arg1, int arg2, int arg3, boolean arg4) {
		...
		if (var7 < client.field9199) {
			...
			if (var6 > client.field9188) {
				...
				if (arg4) {
					toolkit.method753();
					toolkit.method496(arg0, arg1, var10, arg3, -16777216);
					toolkit.method496(arg0 + arg2 - var10, arg1, var10, arg3, -16777216);
				}
				arg0 += var10;
				arg2 -= var10 * 2;
			}
			...
			if (var6 < client.field9197) {
				...
				if (arg4) {
					toolkit.method753();
					toolkit.method496(arg0, arg1, arg2, var13, -16777216);
					toolkit.method496(arg0, arg1 + arg3 - var13, arg2, var13, -16777216);
				}
				arg1 += var13;
				arg3 -= var13 * 2;
			}
	...
	public static final void method7076() {
		int var0 = preferences.field9655.method15735();
		if (var0 == 0) {
	...
	public static final void method12994(class165 arg0, class164 arg1, ClientScriptState arg2) {
	...
	public static final void method7967(class165 arg0, class164 arg1, ClientScriptState arg2) {
		arg2.isp -= 2;
	...
	public static final void method7179(class165 arg0, class164 arg1, ClientScriptState arg2) {
		if (arg0.type == 4) {
			...
			if (client.field9213 > var1.field10622) {
				...
				if (var1.field10626 > 0) {
					if (client.field8988 == 0) {
						...
						if (var2 != null) {
							...
							if ((int) var3.field3475 >= 0 && (int) var3.field3475 < client.world.getSizeX() * 512 && (int) var3.field3477 >= 0 && (int) var3.field3477 < client.world.getSizeZ() * 512) {
								var1.method17162((int) var3.field3475, (int) var3.field3477, client.method8663((int) var3.field3475, (int) var3.field3477, var2.level) - var1.field10620, client.field9213);
							}
						}
					} else {
						...
						if (var4 != null) {
							...
							if ((int) var6.field3475 >= 0 && (int) var6.field3475 < client.world.getSizeX() * 512 && (int) var6.field3477 >= 0 && (int) var6.field3477 < client.world.getSizeZ() * 512) {
								var1.method17162((int) var6.field3475, (int) var6.field3477, client.method8663((int) var6.field3475, (int) var6.field3477, var1.level) - var1.field10620, client.field9213);
							}
						}
					}
				}
				if (var1.field10626 < 0) {
					...
					if (var8 != null) {
						...
						if ((int) var9.field3475 >= 0 && (int) var9.field3475 < client.world.getSizeX() * 512 && (int) var9.field3477 >= 0 && (int) var9.field3477 < client.world.getSizeZ() * 512) {
							var1.method17162((int) var9.field3475, (int) var9.field3477, client.method8663((int) var9.field3475, (int) var9.field3477, var1.level) - var1.field10620, client.field9213);
						}
					}
				}
	...
	public static final void method8049(class165 arg0, class164 arg1, ClientScriptState arg2) {
		arg0.field1806 = 3;
		arg0.field1838 = client.field9071;
		arg0.field1832 = 0;
		if (arg0.id == -1 && !arg1.field1734) {
			method4107(arg0.parentLayer);
		}
	}
	...
	public static final void method6788(class165 arg0, class164 arg1, ClientScriptState arg2) {
		arg0.field1806 = 5;
	...
	public static final void method3319(class165 arg0, class164 arg1, ClientScriptState arg2) {
		arg0.field1852 = null;
	}

	@ObfuscatedName("ks.jl(Lew;Lej;Lrn;I)V")
	public static final void method5069(class165 arg0, class164 arg1, ClientScriptState arg2) {
	...
	public static final void method12479(PathingEntity arg0, PathingEntity arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
		...
		if (var11 == null) {
			...
			var11 = toolkit.method517(var12[0], true);
			client.field9131.method7937(var11, (long) var9);
		}
		Vector3 var13 = arg0.method8565().field3464;
		client.method1979(arg0.level, (int) var13.field3475, (int) var13.field3477, arg0.method13954() * 256, 0, false);
		...
		if (arg0 == arg1) {
			toolkit.method482(var16 - 1, var17 - 1, 18, 18, -256);
		}
	...
	public static final void method7900(class165 arg0, class164 arg1, ClientScriptState arg2) {
	...
	public static final void method4583(class165 arg0, class164 arg1, ClientScriptState arg2) {
	...
	public static final void method15654(class165 arg0, class164 arg1, ClientScriptState arg2) {
		String var3 = (String) arg2.objectStack[--arg2.osp];
	...
	public static final void method3070(class165 arg0, class164 arg1, ClientScriptState arg2) {
		String var3 = (String) arg2.objectStack[--arg2.osp];
		if (ScriptRunner.method3662(var3, arg2) != null) {
			var3 = var3.substring(0, var3.length() - 1);
		}
	...
	public static final void method2929(class165 arg0, class164 arg1, ClientScriptState arg2) {
		String var3 = (String) arg2.objectStack[--arg2.osp];
		if (ScriptRunner.method3662(var3, arg2) != null) {
			var3 = var3.substring(0, var3.length() - 1);
		}
	...
	public static final void method3944(ClientScriptState arg0) {
		class504 var1 = arg0.secondary ? arg0.activeComponent2 : arg0.activeComponent;
		class165 var2 = var1.com;
		arg0.intStack[++arg0.isp - 1] = var2.field1903;
	}
	...
	public static final void method5714(class165 arg0, ClientScriptState arg1) {
		int var2 = arg1.intStack[--arg1.isp];
	...
	public static final void method11638(ClientScriptState arg0) {
		...
		arg0.intStack[++arg0.isp - 1] = var1.field1903;
	}
	...
	public static final void method12702(ClientScriptState arg0) {
		...
		class504 var3 = arg0.secondary ? arg0.activeComponent2 : arg0.activeComponent;
		client.method8390(var3.com, var1, var2);
	}
	...
	public static final void method8398(ClientScriptState arg0) {
		arg0.isp -= 4;
		class395.method1717(arg0.intStack[arg0.isp], arg0.intStack[arg0.isp + 1], arg0.intStack[arg0.isp + 2], arg0.intStack[arg0.isp + 3], false, 256);
	}
	...
	public static final void method3531(ClientScriptState arg0) {
		arg0.intStack[++arg0.isp - 1] = currentWorld.field6768;
	}
	...
	public static final void method5827(ClientScriptState arg0) {
		arg0.intStack[++arg0.isp - 1] = field7136.method7255();
	}
	...
	public static final void method3939(ClientScriptState arg0) {
		arg0.intStack[++arg0.isp - 1] = arg0.field5226.field2354;
	}

	@ObfuscatedName("ol.yo(Lrn;B)V")
	public static final void method7074(ClientScriptState arg0) {
		int var1 = arg0.intStack[--arg0.isp];
		arg0.objectStack[++arg0.osp - 1] = arg0.field5217.field9429[var1].field2343;
	}
	...
	public static final void method5571(ClientScriptState arg0) {
		int var1 = arg0.intStack[--arg0.isp];
		arg0.intStack[++arg0.isp - 1] = class526.method8060((char) var1) ? 1 : 0;
	}
	...
	public static final void method6647(ClientScriptState arg0) {
		int var1 = arg0.intStack[--arg0.isp];
		arg0.intStack[++arg0.isp - 1] = field3492.method12316(var1).field7078 == 1 ? 1 : 0;
	}
	...
	public static final void method3207(ClientScriptState arg0) {
		int var1 = arg0.intStack[--arg0.isp];
		arg0.intStack[++arg0.isp - 1] = field3492.method12316(var1).field7085;
	}

	@ObfuscatedName("nx.abk(Lrn;B)V")
	public static final void method6829(ClientScriptState arg0) {
		int var1 = arg0.intStack[--arg0.isp];
		arg0.intStack[++arg0.isp - 1] = field3492.method12316(var1).field7068;
	}
	...
	public static void method11974(class165 arg0, int arg1, int arg2) {
		...
		field4166 = arg0.parentLayer;
		client.field9101 = arg0.id;
		field4822 = arg1;
		field7366 = arg2;
	...
	public static final void method3642(ClientScriptState arg0) {
		arg0.intStack[++arg0.isp - 1] = class822.field9753 == 100 ? 1 : 0;
	}
	...
	public static final void method3585(ClientScriptState arg0) {
		WorldMapAreaMetadata var1 = class822.method12024();
		if (var1 == null) {
			arg0.intStack[++arg0.isp - 1] = -1;
			arg0.intStack[++arg0.isp - 1] = -1;
			return;
		}
		boolean var2 = var1.method16707(field4465 + field4283, field6770 + field4284, ScriptRunner.result);
		if (var2) {
	...
	public static final void method2611(ClientScriptState arg0) {
		int var1 = client.field9076[arg0.intStack[--arg0.isp]].length >> 1;
		arg0.intStack[++arg0.isp - 1] = var1;
	}
	...
	public static final void method3622(ClientScriptState arg0) throws class884 {
		field1307.method3696((float) arg0.intStack[--arg0.isp] / 1000.0F);
	}

	@ObfuscatedName("iy.aio(Lrn;I)V")
	public static final void method4697(ClientScriptState arg0) throws class884 {
		arg0.isp -= 4;
	...
	public static final void method8091(ClientScriptState arg0) {
		arg0.intStack[++arg0.isp - 1] = class33.field507;
	}

	@ObfuscatedName("eu.ajc(Lrn;I)V")
	public static final void method2932(ClientScriptState arg0) {
		if (client.state == 3) {
			class792 var1 = class792.method14781(class280.field2949, client.lobbyConnection.randomOut);
	...
	public static final void method5615(ClientScriptState arg0) {
		arg0.intStack[++arg0.isp - 1] = class33.field545;
	}
	...
	public static final void method8622(ClientScriptState arg0) {
		preferences.method15448(preferences.field9672, arg0.intStack[--arg0.isp]);
		method1245();
	...
	public static void method5567(class165 arg0) {
		if (arg0.type == 5 && arg0.field1903 != -1) {
			class52.method8730(toolkit, arg0);
		}
	}

	@ObfuscatedName("lf.akf(Lrn;I)V")
	public static final void method6069(ClientScriptState arg0) {
		preferences.method15448(preferences.buildArea, arg0.intStack[--arg0.isp]);
		method1245();
		client.field8932 = false;
	}
	...
	public static final void method4711(ClientScriptState arg0) {
		...
		preferences.method15448(preferences.field9670, var1);
		if (!var2) {
			preferences.method15448(preferences.field9633, 0);
		}
		method1245();
		client.field8932 = false;
	}
	...
	public static final void method14199(ClientScriptState arg0) {
		arg0.intStack[++arg0.isp - 1] = preferences.field9660.method15735() == 2 ? 1 : 0;
	}

	@ObfuscatedName("gm.ali(Lrn;I)V")
	public static final void method3967(ClientScriptState arg0) {
		arg0.intStack[++arg0.isp - 1] = preferences.field9676.method15891() == 1 ? 1 : 0;
	}

	@ObfuscatedName("wb.alf(Lrn;I)V")
	public static final void method12728(ClientScriptState arg0) {
		arg0.intStack[++arg0.isp - 1] = preferences.field9674.method15899();
	}
	...
	public static final void method8633(class165 arg0) {
		...
		arg0.field1806 = 5;
		arg0.field1838 = client.field9071;
		arg0.field1832 = class526.method1347(localPlayerEntity.field10040);
		class874 var1 = localPlayerEntity.field8616;
		if (var1 == null) {
			arg0.field1789 = null;
			return;
		}
	...
	public static final void method12716(String arg0) {
		...
		for (int var2 = 0; var2 < client.friendsCount; var2++) {
			...
			if (class160.method7055(arg0, var1, var4, var5)) {
				client.friendsCount--;
				for (int var6 = var2; var6 < client.friendsCount; var6++) {
	...
	public static final void method11369(String arg0) {
		...
		for (int var2 = 0; var2 < client.ignoresCount; var2++) {
			class45 var3 = client.field8999[var2];
			String var4 = var3.field639;
			String var5 = class625.method4744(var4);
			if (class160.method7055(arg0, var1, var4, var5)) {
				client.ignoresCount--;
				for (int var6 = var2; var6 < client.ignoresCount; var6++) {
	...
	public static final void method2426(ClientScriptState arg0) {
		...
		arg0.intStack[++arg0.isp - 1] = (int) ((field6701 - class153.method5554() - field3384) / 60000L);
	...
	public static void method11760(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, boolean arg14, int arg15) {
		...
		class1009 var21 = new class1009(client.world.getScene(), arg0, field3161, field3161, arg6, arg7, arg4, client.field9213 + arg10, client.field9213 + arg11, arg12, arg13, arg1, arg2, arg5, arg14, arg3, arg15);
	...
	public static final void method12185(ClientScriptState arg0) {
		arg0.intStack[++arg0.isp - 1] = ((class903) arg0.activeEntity).field10075.field7211;
	}
