...
public final class Stream {
	...
	public void method35(Buffer arg0, int arg1, int arg2) {
		this.method41();
		this.field362 = arg0;
		this.field364 = arg1 * 1886881679;
		this.field363 = (arg1 + arg2) * -972522321;
		if (this.field363 * -1405855153 > arg0.method31()) {
	...
	public int method36() {
		return this.field365 * -1570267835 + this.field364 * 116111215;
	}

	@ObfuscatedName("jaclib/memory/Stream.a(I)V")
	public void method37(int arg0) {
		this.method41();
		this.field364 = arg0 * 1886881679;
	}

	@ObfuscatedName("jaclib/memory/Stream.s(I)V")
	public void method38(int arg0) {
		if (this.field365 * -1570267835 >= this.field366.length) {
			this.method41();
		}
		this.field366[(this.field365 += -1231524467) * -1570267835 - 1] = (byte) arg0;
	}

	@ObfuscatedName("jaclib/memory/Stream.c(F)V")
	public void method39(float arg0) {
		if (this.field365 * -1570267835 + 3 >= this.field366.length) {
			this.method41();
		}
		int var2 = floatToRawIntBits(arg0);
		this.field366[(this.field365 += -1231524467) * -1570267835 - 1] = (byte) (var2 >> 24);
		this.field366[(this.field365 += -1231524467) * -1570267835 - 1] = (byte) (var2 >> 16);
		this.field366[(this.field365 += -1231524467) * -1570267835 - 1] = (byte) (var2 >> 8);
		this.field366[(this.field365 += -1231524467) * -1570267835 - 1] = (byte) var2;
	}
	...
	public void method41() {
		if (this.field365 * -1570267835 <= 0) {
			return;
		}
		if (this.field365 * -1570267835 + this.field364 * 116111215 > this.field363 * -1405855153) {
			throw new RuntimeException();
		}
		this.field362.method13(this.field366, 0, this.field364 * 116111215, this.field365 * -1570267835);
		this.field364 += this.field365 * -1495057269;
		this.field365 = 0;
	}
