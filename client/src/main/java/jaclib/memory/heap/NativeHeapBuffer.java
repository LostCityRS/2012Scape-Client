...
public final class NativeHeapBuffer implements Buffer, Source {
	...
	public NativeHeapBuffer(NativeHeap arg0, int arg1, int arg2) {
		this.field371 = arg0;
		this.field372 = arg1 * 548540291;
		this.field370 = arg2 * -2081008383;
	}
	...
	public final long method32() {
		return this.field371.getBufferAddress(this.field372 * 1281423147);
	}

	@ObfuscatedName("jaclib/memory/heap/NativeHeapBuffer.u()I")
	public final int method31() {
		return this.field370 * 121809665;
	}
	...
	public final synchronized void method13(byte[] arg0, int arg1, int arg2, int arg3) {
		if (!this.method61() | arg0 == null | arg1 < 0 | arg1 + arg3 > arg0.length | arg2 < 0 | arg2 + arg3 > this.field370 * 121809665) {
			throw new RuntimeException();
		}
		this.field371.put(this.field372 * 1281423147, arg0, arg1, arg2, arg3);
	}

	@ObfuscatedName("jaclib/memory/heap/NativeHeapBuffer.z()V")
	public final synchronized void method62() {
		if (this.method61()) {
			this.field371.deallocateBuffer(this.field372 * 1281423147);
		}
		this.field373 = false;
	}
